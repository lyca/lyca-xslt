...
public class XMLErrorResources_hu extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CANNOT_OVERWRITE_CAUSE, "Nem lehet fel\u00fcl\u00edrni az okot" },

            { ER_NO_DEFAULT_IMPL, "Nem tal\u00e1lhat\u00f3 alap\u00e9rtelmezett megval\u00f3s\u00edt\u00e1s " },

            { ER_CHUNKEDINTARRAY_NOT_SUPPORTED, "A ChunkedIntArray({0}) jelenleg nem t\u00e1mogatott" },

            { ER_OFFSET_BIGGER_THAN_SLOT, "Az eltol\u00e1s nagyobb mint a ny\u00edl\u00e1s" },

            { ER_COROUTINE_NOT_AVAIL, "T\u00e1rs szubrutin nem \u00e9rhet\u0151 el, id={0}" },

            { ER_COROUTINE_CO_EXIT, "CoroutineManager \u00e9rkezett a co_exit() k\u00e9r\u00e9sre" },

            { ER_COJOINROUTINESET_FAILED, "A co_joinCoroutineSet() nem siker\u00fclt " },

            { ER_COROUTINE_PARAM, "T\u00e1rs szubrutin param\u00e9terhiba ({0})" },
            ...
            { ER_ITERATOR_CLONE_NOT_SUPPORTED, "Az iter\u00e1tor kl\u00f3noz\u00e1sa nem t\u00e1mogatott" },

            { ER_UNKNOWN_AXIS_TYPE, "Ismeretlen tengely bej\u00e1r\u00e1si \u00fat t\u00edpus: {0}" },

            { ER_AXIS_NOT_SUPPORTED, "A tengely bej\u00e1r\u00e1si \u00fat nem t\u00e1mogatott: {0}" },

            { ER_NO_DTMIDS_AVAIL, "Nincs t\u00f6bb DTM azonos\u00edt\u00f3" },

            { ER_NOT_SUPPORTED, "Nem t\u00e1mogatott: {0}" },

            { ER_NODE_NON_NULL, "A csom\u00f3pont nem lehet null a getDTMHandleFromNode f\u00fcggv\u00e9nyhez" },

            { ER_COULD_NOT_RESOLVE_NODE, "A csom\u00f3pontot nem lehet azonos\u00edt\u00f3ra feloldani" },

            { ER_STARTPARSE_WHILE_PARSING,
                    "A startParse f\u00fcggv\u00e9nyt nem h\u00edvhatja meg \u00e9rtelmez\u00e9s k\u00f6zben" },

            { ER_STARTPARSE_NEEDS_SAXPARSER, "A startParse f\u00fcggv\u00e9nyhez nemnull SAXParser sz\u00fcks\u00e9ges" },

            { ER_COULD_NOT_INIT_PARSER, "Nem lehet inicializ\u00e1lni az \u00e9rtelmez\u0151t ezzel" },
            ...
            { ER_SCHEME_REQUIRED, "S\u00e9ma sz\u00fcks\u00e9ges." },

            { ER_NO_SCHEME_IN_URI, "Nem tal\u00e1lhat\u00f3 s\u00e9ma az URI-ban: {0}" },

            { ER_NO_SCHEME_INURI, "Nem tal\u00e1lhat\u00f3 s\u00e9ma az URI-ban" },

            { ER_PATH_INVALID_CHAR, "Az el\u00e9r\u00e9si \u00fat \u00e9rv\u00e9nytelen karaktert tartalmaz: {0}" },

            { ER_SCHEME_FROM_NULL_STRING,
                    "Nem lehet be\u00e1ll\u00edtani a s\u00e9m\u00e1t null karaktersorozatb\u00f3l" },

            { ER_SCHEME_NOT_CONFORMANT, "A s\u00e9ma nem megfelel\u0151." },

            { ER_HOST_ADDRESS_NOT_WELLFORMED, "A hoszt nem j\u00f3l form\u00e1zott c\u00edm" },

            { ER_PORT_WHEN_HOST_NULL, "A portot nem \u00e1ll\u00edthatja be, ha a hoszt null" },

            { ER_INVALID_PORT, "\u00c9rv\u00e9nytelen portsz\u00e1m" },

            { ER_FRAG_FOR_GENERIC_URI, "Csak \u00e1ltal\u00e1nos URI-hoz \u00e1ll\u00edthat be t\u00f6red\u00e9ket " },

            { ER_FRAG_WHEN_PATH_NULL,
                    "A t\u00f6red\u00e9ket nem \u00e1ll\u00edthatja be, ha az el\u00e9r\u00e9si \u00fat null" },

            { ER_FRAG_INVALID_CHAR, "A t\u00f6red\u00e9k \u00e9rv\u00e9nytelen karaktert tartalmaz" },

            { ER_PARSER_IN_USE, "Az \u00e9rtelmez\u0151 m\u00e1r haszn\u00e1latban van" },

            { ER_CANNOT_CHANGE_WHILE_PARSING,
                    "Nem v\u00e1ltoztathat\u00f3 meg a(z) {0} {1} \u00e9rtelmez\u00e9s k\u00f6zben" },

            { ER_SELF_CAUSATION_NOT_PERMITTED, "Az \u00f6n-megokol\u00e1s nem megengedett" },

            { ER_NO_USERINFO_IF_NO_HOST,
                    "Nem adhatja meg a felhaszn\u00e1l\u00f3i inform\u00e1ci\u00f3kat, ha nincs megadva hoszt" },

            { ER_NO_PORT_IF_NO_HOST, "Nem adhatja meg a portot, ha nincs megadva hoszt" },
            ...
            { ER_CANNOT_INIT_URI_EMPTY_PARMS, "Az URI nem inicializ\u00e1lhat\u00f3 \u00fcres param\u00e9terekkel" },

            { ER_METHOD_NOT_SUPPORTED, "A met\u00f3dus m\u00e9g nem t\u00e1mogatott " },

            { ER_INCRSAXSRCFILTER_NOT_RESTARTABLE,
                    "Az IncrementalSAXSource_Filter jelenleg nem \u00ednd\u00edthat\u00f3 \u00fajra" },

            { ER_XMLRDR_NOT_BEFORE_STARTPARSE, "Az XMLReader nem a startParse k\u00e9r\u00e9s el\u0151tt van " },

            { ER_AXIS_TRAVERSER_NOT_SUPPORTED, "A tengely bej\u00e1r\u00e1si \u00fat nem t\u00e1mogatott: {0}" },

            { ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER,
                    "A ListingErrorHandler null PrintWriter \u00e9rt\u00e9kkel j\u00f6tt l\u00e9tre." },

            { ER_SYSTEMID_UNKNOWN, "Ismeretlen SystemId" },

            { ER_LOCATION_UNKNOWN, "A hiba helye ismeretlen" },

            { ER_PREFIX_MUST_RESOLVE, "Az el\u0151tagnak egy n\u00e9vt\u00e9rre kell felold\u00f3dnia: {0}" },

            { ER_CREATEDOCUMENT_NOT_SUPPORTED, "A createDocument() nem t\u00e1mogatott az XPathContext-ben." },

            { ER_CHILD_HAS_NO_OWNER_DOCUMENT, "Az attrib\u00fatum ut\u00f3dnak nincs tulajdonos dokumentuma." },
            ...
            { ER_CANT_HAVE_MORE_THAN_ONE_ROOT, "Nem lehet egyn\u00e9l t\u00f6bb gy\u00f6k\u00e9r a DOM-ban" },

            { ER_ARG_LOCALNAME_NULL, "A 'localName' argumentum null" },
            ...
            { ER_ARG_LOCALNAME_INVALID, "A QNAME-beli helyi n\u00e9vnek egy \u00e9rv\u00e9nyes NCName-nek kell lennie" },
            ...
            // indicates
            // that there is a problem with that part of the QNAME.
            { ER_ARG_PREFIX_INVALID, "A QNAME-beli el\u0151tagnak \u00e9rv\u00e9nyes NCName-nek kell lennie" },

            { ER_NAME_CANT_START_WITH_COLON, "A n\u00e9v nem kezd\u0151dhet kett\u0151sponttal" },
