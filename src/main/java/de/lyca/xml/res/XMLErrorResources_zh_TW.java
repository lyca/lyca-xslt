...
public class XMLErrorResources_zh_TW extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CANNOT_OVERWRITE_CAUSE, "\u7121\u6cd5\u6539\u5beb\u539f\u56e0" },

            { ER_NO_DEFAULT_IMPL, "\u627e\u4e0d\u5230\u9810\u8a2d\u5be6\u4f5c" },

            { ER_CHUNKEDINTARRAY_NOT_SUPPORTED, "ChunkedIntArray({0}) \u76ee\u524d\u4e0d\u53d7\u652f\u63f4" },

            { ER_OFFSET_BIGGER_THAN_SLOT, "\u504f\u79fb\u6bd4\u69fd\u5927" },

            { ER_COROUTINE_NOT_AVAIL, "\u6c92\u6709 Coroutine \u53ef\u7528\uff0cid={0}" },

            { ER_COROUTINE_CO_EXIT, "CoroutineManager \u6536\u5230 co_exit() \u8981\u6c42" },

            { ER_COJOINROUTINESET_FAILED, "co_joinCoroutineSet() \u5931\u6548" },

            { ER_COROUTINE_PARAM, "Coroutine \u53c3\u6578\u932f\u8aa4 ({0})" },

            { ER_PARSER_DOTERMINATE_ANSWERS,
                    "\n\u975e\u9810\u671f\u7684\u7d50\u679c\uff1a\u5256\u6790\u5668 doTerminate \u56de\u7b54 {0}" },

            { ER_NO_PARSE_CALL_WHILE_PARSING, "\u5728\u5256\u6790\u6642\u672a\u547c\u53eb parse" },
            ...
            { ER_ITERATOR_CLONE_NOT_SUPPORTED, "\u91cd\u8907\u9805\u76ee\u8907\u88fd\u4e0d\u53d7\u652f\u63f4" },

            { ER_UNKNOWN_AXIS_TYPE, "\u4e0d\u660e\u7684\u8ef8\u904d\u6b77\u985e\u578b\uff1a{0}" },

            { ER_AXIS_NOT_SUPPORTED, "\u4e0d\u652f\u63f4\u8ef8\u904d\u6b77\uff1a{0}" },

            { ER_NO_DTMIDS_AVAIL, "\u6c92\u6709\u53ef\u7528\u7684 DTM ID" },
            ...
            { ER_COULD_NOT_RESOLVE_NODE, "\u7121\u6cd5\u89e3\u6790\u7bc0\u9ede\u70ba\u63a7\u9ede" },

            { ER_STARTPARSE_WHILE_PARSING, "\u5728\u5256\u6790\u6642\u672a\u547c\u53eb startParse" },

            { ER_STARTPARSE_NEEDS_SAXPARSER, "startParse \u9700\u8981\u975e\u7a7a\u503c\u7684 SAXParser" },
            ...
            { ER_SCHEME_REQUIRED, "\u7db1\u8981\u662f\u5fc5\u9700\u7684\uff01" },

            { ER_NO_SCHEME_IN_URI, "\u5728 URI\uff1a{0} \u627e\u4e0d\u5230\u7db1\u8981" },

            { ER_NO_SCHEME_INURI, "\u5728 URI \u627e\u4e0d\u5230\u7db1\u8981" },

            { ER_PATH_INVALID_CHAR, "\u8def\u5f91\u5305\u542b\u7121\u6548\u7684\u5b57\u5143\uff1a{0}" },

            { ER_SCHEME_FROM_NULL_STRING, "\u7121\u6cd5\u5f9e\u7a7a\u5b57\u4e32\u8a2d\u5b9a\u7db1\u8981" },

            { ER_SCHEME_NOT_CONFORMANT, "\u7db1\u8981\u4e0d\u662f conformant\u3002" },

            { ER_HOST_ADDRESS_NOT_WELLFORMED, "\u4e3b\u6a5f\u6c92\u6709\u5b8c\u6574\u7684\u4f4d\u5740" },

            { ER_PORT_WHEN_HOST_NULL, "\u4e3b\u6a5f\u70ba\u7a7a\u503c\u6642\uff0c\u7121\u6cd5\u8a2d\u5b9a\u57e0" },

            { ER_INVALID_PORT, "\u7121\u6548\u7684\u57e0\u7de8\u865f" },

            { ER_FRAG_FOR_GENERIC_URI, "\u53ea\u80fd\u5c0d\u901a\u7528\u7684 URI \u8a2d\u5b9a\u7247\u6bb5" },

            { ER_FRAG_WHEN_PATH_NULL, "\u8def\u5f91\u70ba\u7a7a\u503c\u6642\uff0c\u7121\u6cd5\u8a2d\u5b9a\u7247\u6bb5" },

            { ER_FRAG_INVALID_CHAR, "\u7247\u6bb5\u5305\u542b\u7121\u6548\u7684\u5b57\u5143" },

            { ER_PARSER_IN_USE, "\u5256\u6790\u5668\u5df2\u5728\u4f7f\u7528\u4e2d" },

            { ER_CANNOT_CHANGE_WHILE_PARSING, "\u5256\u6790\u6642\u7121\u6cd5\u8b8a\u66f4 {0} {1}" },

            { ER_SELF_CAUSATION_NOT_PERMITTED, "\u4e0d\u5141\u8a31\u672c\u8eab\u7684\u56e0\u679c\u95dc\u4fc2" },
            ...
            { ER_CANNOT_INIT_URI_EMPTY_PARMS, "\u7121\u6cd5\u4ee5\u7a7a\u767d\u53c3\u6578\u8d77\u59cb\u8a2d\u5b9a URI" },

            { ER_METHOD_NOT_SUPPORTED, "\u65b9\u6cd5\u4e0d\u53d7\u652f\u63f4" },

            { ER_INCRSAXSRCFILTER_NOT_RESTARTABLE,
                    "IncrementalSAXSource_Filter \u76ee\u524d\u7121\u6cd5\u91cd\u65b0\u555f\u52d5" },

            { ER_XMLRDR_NOT_BEFORE_STARTPARSE, "XMLReader \u6c92\u6709\u5728 startParse \u8981\u6c42\u4e4b\u524d" },

            { ER_AXIS_TRAVERSER_NOT_SUPPORTED, "\u4e0d\u652f\u63f4\u8ef8\u904d\u6b77\uff1a{0}" },
            ...
            { ER_LOCATION_UNKNOWN, "\u932f\u8aa4\u4f4d\u7f6e\u4e0d\u660e" },

            { ER_PREFIX_MUST_RESOLVE, "\u5b57\u9996\u5fc5\u9808\u89e3\u6790\u70ba\u540d\u7a31\u7a7a\u9593\uff1a{0}" },

            { ER_CREATEDOCUMENT_NOT_SUPPORTED, "\u5728 XPathContext \u4e2d\u4e0d\u652f\u63f4 createDocument()" },
            ...
            // indicates
            // that there is a problem with that part of the QNAME.
            { ER_ARG_PREFIX_INVALID, "QNAME \u4e2d\u7684\u5b57\u9996\u61c9\u8a72\u662f\u6709\u6548\u7684 NCName" },

            { ER_NAME_CANT_START_WITH_COLON, "\u540d\u7a31\u7684\u958b\u982d\u4e0d\u53ef\u70ba\u5192\u865f" },
