...
public class XMLErrorResources extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    { ER_AXIS_TRAVERSER_NOT_SUPPORTED, "Axis traverser not supported: {0}" },
            ...
            { ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER, "ListingErrorHandler created with null PrintWriter!" },
            ...
            { ER_CHILD_HAS_NO_OWNER_DOCUMENT_ELEMENT, "Attribute child does not have an owner document element!" },

            { ER_CANT_OUTPUT_TEXT_BEFORE_DOC, "Warning: can't output text before document element!  Ignoring..." },
