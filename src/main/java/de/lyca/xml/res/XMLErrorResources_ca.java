...
public class XMLErrorResources_ca extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CHUNKEDINTARRAY_NOT_SUPPORTED, "Actualment no es d\u00f3na suport a ChunkedIntArray({0})" },
            ...
            { ER_COROUTINE_CO_EXIT, "CoroutineManager ha rebut una sol\u00b7licitud co_exit()" },
            ...
            { ER_NO_PARSE_CALL_WHILE_PARSING, "L'an\u00e0lisi no es pot cridar mentre s'est\u00e0 duent a terme" },

            { ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED, "Error: l''iterador de tipus de l''eix {0} no s''ha implementat" },
            ...
            { ER_HOST_ADDRESS_NOT_WELLFORMED, "El format de l'adre\u00e7a del sistema principal no \u00e9s el correcte" },
            ...
            { ER_FRAG_WHEN_PATH_NULL, "El fragment no es pot establir si la via d'acc\u00e9s \u00e9s nul\u00b7la" },

            { ER_FRAG_INVALID_CHAR, "El fragment cont\u00e9 un car\u00e0cter no v\u00e0lid" },

            { ER_PARSER_IN_USE, "L'analitzador ja s'est\u00e0 utilitzant" },

            { ER_CANNOT_CHANGE_WHILE_PARSING, "No es pot modificar {0} {1} mentre es duu a terme l''an\u00e0lisi" },
            ...
            { ER_NO_PORT_IF_NO_HOST, "No es pot especificar el port si no s'especifica el sistema principal" },
            ...
            { ER_INCRSAXSRCFILTER_NOT_RESTARTABLE, "Ara mateix no es pot reiniciar IncrementalSAXSource_Filter" },

            { ER_XMLRDR_NOT_BEFORE_STARTPARSE, "XMLReader no es pot produir abans de la sol\u00b7licitud d'startParse" },

            { ER_AXIS_TRAVERSER_NOT_SUPPORTED, "La commutaci\u00f3 de l''eix no t\u00e9 suport: {0}" },

            { ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER, "S'ha creat ListingErrorHandler amb PrintWriter nul" },
            ...
            { ER_CHILD_HAS_NO_OWNER_DOCUMENT, "El subordinat de l'atribut no t\u00e9 un document de propietari." },
            ...
            { ER_NAME_CANT_START_WITH_COLON, "El nom no pot comen\u00e7ar amb dos punts. " },
