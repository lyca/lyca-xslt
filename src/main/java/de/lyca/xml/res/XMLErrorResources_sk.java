...
public class XMLErrorResources_sk extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_DEFAULT_IMPL, "Nebola n\u00e1jden\u00e1 \u017eiadna predvolen\u00e1 implement\u00e1cia " },

            { ER_CHUNKEDINTARRAY_NOT_SUPPORTED, "ChunkedIntArray({0}) nie je moment\u00e1lne podporovan\u00fd" },

            { ER_OFFSET_BIGGER_THAN_SLOT, "Offset v\u00e4\u010d\u0161\u00ed, ne\u017e z\u00e1suvka" },

            { ER_COROUTINE_NOT_AVAIL, "Ko-rutina nie je dostupn\u00e1, id={0}" },
            ...
            { ER_ITERATOR_AXIS_NOT_IMPLEMENTED, "Chyba: iter\u00e1tor pre os {0} nie je implementovan\u00fd " },
            ...
            { ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, "Cesta obsahuje neplatn\u00fa \u00fanikov\u00fa sekvenciu" },
            ...
            { ER_HOST_ADDRESS_NOT_WELLFORMED, "Hostite\u013e nie je spr\u00e1vne form\u00e1tovan\u00e1 adresa" },

            { ER_PORT_WHEN_HOST_NULL, "Nem\u00f4\u017ee by\u0165 stanoven\u00fd port, ak je hostite\u013e nulov\u00fd" },
            ...
            { ER_FRAG_WHEN_PATH_NULL, "Ak je cesta nulov\u00e1, nem\u00f4\u017ee by\u0165 stanoven\u00fd fragment" },
            ...
            { ER_NO_USERINFO_IF_NO_HOST, "Ak nebol zadan\u00fd hostite\u013e, mo\u017eno nebolo zadan\u00e9 userinfo" },

            { ER_NO_PORT_IF_NO_HOST, "Ak nebol zadan\u00fd hostite\u013e, mo\u017eno nebol zadan\u00fd port" },

            { ER_NO_QUERY_STRING_IN_PATH,
                    "Re\u0165azec dotazu nem\u00f4\u017ee by\u0165 zadan\u00fd v ceste a re\u0165azci dotazu" },

            { ER_NO_FRAGMENT_STRING_IN_PATH, "Fragment nem\u00f4\u017ee by\u0165 zadan\u00fd v ceste, ani vo fragmente" },
            ...
            { ER_CANT_HAVE_MORE_THAN_ONE_ROOT, "Nie je mo\u017en\u00e9 ma\u0165 viac, ne\u017e jeden kore\u0148 DOM!" },

            { ER_ARG_LOCALNAME_NULL, "Argument 'localName' je nulov\u00fd" },
            ...
            { ER_ARG_LOCALNAME_INVALID, "Lok\u00e1lny n\u00e1zov v QNAME by mal by\u0165 platn\u00fdm NCName" },
            ...
            { ER_NAME_CANT_START_WITH_COLON, "N\u00e1zov sa nem\u00f4\u017ee za\u010d\u00edna\u0165 dvojbodkou." },

            { "BAD_CODE", "Parameter na createMessage bol mimo ohrani\u010denia" },
            { "FORMAT_FAILED", "V\u00fdnimka po\u010das volania messageFormat" }, { "line", "Riadok #" },
            { "column", "St\u013apec #" }
