...
public final class Messages {
  ...
  private static final String BUNDLE_NAME = "de.lyca.xml.res.XmlError";

  private static XmlErrorMessages messages = (XmlErrorMessages) Proxy.newProxyInstance(//
      XmlErrorMessages.class.getClassLoader(), //
      new Class[] { XmlErrorMessages.class }, //
      new MessageResolver());
   ...
   */
  public static XmlErrorMessages get() {
    return messages;
  }
