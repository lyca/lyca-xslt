...
public final class SerializerFactory {
   ...
   * specified by the value of the property associated with the "method" key. If
   * no implementation exists that supports the specified output method an
   * exception of some type will be thrown. For a list of the output "method"
   * key values see {@link Method}.
   * 
   * @param format
   ...
   * @throws Exception
   *           if the class for the serializer is found but does not implement
   *           ContentHandler.
  ...
  public static Serializer getSerializer(Properties format) {
    ...
    try {
      ...
      if (obj instanceof SerializationHandler) {
        ...
        /*
         * This must be a user defined Serializer. It had better implement
         * ContentHandler.
         */
        if (obj instanceof ContentHandler) {

          /*
           * The user defined serializer defines ContentHandler, but we need to
           * wrap it with ToXMLSAXHandler which will collect SAX-like events and
           * emit true SAX ContentHandler events to the users handler.
           */
      ...
      throw new de.lyca.xml.serializer.utils.WrappedRuntimeException(e);
    }
