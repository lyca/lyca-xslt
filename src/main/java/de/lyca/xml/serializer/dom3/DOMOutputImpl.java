 ...
 * org.apache.xerces.dom.DOMOutputImpl.java
 * 
...
final class DOMOutputImpl implements LSOutput {
   ...
   * destination. If the application knows the character encoding of the object
   * pointed to by the system identifier, it can set the encoding using the
   * encoding attribute. If the system ID is a relative URI reference (see
