...
/**
 * This interface is not intended to be used by an end user, but rather by an
 * XML parser that is implementing the DOM Level 3 Load and Save APIs.
 * <p>
 * 
 * See the DOM Level 3 Load and Save interface at <a href=
 * "http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407/load-save.html#LS-LSSerializer"
 * >LSSeializer</a>.
 * 
 * For a list of configuration parameters for DOM Level 3 see <a href=
 * "http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMConfiguration"
 * >DOMConfiguration</a>. For additional configuration parameters available with
 * the DOM Level 3 Load and Save API LSSerializer see <a href=
 * "http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407/load-save.html#LS-LSSerializer-config"
 * >LSerializer config</a>.
 * <p>
 ...
 * Load and Save APIs, and is the prefered way to serialize with DOM Level 3
 * APIs.
 * <p>
 * Example:
 * 
 ...
 * 
 * @see <a
 *      href="http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMConfiguration">DOMConfiguration</a>
 * @see <a
 *      href="http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407/load-save.html#LS-LSSerializer-config">LSSerializer</a>
