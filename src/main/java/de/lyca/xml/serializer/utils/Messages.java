 ...
 * suffix.
 * 
 * More sophisticated use of this class would be to pass null when contructing
 * it, but then call loadResourceBundle() before creating any messages.
 * 
...
public final class Messages {
   ...
   *          the class name of the ListResourceBundle that the instance of this
   *          class is associated with and will use when creating messages. The
  ...
  /*
   * Set the Locale object to use. If this method is not called the default
                                                                                                   ...
                                                                                                   // Exception
  {
    ...
    if (msg == null) {
      throwex = true;
      /*
       * The message is not in the bundle . . . this is bad, so try to get the
       * message that the message is not in the bundle
       */
      try {
        ...
        /*
         * even the message that the message is not in the bundle is not there
         * ... this is really bad
         */
  ...
  private ListResourceBundle loadResourceBundle(String resourceBundle) throws MissingResourceException {
    ...
    try {
      ...
      final ResourceBundle rb = ResourceBundle.getBundle(m_resourceBundleName, locale);
      ...
      try // try to fall back to en_US if we can't load
      {
        ...
        throw new MissingResourceException("Could not load any resource bundles." + m_resourceBundleName,
