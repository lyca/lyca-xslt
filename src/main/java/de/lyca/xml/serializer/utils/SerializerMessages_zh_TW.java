...
public class SerializerMessages_zh_TW extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            { MsgKey.BAD_MSGKEY, "\u8a0a\u606f\u9375 ''{0}'' \u4e0d\u5728\u8a0a\u606f\u985e\u5225 ''{1}'' \u4e2d" },
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "\u7121\u6cd5\u8f09\u5165\u8cc7\u6e90 [ {0} ]\uff1a{1} \n {2} \t {3}" },

            { MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "\u7de9\u885d\u5340\u5927\u5c0f <=0" },

            { MsgKey.ER_INVALID_UTF16_SURROGATE, "\u5075\u6e2c\u5230\u7121\u6548\u7684 UTF-16 \u4ee3\u7406\uff1a{0}?" },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "\u5c6c\u6027 ''{0}'' \u8d85\u51fa\u5143\u7d20\u5916\u3002" },
            ...
            { MsgKey.ER_INVALID_PORT, "\u7121\u6548\u7684\u57e0\u7de8\u865f" },

            { MsgKey.ER_PORT_WHEN_HOST_NULL, "\u4e3b\u6a5f\u70ba\u7a7a\u503c\u6642\uff0c\u7121\u6cd5\u8a2d\u5b9a\u57e0" },

            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "\u4e3b\u6a5f\u6c92\u6709\u5b8c\u6574\u7684\u4f4d\u5740" },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "\u7db1\u8981\u4e0d\u662f conformant\u3002" },

            { MsgKey.ER_SCHEME_FROM_NULL_STRING, "\u7121\u6cd5\u5f9e\u7a7a\u5b57\u4e32\u8a2d\u5b9a\u7db1\u8981" },

            { MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE,
                    "\u8def\u5f91\u5305\u542b\u7121\u6548\u7684\u8df3\u812b\u5b57\u5143" },

            { MsgKey.ER_PATH_INVALID_CHAR, "\u8def\u5f91\u5305\u542b\u7121\u6548\u7684\u5b57\u5143\uff1a{0}" },
            ...
            { MsgKey.ER_FRAG_FOR_GENERIC_URI, "\u53ea\u80fd\u5c0d\u901a\u7528\u7684 URI \u8a2d\u5b9a\u7247\u6bb5" },

            { MsgKey.ER_NO_SCHEME_IN_URI, "\u5728 URI \u627e\u4e0d\u5230\u7db1\u8981" },
            ...
            { MsgKey.ER_SCHEME_REQUIRED, "\u7db1\u8981\u662f\u5fc5\u9700\u7684\uff01" },
            ...
            { MsgKey.ER_FEATURE_NOT_FOUND, "\u7121\u6cd5\u8fa8\u8b58\u53c3\u6578 ''{0}''\u3002" },
            ...
            { MsgKey.ER_UNSUPPORTED_ENCODING, "\u767c\u73fe\u4e0d\u652f\u63f4\u7684\u7de8\u78bc\u3002" },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "\u7bc0\u9ede\u7121\u6cd5\u5e8f\u5217\u5316\u3002" },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "\u8a3b\u89e3\u4e2d\u4e0d\u5141\u8a31\u4f7f\u7528\u5b57\u4e32 \"--\"\u3002" },
