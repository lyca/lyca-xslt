...
public class SerializerMessages_hu extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_FIND, "A(z) [ {0} ] er\u0151forr\u00e1s nem tal\u00e1lhat\u00f3.\n {1}" },

            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD,
                    "A(z) [ {0} ] er\u0151forr\u00e1st nem lehet bet\u00f6lteni: {1} \n {2} \t {3}" },

            { MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Pufferm\u00e9ret <= 0" },

            { MsgKey.ER_INVALID_UTF16_SURROGATE, "\u00c9rv\u00e9nytelen UTF-16 helyettes\u00edt\u00e9s: {0} ?" },

            { MsgKey.ER_OIERROR, "IO hiba" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "A(z) ''{0}'' el\u0151tag n\u00e9vtere nincs deklar\u00e1lva." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "A(z) ''{0}'' attrib\u00fatum k\u00edv\u00fcl esik az elemen." },
            ...
            { MsgKey.ER_INVALID_PORT, "\u00c9rv\u00e9nytelen portsz\u00e1m" },

            { MsgKey.ER_PORT_WHEN_HOST_NULL, "A portot nem \u00e1ll\u00edthatja be, ha a hoszt null" },

            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "A hoszt nem j\u00f3l form\u00e1zott c\u00edm" },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "A s\u00e9ma nem megfelel\u0151." },
            ...
            { MsgKey.ER_FRAG_INVALID_CHAR, "A t\u00f6red\u00e9k \u00e9rv\u00e9nytelen karaktert tartalmaz" },
            ...
            { MsgKey.ER_NO_SCHEME_IN_URI, "Nem tal\u00e1lhat\u00f3 s\u00e9ma az URI-ban" },
            ...
            { MsgKey.ER_NO_PORT_IF_NO_HOST, "Nem adhatja meg a portot, ha nincs megadva hoszt" },
            ...
            { MsgKey.ER_SCHEME_REQUIRED, "S\u00e9m\u00e1ra van sz\u00fcks\u00e9g!" },
            ...
            { MsgKey.ER_FEATURE_NOT_FOUND, "A(z) ''{0}'' param\u00e9ter nem ismerhet\u0151 fel." },
            ...
            { MsgKey.ER_UNSUPPORTED_ENCODING, "Nem t\u00e1mogatott k\u00f3dol\u00e1s." },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "A csom\u00f3pont nem p\u00e9ld\u00e1nyos\u00edthat\u00f3." },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "A \"--\" karaktersorozat nem megengedett a megjegyz\u00e9sekben." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "A(z) \"{0}\" elem helyi neve null." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "A(z) \"{0}\" attrib\u00fatum helyi neve null." },
