...
public class SerializerMessages extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            { MsgKey.BAD_MSGKEY, "The message key ''{0}'' is not in the message class ''{1}''" },
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "The resource [ {0} ] could not load: {1} \n {2} \t {3}" },
            ...
            { MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, "Fragment cannot be specified in both the path and fragment" },

            { MsgKey.ER_NO_QUERY_STRING_IN_PATH, "Query string cannot be specified in path and query string" },

            { MsgKey.ER_NO_PORT_IF_NO_HOST, "Port may not be specified if host is not specified" },

            { MsgKey.ER_NO_USERINFO_IF_NO_HOST, "Userinfo may not be specified if host is not specified" },
            ...
            { MsgKey.ER_ENCODING_NOT_SUPPORTED, "Warning:  The encoding ''{0}'' is not supported by the Java runtime." },
            ...
            { MsgKey.ER_STRING_TOO_LONG, "The resulting string is too long to fit in a DOMString: ''{0}''." },

            { MsgKey.ER_TYPE_MISMATCH_ERR,
                    "The value type for this parameter name is incompatible with the expected value type." },

            { MsgKey.ER_NO_OUTPUT_SPECIFIED, "The output destination for data to be written to was null." },
            ...
            { MsgKey.ER_CDATA_SECTIONS_SPLIT, "The CDATA Section contains one or more termination markers ']]>'." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "The node ''{0}'' contains invalid XML characters." },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "The string \"--\" is not permitted within comments." },

            { MsgKey.ER_WF_LT_IN_ATTVAL,
                    "The value of attribute \"{1}\" associated with an element type \"{0}\" must not contain the ''<'' character." },

            { MsgKey.ER_WF_REF_TO_UNPARSED_ENT, "The unparsed entity reference \"&{0};\" is not permitted." },

            { MsgKey.ER_WF_REF_TO_EXTERNAL_ENT,
                    "The external entity reference \"&{0};\" is not permitted in an attribute value." },

            { MsgKey.ER_NS_PREFIX_CANNOT_BE_BOUND, "The prefix \"{0}\" can not be bound to namespace \"{1}\"." },

            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "The local name of element \"{0}\" is null." },
            ...
            { MsgKey.ER_WRITING_INTERNAL_SUBSET, "An error occured while writing the internal subset." }, };
