...
public class SerializerMessages_sk extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            ...
            { MsgKey.BAD_MSGFORMAT, "Zlyhal form\u00e1t spr\u00e1vy ''{0}'' v triede spr\u00e1v ''{1}''." },

            { MsgKey.ER_SERIALIZER_NOT_CONTENTHANDLER,
                    "Trieda serializ\u00e1tora ''{0}'' neimplementuje org.xml.sax.ContentHandler." },

            { MsgKey.ER_RESOURCE_COULD_NOT_FIND, "Prostriedok [ {0} ] nemohol by\u0165 n\u00e1jden\u00fd.\n {1}" },

            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD,
                    "Prostriedok [ {0} ] sa nedal na\u010d\u00edta\u0165: {1} \n {2} \t {3}" },

            { MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Ve\u013ekos\u0165 vyrovn\u00e1vacej pam\u00e4te <=0" },

            { MsgKey.ER_INVALID_UTF16_SURROGATE, "Bolo zisten\u00e9 neplatn\u00e9 nahradenie UTF-16: {0} ?" },

            { MsgKey.ER_OIERROR, "chyba IO" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "N\u00e1zvov\u00fd priestor pre predponu ''{0}'' nebol deklarovan\u00fd." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "Atrib\u00fat ''{0}'' je mimo prvku." },
             ...
             */
            { MsgKey.ER_STRAY_NAMESPACE, "Deklar\u00e1cia n\u00e1zvov\u00e9ho priestoru ''{0}''=''{1}'' je mimo prvku." },
            ...
            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "Hostite\u013e nie je spr\u00e1vne form\u00e1tovan\u00e1 adresa" },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "Nezhodn\u00e1 sch\u00e9ma." },
            ...
            { MsgKey.ER_NO_SCHEME_IN_URI, "V URI nebola n\u00e1jden\u00e1 \u017eiadna sch\u00e9ma" },
            ...
            { MsgKey.ER_NO_PORT_IF_NO_HOST, "Ak nebol zadan\u00fd hostite\u013e, mo\u017eno nebol zadan\u00fd port" },
            ...
            { MsgKey.ER_SCHEME_REQUIRED, "Je po\u017eadovan\u00e1 sch\u00e9ma!" },
            ...
            { MsgKey.ER_ENCODING_NOT_SUPPORTED, "Varovanie:  Java runtime nepodporuje k\u00f3dovanie ''{0}''." },

            { MsgKey.ER_FEATURE_NOT_FOUND, "Parameter ''{0}'' nebol rozpoznan\u00fd." },
            ...
            { MsgKey.ER_NO_OUTPUT_SPECIFIED, "Cie\u013e v\u00fdstupu pre zap\u00edsanie \u00fadajov bol null." },

            { MsgKey.ER_UNSUPPORTED_ENCODING, "Bolo zaznamenan\u00e9 nepodporovan\u00e9 k\u00f3dovanie." },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Uzol nebolo mo\u017en\u00e9 serializova\u0165." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "Uzol ''{0}'' obsahuje neplatn\u00e9 znaky XML." },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "Re\u0165azec \"--\" nie je povolen\u00fd v r\u00e1mci koment\u00e1rov." },

            { MsgKey.ER_WF_LT_IN_ATTVAL,
                    "Hodnota atrib\u00fatu \"{1}\", ktor\u00e1 je priraden\u00e1 k prvku typu \"{0}\", nesmie obsahova\u0165 znak ''<''." },

            { MsgKey.ER_WF_REF_TO_UNPARSED_ENT, "Neanalyzovan\u00fd odkaz na entitu \"&{0};\" nie je povolen\u00fd." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Lok\u00e1lny n\u00e1zov prvku \"{0}\" je null." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Lok\u00e1lny n\u00e1zov atrib\u00fatu \"{0}\" je null." },
