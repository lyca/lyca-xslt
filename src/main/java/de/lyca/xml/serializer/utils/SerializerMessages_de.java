...
public class SerializerMessages_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_FIND, "Die Ressource [ {0} ] konnte nicht gefunden werden.\n {1}" },

            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "Die Ressource [ {0} ] konnte nicht geladen werden: {1} \n {2} \t {3}" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "Der Namensbereich f\u00fcr Pr\u00e4fix ''{0}'' wurde nicht deklariert." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "Attribut ''{0}'' befindet sich nicht in einem Element." },
            ...
            { MsgKey.ER_PORT_WHEN_HOST_NULL, "Der Port kann nicht festgelegt werden, wenn der Host gleich Null ist." },

            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "Der Host ist keine syntaktisch korrekte Adresse." },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "Das Schema ist nicht angepasst." },

            { MsgKey.ER_SCHEME_FROM_NULL_STRING, "Schema kann nicht von Nullzeichenfolge festgelegt werden." },
            ...
            { MsgKey.ER_FRAG_WHEN_PATH_NULL, "Fragment kann nicht festgelegt werden, wenn der Pfad gleich Null ist." },
            ...
            { MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, "Fragment kann nicht im Pfad und im Fragment angegeben werden." },
            ...
            { MsgKey.ER_FEATURE_NOT_FOUND, "Der Parameter ''{0}'' wird nicht erkannt." },
            ...
            { MsgKey.ER_NO_OUTPUT_SPECIFIED, "Das Ausgabeziel f\u00fcr die zu schreibenden Daten war leer." },

            { MsgKey.ER_UNSUPPORTED_ENCODING, "Eine nicht unterst\u00fctzte Codierung wurde festgestellt." },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Der Knoten konnte nicht serialisiert werden." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "Der Knoten ''{0}'' enth\u00e4lt ung\u00fcltige XML-Zeichen." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Der lokale Name von Element \"{0}\" ist nicht angegeben." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Der lokale Name des Attributs \"{0}\" ist nicht angegeben." },
