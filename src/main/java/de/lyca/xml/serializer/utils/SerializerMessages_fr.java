...
public class SerializerMessages_fr extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            { MsgKey.BAD_MSGKEY, "La cl\u00e9 du message ''{0}'' ne se trouve pas dans la classe du message ''{1}''" },

            { MsgKey.BAD_MSGFORMAT, "Le format du message ''{0}'' de la classe du message ''{1}'' est incorrect." },
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "La ressource [ {0} ] n''a pas pu charger : {1} \n {2} \t {3}" },

            { MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Taille du tampon <=0" },

            { MsgKey.ER_INVALID_UTF16_SURROGATE, "Substitut UTF-16 non valide d\u00e9tect\u00e9 : {0} ?" },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "L''attribut ''{0}'' est \u00e0 l''ext\u00e9rieur de l''\u00e9l\u00e9ment." },
            ...
            { MsgKey.ER_PORT_WHEN_HOST_NULL, "Le port ne peut \u00eatre d\u00e9fini quand l'h\u00f4te est vide" },

            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "L'h\u00f4te n'est pas une adresse bien form\u00e9e" },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "Le processus n'est pas conforme." },
            ...
            { MsgKey.ER_NO_SCHEME_IN_URI, "Processus introuvable dans l'URI" },

            { MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, "Impossible d'initialiser l'URI avec des param\u00e8tres vides" },
            ...
            { MsgKey.ER_SCHEME_REQUIRED, "Processus requis !" },
            ...
            { MsgKey.ER_STRING_TOO_LONG, "La cha\u00eene obtenue est trop longue pour un DOMString : ''{0}''." },
            ...
            { MsgKey.ER_UNSUPPORTED_ENCODING, "Codage non pris en charge." },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Le noeud ne peut pas \u00eatre s\u00e9rialis\u00e9." },

            { MsgKey.ER_CDATA_SECTIONS_SPLIT, "La section CDATA contient un ou plusieurs marqueurs de fin ']]>'." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "Le noeud ''{0}'' contient des caract\u00e8res XML non valides." },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "La cha\u00eene \"--\" est interdite dans des commentaires." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Le nom local de l''\u00e9l\u00e9ment \"{0}\" a une valeur null." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Le nom local de l''attribut \"{0}\" a une valeur null." },
