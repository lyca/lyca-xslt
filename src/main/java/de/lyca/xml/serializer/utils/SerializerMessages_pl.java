...
public class SerializerMessages_pl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            { MsgKey.BAD_MSGKEY, "Klucz komunikatu ''{0}'' nie znajduje si\u0119 w klasie komunikat\u00f3w ''{1}''" },
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_FIND, "Nie mo\u017cna znale\u017a\u0107 zasobu [ {0} ].\n {1}" },

            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD,
                    "Zas\u00f3b [ {0} ] nie m\u00f3g\u0142 za\u0142adowa\u0107: {1} \n {2} \t {3}" },

            { MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Wielko\u015b\u0107 buforu <=0" },

            { MsgKey.ER_INVALID_UTF16_SURROGATE, "Wykryto niepoprawny odpowiednik UTF-16: {0} ?" },

            { MsgKey.ER_OIERROR, "B\u0142\u0105d we/wy" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "Nie zadeklarowano przestrzeni nazw dla przedrostka ''{0}''." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "Atrybut ''{0}'' znajduje si\u0119 poza elementem." },
            ...
            { MsgKey.ER_INVALID_PORT, "Niepoprawny numer portu" },

            { MsgKey.ER_PORT_WHEN_HOST_NULL, "Nie mo\u017cna ustawi\u0107 portu, kiedy host jest pusty" },

            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "Host nie jest poprawnie skonstruowanym adresem" },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "Schemat nie jest zgodny." },
            ...
            { MsgKey.ER_PATH_INVALID_CHAR, "\u015acie\u017cka zawiera niepoprawny znak {0}" },

            { MsgKey.ER_FRAG_INVALID_CHAR, "Fragment zawiera niepoprawny znak" },

            { MsgKey.ER_FRAG_WHEN_PATH_NULL,
                    "Nie mo\u017cna ustawi\u0107 fragmentu, kiedy \u015bcie\u017cka jest pusta" },

            { MsgKey.ER_FRAG_FOR_GENERIC_URI, "Fragment mo\u017cna ustawi\u0107 tylko dla og\u00f3lnego URI" },

            { MsgKey.ER_NO_SCHEME_IN_URI, "Nie znaleziono schematu w URI" },

            { MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, "Nie mo\u017cna zainicjowa\u0107 URI z pustymi parametrami" },
            ...
            { MsgKey.ER_NO_PORT_IF_NO_HOST, "Nie mo\u017cna poda\u0107 portu, je\u015bli nie podano hosta" },
            ...
            { MsgKey.ER_SCHEME_REQUIRED, "Schemat jest wymagany!" },
            ...
            { MsgKey.ER_FEATURE_NOT_FOUND, "Parametr ''{0}'' nie zosta\u0142 rozpoznany." },
            ...
            { MsgKey.ER_NO_OUTPUT_SPECIFIED, "Docelowe miejsce zapisu danych wyj\u015bciowych by\u0142o puste (null)." },

            { MsgKey.ER_UNSUPPORTED_ENCODING, "Napotkano nieobs\u0142ugiwane kodowanie." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "W\u0119ze\u0142 ''{0}'' zawiera niepoprawne znaki XML." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME, "W {0} o nazwie ''{1}'' znaleziono niepoprawne znaki XML." },

            { MsgKey.ER_WF_DASH_IN_COMMENT, "Ci\u0105g znak\u00f3w \"--\" jest niedozwolony w komentarzu." },

            { MsgKey.ER_WF_LT_IN_ATTVAL,
                    "Warto\u015b\u0107 atrybutu \"{1}\" zwi\u0105zanego z typem elementu \"{0}\" nie mo\u017ce zawiera\u0107 znaku ''<''." },

            { MsgKey.ER_WF_REF_TO_UNPARSED_ENT, "Odwo\u0142anie do encji nieprzetwarzanej \"&{0};\" jest niedozwolone." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Nazwa lokalna elementu \"{0}\" jest pusta (null)." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Nazwa lokalna atrybutu \"{0}\" jest pusta (null)." },
