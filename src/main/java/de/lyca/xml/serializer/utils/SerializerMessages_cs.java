...
public class SerializerMessages_cs extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            ...
            { MsgKey.ER_INVALID_UTF16_SURROGATE, "Byla zji\u0161t\u011bna neplatn\u00e1 n\u00e1hrada UTF-16: {0} ?" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "Obor n\u00e1zv\u016f pro p\u0159edponu ''{0}'' nebyl deklarov\u00e1n." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "Atribut ''{0}'' se nach\u00e1z\u00ed vn\u011b prvku." },
            ...
            { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "Adresa hostitele m\u00e1 nespr\u00e1vn\u00fd form\u00e1t." },

            { MsgKey.ER_SCHEME_NOT_CONFORMANT, "Sch\u00e9ma nevyhovuje." },

            { MsgKey.ER_SCHEME_FROM_NULL_STRING, "Nelze nastavit sch\u00e9ma \u0159et\u011bzce s hodnotou null." },

            { MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, "Cesta obsahuje neplatnou escape sekvenci" },
            ...
            { MsgKey.ER_NO_SCHEME_IN_URI, "V URI nebylo nalezeno \u017e\u00e1dn\u00e9 sch\u00e9ma" },

            { MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, "URI nelze inicializovat s pr\u00e1zdn\u00fdmi parametry." },
            ...
            { MsgKey.ER_UNSUPPORTED_ENCODING, "Bylo nalezeno nepodporovan\u00e9 k\u00f3dov\u00e1n\u00ed." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "Uzel ''{0}'' obsahuje neplatn\u00e9 znaky XML. " },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "V pozn\u00e1mk\u00e1ch nen\u00ed povolen \u0159et\u011bzec \"--\"." },

            { MsgKey.ER_WF_LT_IN_ATTVAL,
                    "Hodnota atributu \"{1}\" souvisej\u00edc\u00edho s typem prvku \"{0}\" nesm\u00ed obsahovat znak ''<''." },

            { MsgKey.ER_WF_REF_TO_UNPARSED_ENT, "Odkaz na neanalyzovanou entitu \"&{0};\" nen\u00ed povolen." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Lok\u00e1ln\u00ed n\u00e1zev prvku \"{0}\" m\u00e1 hodnotu Null. " },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Lok\u00e1ln\u00ed n\u00e1zev atributu \"{0}\" m\u00e1 hodnotu Null. " },
