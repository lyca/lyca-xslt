...
public class SerializerMessages_it extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    final Object[][] contents = new Object[][] {
            { MsgKey.BAD_MSGKEY, "La chiave messaggio ''{0}'' non si trova nella classe del messaggio ''{1}''" },
            ...
            { MsgKey.ER_RESOURCE_COULD_NOT_LOAD, "Impossibile caricare la risorsa [ {0} ]: {1} \n {2} \t {3}" },
             ...
             */
            { MsgKey.ER_NAMESPACE_PREFIX, "Lo spazio nomi per il prefisso ''{0}'' non \u00e8 stato dichiarato." },
             ...
             */
            { MsgKey.ER_STRAY_ATTRIBUTE, "L''''attributo ''{0}'' al di fuori dell''''elemento." },
            ...
            { MsgKey.ER_PORT_WHEN_HOST_NULL, "La porta non pu\u00f2 essere impostata se l'host \u00e8 nullo" },
            ...
            { MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, "Il percorso contiene sequenza di escape non valida" },
            ...
            { MsgKey.ER_FRAG_WHEN_PATH_NULL, "Il frammento non pu\u00f2 essere impostato se il percorso \u00e8 nullo" },

            { MsgKey.ER_FRAG_FOR_GENERIC_URI, "Il frammento pu\u00f2 essere impostato solo per un URI generico" },

            { MsgKey.ER_NO_SCHEME_IN_URI, "Non \u00e8 stato trovato alcuno schema nell'URI" },

            { MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, "Impossibile inizializzare l'URI con i parametri vuoti" },
            ...
            { MsgKey.ER_NO_PORT_IF_NO_HOST, "La porta non pu\u00f2 essere specificata se l'host non S specificato" },

            { MsgKey.ER_NO_USERINFO_IF_NO_HOST, "Userinfo non pu\u00f2 essere specificato se l'host non S specificato" },
            {
            ...
            { MsgKey.ER_NO_OUTPUT_SPECIFIED, "La destinazione di output in cui scrivere i dati era nulla." },

            { MsgKey.ER_UNSUPPORTED_ENCODING, "\u00c8 stata rilevata una codifica non supportata." },

            { MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Impossibile serializzare il nodo." },

            { MsgKey.ER_CDATA_SECTIONS_SPLIT, "La Sezione CDATA contiene uno o pi\u00f9 markers di termine ']]>'." },
            ...
            { MsgKey.ER_WF_INVALID_CHARACTER, "Il nodo ''{0}'' contiene caratteri XML non validi." },
            ...
            { MsgKey.ER_WF_DASH_IN_COMMENT, "La stringa \"--\" non \u00e8 consentita nei commenti." },
            ...
            { MsgKey.ER_NULL_LOCAL_ELEMENT_NAME, "Il nome locale dell''''elemento \"{0}\" \u00e8 null." },

            { MsgKey.ER_NULL_LOCAL_ATTR_NAME, "Il nome locale dell''''attributo \"{0}\" \u00e8  null." },
