...
public final class AttributesImplSerializer extends AttributesImpl {
   ...
   * attributes, but up until now we haven't kept any information in the
   * Hashtable, so we now update the Hashtable. Future additional attributes
   * will update the Hashtable as they are added.
   * 
   * @param numAtts
   */
