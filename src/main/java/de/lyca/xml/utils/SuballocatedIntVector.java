...
public class SuballocatedIntVector {
  ...
  /**
   * Construct a IntVector, using the given block size and number of blocks. For
   * efficiency, we will round the requested size off to a power of two.
   * 
   * @param blocksize
  ...
  /**
   * Construct a IntVector, using the given block size and the default number of
   * blocks (32).
   * 
   * @param blocksize
   *          Size of block to allocate
