...
public class Constants {
   ...
   * built into the XML specification itself, such as xml:space and xml:lang. It
   * was defined by the W3C's XML Namespaces spec.</li>
   ...
   * stylesheets, this is bound to the "xsl:" prefix. It's defined by the W3C's
   * XSLT Recommendation.</li>
   * <li>S_OLDXSLNAMESPACEURL (http://www.w3.org/XSL/Transform/1.0) was used in
   * early prototypes of XSLT processors for much the same purpose as
   ...
   * Recommendation, so what it really signifies is a badly obsolete stylesheet.
   * </li>
   * </ul>
   */
   ...
   * <ul>
   * <li>S_VENDOR -- the name of the organization/individual who published this
   * XSLT processor.</li>
  ...
  public static final String S_EXSLT_COMMON_URL = "http://exslt.org/common",
          ...
          S_EXSLT_FUNCTIONS_URL = "http://exslt.org/functions", S_EXSLT_DYNAMIC_URL = "http://exslt.org/dynamic",
