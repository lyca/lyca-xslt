...
public class StylesheetPIHandler extends DefaultHandler {
  ...
  /**
   * Get the object that will be used to resolve URIs in href in xml-stylesheet
   ...
   * 
   * @param baseID
   *          The base ID of the XML document, needed to resolve relative IDs.
   * @param media
   *          The desired media criteria.
   * @param title
   *          The desired title criteria.
  ...
  public void processingInstruction(String target, String data) throws org.xml.sax.SAXException {
    ...
    if (target.equals("xml-stylesheet")) {
      ...
      if (null != type && (type.equals("text/xsl") || type.equals("text/xml") || type.equals("application/xml+xslt"))
              && null != href) {
        if (null != m_media) {
          if (null != media) {
  ...
  /**
   * Added additional getter and setter methods for the Base Id to fix bugzilla
   * bug 24187
   * 
   */
