...
public class XML11Char {
  ...
  static {
    ...
    Arrays.fill(XML11CHARS, 192, 215, (byte) -19); // Fill 23 of value (byte)
                                                   // -19
    XML11CHARS[215] = 33;
    Arrays.fill(XML11CHARS, 216, 247, (byte) -19); // Fill 31 of value (byte)
                                                   // -19
    XML11CHARS[247] = 33;
    Arrays.fill(XML11CHARS, 248, 768, (byte) -19); // Fill 520 of value (byte)
                                                   // -19
    Arrays.fill(XML11CHARS, 768, 880, (byte) -87); // Fill 112 of value (byte)
                                                   // -87
    Arrays.fill(XML11CHARS, 880, 894, (byte) -19); // Fill 14 of value (byte)
                                                   // -19
    XML11CHARS[894] = 33;
    Arrays.fill(XML11CHARS, 895, 8192, (byte) -19); // Fill 7297 of value (byte)
                                                    // -19
    Arrays.fill(XML11CHARS, 8192, 8204, (byte) 33); // Fill 12 of value (byte)
                                                    // 33
    Arrays.fill(XML11CHARS, 8204, 8206, (byte) -19); // Fill 2 of value (byte)
                                                     // -19
    Arrays.fill(XML11CHARS, 8206, 8232, (byte) 33); // Fill 26 of value (byte)
                                                    // 33
    XML11CHARS[8232] = 35;
    Arrays.fill(XML11CHARS, 8233, 8255, (byte) 33); // Fill 22 of value (byte)
                                                    // 33
    Arrays.fill(XML11CHARS, 8255, 8257, (byte) -87); // Fill 2 of value (byte)
                                                     // -87
    Arrays.fill(XML11CHARS, 8257, 8304, (byte) 33); // Fill 47 of value (byte)
                                                    // 33
    Arrays.fill(XML11CHARS, 8304, 8592, (byte) -19); // Fill 288 of value (byte)
                                                     // -19
    ...
    Arrays.fill(XML11CHARS, 11264, 12272, (byte) -19); // Fill 1008 of value
                                                       // (byte) -19
    Arrays.fill(XML11CHARS, 12272, 12289, (byte) 33); // Fill 17 of value (byte)
                                                      // 33
    Arrays.fill(XML11CHARS, 12289, 55296, (byte) -19); // Fill 43007 of value
                                                       // (byte) -19
    ...
    Arrays.fill(XML11CHARS, 63744, 64976, (byte) -19); // Fill 1232 of value
                                                       // (byte) -19
    Arrays.fill(XML11CHARS, 64976, 65008, (byte) 33); // Fill 32 of value (byte)
                                                      // 33
