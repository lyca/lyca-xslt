...
public class StringBufferPool {
  ...
  private static ObjectPool m_stringBufPool = new ObjectPool(de.lyca.xml.utils.FastStringBuffer.class);

  /**
   * Get the first free instance of a string buffer, or create one if there are
   * no free instances.
   * 
