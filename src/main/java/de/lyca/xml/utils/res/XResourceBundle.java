...
public class XResourceBundle extends ListResourceBundle {
  ...
  public static final String ERROR_RESOURCES = "de.lyca.xalan.res.XSLTErrorResources",
          XSLT_RESOURCE = "de.lyca.xml.utils.res.XResourceBundle",
          LANG_BUNDLE_NAME = "de.lyca.xml.utils.res.XResources", MULT_ORDER = "multiplierOrder",
          MULT_PRECEDES = "precedes", MULT_FOLLOWS = "follows", LANG_ORIENTATION = "orientation",
          LANG_RIGHTTOLEFT = "rightToLeft", LANG_LEFTTORIGHT = "leftToRight", LANG_NUMBERING = "numbering",
          LANG_ADDITIVE = "additive", LANG_MULT_ADD = "multiplicative-additive", LANG_MULTIPLIER = "multiplier",
          LANG_MULTIPLIER_CHAR = "multiplierChar", LANG_NUMBERGROUPS = "numberGroups", LANG_NUM_TABLES = "tables",
   ...
   * @param locale
   *          the locale to prefer when searching for the bundle
   */
