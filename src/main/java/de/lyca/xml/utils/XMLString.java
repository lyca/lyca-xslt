 ...
 * character data. By using XMLString, character copies can be reduced in the
 * XML pipeline.
 */
public interface XMLString {
   ...
   * String. All strings of white space are replaced by a single space character
   * (#x20), except spaces after punctuation which receive double spaces if
   * doublePunctuationSpaces is true. This function may be useful to a
   * formatter, but to get first class results, the formatter should probably do
   * it's own white space handling based on the semantics of the formatting
   * object.
   * 
   * @param trimHead
   ...
   * is an <code>XMLString</code> object that represents the same sequence of
   ...
   * <code>true</code> if and only if the argument is not <code>null</code> and
   * is a <code>String</code> object that represents the same sequence of
   * characters as this object.
   * 
   * @param anotherString
   *          the object to compare this <code>String</code> against.
  ...
  /**
   * Compares this <code>String</code> to another <code>String</code>, ignoring
   ...
   *         <code>String</code>s are equal, ignoring case; <code>false</code>
   *         otherwise.
   * @see #equals(Object)
  ...
  /**
   * Compares two strings lexicographically, ignoring case considerations. This
   * method returns an integer whose sign is that of
   ...
   *         string; <code>false</code> otherwise. Note also that
  ...
  /**
   * Returns a hashcode for this string. The hashcode for a <code>String</code>
   ...
   * the character sequence represented by this <code>String</code> object, then
   * the index of the first such occurrence is returned -- that is, the smallest
   ...
   * <p>
   * If a character with value <code>ch</code> occurs in the character sequence
   * represented by this <code>String</code> object at an index no smaller than
   ...
   * be searched. If it is greater than the length of this string, it has the
   * same effect as if it were equal to the length of this string:
   ...
   * @return the index of the first occurrence of the character in the character
   *         sequence represented by this object that is greater than or equal
   *         to <code>fromIndex</code>, or <code>-1</code> if the character does
   *         not occur.
   */
  ...
  /**
   * Returns the index within this string of the first occurrence of the
   * specified substring, starting at the specified index. The integer returned
   ...
   * @param fromIndex
   *          the index to start the search from.
   * @return If the string argument occurs as a substring within this object at
   *         a starting index no smaller than <code>fromIndex</code>, then the
   ...
   * @param fromIndex
   *          the index to start the search from. There is no restriction on the
   *          value of fromIndex. If it is greater than the length of this
   *          string, it has the same effect as if it were equal to the length
   *          of this string: this entire string may be searched. If it is
   ...
   * 
   * @param str
   *          the <code>String</code> that is concatenated to the end of this
   *          <code>String</code>.
   ...
   * calling the <code>toUpperCase</code> method defined by
   ...
   * <p>
   * If this <code>String</code> object represents an empty character sequence,
   * or the first and last characters of character sequence represented by this
   * <code>String</code> object both have codes greater than
   ...
   * index <i>k</i> and ends with the character at index <i>m</i>-that is, the
   * result of <code>this.substring(<i>k</i>,&nbsp;<i>m</i>+1)</code>.
   * <p>
   * This method may be used to trim {@link Character#isSpace(char) whitespace}
