...
public class MutableAttrListImpl extends AttributesImpl implements Serializable {
   ...
   * 
   * <p>
   * For the sake of speed, this method does no checking to see if the attribute
   * is already in the list: that is the responsibility of the application.
   * </p>
   * 
   * @param uri
   ...
   * @param localName
   *          The local name, or the empty string if Namespace processing is not
   *          being performed.
   * @param qName
   *          The qualified (prefixed) name, or the empty string if qualified
