...
public interface PrefixResolver {
   ...
   * 
   * @return The associated Namespace URI as a string, or null if the prefix is
   *         undeclared in this context.
   */
   ...
   * 
   * @return The base identifier from where relative URIs should be absolutized,
   *         or null if the base ID is unknown.
   *         <p>
   ...
   *         as xml:base have been used. Unless this PrefixResolver is bound to
   *         a specific portion of the document, or has been kept up to date via
   *         some other mechanism, it may not accurately reflect that context
   *         information.
   */
