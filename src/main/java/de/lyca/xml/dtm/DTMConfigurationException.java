...
public class DTMConfigurationException extends DTMException {
   ...
   * 
   * @param e
   *          The exception to be encapsulated in a DTMConfigurationException.
   */
  ...
  /**
   * Create a new <code>DTMConfigurationException</code> with the given
   * <code>Exception</code> base cause and detail message.
   * 
   * @param msg
   *          The detail message.
   * @param e
   *          The exception to be wrapped in a DTMConfigurationException
   */
