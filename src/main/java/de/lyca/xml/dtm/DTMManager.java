 ...
 * to create is named "de.lyca.xml.utils.DTMFactory". This
...
public abstract class DTMManager
{
   ...
   * <ul>
   * <li>
   * Use the <code>de.lyca.xml.dtm.DTMManager</code> system
   * property.
   * </li>
   * <li>
   ...
   * <code>META-INF/services/de.lyca.xml.dtm.DTMManager</code>
   * in jars available to the runtime.
   * </li>
   * <li>
   * Use the default <code>DTMManager</code> classname, which is
   * <code>de.lyca.xml.dtm.ref.DTMManagerDefault</code>.
   * </li>
   * </ul>
   *
