...
public class DTMChildIterNodeList extends DTMNodeListBase {
   ...
   * 
   * Unfortunately AxisIterators and DTMIterators don't share an API, so I can't
   * use the existing Axis.CHILD iterator. Rather than create Yet Another Class,
   * let's set up a special case of this one.
   * 
   * @param parentDTM
