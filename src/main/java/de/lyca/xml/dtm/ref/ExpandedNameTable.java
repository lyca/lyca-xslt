...
public class ExpandedNameTable {
   ...
   * table, otherwise the name is added to the table and the expanded name id of
   ...
   *          The node type
   * @param searchOnly
   *          If it is true, we will only search for the expanded name. -1 is
   *          return is the name is not found.
   * 
   * @return the expanded-name id of the node.
   */
   ...
   * is called when the number of keys in the hashtable exceeds this hashtable's
  ...
  public String getNamespace(int ExpandedNameID) {
    final String namespace = m_extendedTypes[ExpandedNameID].getNamespace();
