...
public final class ExtendedType {
  ...
  /**
   * Create an ExtendedType object from node type, namespace and local name. The
   * hash code is calculated from the node type, namespace and local name.
   * 
   * @param nodetype
   *          Type of the node
   * @param namespace
  ...
  public boolean equals(ExtendedType other) {
    try {
      return other.nodetype == nodetype && other.localName.equals(localName) && other.namespace.equals(namespace);
