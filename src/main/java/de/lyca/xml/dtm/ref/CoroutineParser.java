...
public interface CoroutineParser {
  ...
  /**
   * @return the coroutine ID number for this CoroutineParser object. Note that
   *         this isn't useful unless you know which CoroutineManager you're
   *         talking to. Also note that the do...() methods encapsulate the
   *         common transactions with the CoroutineParser, so you shouldn't need
   *         this in most cases.
   * */
   ...
   *         using the do...() methods, applications should only need to talk to
   *         the CoroutineManager once, to obtain the application's Coroutine
   *         ID.
   * */
  ...
  // ================================================================
  /**
   * doParse() is a simple API which tells the coroutine parser to begin reading
   * from a file. This is intended to be called from one of our partner
   ...
   * @param appCoroutine
   *          The coroutine ID number of the coroutine invoking this method, so
   *          it can be resumed after the parser has responded to the request.
  ...
  /**
   * doMore() is a simple API which tells the coroutine parser that we need more
   * nodes. This is intended to be called from one of our partner coroutines,
   * and serves both to encapsulate the communication protocol and to avoid
   * having to explicitly use the CoroutineParser's coroutine ID number.
   * 
   * @param parsemore
  ...
  /**
   * doTerminate() is a simple API which tells the coroutine parser to terminate
   * itself. This is intended to be called from one of our partner coroutines,
   * and serves both to encapsulate the communication protocol and to avoid
   * having to explicitly use the CoroutineParser's coroutine ID number.
   * 
