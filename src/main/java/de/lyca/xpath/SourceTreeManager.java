...
public class SourceTreeManager {
  ...
  public void putDocumentInCache(int n, Source source) {
    ...
    final int cachedNode = getNode(source);
  ...
  public int parseToNode(Source source, SourceLocator locator, XPathContext xctxt) throws TransformerException {
    ...
    try {
      ...
      DTM dtm;
      if (null != xowner && xowner instanceof de.lyca.xml.dtm.DTMWSFilter) {
        dtm = xctxt.getDTM(source, false, (de.lyca.xml.dtm.DTMWSFilter) xowner, false, true);
      } else {
