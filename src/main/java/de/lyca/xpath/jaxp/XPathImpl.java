...
public class XPathImpl implements javax.xml.xpath.XPath {
    ...
    private XObject eval(String expression, Object contextItem)
        ...
        de.lyca.xpath.XPath xpath = new de.lyca.xpath.XPath( expression,
            null, prefixResolver, de.lyca.xpath.XPath.SELECT ); 
    ...
    public XPathExpression compile(String expression)
        ...
        try {
            de.lyca.xpath.XPath xpath = new XPath (expression, null,
                    prefixResolver, de.lyca.xpath.XPath.SELECT );
