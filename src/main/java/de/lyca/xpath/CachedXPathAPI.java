...
public class CachedXPathAPI
{
  ...
  */
   ...
   * its own {@link de.lyca.xml.dtm.DTMManager}.
   ...
   * ({@link de.lyca.xml.dtm.DTM}) and previously established location
   * state.</p>
   ...
   * to a single {@link de.lyca.xml.dtm.DTM} at this time.  Similarly,
