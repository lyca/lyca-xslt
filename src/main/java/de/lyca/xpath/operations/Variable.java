...
public class Variable extends Expression implements PathComponent
{
  ...
  {
    de.lyca.xml.utils.PrefixResolver xprefixResolver = xctxt.getNamespaceContext();
...
//    }
  ...
  public de.lyca.xalan.templates.ElemVariable getElemVariable()
  {
    ...
    de.lyca.xpath.ExpressionNode owner = getExpressionOwner();

    if (null != owner && owner instanceof de.lyca.xalan.templates.ElemTemplateElement)
    {

      de.lyca.xalan.templates.ElemTemplateElement prev = 
        (de.lyca.xalan.templates.ElemTemplateElement) owner;
      ...
      {            
        ...
        {
          de.lyca.xalan.templates.ElemTemplateElement savedprev = prev;
