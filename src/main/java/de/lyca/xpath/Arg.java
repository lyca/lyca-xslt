...
public class Arg {
   ...
   * 
   * @param expr
   *          String containing the expression to be stored as this argument's
   *          value.
   * @see #getExpression
   */
   ...
   * setParameter.
   */
  private final boolean m_isFromWithParam;
  ...
  /**
   * True if this variable is currently visible. To be visible, a variable needs
   * to come either from xsl:variable or be a "received" parameter, ie one for
   * which an xsl:param has been encountered. Set at the time the object is
   * constructed and updated as needed.
   */
  ...
  /**
   * Equality function specialized for the variable name. If the argument is not
   * a qname, it will deligate to the super class.
   * 
   * @param obj
