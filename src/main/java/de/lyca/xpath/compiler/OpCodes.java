...
public class OpCodes {
  ...
  /**
   * [OP_EXTFUNCTION] (Extension function.) [length] [index to namespace token]
   * [index to function name token] {OP_ARGUMENT}
   * 
   * returns: XNodeSet XNumber XString XBoolean XRTree XObject
   * 
   * @xsl.usage advanced
  ...
  /**
   * [NODETYPE_COMMENT] No size or arguments. Note: must not overlap function OP
   * number!
   * 
   * returns: XBoolean
   * 
