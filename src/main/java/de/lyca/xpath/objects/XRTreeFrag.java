...
import de.lyca.xpath.axes.RTFIterator;
...
public class XRTreeFrag extends XObject implements Cloneable {
  ...
  public Object object() {
    if (m_DTMXRTreeFrag.getXPathContext() != null)
      return new de.lyca.xml.dtm.ref.DTMNodeIterator(new de.lyca.xpath.NodeSetDTM(m_dtmRoot, m_DTMXRTreeFrag
  ...
  @Override
  public String str() {
    final String str = m_DTMXRTreeFrag.getDTM().getStringValue(m_dtmRoot).toString();
   ...
   * {@link de.lyca.xalan.lib.ExsltCommon}.
   * 
  ...
  public NodeList convertToNodeset() {
    ...
    if (m_obj instanceof NodeList)
      ...
      return new de.lyca.xml.dtm.ref.DTMNodeList(asNodeIterator());
  }
