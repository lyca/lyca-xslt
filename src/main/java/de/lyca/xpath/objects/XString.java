...
public class XString extends XObject implements XMLString {
  ...
  public double toDouble() {
     ...
     * characters as white space characters. ht - horizontal tab, nl - newline ,
     * cr - carriage return and sp - space trim() methods by default also takes
     * care of these white space characters So trim() method is used to remove
     * leading and trailing white spaces.
     */
    final XMLString s = trim();
  ...
  public int compareToIgnoreCase(XMLString str) {
    ...
    throw new de.lyca.xml.utils.WrappedRuntimeException(new java.lang.NoSuchMethodException(
