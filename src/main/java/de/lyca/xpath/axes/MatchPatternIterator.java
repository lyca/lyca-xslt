...
/**
 * This class treats a <a
 * href="http://www.w3.org/TR/xpath#location-paths">LocationPath</a> as a
...
public class MatchPatternIterator extends LocPathIterator {
  ...
  MatchPatternIterator(Compiler compiler, int opPos, int analysis) throws javax.xml.transform.TransformerException {
    ...
    if (0 != (analysis & (WalkerFactory.BIT_ANCESTOR | WalkerFactory.BIT_ANCESTOR_OR_SELF | WalkerFactory.BIT_PRECEDING
            | WalkerFactory.BIT_PRECEDING_SIBLING | WalkerFactory.BIT_FOLLOWING | WalkerFactory.BIT_FOLLOWING_SIBLING
