...
public abstract class PredicatedNodeTest extends NodeTest implements SubContextList {
  ...
  /**
   * Set the number of predicates that this walker has. This does more that one
   * would think, as it creates a new predicate array of the size of the count
   * argument, and copies count predicates into the new one from the old, and
   * then reassigns the predicates value. All this to keep from having to have a
   * predicate count value.
   * 
   * @param count
