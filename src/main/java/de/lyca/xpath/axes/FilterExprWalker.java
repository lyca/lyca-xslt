...
public class FilterExprWalker extends AxesWalker {
  ...
  public void init(Compiler compiler, int opPos, int stepType) throws javax.xml.transform.TransformerException {
    ...
    switch (stepType) {
      ...
      case OpCodes.OP_VARIABLE:
        ...
        // de.lyca.xalan.templates.FuncKey))
        if (m_expr instanceof de.lyca.xpath.operations.Variable) {
  ...
  public void setRoot(int root) {
    ...
    m_exprObj = FilterExprIteratorSimple.executeFilterExpr(root, m_lpi.getXPathContext(), m_lpi.getPrefixResolver(),
  ...
  public int getNextNode() {
    ...
    if (null != m_exprObj) {
      final int next = m_exprObj.nextNode();
      return next;
    } else
      return DTM.NULL;
  }
