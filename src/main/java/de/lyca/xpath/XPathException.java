...
public class XPathException extends TransformerException {
  ...
  public org.w3c.dom.Node getStylesheetNode(ExpressionNode ex) {
    ...
    final ExpressionNode owner = getExpressionOwner(ex);
  ...
  /**
   * Create an XPathException object that holds an error message, the stylesheet
   * node that the error originated from, and another exception that caused this
   * exception.
   * 
   * @param message
   *          The error message.
