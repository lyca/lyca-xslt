...
public class XPATHErrorResources_sl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_DOCUMENT_REPLACED,
                    "Implementacija funkcije document() je bila nadome\u0161\u010dena z de.lyca.xalan.xslt.FuncDocument!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "Kontekst ne vsebuje lastni\u0161kega dokumenta!" },

            { ER_LOCALNAME_HAS_TOO_MANY_ARGS, "local-name() ima preve\u010d argumentov." },

            { ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "namespace-uri() ima preve\u010d argumentov." },

            { ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS, "normalize-space() ima preve\u010d argumentov." },

            { ER_NUMBER_HAS_TOO_MANY_ARGS, "number() ima preve\u010d argumentov." },

            { ER_NAME_HAS_TOO_MANY_ARGS, "name() ima preve\u010d argumentov." },

            { ER_STRING_HAS_TOO_MANY_ARGS, "string() ima preve\u010d argumentov." },

            { ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "string-length() ima preve\u010d argumentov." },

            { ER_TRANSLATE_TAKES_3_ARGS, "Funkcija translate() sprejme tri argumente!" },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "Funkcija unparsed-entity-uri bi morala vsebovati en argument!" },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "Os imenskega prostora \u0161e ni implementirana!" },

            { ER_UNKNOWN_AXIS, "neznana os: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "neznana operacija ujemanja!" },

            { ER_INCORRECT_ARG_LENGTH,
                    "Dol\u017eina argumenta pri preskusu vozli\u0161\u010da s processing-instruction() ni pravilna!" },

            { ER_CANT_CONVERT_TO_NUMBER, "{0} ni mogo\u010de pretvoriti v \u0161tevilko" },

            { ER_CANT_CONVERT_TO_NODELIST, "{0} ni mogo\u010de pretvoriti v seznam vozli\u0161\u010d (NodeList)" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "{0} ni mogo\u010de pretvoriti v NodeSetDTM" },

            { ER_CANT_CONVERT_TO_TYPE, "{0} ni mogo\u010de pretvoriti v type#{1}" },

            { ER_EXPECTED_MATCH_PATTERN, "Pri\u010dakovan primerjalni vzorec v getMatchScore!" },

            { ER_COULDNOT_GET_VAR_NAMED, "Nisem na\u0161el predloge z imenom {0}" },

            { ER_UNKNOWN_OPCODE, "NAPAKA! Neznana op. koda: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Dodatni neveljavni \u017eetoni: {0}" },
            ...
            { ER_EMPTY_EXPRESSION, "Prazen izraz!" },

            { ER_EXPECTED_BUT_FOUND, "Pri\u010dakovano {0}, najdeno: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Programerjeva predpostavka ni pravilna! - {0}" },

            { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "Argument logi\u010dne vrednosti(...) ni ve\u010d izbiren z osnutkom 19990709 XPath." },

            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Najdeno ',' vendar ni predhodnih argumentov!" },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Najdeno ',' vendar ni slede\u010dih argumentov!" },

            { ER_PREDICATE_ILLEGAL_SYNTAX,
                    "'..[predicate]' ali '.[predicate]' je neveljavna sintaksa.  Namesto tega uporabite 'self::node()[predicate]'." },

            { ER_ILLEGAL_AXIS_NAME, "Neveljavno ime osi: {0}" },

            { ER_UNKNOWN_NODETYPE, "Neveljavni tip vozli\u0161\u010da: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Navedek vzorca ({0}) mora biti v navednicah!" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} ni mogo\u010de oblikovati v \u0161tevilko!" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Ne morem ustvariti zveze XML TransformerFactory: {0}" },

            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Napaka! Ne najdem izbirnega izraza xpath (-select)." },

            { ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH, "NAPAKA! Ne najdem ENDOP po OP_LOCATIONPATH" },

            { ER_ERROR_OCCURED, "Pri\u0161lo je do napake!" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key()ima nepravilno \u0161tevilo argumentov." },

            { ER_COUNT_TAKES_1_ARG, "\u0160tevna funkcija zahteva en argument!" },

            { ER_COULDNOT_FIND_FUNCTION, "Ne najdem funkcije: {0}" },

            { ER_UNSUPPORTED_ENCODING, "Nepodprto kodiranje: {0}" },

            { ER_PROBLEM_IN_DTM_NEXTSIBLING,
                    "Pri\u0161lo je do te\u017eave v DTM pri getNextSibling... poskus obnovitve" },

            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Programerska napaka: pisanje v EmptyNodeList ni mogo\u010de." },

            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory v XPathContext ni podprt!" },
            ...
            { ER_SAX_API_NOT_HANDLED, "Znaki SAX API(znaka ch[]... ne obravnava DTM!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED, "ignorableWhitespace(znaka ch[]... ne obravnava DTM!" },

            { ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison ne more upravljati z vozli\u0161\u010di tipa {0}" },

            { ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper ne more upravljati z vozli\u0161\u010di tipa {0}" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "Napaka DOM2Helper.parse: ID sistema - {0} vrstica - {1}" },

            { ER_XERCES_PARSE_ERROR, "Napaka DOM2Helper.parse" },

            { ER_INVALID_UTF16_SURROGATE, "Zaznan neveljaven nadomestek UTF-16: {0} ?" },

            { ER_OIERROR, "Napaka V/I" },

            { ER_CANNOT_CREATE_URL, "Ne morem ustvariti naslova URL za: {0}" },

            { ER_XPATH_READOBJECT, "V XPath.readObject: {0}" },

            { ER_FUNCTION_TOKEN_NOT_FOUND, "ne najdem \u017eetona funkcije." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "Ne morem ravnati z tipom XPath: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Ta NodeSet ni spremenljiv" },

            { ER_NODESETDTM_NOT_MUTABLE, "Ta NodeSetDTM ni spremenljiv" },

            { ER_VAR_NOT_RESOLVABLE, "Spremenljivka ni razre\u0161ljiva: {0}" },

            { ER_NULL_ERROR_HANDLER, "Program za obravnavo napak NULL" },

            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Programerjeva izjava: neznana opkoda: {0}" },

            { ER_ZERO_OR_ONE, "0 ali 1" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira rtf()" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira asNodeIterator()" },

            { ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira detach()" },

            { ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira num()" },

            { ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira xstr()" },

            { ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper ne podpira str()" },

            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() ni podprt za XStringForChars" },

            { ER_COULD_NOT_FIND_VAR, "Spremenljivke z imenom {0} ni mogo\u010de najti" },

            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING, "XStringForChars ne more uporabiti niza za argument" },

            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "Argument FastStringBuffer ne more biti NULL" },

            { ER_TWO_OR_THREE, "2 ali 3" },

            { ER_VARIABLE_ACCESSED_BEFORE_BIND, "Spremenljivka uporabljena \u0161e pred njeno vezavo!" },

            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB ne more uporabiti niza za argument!" },
            ...
            { ER_NODESETDTM_CANNOT_INDEX, "Ta NodeSetDTM ne more opravljati funkcij priprave kazala ali \u0161tetja!" },

            { ER_NODESET_CANNOT_INDEX, "Ta NodeSet ne more opravljati funkcij priprave kazala ali \u0161tetja!" },

            { ER_CANNOT_CALL_SETSHOULDCACHENODE, "Za klicem nextNode klic setShouldCacheNodes ni mogo\u010d!" },

            { ER_ONLY_ALLOWS, "{0} dovoljuje samo argumente {1}" },

            { ER_UNKNOWN_STEP, "Programerjeva izjava v getNextStepPos: neznan stepType: {0}" },
            ...
            { ER_EXPECTED_REL_LOC_PATH, "Za \u017eetonom '/' ali '//' je pri\u010dakovana relativna pot do mesta." },
            ...
            { ER_EXPECTED_LOC_STEP, "Za \u017eetonom '/' ali '//' je pri\u010dakovan korak mesta." },
            ...
            { ER_EXPECTED_NODE_TEST, "Pri\u010dakovan preskus vozli\u0161\u010da, ki ustreza NCImenu:* ali QImenu." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Pri\u010dakovan stopnjevalni vzorec, najden pa je '/'." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Pri\u010dakovan vzorec z relativno potjo." },
            ...
            { ER_INVALID_XPATH_TYPE, "Neveljaven argument tipa XPath: {0}" },

            { ER_EMPTY_XPATH_RESULT, "Prazen objekt rezultatov XPath" },

            {
                    ER_INCOMPATIBLE_TYPES,
                    "Rezultat XPathResult izraza XPath ''{0}'' ima XPathResultType {1}, ki ga ni mogo\u010de prisiliti v dolo\u010den tip XPathResultType {2}." },

            { ER_NULL_RESOLVER, "Predpone ni bilo mogo\u010de razre\u0161iti z razre\u0161evalnikom predpon NULL." },
            ...
            { ER_WRONG_DOCUMENT, "Kontekstno vozli\u0161\u010de ne pripada dokumentu, povezanem s tem XPathEvaluator." },

            // Note to translators: The XPath expression cannot be evaluated
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "Tip kontekstnega vozli\u0161\u010da ni podprt." },

            { ER_XPATH_ERROR, "Neznana napaka v XPath." },
            ...
            { ER_UNSUPPORTED_RETURN_TYPE, "Nepodprt tip vrnitve : {0}" },

            /** Field ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL */

            { ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL, "Vir in/ali Tip vrnitve ne moreta biti ni\u010d" },

            /** Field ER_ARG_CANNOT_BE_NULL */

            { ER_ARG_CANNOT_BE_NULL, "Argument {0} ne more biti ni\u010d" },
            ...
            { ER_FEATURE_NAME_NULL, "Poskus nastavitve funkcije brez imena (null name): {0}#setFeature( null, {1})" },

            /** Field ER_FEATURE_UNKNOWN */

            { ER_FEATURE_UNKNOWN, "Poskus nastavitve neznane funkcije \"{0}\":{1}#setFeature({0},{2})" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_NULL_FEATURE, "Poskus pridobitve funkcije brez imena (null name): {0}#getFeature(null)" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_UNKNOWN_FEATURE, "Poskus pridobitve neznane funkcije \"{0}\":{1}#getFeature({0})" },
            ...
            { WG_PROPERTY_NOT_SUPPORTED, "Lastnost XSL ni podprta: {0}" },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "Stara sintaksa: quo(...) v XPath ni ve\u010d definiran." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "XPath potrebuje izpeljani objekt za implementacijo nodeTest!" },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "ne najdem \u017eetona funkcije." },

            { WG_COULDNOT_FIND_FUNCTION, "Ne najdem funkcije: {0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Ne morem narediti naslova URL iz: {0}" },

            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Mo\u017enost -E za raz\u010dlenjevalnik DTM ni podprta." },

            { WG_ILLEGAL_VARIABLE_REFERENCE,
                    "Dani VariableReference je izven konteksta ali brez definicije!  Ime = {0}" },

            { WG_UNSUPPORTED_ENCODING, "Nepodprto kodiranje: {0}" },

            // Other miscellaneous text used inside the code...
            { "ui_language", "sl" }, { "help_language", "sl" }, { "language", "sl" },
            { "BAD_CODE", "Parameter za createMessage presega meje" },
            { "FORMAT_FAILED", "Med klicem je messageFormat naletel na izjemo" },
            { "version", ">>>>>>> Razli\u010dica Xalan " }, { "version2", "<<<<<<<" }, { "yes", "da" },
            { "line", "Vrstica #" }, { "column", "Stolpec #" }, { "xsldone", "XSLProcessor: dokon\u010dano" },
            ...
            { "noParsermsg5", "IBM AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" }, { "gtone", ">1" },
  ...
  public static final String ERROR_RESOURCES = "de.lyca.xpath.res.XPATHErrorResources";
