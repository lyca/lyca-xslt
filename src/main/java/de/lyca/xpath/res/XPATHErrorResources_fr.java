  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CURRENT_NOT_ALLOWED_IN_MATCH,
                    "La fonction current() n'est pas admise dans un motif de correspondance !" },

            { ER_CURRENT_TAKES_NO_ARGS, "La fonction current() n'accepte pas d'arguments !" },

            { ER_DOCUMENT_REPLACED,
                    "L'impl\u00e9mentation de la fonction document() a \u00e9t\u00e9 remplac\u00e9e par de.lyca.xalan.xslt.FuncDocument !" },
            ...
            { ER_UNKNOWN_OPCODE, "ERREUR ! Code op\u00e9ration inconnu : {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Jetons incorrects suppl\u00e9mentaires : {0}" },

            { ER_EXPECTED_DOUBLE_QUOTE, "Erreur de guillemets dans un litt\u00e9ral... Guillemet double obligatoire !" },

            { ER_EXPECTED_SINGLE_QUOTE, "Erreur de guillemets dans un litt\u00e9ral... Guillemet simple obligatoire !" },

            { ER_EMPTY_EXPRESSION, "Expression vide !" },

            { ER_EXPECTED_BUT_FOUND, "{1} a \u00e9t\u00e9 trouv\u00e9 alors que {0} \u00e9tait attendu :" },
            ...
            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Virgule trouv\u00e9e sans argument qui la pr\u00e9c\u00e8de !" },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Virgule trouv\u00e9e sans argument qui la suit !" },
            ...
            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Le litt\u00e9ral de motif ({0}) doit figurer entre guillemets !" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} ne peut \u00eatre format\u00e9e sous forme num\u00e9rique !" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Impossible de cr\u00e9er XML TransformerFactory Liaison : {0}" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key() poss\u00e8de un nombre non valide d'arguments." },

            { ER_COUNT_TAKES_1_ARG, "Un seul argument doit \u00eatre fourni \u00e0 la fonction count !" },
            ...
            { ER_SAX_API_NOT_HANDLED, "Caract\u00e8res (char ch[]...) de l'API SAX non pris en charge par le DTM !" },
            ...
            { ER_XERCES_PARSE_ERROR_DETAILS, "Erreur de DOM2Helper.parse : ID syst\u00e8me - {0} ligne - {1}" },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Assertion de programme : code op\u00e9ration inconnu : {0}" },
            ...
            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING, "XStringForChars n'accepte pas de cha\u00eene comme argument" },

            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "L'argument FastStringBuffer ne doit pas \u00eatre vide" },
            ...
            { ER_CANNOT_CALL_SETSHOULDCACHENODE, "Impossible d'appeler setShouldCacheNodes apr\u00e8s nextNode !" },
            ...
            { ER_EXPECTED_LOC_STEP, "Une \u00e9tape d'emplacement \u00e9tait attendue apr\u00e8s le jeton '/' ou '//'." },
            ...
            { ER_EXPECTED_NODE_TEST, "Un test de noeud correspondant \u00e0 NCName:* ou QName \u00e9tait attendu." },
            ...
            { ER_DOC_MUTATED, "Mutation du document depuis le renvoi du r\u00e9sultat. L'it\u00e9rateur est incorrect." },

            { ER_INVALID_XPATH_TYPE, "Argument de type XPath incorrect : {0}" },

            { ER_EMPTY_XPATH_RESULT, "Objet r\u00e9sultat XPath vide" },
            ...
            { ER_WRONG_DOCUMENT, "Le noeud de contexte n'appartient pas au document li\u00e9 \u00e0 ce XPathEvaluator." },
            ...
            { WG_DONT_DO_ANYTHING_WITH_NS, "Espace de noms {0} inexploitable dans la propri\u00e9t\u00e9 : {1}" },
            ...
            { "line", "Ligne #" }, { "column", "Colonne #" }, { "xsldone", "XSLProcessor : termin\u00e9" },
            { "xpath_option", "options xpath : " }, { "optionIN", "   [-in URLXMLentr\u00e9e]" },
            ...
            { "noParsermsg1", "Echec du processus XSL." }, { "noParsermsg2", "** Analyseur introuvable **" },
            ...
            { "noParsermsg5", "AlphaWorks de IBM : http://www.alphaworks.ibm.com/formula/xml" }, { "gtone", ">1" },
