  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_DOCUMENT_REPLACED,
                    "implementace funkce document() byla nahrazena funkc\u00ed de.lyca.xalan.xslt.FuncDocument!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "Parametr context nem\u00e1 dokument vlastn\u00edka!" },

            { ER_LOCALNAME_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce local-name()." },

            { ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce namespace-uri()." },

            { ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS,
                    "P\u0159\u00edli\u0161 mnoho argument\u016f funkce normalize-space()." },

            { ER_NUMBER_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce number()." },

            { ER_NAME_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce name()." },

            { ER_STRING_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce string()." },

            { ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "P\u0159\u00edli\u0161 mnoho argument\u016f funkce string-length()." },

            { ER_TRANSLATE_TAKES_3_ARGS, "Funkce translate() akceptuje t\u0159i argumenty!" },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "Funkce unparsed-entity-uri mus\u00ed akceptovat jeden argument!" },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "Obor n\u00e1zv\u016f axis nebyl je\u0161t\u011b implementov\u00e1n!" },

            { ER_UNKNOWN_AXIS, "nezn\u00e1m\u00fd parametr axis: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "nezn\u00e1m\u00e1 operace shody!" },

            { ER_INCORRECT_ARG_LENGTH, "Nespr\u00e1vn\u00e1 d\u00e9lka argumentu testu uzlu processing-instruction()!" },

            { ER_CANT_CONVERT_TO_NUMBER, "{0} nelze p\u0159ev\u00e9st na parametr number" },

            { ER_CANT_CONVERT_TO_NODELIST, "{0} nelze p\u0159ev\u00e9st na parametr NodeList!" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "{0} nelze p\u0159ev\u00e9st na parametr NodeSetDTM!" },

            { ER_CANT_CONVERT_TO_TYPE, "{0} nelze p\u0159ev\u00e9st na parametr type#{1}" },

            { ER_EXPECTED_MATCH_PATTERN, "Funkce getMatchScore o\u010dek\u00e1v\u00e1 parametr!" },

            { ER_COULDNOT_GET_VAR_NAMED, "Nelze z\u00edskat prom\u011bnnou s n\u00e1zvem {0}" },

            { ER_UNKNOWN_OPCODE, "Chyba! Nezn\u00e1m\u00fd k\u00f3d operace: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Dal\u0161\u00ed nepovolen\u00e9 tokeny: {0}" },
            ...
            { ER_EMPTY_EXPRESSION, "Pr\u00e1zdn\u00fd v\u00fdraz!" },

            { ER_EXPECTED_BUT_FOUND, "O\u010dek\u00e1v\u00e1no: {0}, ale nalezeno: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Nespr\u00e1vn\u00e9 tvrzen\u00ed program\u00e1tora! - {0}" },

            { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "booleovsk\u00fd(...) argument ji\u017e nen\u00ed v n\u00e1vrhu 19990709 XPath voliteln\u00fd." },

            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Byl nalezen znak ',' bez p\u0159edchoz\u00edho argumentu!" },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Byl nalezen znak ',' bez n\u00e1sleduj\u00edc\u00edho argumentu!" },

            {
                    ER_PREDICATE_ILLEGAL_SYNTAX,
                    "V\u00fdraz '..[predicate]' nebo '.[predicate]' m\u00e1 nespr\u00e1vnou syntaxi. Pou\u017eijte m\u00edsto toho 'self::node()[predicate]'." },

            { ER_ILLEGAL_AXIS_NAME, "nepovolen\u00fd n\u00e1zev osy: {0}" },

            { ER_UNKNOWN_NODETYPE, "Nezn\u00e1m\u00fd typ uzlu: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Je nutno uv\u00e9st vzorek liter\u00e1lu ({0})!" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} nelze zform\u00e1tovat jako \u010d\u00edslo!" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Nelze vytvo\u0159it prvek XML TransformerFactory Liaison: {0}" },

            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Chyba! Nebyl nalezen v\u00fdraz v\u00fdb\u011bru xpath (-select)." },

            { ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH, "Chyba! Nebyl nalezen v\u00fdraz ENDOP po OP_LOCATIONPATH" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "nespr\u00e1vn\u00fd po\u010det argument\u016f parametru key()." },

            { ER_COUNT_TAKES_1_ARG, "Funkce count mus\u00ed obsahovat jeden argument!" },

            { ER_COULDNOT_FIND_FUNCTION, "Nelze nal\u00e9zt funkci: {0}" },

            { ER_UNSUPPORTED_ENCODING, "Nepodporovan\u00e9 k\u00f3dov\u00e1n\u00ed: {0}" },

            { ER_PROBLEM_IN_DTM_NEXTSIBLING,
                    "Ve funkci getNextSibling do\u0161lo v DTM k chyb\u011b... Prob\u00edh\u00e1 pokus o obnovu" },

            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Chyba program\u00e1tora: Do funkce EmptyNodeList nelze zapisovat." },
            ...
            { ER_SAX_API_NOT_HANDLED, "Znaky SAX API (char ch[]... nen\u00ed v DTM zpracov\u00e1v\u00e1na!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED,
                    "Funkce ignorableWhitespace(char ch[]... nen\u00ed v DTM zpracov\u00e1v\u00e1na!" },

            { ER_DTM_CANNOT_HANDLE_NODES, "Funkce DTMLiaison nem\u016f\u017ee zpracov\u00e1vat uzly typu {0}" },

            { ER_XERCES_CANNOT_HANDLE_NODES, "Funkce DOM2Helper nem\u016f\u017ee zpracov\u00e1vat uzly typu {0}" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "Chyba funkce DOM2Helper.parse: SystemID - {0} \u0159\u00e1dek - {1}" },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Tvrzen\u00ed program\u00e1tora: nezn\u00e1m\u00fd k\u00f3d operace: {0}" },
            ...
            { ER_COULD_NOT_FIND_VAR, "Nelze nal\u00e9zt prom\u011bnnou s n\u00e1zvem {0}" },
            ...
            { ER_FSB_CANNOT_TAKE_STRING, "Argumentem funkce XStringForFSB nem\u016f\u017ee b\u00fdt \u0159et\u011bzec!" },
            ...
            { ER_EXPECTED_LOC_STEP, "Po tokenu '/' nebo '//' byl o\u010dek\u00e1v\u00e1n krok um\u00edst\u011bn\u00ed" },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Byl o\u010dek\u00e1v\u00e1n vzorek relativn\u00ed cesty." },
            ...
            { ER_EMPTY_XPATH_RESULT, "Pr\u00e1zdn\u00fd objekt v\u00fdsledku XPath" },
            ...
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "Typ uzlu kontextu nen\u00ed podporov\u00e1n." },

            { ER_XPATH_ERROR, "Nezn\u00e1m\u00e1 chyba objektu XPath." },
            ...
            { ER_RESOLVE_VARIABLE_RETURNS_NULL, "Funkce resolveVariable pro prom\u011bnnou {0} vrac\u00ed hodnotu Null" },

            /** Field ER_UNSUPPORTED_RETURN_TYPE */

            { ER_UNSUPPORTED_RETURN_TYPE, "Nepodporovan\u00fd n\u00e1vratov\u00fd typ: {0}" },
            ...
            { ER_ARG_CANNOT_BE_NULL, "Argument {0} nesm\u00ed m\u00edt hodnotu Null" },
            ...
            { ER_FEATURE_UNKNOWN, "Pokus o nastaven\u00ed nezn\u00e1m\u00e9 funkce \"{0}\":{1}#setFeature({0},{2})" },
            ...
            { WG_PROPERTY_NOT_SUPPORTED, "Vlastnost XSL nen\u00ed podporov\u00e1na: {0}" },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "Zastaral\u00e1 syntaxe: quo(...) ji\u017e nen\u00ed v XPath definov\u00e1no." },
            ...
            { WG_COULDNOT_FIND_FUNCTION, "Nelze nal\u00e9zt funkci: {0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Nelze vytvo\u0159it adresu URL z: {0}" },

            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Analyz\u00e1tor DTM nepodporuje volbu -E" },

            { WG_ILLEGAL_VARIABLE_REFERENCE,
                    "Odkaz VariableReference uveden k prom\u011bnn\u00e9 mimo kontext nebo bez definice!  N\u00e1zev = {0}" },

            { WG_UNSUPPORTED_ENCODING, "Nepodporovan\u00e9 k\u00f3dov\u00e1n\u00ed: {0}" },
            ...
            { "noParsermsg5", "AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" }, { "gtone", ">1" },
