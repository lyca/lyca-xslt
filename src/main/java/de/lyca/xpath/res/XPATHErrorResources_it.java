  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CURRENT_NOT_ALLOWED_IN_MATCH,
                    "La funzione corrente () non \u00e8 consentita in un modello di corrispondenza." },

            { ER_CURRENT_TAKES_NO_ARGS, "La funzione corrente () non accetta argomenti." },

            { ER_DOCUMENT_REPLACED,
                    "L'implementazione della funzione documento () \u00e8 stata sostituita da de.lyca.xalan.xslt.FuncDocument." },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "il contesto non ha un documento proprietario." },
            ...
            { ER_TRANSLATE_TAKES_3_ARGS, "La funzione translate() richiede tre argomenti." },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "La funzione unparsed-entity-uri richiede un argomento." },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "namespace axis non ancora implementato." },

            { ER_UNKNOWN_AXIS, "asse sconosciuto: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "operazione di corrispondenza sconosciuta." },

            { ER_INCORRECT_ARG_LENGTH, "Lunghezza argomento nella prova nodo processing-instruction() non corretta." },

            { ER_CANT_CONVERT_TO_NUMBER, "Impossibile convertire {0} in un numero" },

            { ER_CANT_CONVERT_TO_NODELIST, "Impossibile convertire {0} in un NodeList." },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "Impossibile convertire {0} in un NodeSetDTM." },

            { ER_CANT_CONVERT_TO_TYPE, "Impossibile convertire {0} in un type#{1}" },

            { ER_EXPECTED_MATCH_PATTERN, "Modello corrispondenza previsto in getMatchScore!" },

            { ER_COULDNOT_GET_VAR_NAMED, "Impossibile richiamare la variabile denominata {0}" },

            { ER_UNKNOWN_OPCODE, "ERRORE! Codice operativo sconosciuto: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Token aggiuntivi non validi: {0}" },

            { ER_EXPECTED_DOUBLE_QUOTE, "letterale con numero di apici errato... previsti i doppi apici." },

            { ER_EXPECTED_SINGLE_QUOTE, "letterale con numero di apici errato... previsto un solo apice." },

            { ER_EMPTY_EXPRESSION, "Espressione vuota." },

            { ER_EXPECTED_BUT_FOUND, "Era previsto {0}, ma \u00e8 stato trovato: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Asserzione programmatore errata. - {0}" },

            { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "Argomento boolean(...) non pi\u00f9 facoltativo con la versione 19990709 XPath." },

            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Trovata ',' senza argomento che la precede." },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Trovata ',' senza argomento che la segue." },
            ...
            { ER_UNKNOWN_NODETYPE, "Nodetype sconosciuto: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Il letterale modello ({0}) deve essere racchiuso fra virgolette." },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} non pu\u00f2 essere formattato in un numero." },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Impossibile creare XML TransformerFactory Liaison: {0}" },

            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Errore! Impossibile trovare espressione selezione xpath (-select)." },

            { ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH, "ERRORE! Impossibile trovare ENDOP dopo OP_LOCATIONPATH" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key() con numero di argomenti scorretto." },

            { ER_COUNT_TAKES_1_ARG, "La funzione count richiede un argomento." },
            ...
            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Errore di programmazione: Impossibile scrivere su EmptyNodeList." },
            ...
            { ER_SAX_API_NOT_HANDLED, "Caratteri SAX API (char ch[]... non gestiti da DTM!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED, "ignorableWhitespace(char ch[]... non gestiti da DTM!" },
            ...
            { ER_FUNCTION_TOKEN_NOT_FOUND, "token funzione non trovato." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "Impossibile gestire il tipo XPath: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Questo NodeSet non \u00e8 trasformabile" },

            { ER_NODESETDTM_NOT_MUTABLE, "Questo NodeSetDTM non \u00e8 trasformabile" },

            { ER_VAR_NOT_RESOLVABLE, "Variabile non risolvibile: {0}" },

            { ER_NULL_ERROR_HANDLER, "Handler errori nullo" },

            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Asserzione di programmatore: codice operativo sconosciuto: {0}" },

            { ER_ZERO_OR_ONE, "0 oppure 1" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "rtf() non supportato da XRTreeFragSelectWrapper" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER,
                    "asNodeIterator() non supportato da XRTreeFragSelectWrapper" },

            { ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "detach() non supportato da XRTreeFragSelectWrapper" },

            { ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "num() non supportato da XRTreeFragSelectWrapper" },

            { ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "xstr() non supportato da XRTreeFragSelectWrapper" },

            { ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "str() non supportato da XRTreeFragSelectWrapper" },

            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() non supportato per XStringForChars" },

            { ER_COULD_NOT_FIND_VAR, "Impossibile trovare la variabile con il nome {0}" },
            ...
            { ER_VARIABLE_ACCESSED_BEFORE_BIND, "Variabile acceduta prima che fosse delimitata." },

            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB non pu\u00f2 accettare una stringa come argomento." },

            { ER_SETTING_WALKER_ROOT_TO_NULL, "\n !!!! Errore! Si sta impostando il nodo di partenza su null" },

            { ER_NODESETDTM_CANNOT_ITERATE, "NodeSetDTM non pu\u00f2 collegarsi al nodo precedente" },

            { ER_NODESET_CANNOT_ITERATE, "NodeSet non pu\u00f2 collegarsi al nodo precedente" },

            { ER_NODESETDTM_CANNOT_INDEX,
                    "NodeSetDTM non pu\u00f2 eseguire l'indicizzazione o il conteggio delle funzioni." },

            { ER_NODESET_CANNOT_INDEX, "NodeSet non pu\u00f2 eseguire l'indicizzazione o il conteggio delle funzioni." },
            ...
            { ER_UNKNOWN_STEP, "Asserzione di programmatore in getNextStepPos: stepType sconosciuto: {0}" },
            ...
            { ER_EXPECTED_REL_LOC_PATH, "Era previsto un percorso relativo dopo il token '/' oppure '//'." },
            ...
            // encountered instead.
            { ER_EXPECTED_LOC_PATH, "Era previsto un percorso, ma \u00e8 stato rilevato il seguente token\u003a  {0}" },
            ...
            { ER_EXPECTED_LOC_STEP, "Era previsto un passo di posizione dopo il token '/' oppure '//'." },
            ...
            { ER_EXPECTED_NODE_TEST, "Era prevista una prova nodo che corrisponde a NCName:* oppure a QName." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Era previsto un modello passo, ma \u00e8 stato rilevato '/'." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Era previsto un modello percorso relativo." },
            ...
            { ER_INVALID_XPATH_TYPE, "Argomento di tipo XPath non valido: {0}" },

            { ER_EMPTY_XPATH_RESULT, "Oggetto risultato XPath vuoto" },
            ...
            { ER_NULL_RESOLVER, "Impossibile risolvere il prefisso con resolver di prefisso nullo." },
            ...
            { ER_XPATH_ERROR, "Errore sconosciuto in XPath." },
            ...
            { ER_RESOLVE_VARIABLE_RETURNS_NULL, "resolveVariable per la variabile {0} che restituisce null" },

            /** Field ER_UNSUPPORTED_RETURN_TYPE */

            { ER_UNSUPPORTED_RETURN_TYPE, "Tipo di ritorno non supportato : {0}" },

            /** Field ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL */

            { ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL, "Il tipo origine e/o ritorno non pu\u00f2 essere nullo" },
            ...
            { ER_FEATURE_NAME_NULL, "Tentativo di impostare una funzione con un nome nullo: {0}#setFeature( null, {1})" },

            /** Field ER_FEATURE_UNKNOWN */

            { ER_FEATURE_UNKNOWN, "Tentativo di impostare una funzione sconosciuta \"{0}\":{1}#setFeature({0},{2})" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_NULL_FEATURE, "Tentativo di ottenere una funzione con un nome nullo: {0}#getFeature(null)" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_UNKNOWN_FEATURE, "Tentativo di ottenere una funzione sconosciuta \"{0}\":{1}#getFeature({0})" },
            ...
            { WG_LOCALE_NAME_NOT_HANDLED, "nome locale nella funzione format-number non ancora gestito." },

            { WG_PROPERTY_NOT_SUPPORTED, "Propriet\u00e0 XSL non supportata: {0}" },

            { WG_DONT_DO_ANYTHING_WITH_NS, "Non eseguire alcune azione per lo namespace {0} nella propriet\u00e0: {1}" },

            { WG_SECURITY_EXCEPTION,
                    "SecurityException durante il tentativo di accesso alla propriet\u00e0 di sistema XSL: {0}" },

            { WG_QUO_NO_LONGER_DEFINED, "Sintassi obsoleta: quo(...) non \u00e8 pi\u00f9 definito in XPath." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "XPath richiede un oggetto derivato per implementare nodeTest!" },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "token funzione non trovato." },
            ...
            { "version", ">>>>>>> Versione Xalan " }, { "version2", "<<<<<<<" }, { "yes", "s\u00ec" },
            { "line", "Riga #" }, { "column", "Colonna #" }, { "xsldone", "XSLProcessor: eseguito" },
            ...
            { "noParsermsg2", "** Impossibile trovare il parser **" }, { "noParsermsg3", "Controllare il classpath." },
