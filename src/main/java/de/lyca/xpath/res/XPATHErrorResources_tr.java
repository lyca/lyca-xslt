  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CURRENT_NOT_ALLOWED_IN_MATCH,
                    "E\u015fle\u015fme \u00f6r\u00fcnt\u00fcs\u00fcnde current() i\u015flevine izin verilmez!" },

            { ER_CURRENT_TAKES_NO_ARGS, "current() i\u015flevi ba\u011f\u0131ms\u0131z de\u011fi\u015fken kabul etmez!" },

            { ER_DOCUMENT_REPLACED,
                    "document() i\u015flevi uygulamas\u0131 de.lyca.xalan.xslt.FuncDocument ile de\u011fi\u015ftirildi!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "Ba\u011flam\u0131n iye belgesi yok!" },
            ...
            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "namespace ekseni hen\u00fcz ger\u00e7ekle\u015ftirilmedi!" },

            { ER_UNKNOWN_AXIS, "Bilinmeyen eksen: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "Bilinmeyen e\u015fle\u015fme i\u015flemi!" },

            {
                    ER_INCORRECT_ARG_LENGTH,
                    "processing-instruction() d\u00fc\u011f\u00fcm s\u0131namas\u0131n\u0131n ba\u011f\u0131ms\u0131z de\u011fi\u015fken uzunlu\u011fu yanl\u0131\u015f!" },

            { ER_CANT_CONVERT_TO_NUMBER, "{0} bir say\u0131ya d\u00f6n\u00fc\u015ft\u00fcr\u00fclemez" },

            { ER_CANT_CONVERT_TO_NODELIST, "{0} NodeList''e d\u00f6n\u00fc\u015ft\u00fcr\u00fclemez!" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "{0} NodeSetDTM''ye d\u00f6n\u00fc\u015ft\u00fcr\u00fclemez!" },

            { ER_CANT_CONVERT_TO_TYPE, "{0} - type#{1} d\u00f6n\u00fc\u015f\u00fcm\u00fc yap\u0131lamaz" },

            { ER_EXPECTED_MATCH_PATTERN,
                    "getMatchScore i\u00e7inde e\u015fle\u015fme \u00f6r\u00fcnt\u00fcs\u00fc bekleniyor!" },

            { ER_COULDNOT_GET_VAR_NAMED, "{0} adl\u0131 de\u011fi\u015fken al\u0131namad\u0131" },

            { ER_UNKNOWN_OPCODE, "HATA! Bilinmeyen i\u015flem kodu: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Fazladan ge\u00e7ersiz simgeler: {0}" },
            ...
            { ER_EMPTY_EXPRESSION, "\u0130fade bo\u015f!" },

            { ER_EXPECTED_BUT_FOUND, "{0} bekleniyordu, {1} bulundu" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Programc\u0131 de\u011ferlendirmesi yanl\u0131\u015f! - {0}" },
            ...
            { ER_ILLEGAL_AXIS_NAME, "Eksen ad\u0131 ge\u00e7ersiz: {0}" },

            { ER_UNKNOWN_NODETYPE, "D\u00fc\u011f\u00fcm tipi ge\u00e7ersiz: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED,
                    "\u00d6r\u00fcnt\u00fc haz\u0131r bilgisinin ({0}) t\u0131rnak i\u00e7ine al\u0131nmas\u0131 gerekiyor!" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} bir say\u0131 olarak bi\u00e7imlenemedi!" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "XML TransformerFactory ili\u015fkisi {0} yarat\u0131lamad\u0131" },

            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Hata! xpath select ifadesi (-select) bulunamad\u0131." },

            { ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH,
                    "HATA! OP_LOCATIONPATH sonras\u0131nda ENDOP bulunamad\u0131." },

            { ER_ERROR_OCCURED, "Hata olu\u015ftu!" },
            ...
            { ER_COULDNOT_FIND_FUNCTION, "\u0130\u015flev bulunamad\u0131: {0}" },

            { ER_UNSUPPORTED_ENCODING, "Desteklenmeyen kodlama: {0}" },
            ...
            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory, XPathContext taraf\u0131ndan desteklenmiyor!" },
            ...
            { ER_SAX_API_NOT_HANDLED, "SAX API characters(char ch[]... DTM taraf\u0131ndan i\u015flenmedi!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED,
                    "ignorableWhitespace(char ch[]... DTM taraf\u0131ndan i\u015flenmedi!" },

            { ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison {0} tipi d\u00fc\u011f\u00fcmleri i\u015fleyemez" },

            { ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper {0} tipi d\u00fc\u011f\u00fcmleri i\u015fleyemez" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "DOM2Helper.parse hatas\u0131: Sistem tnt - {0} sat\u0131r - {1}" },

            { ER_XERCES_PARSE_ERROR, "DOM2Helper.parse hatas\u0131" },

            { ER_INVALID_UTF16_SURROGATE, "UTF-16 yerine kullan\u0131lan de\u011fer ge\u00e7ersiz: {0} ?" },

            { ER_OIERROR, "G\u00c7 hatas\u0131" },

            { ER_CANNOT_CREATE_URL, "\u0130lgili url yarat\u0131lam\u0131yor: {0}" },

            { ER_XPATH_READOBJECT, "XPath.readObject i\u00e7inde: {0}" },

            { ER_FUNCTION_TOKEN_NOT_FOUND, "\u0130\u015flev simgesi bulunamad\u0131." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "XPath tipi i\u015flenemiyor: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Bu NodeSet de\u011fi\u015febilir t\u00fcrde de\u011fil" },

            { ER_NODESETDTM_NOT_MUTABLE, "Bu NodeSetDTM de\u011fi\u015febilir t\u00fcrde de\u011fil" },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Programc\u0131 do\u011frulamas\u0131: bilinmeyen opcode:{0}" },

            { ER_ZERO_OR_ONE, "0 ya da 1" },
            ...
            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() XStringForChars i\u00e7in desteklenmiyor" },

            { ER_COULD_NOT_FIND_VAR, "{0} ad\u0131nda de\u011fi\u015fken bulunamad\u0131" },
            ...
            { ER_NODESETDTM_CANNOT_ITERATE, "Bu NodeSetDTM \u00f6nceki bir d\u00fc\u011f\u00fcme yineleme yapamaz!" },

            { ER_NODESET_CANNOT_ITERATE, "Bu NodeSet \u00f6nceki bir d\u00fc\u011f\u00fcme yineleme yapamaz!" },

            { ER_NODESETDTM_CANNOT_INDEX, "Bu NodeSetDTM dizinleme ya da sayma i\u015flevleri yapamaz!" },

            { ER_NODESET_CANNOT_INDEX, "Bu NodeSet dizinleme ya da sayma i\u015flevleri yapamaz!" },

            { ER_CANNOT_CALL_SETSHOULDCACHENODE,
                    "nextNode \u00e7a\u011fr\u0131ld\u0131ktan sonra setShouldCacheNodes \u00e7a\u011fr\u0131lamaz!" },

            { ER_ONLY_ALLOWS, "{0} yaln\u0131zca {1} ba\u011f\u0131ms\u0131z de\u011fi\u015fkene izin verir" },
            ...
            { ER_EXPECTED_REL_LOC_PATH, "'/' ya da '//' simgesinden sonra g\u00f6reli yer yolu bekleniyordu." },
            ...
            // encountered instead.
            { ER_EXPECTED_LOC_PATH, "Yer yolu bekleniyordu, ancak \u015fu simge saptand\u0131\u003a  {0}" },
            ...
            { ER_EXPECTED_LOC_PATH_AT_END_EXPR, "Yer yolu bekleniyordu, ancak XPath ifadesinin sonu saptand\u0131." },
            ...
            { ER_EXPECTED_LOC_STEP, "'/' ya da '//' simgesinden sonra yer ad\u0131m\u0131 bekleniyordu." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Ad\u0131m \u00f6r\u00fcnt\u00fcs\u00fc bekleniyordu, ancak '/' saptand\u0131." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "G\u00f6reli yol \u00f6r\u00fcnt\u00fcs\u00fc bekleniyordu." },
            ...
            { ER_INVALID_XPATH_TYPE, "Ge\u00e7ersiz XPath tipi ba\u011f\u0131ms\u0131z de\u011fi\u015fkeni: {0}" },

            { ER_EMPTY_XPATH_RESULT, "Bo\u015f XPath sonu\u00e7 nesnesi" },
            ...
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "Ba\u011flam d\u00fc\u011f\u00fcm\u00fc tipi desteklenmiyor." },

            { ER_XPATH_ERROR, "XPath i\u00e7inde bilinmeyen hata." },
            ...
            { ER_UNSUPPORTED_RETURN_TYPE, "Desteklenmeyen d\u00f6n\u00fc\u015f tipi: {0}" },
            ...
            { ER_ARG_CANNOT_BE_NULL, "{0} ba\u011f\u0131ms\u0131z de\u011fi\u015fkeni bo\u015f de\u011ferli olamaz" },
            ...
            { WG_PROPERTY_NOT_SUPPORTED, "XSL \u00f6zelli\u011fi desteklenmiyor: {0}" },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "Eski s\u00f6zdizimi: quo(...) art\u0131k XPath i\u00e7inde tan\u0131mlanmaz." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "nodeTest uygulanmas\u0131 i\u00e7in XPath t\u00fcretilmi\u015f bir nesne gerektirir!" },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "\u0130\u015flev simgesi bulunamad\u0131." },

            { WG_COULDNOT_FIND_FUNCTION, "\u0130\u015flev bulunamad\u0131: {0}" },
            ...
            { WG_UNSUPPORTED_ENCODING, "Desteklenmeyen kodlama: {0}" },
            ...
            { "optionMatch",
                    "   [-match e\u015fle\u015fme \u00f6r\u00fcnt\u00fcs\u00fc (e\u015fle\u015fme tan\u0131lamas\u0131 i\u00e7in)]" },
