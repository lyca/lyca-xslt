  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_DOCUMENT_REPLACED,
                    "Implement\u00e1cia funkcie document() bola nahraden\u00e1 de.lyca.xalan.xslt.FuncDocument!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "kontext nem\u00e1 dokument vlastn\u00edka!" },

            { ER_LOCALNAME_HAS_TOO_MANY_ARGS, "local-name() m\u00e1 prive\u013ea argumentov." },

            { ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "namespace-uri() m\u00e1 prive\u013ea argumentov." },

            { ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS, "normalize-space() m\u00e1 prive\u013ea argumentov." },

            { ER_NUMBER_HAS_TOO_MANY_ARGS, "number() m\u00e1 prive\u013ea argumentov." },

            { ER_NAME_HAS_TOO_MANY_ARGS, "name() m\u00e1 prive\u013ea argumentov." },

            { ER_STRING_HAS_TOO_MANY_ARGS, "string() m\u00e1 prive\u013ea argumentov" },

            { ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "string-length() m\u00e1 prive\u013ea argumentov" },

            { ER_TRANSLATE_TAKES_3_ARGS, "Funkcia translate() pr\u00edma tri argumenty!" },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "Funkcia unparsed-entity-uri by mala prija\u0165 jeden argument!" },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED,
                    "osi n\u00e1zvov\u00fdch priestorov e\u0161te nie s\u00fa implementovan\u00e9!" },

            { ER_UNKNOWN_AXIS, "nezn\u00e1ma os: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "nezn\u00e1ma porovn\u00e1vacia oper\u00e1cia!" },

            { ER_INCORRECT_ARG_LENGTH, "Testovanie uzla arg length of processing-instruction() je nespr\u00e1vne!" },

            { ER_CANT_CONVERT_TO_NUMBER, "Nie je mo\u017en\u00e9 konvertova\u0165 {0} na \u010d\u00edslo" },

            { ER_CANT_CONVERT_TO_NODELIST, "Nie je mo\u017en\u00e9 konvertova\u0165 {0} na NodeList!" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "Nie je mo\u017en\u00e9 konvertova\u0165 {0} na NodeSetDTM!" },

            { ER_CANT_CONVERT_TO_TYPE, "Nie je mo\u017en\u00e1 konverzia {0} na typ#{1}" },

            { ER_EXPECTED_MATCH_PATTERN, "O\u010dak\u00e1van\u00fd porovn\u00e1vac\u00ed vzor v getMatchScore!" },

            { ER_COULDNOT_GET_VAR_NAMED, "Nie je mo\u017en\u00e9 dosiahnu\u0165 premenn\u00fa s n\u00e1zvom {0}" },

            { ER_UNKNOWN_OPCODE, "CHYBA! Nezn\u00e1my k\u00f3d op: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Nadbyto\u010dn\u00e9 neplatn\u00e9 symboly: {0}" },
            ...
            { ER_EMPTY_EXPRESSION, "Pr\u00e1zdny v\u00fdraz!" },

            { ER_EXPECTED_BUT_FOUND, "O\u010dak\u00e1vala sa {0}, ale bola n\u00e1jden\u00e1: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Program\u00e1torsk\u00e9 vyjadrenie je nespr\u00e1vne! - {0}" },
            ...
            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "N\u00e1jden\u00e9 ',' ale \u017eiaden nasleduj\u00faci argument!" },

            { ER_PREDICATE_ILLEGAL_SYNTAX,
                    "'..[predicate]' alebo '.[predicate]' je nespr\u00e1vna syntax.  Pou\u017eite namiesto toho 'self::node()[predicate]'." },

            { ER_ILLEGAL_AXIS_NAME, "Neplatn\u00fd n\u00e1zov osi: {0}" },

            { ER_UNKNOWN_NODETYPE, "Nezn\u00e1my typ uzla: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Vzorov\u00fd liter\u00e1l ({0}) potrebuje by\u0165 citovan\u00fd!" },
            ...
            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Chyba! Nena\u0161lo sa vyjadrenie v\u00fdberu xpath (-select)." },

            { ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH,
                    "CHYBA! Nebolo mo\u017en\u00e9 n\u00e1js\u0165 ENDOP po OP_LOCATIONPATH" },

            { ER_ERROR_OCCURED, "Vyskytla sa chyba!" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key() m\u00e1 nespr\u00e1vny po\u010det argumentov." },

            { ER_COUNT_TAKES_1_ARG, "Funkcia count by mala prija\u0165 jeden argument!" },

            { ER_COULDNOT_FIND_FUNCTION, "Nebolo mo\u017en\u00e9 n\u00e1js\u0165 funkciu: {0}" },

            { ER_UNSUPPORTED_ENCODING, "Nepodporovan\u00e9 k\u00f3dovanie: {0}" },

            { ER_PROBLEM_IN_DTM_NEXTSIBLING, "Vyskytol sa probl\u00e9m v DTM v getNextSibling... pokus o obnovu" },

            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL,
                    "Chyba program\u00e1tora: EmptyNodeList nebolo mo\u017en\u00e9 zap\u00edsa\u0165." },

            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory nie je podporovan\u00e9 XPathContext!" },
            ...
            { ER_SAX_API_NOT_HANDLED, "SAX API znaky(char ch[]... nie s\u00fa spracovan\u00e9 DTM!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED, "ignorableWhitespace(char ch[]... nie s\u00fa spracovan\u00e9 DTM!" },

            { ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison nem\u00f4\u017ee spracova\u0165 uzly typu {0}" },

            { ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper nem\u00f4\u017ee spracova\u0165 uzly typu {0}" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "Chyba DOM2Helper.parse: SystemID - {0} riadok - {1}" },

            { ER_XERCES_PARSE_ERROR, "chyba DOM2Helper.parse" },

            { ER_INVALID_UTF16_SURROGATE, "Bolo zisten\u00e9 neplatn\u00e9 nahradenie UTF-16: {0} ?" },

            { ER_OIERROR, "chyba IO" },

            { ER_CANNOT_CREATE_URL, "Nie je mo\u017en\u00e9 vytvori\u0165 url pre: {0}" },

            { ER_XPATH_READOBJECT, "V XPath.readObject: {0}" },

            { ER_FUNCTION_TOKEN_NOT_FOUND, "nebol n\u00e1jden\u00fd symbol funkcie." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "Nie je mo\u017en\u00e9 pracova\u0165 s typom XPath: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Tento NodeSet je nest\u00e1ly" },

            { ER_NODESETDTM_NOT_MUTABLE, "Tento NodeSetDTM nie je nest\u00e1ly" },

            { ER_VAR_NOT_RESOLVABLE, "Premenn\u00fa nie je mo\u017en\u00e9 rozl\u00ed\u0161i\u0165: {0}" },

            { ER_NULL_ERROR_HANDLER, "Nulov\u00fd chybov\u00fd manipula\u010dn\u00fd program" },

            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Tvrdenie program\u00e1tora: nezn\u00e1my opcode: {0}" },

            { ER_ZERO_OR_ONE, "0, alebo 1" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "rtf() nie je podporovan\u00fd XRTreeFragSelectWrapper" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER,
                    "asNodeIterator() nie je podporovan\u00fd XRTreeFragSelectWrapper" },

            { ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper nepodporuje detach()" },

            { ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper nepodporuje num()" },

            { ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper nepodporuje xstr()" },

            { ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "XRTreeFragSelectWrapper nepodporuje str()" },

            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() nie je podporovan\u00fd pre XStringForChars" },

            { ER_COULD_NOT_FIND_VAR, "Nebolo mo\u017en\u00e9 n\u00e1js\u0165 premenn\u00fa s n\u00e1zvom {0}" },

            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING,
                    "XStringForChars nem\u00f4\u017ee ako argument prija\u0165 re\u0165azec" },

            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "Argument FastStringBuffer nem\u00f4\u017ee by\u0165 nulov\u00fd" },
            ...
            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB nem\u00f4\u017ee pova\u017eova\u0165 re\u0165azec za argument!" },
            ...
            { ER_ONLY_ALLOWS, "{0} povo\u013eulje iba {1} argumentov" },

            { ER_UNKNOWN_STEP, "Tvrdenie program\u00e1tora v getNextStepPos: nezn\u00e1my stepType: {0}" },
            ...
            { ER_EXPECTED_LOC_STEP, "Po symbole '/' alebo '//' sa o\u010dak\u00e1val krok umiestnenia." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "O\u010dak\u00e1val sa vzor kroku, ale bol zaznamenan\u00fd '/'." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "O\u010dak\u00e1val sa vzor relat\u00edvnej cesty." },
            ...
            { ER_DOC_MUTATED, "Dokument sa od vr\u00e1tenia v\u00fdsledku zmenil. Iter\u00e1tor je neplatn\u00fd." },

            { ER_INVALID_XPATH_TYPE, "Neplatn\u00fd argument typu XPath: {0}" },

            { ER_EMPTY_XPATH_RESULT, "Pr\u00e1zdny objekt v\u00fdsledku XPath" },
            ...
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "Typ uzla kontextu nie je podporovan\u00fd." },

            { ER_XPATH_ERROR, "Nezn\u00e1ma chyba v XPath." },
            ...
            { ER_RESOLVE_VARIABLE_RETURNS_NULL, "resolveVariable pre premenn\u00fa {0} vracia hodnotu null" },

            /** Field ER_UNSUPPORTED_RETURN_TYPE */

            { ER_UNSUPPORTED_RETURN_TYPE, "Nepodporovan\u00fd typ n\u00e1vratu : {0}" },
            ...
            { ER_ARG_CANNOT_BE_NULL, "Argument {0} nem\u00f4\u017ee ma\u0165 hodnotu null" },
            ...
            { ER_FEATURE_UNKNOWN, "Prebieha pokus o nastavenie nezn\u00e1mej funkcie \"{0}\":{1}#setFeature({0},{2})" },
            ...
            { WG_PROPERTY_NOT_SUPPORTED, "Vlastn\u00edctvo XSL nie je podporovan\u00e9: {0}" },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "Star\u00e1 syntax: quo(...) u\u017e nie je v XPath definovan\u00e9." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "XPath potrebuje odvoden\u00fd objekt na implement\u00e1ciu nodeTest!" },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "nebol n\u00e1jden\u00fd symbol funkcie." },

            { WG_COULDNOT_FIND_FUNCTION, "Nebolo mo\u017en\u00e9 n\u00e1js\u0165 funkciu: {0}" },
            ...
            { WG_UNSUPPORTED_ENCODING, "Nepodporovan\u00e9 k\u00f3dovanie: {0}" },
