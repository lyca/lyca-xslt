...
public class XPATHErrorResources_sv extends XPATHErrorResources {
  ...
  /** Field MAX_CODE */
  public static final int MAX_CODE = 108; // this is needed to keep track of the
                                          // number of messages

  /** Field MAX_WARNING */
  public static final int MAX_WARNING = 11; // this is needed to keep track of
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_DOCUMENT_REPLACED,
                    "Implementeringen av funktionen document() har ersatts av de.lyca.xalan.xslt.FuncDocument!" },

            /** Field ER_CONTEXT_HAS_NO_OWNERDOC */
            // public static final int ER_CONTEXT_HAS_NO_OWNERDOC = 4;

            { ER_CONTEXT_HAS_NO_OWNERDOC, "Kontext saknar \u00e4gardokument!" },
            ...
            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "Funktionen unparsed-entity-uri borde ta emot ett argument!" },

            /** Field ER_NAMESPACEAXIS_NOT_IMPLEMENTED */
            // public static final int ER_NAMESPACEAXIS_NOT_IMPLEMENTED = 14;

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "Namespace-axel inte implementerad \u00e4n!" },
            ...
            { ER_INCORRECT_ARG_LENGTH, "Nodtests argumentl\u00e4ngd i processing-instruction() \u00e4r inte korrekt!" },

            /** Field ER_CANT_CONVERT_TO_NUMBER */
            // public static final int ER_CANT_CONVERT_TO_NUMBER = 18;

            { ER_CANT_CONVERT_TO_NUMBER, "Kan inte konvertera {0} till ett nummer" },

            /** Field ER_CANT_CONVERT_TO_NODELIST */
            // public static final int ER_CANT_CONVERT_TO_NODELIST = 19;

            { ER_CANT_CONVERT_TO_NODELIST, "Kan inte konvertera {0} till en NodeList!" },

            /** Field ER_CANT_CONVERT_TO_MUTABLENODELIST */
            // public static final int ER_CANT_CONVERT_TO_MUTABLENODELIST = 20;

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "Kan inte konvertera {0} till en NodeSetDTM!" },

            /** Field ER_CANT_CONVERT_TO_TYPE */
            // public static final int ER_CANT_CONVERT_TO_TYPE = 21;

            { ER_CANT_CONVERT_TO_TYPE, "Kan inte konvertera {0} till en type//{1}" },

            /** Field ER_EXPECTED_MATCH_PATTERN */
            // public static final int ER_EXPECTED_MATCH_PATTERN = 22;

            { ER_EXPECTED_MATCH_PATTERN, "Matchningsm\u00f6nster i getMatchScore f\u00f6rv\u00e4ntat!" },
            ...
            { ER_INCORRECT_PROGRAMMER_ASSERTION, "Programmerares f\u00f6rs\u00e4kran \u00e4r inte korrekt! - {0}" },
            ...
            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Hittade ',' men inget f\u00f6reg\u00e5ende argument!" },

            /** Field ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG */
            // public static final int ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG = 33;

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Hittade ',' men inget efterf\u00f6ljande argument!" },
            ...
            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} kunde inte formateras till ett nummer" },

            /** Field ER_COULDNOT_CREATE_XMLPROCESSORLIAISON */
            // public static final int ER_COULDNOT_CREATE_XMLPROCESSORLIAISON =
            // 39;

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Kunde inte skapa XML TransformerFactory Liaison: {0}" },
            ...
            // ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH = 41;
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key() har ett felaktigt antal argument." },
            ...
            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Programmerarfel: EmptyNodeList kan inte skrivas till." },

            /** Field ER_SETDOMFACTORY_NOT_SUPPORTED */
            // public static final int ER_SETDOMFACTORY_NOT_SUPPORTED = 51;

            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory underst\u00f6ds inte av XPathContext!" },
            ...
            { ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison kan inte hantera noder av typen {0}" },

            /** Field ER_XERCES_CANNOT_HANDLE_NODES */
            // public static final int ER_XERCES_CANNOT_HANDLE_NODES = 60;

            { ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper kan inte hantera noder av typen {0}" },

            /** Field ER_XERCES_PARSE_ERROR_DETAILS */
            // public static final int ER_XERCES_PARSE_ERROR_DETAILS = 61;

            { ER_XERCES_PARSE_ERROR_DETAILS, "DOM2Helper.parse-fel: SystemID - {0} rad - {1}" },
            ...
            { ER_FUNCTION_TOKEN_NOT_FOUND, "funktionstecken saknas." },
            ...
            { ER_NODESET_NOT_MUTABLE, "NodeSet \u00e4r of\u00f6r\u00e4nderlig" },

            /** This NodeSetDTM is not mutable */
            // public static final int ER_NODESETDTM_NOT_MUTABLE = 73;

            { ER_NODESETDTM_NOT_MUTABLE, "NodeSetDTM \u00e4r of\u00f6r\u00e4nderlig" },

            /** Variable not resolvable: */
            // public static final int ER_VAR_NOT_RESOLVABLE = 74;

            { ER_VAR_NOT_RESOLVABLE, "Variabel ej l\u00f6sbar: {0}" },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Programmerares f\u00f6rs\u00e4kran: ok\u00e4nd op-kod: {0}" },
            ...
            // public static final int
            // ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER = 78;

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "rtf() underst\u00f6ds inte av XRTreeFragSelectWrapper!" },
            ...
            // public static final int ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS =
            // 80;

            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() underst\u00f6ds inte av XRStringForChars!" },

            /** Could not find variable with the name of */
            // public static final int ER_COULD_NOT_FIND_VAR = 81;

            { ER_COULD_NOT_FIND_VAR, "Hittade inte variabeln med namn {0}" },

            /** XStringForChars can not take a string for an argument */
            // public static final int ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING =
            // 82;

            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING, "XStringForChars kan inte ta en str\u00e4ng som argument" },
            ...
            { ER_VARIABLE_ACCESSED_BEFORE_BIND, "Variabeln anv\u00e4ndes innan den bands!" },

            /** XStringForFSB can not take a string for an argument! */
            // public static final int ER_FSB_CANNOT_TAKE_STRING = 86;

            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB kan inte ha en str\u00e4ng som argument!" },
            ...
            { ER_NODESETDTM_CANNOT_INDEX, "Detta NodeSetDTM har inte funktioner f\u00f6r indexering och r\u00e4kning!" },

            /** This NodeSet can not do indexing or counting functions! */
            // public static final int ER_NODESET_CANNOT_INDEX = 91;

            { ER_NODESET_CANNOT_INDEX, "Detta NodeSet har inte funktioner f\u00f6r indexering och r\u00e4kning!" },
            ...
            { ER_ONLY_ALLOWS, "{0} till\u00e5ter bara {1} argument" },

            /** Programmer's assertion in getNextStepPos: unknown stepType: {0} */
            // public static final int ER_UNKNOWN_STEP = 94;

            { ER_UNKNOWN_STEP, "Programmerarkontroll i getNextStepPos: ok\u00e4nt steg Typ: {0}" },
            ...
            { ER_EXPECTED_REL_LOC_PATH, "En relativ s\u00f6kv\u00e4g f\u00f6rv\u00e4ntades efter token '/' eller '//'." },
            ...
            { ER_EXPECTED_LOC_STEP, "Ett platssteg f\u00f6rv\u00e4ntades efter token  '/' eller '//'." },
            ...
            { ER_EXPECTED_NODE_TEST, "Ett nodtest som matchar antingen NCName:* eller QName f\u00f6rv\u00e4ntades." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Ett stegm\u00f6nster f\u00f6rv\u00e4ntades, men '/' p\u00e5tr\u00e4ffades." },
            ...
            { ER_EXPECTED_REL_PATH_PATTERN, "Ett m\u00f6nster f\u00f6r relativ s\u00f6kv\u00e4g f\u00f6rv\u00e4ntades." },
            ...
            { ER_CANT_CONVERT_TO_BOOLEAN, "Det g\u00e5r inte att konvertera {0} till ett Booleskt v\u00e4rde." },
            ...
            { ER_NON_ITERATOR_TYPE, "Det g\u00e5r inte att iterera \u00f6ver den icke itererbara typen: {0}" },
            ...
            { ER_DOC_MUTATED, "Dokumentet har \u00e4ndrats sedan resultatet genererades. Iterering ogiltig." },
            ...
            { ER_INCOMPATIBLE_TYPES, "Den genererade typen: {0} kan inte bearbetas i den angivna typen: {1}" },

            /** Field ER_NULL_RESOLVER */
            // public static final int ER_NULL_RESOLVER = 111;

            { ER_NULL_RESOLVER, "Det g\u00e5r inte att l\u00f6sa prefixet utan prefixl\u00f6sare." },
            ...
            { ER_CANT_CONVERT_TO_STRING, "Det g\u00e5r inte att konvertera {0} till en str\u00e4ng." },
            ...
            { ER_WRONG_NODETYPE, "Kontextnoden kan inte hanteras." },
            ...
            { WG_LOCALE_NAME_NOT_HANDLED, "locale-namnet i format-number-funktionen \u00e4nnu inte hanterat!" },

            /** Field WG_PROPERTY_NOT_SUPPORTED */
            // public static final int WG_PROPERTY_NOT_SUPPORTED = 2;

            { WG_PROPERTY_NOT_SUPPORTED, "XSL-Egenskap underst\u00f6ds inte: {0}" },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "Gammal syntax: quo(...) \u00e4r inte l\u00e4ngre definierad i XPath." },

            /** Field WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST */
            // public static final int
            // WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST = 6;
            ...
            { WG_FUNCTION_TOKEN_NOT_FOUND, "funktionstecken saknas." },

            /** Field WG_COULDNOT_FIND_FUNCTION */
            // public static final int WG_COULDNOT_FIND_FUNCTION = 8;

            { WG_COULDNOT_FIND_FUNCTION, "Hittade inte funktion: {0}" },
            ...
            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Alternativet -E underst\u00f6ds inte f\u00f6r DTM-tolk" },
            ...
            { "version", ">>>>>>> Xalan Version" }, { "version2", "<<<<<<<" }, { "yes", "ja" }, { "line", "Rad //" },
            { "column", "Kolumn //" }, { "xsldone", "XSLProcessor f\u00e4rdig" },
            { "xpath_option", "xpath-alternativ" }, { "optionIN", "    [-in inputXMLURL]" },
            { "optionSelect", "[-select xpath-uttryck]" },
            { "optionMatch", "   [-match matchningsm\u00f6nster (f\u00f6r matchningsdiagnostik)]" },
            { "optionAnyExpr", "Eller bara ett xpath-uttryck kommer att g\u00f6ra en diagnostik-dump" },
            { "noParsermsg1", "XSL-Process misslyckades." }, { "noParsermsg2", "** Hittade inte tolk **" },
