  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_DOCUMENT_REPLACED,
                    "A implementa\u00e7\u00e3o da fun\u00e7\u00e3o document() foi substitu\u00edda por de.lyca.xalan.xslt.FuncDocument!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "context n\u00e3o possui um documento do propriet\u00e1rio!" },

            { ER_LOCALNAME_HAS_TOO_MANY_ARGS, "local-name() possui argumentos em excesso." },

            { ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "namespace-uri() possui argumentos em excesso." },

            { ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS, "normalize-space() possui argumentos em excesso." },

            { ER_NUMBER_HAS_TOO_MANY_ARGS, "number() possui argumentos em excesso." },

            { ER_NAME_HAS_TOO_MANY_ARGS, "name() possui argumentos em excesso." },

            { ER_STRING_HAS_TOO_MANY_ARGS, "string() possui argumentos em excesso." },

            { ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "string-length() possui argumentos em excesso." },

            { ER_TRANSLATE_TAKES_3_ARGS, "A fun\u00e7\u00e3o translate() tem tr\u00eas argumentos!" },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG, "A fun\u00e7\u00e3o unparsed-entity-uri deve ter um argumento!" },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "eixo do espa\u00e7o de nomes ainda n\u00e3o implementado!" },

            { ER_UNKNOWN_AXIS, "eixo desconhecido: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "opera\u00e7\u00e3o de correspond\u00eancia desconhecida!" },

            { ER_INCORRECT_ARG_LENGTH,
                    "O comprimento de arg do teste de n\u00f3 de processing-instruction() est\u00e1 incorreto! " },

            { ER_CANT_CONVERT_TO_NUMBER, "Imposs\u00edvel converter {0} em um n\u00famero" },

            { ER_CANT_CONVERT_TO_NODELIST, "Imposs\u00edvel converter {0} em um NodeList!" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "Imposs\u00edvel converter {0} em um NodeSetDTM!" },

            { ER_CANT_CONVERT_TO_TYPE, "Imposs\u00edvel converter {0} em um tipo {1}" },

            { ER_EXPECTED_MATCH_PATTERN, "Padr\u00e3o de correspond\u00eancia esperado em getMatchScore!" },

            { ER_COULDNOT_GET_VAR_NAMED, "N\u00e3o foi poss\u00edvel obter a vari\u00e1vel {0}" },

            { ER_UNKNOWN_OPCODE, "ERRO! C\u00f3digo op desconhecido: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Tokens inv\u00e1lidos extras: {0}" },

            { ER_EXPECTED_DOUBLE_QUOTE, "literal com aspa incorreta... era esperada aspa dupla!" },

            { ER_EXPECTED_SINGLE_QUOTE, "literal com aspa incorreta... era esperada aspa simples!" },

            { ER_EMPTY_EXPRESSION, "Express\u00e3o vazia!" },

            { ER_EXPECTED_BUT_FOUND, "Esperado {0}, mas encontrado: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "A declara\u00e7\u00e3o do programador est\u00e1 incorreta! - {0}" },

            { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "O argumento boolean(...) n\u00e3o \u00e9 mais opcional com o rascunho 19990709 XPath." },

            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Encontrado ',' mas sem argumento precedente!" },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Encontrado ',' mas sem argumento seguinte!" },

            { ER_PREDICATE_ILLEGAL_SYNTAX,
                    "'..[predicate]' ou '.[predicate]' \u00e9 sintaxe inv\u00e1lida. Utilize ent\u00e3o 'self::node()[predicate]'." },

            { ER_ILLEGAL_AXIS_NAME, "nome de eixo inv\u00e1lido: {0}" },

            { ER_UNKNOWN_NODETYPE, "Tipo de n\u00f3 desconhecido: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "O literal de padr\u00e3o ({0}) precisa ser colocado entre aspas!" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} n\u00e3o p\u00f4de ser formatado para um n\u00famero!" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON,
                    "N\u00e3o foi poss\u00edvel criar XML TransformerFactory Liaison: {0}" },

            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Erro! N\u00e3o encontrada a express\u00e3o xpath select (-select)." },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "key() possui um n\u00famero incorreto de argumentos." },
            ...
            { ER_PROBLEM_IN_DTM_NEXTSIBLING, "Ocorreu um problema no DTM em getNextSibling... tentando recuperar" },

            { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Erro do programador: EmptyNodeList n\u00e3o pode ser gravado." },

            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory n\u00e3o \u00e9 suportado por XPathContext!" },
            ...
            { ER_SAX_API_NOT_HANDLED, "SAX API characters(char ch[]... n\u00e3o tratado pelo DTM!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED, "ignorableWhitespace(char ch[]... n\u00e3o tratado pelo DTM!" },
            ...
            { ER_XERCES_PARSE_ERROR_DETAILS, "DOM2Helper.parse error: SystemID - {0} linha - {1}" },
            ...
            { ER_CANNOT_CREATE_URL, "Imposs\u00edvel criar url para: {0}" },

            { ER_XPATH_READOBJECT, "Em XPath.readObject: {0}" },

            { ER_FUNCTION_TOKEN_NOT_FOUND, "Token function n\u00e3o encontrado." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "Imposs\u00edvel lidar com o tipo XPath: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Este NodeSet n\u00e3o \u00e9 mut\u00e1vel" },

            { ER_NODESETDTM_NOT_MUTABLE, "Este NodeSetDTM n\u00e3o \u00e9 mut\u00e1vel" },

            { ER_VAR_NOT_RESOLVABLE, "A vari\u00e1vel n\u00e3o pode ser resolvida: {0}" },

            { ER_NULL_ERROR_HANDLER, "Rotina de tratamento de erros nula" },

            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Declara\u00e7\u00e3o do programador: opcode desconhecido: {0} " },

            { ER_ZERO_OR_ONE, "0 ou 1" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "rtf() n\u00e3o suportado por XRTreeFragSelectWrapper" },
            ...
            { ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "num() n\u00e3o suportado por XRTreeFragSelectWrapper" },

            { ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "xstr() n\u00e3o suportado por XRTreeFragSelectWrapper " },

            { ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "str() n\u00e3o suportado por XRTreeFragSelectWrapper" },

            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() n\u00e3o suportado para XStringForChars" },

            { ER_COULD_NOT_FIND_VAR, "N\u00e3o foi poss\u00edvel encontrar a vari\u00e1vel com o nome {0}" },

            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING, "XStringForChars n\u00e3o pode obter uma cadeia para um argumento" },

            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "O argumento FastStringBuffer n\u00e3o pode ser nulo" },

            { ER_TWO_OR_THREE, "2 ou 3" },

            { ER_VARIABLE_ACCESSED_BEFORE_BIND, "Vari\u00e1vel acessada antes de ser ligada!" },

            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB n\u00e3o pode obter uma cadeia para um argumento!" },

            { ER_SETTING_WALKER_ROOT_TO_NULL, "\n !!!! Erro! Definindo a raiz de um transmissor como nula!!!" },

            { ER_NODESETDTM_CANNOT_ITERATE, "Este NodeSetDTM n\u00e3o pode iterar em um n\u00f3 anterior!" },

            { ER_NODESET_CANNOT_ITERATE, "Este NodeSet n\u00e3o pode iterar em um n\u00f3 anterior!" },
            ...
            { ER_ONLY_ALLOWS, "{0} permite apenas {1} argumento(s)" },

            { ER_UNKNOWN_STEP, "Declara\u00e7\u00e3o do programador em getNextStepPos: stepType desconhecido: {0} " },
            ...
            { ER_EXPECTED_LOC_STEP, "Era esperada uma etapa de localiza\u00e7\u00e3o ap\u00f3s o token '/' ou '//'." },
            ...
            { ER_EXPECTED_NODE_TEST, "Era esperado um n\u00f3 correspondente a NCName:* ou QName." },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Era esperado um padr\u00e3o de etapa, mas foi encontrado '/'." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Era esperado um padr\u00e3o de caminho relativo." },
            ...
            { ER_DOC_MUTATED, "Documento alterado desde o retorno do resultado. O iterador \u00e9 inv\u00e1lido." },

            { ER_INVALID_XPATH_TYPE, "Argumento de tipo XPath inv\u00e1lido: {0}" },

            { ER_EMPTY_XPATH_RESULT, "Objeto de resultado XPath vazio" },
            ...
            { ER_NULL_RESOLVER, "N\u00e3o foi poss\u00edvel resolver o prefixo com um resolvedor de prefixo nulo." },
            ...
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "O tipo de n\u00f3 de contexto n\u00e3o \u00e9 suportado." },

            { ER_XPATH_ERROR, "Erro desconhecido em XPath." },
            ...
            { ER_RESOLVE_VARIABLE_RETURNS_NULL, "resolveVariable para a vari\u00e1vel {0} retornando nulo" },
            ...
            { ER_FEATURE_NAME_NULL, "Tentando definir um recurso com um nome nulo: {0}#setFeature( null, {1})" },

            /** Field ER_FEATURE_UNKNOWN */

            { ER_FEATURE_UNKNOWN, "Tentando definir o recurso desconhecido \"{0}\":{1}#setFeature({0},{2})" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_NULL_FEATURE, "Tentando obter um recurso com um nome nulo: {0}#getFeature(null)" },

            /** Field ER_GETTING_NULL_FEATURE */

            { ER_GETTING_UNKNOWN_FEATURE, "Tentando obter o recurso desconhecido \"{0}\":{1}#getFeature({0})" },
            ...
            { WG_LOCALE_NAME_NOT_HANDLED, "nome de locale na fun\u00e7\u00e3o format-number ainda n\u00e3o tratado!" },
            ...
            { WG_SECURITY_EXCEPTION, "SecurityException ao tentar acessar a propriedade do sistema XSL: {0}" },

            { WG_QUO_NO_LONGER_DEFINED, "Sintaxe antiga: quo(...) n\u00e3o est\u00e1 mais definida no XPath." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "XPath precisa de um objeto derivado para implementar nodeTest!" },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "Token function n\u00e3o encontrado." },
            ...
            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "A op\u00e7\u00e3o -E n\u00e3o \u00e9 suportada pelo analisador do DTM" },
            ...
            { "noParsermsg5", "IBM's AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" }, { "gtone", ">1" },
