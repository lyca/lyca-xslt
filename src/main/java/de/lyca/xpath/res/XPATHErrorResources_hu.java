  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CURRENT_NOT_ALLOWED_IN_MATCH,
                    "A current() f\u00fcggv\u00e9ny nem megengedett az illeszt\u00e9si mint\u00e1ban!" },

            { ER_CURRENT_TAKES_NO_ARGS, "A current() f\u00fcggv\u00e9ny nem fogad el argumentumokat!" },

            {
                    ER_DOCUMENT_REPLACED,
                    "A document() f\u00fcggv\u00e9ny megval\u00f3s\u00edt\u00e1s\u00e1t lecser\u00e9lte az de.lyca.xalan.xslt.FuncDocument!" },

            { ER_CONTEXT_HAS_NO_OWNERDOC, "A k\u00f6rnyezetnek nincs tulajdonos dokumentuma!" },

            { ER_LOCALNAME_HAS_TOO_MANY_ARGS, "A local-name()-nek t\u00fal sok argumentuma van." },

            { ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "A namespace-uri()-nek t\u00fal sok argumentuma van." },

            { ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS, "A normalize-space()-nek t\u00fal sok argumentuma van." },

            { ER_NUMBER_HAS_TOO_MANY_ARGS, "A number()-nek t\u00fal sok argumentuma van." },

            { ER_NAME_HAS_TOO_MANY_ARGS, "A name()-nek t\u00fal sok argumentuma van." },

            { ER_STRING_HAS_TOO_MANY_ARGS, "A string()-nek t\u00fal sok argumentuma van." },

            { ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "A string-length()-nek t\u00fal sok argumentuma van." },

            { ER_TRANSLATE_TAKES_3_ARGS, "A translate() f\u00fcggv\u00e9ny h\u00e1rom argumentumot k\u00e9r!" },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG,
                    "Az unparsed-entity-uri f\u00fcggv\u00e9nyhez egy argumentum sz\u00fcks\u00e9ges!" },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "A n\u00e9vt\u00e9r tengely m\u00e9g nincs magval\u00f3s\u00edtva!" },

            { ER_UNKNOWN_AXIS, "Ismeretlen tengely: {0}" },

            { ER_UNKNOWN_MATCH_OPERATION, "ismeretlen illeszt\u00e9si m\u0171velet!" },

            { ER_INCORRECT_ARG_LENGTH,
                    "A processing-instruction() csom\u00f3pont teszt argumentum\u00e1nak hossza helytelen!" },

            { ER_CANT_CONVERT_TO_NUMBER, "A(z) {0} nem konvert\u00e1lhat\u00f3 sz\u00e1mm\u00e1" },

            { ER_CANT_CONVERT_TO_NODELIST, "A(z) {0} nem konvert\u00e1lhat\u00f3 NodeList-t\u00e9!" },

            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "A(z) {0} nem konvert\u00e1lhat\u00f3 NodeSetDTM-m\u00e9!" },

            { ER_CANT_CONVERT_TO_TYPE, "{0} nem konvert\u00e1lhat\u00f3 type#{1} t\u00edpuss\u00e1" },

            { ER_EXPECTED_MATCH_PATTERN, "Illeszt\u00e9si mint\u00e1t v\u00e1rtunk a getMatchScore-ban!" },

            { ER_COULDNOT_GET_VAR_NAMED, "Nem lehet lek\u00e9rni a(z) {0} nev\u0171 v\u00e1ltoz\u00f3t" },

            { ER_UNKNOWN_OPCODE, "HIBA! Ismeretlen opk\u00f3d: {0}" },

            { ER_EXTRA_ILLEGAL_TOKENS, "Extra tiltott tokenek: {0}" },

            { ER_EXPECTED_DOUBLE_QUOTE, "rosszul id\u00e9zett liter\u00e1l... dupla id\u00e9z\u0151jelet v\u00e1rtunk!" },

            { ER_EXPECTED_SINGLE_QUOTE,
                    "rosszul id\u00e9zett liter\u00e1l... szimpla id\u00e9z\u0151jelet v\u00e1rtunk!" },

            { ER_EMPTY_EXPRESSION, "\u00dcres kifejez\u00e9s!" },

            { ER_EXPECTED_BUT_FOUND, "{0}-t v\u00e1rtunk, de ezt tal\u00e1ltuk: {1}" },

            { ER_INCORRECT_PROGRAMMER_ASSERTION, "A programoz\u00f3 feltev\u00e9se hib\u00e1s! - {0}" },

            { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "A boolean(...) argumentuma t\u00f6bb\u00e9 nem opcion\u00e1lis az 19990709 XPath v\u00e1zlat szerint." },

            { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "','-t tal\u00e1ltunk, de nincs el\u0151tte argumentum!" },

            { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "','-t tal\u00e1ltunk, de nincs ut\u00e1na argumentum!" },

            {
                    ER_PREDICATE_ILLEGAL_SYNTAX,
                    "A '..[felt\u00e9tel]' vagy '.[felt\u00e9tel]' szintaktika tiltott.  Haszn\u00e1lja ink\u00e1bb a 'self::node()[predicate]' defin\u00edci\u00f3t." },

            { ER_ILLEGAL_AXIS_NAME, "Tiltott tengelyn\u00e9v: {0}" },

            { ER_UNKNOWN_NODETYPE, "Ismeretlen node-t\u00edpus: {0}" },

            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED,
                    "A minta-liter\u00e1lt ({0}) id\u00e9z\u0151jelek k\u00f6z\u00e9 kell tenni!" },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "A(z) {0} nem form\u00e1zhat\u00f3 sz\u00e1mm\u00e1!" },

            { ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Nem lehet XML TransformerFactory Liaison-t l\u00e9trehozni: {0}" },
            ...
            { ER_KEY_HAS_TOO_MANY_ARGS, "A key()-nek nem megfelel\u0151 sz\u00e1m\u00fa argumentuma van." },

            { ER_COUNT_TAKES_1_ARG, "A count f\u00fcggv\u00e9nyhez csak egy argumentumot lehet megadni!" },

            { ER_COULDNOT_FIND_FUNCTION, "Nem tal\u00e1lhat\u00f3 a f\u00fcggv\u00e9ny: {0}" },

            { ER_UNSUPPORTED_ENCODING, "Nem t\u00e1mogatott k\u00f3dol\u00e1s: {0}" },
            ...
            { ER_SETDOMFACTORY_NOT_SUPPORTED, "A setDOMFactory-t nem t\u00e1mogatja az XPathContext!" },
            ...
            { ER_SAX_API_NOT_HANDLED, "SAX API characters(char ch[]... f\u00fcggv\u00e9nyt nem kezeli a DTM!" },

            { ER_IGNORABLE_WHITESPACE_NOT_HANDLED,
                    "Az ignorableWhitespace(char ch[]... f\u00fcggv\u00e9nyt nem kezeli a DTM!" },

            { ER_DTM_CANNOT_HANDLE_NODES, "A DTMLiaison nem tud {0} t\u00edpus\u00fa csom\u00f3pontokat kezelni" },

            { ER_XERCES_CANNOT_HANDLE_NODES, "A DOM2Helper nem tud {0} t\u00edpus\u00fa csom\u00f3pontokat kezelni" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "DOM2Helper.parse hiba: SystemID - {0} sor - {1}" },

            { ER_XERCES_PARSE_ERROR, "DOM2Helper.parse hiba" },

            { ER_INVALID_UTF16_SURROGATE, "\u00c9rv\u00e9nytelen UTF-16 helyettes\u00edt\u00e9s: {0} ?" },

            { ER_OIERROR, "IO hiba" },

            { ER_CANNOT_CREATE_URL, "Nem lehet URL-t l\u00e9trehozni ehhez: {0}" },

            { ER_XPATH_READOBJECT, "A XPath.readObject met\u00f3dusban: {0}" },

            { ER_FUNCTION_TOKEN_NOT_FOUND, "A f\u00fcggv\u00e9ny jelsor nem tal\u00e1lhat\u00f3." },

            { ER_CANNOT_DEAL_XPATH_TYPE, "Nem lehet megbirk\u00f3zni az XPath t\u00edpussal: {0}" },

            { ER_NODESET_NOT_MUTABLE, "Ez a NodeSet nem illeszthet\u0151 be" },

            { ER_NODESETDTM_NOT_MUTABLE, "Ez a NodeSetDTM nem illeszthet\u0151 be" },

            { ER_VAR_NOT_RESOLVABLE, "A v\u00e1ltoz\u00f3 nem oldhat\u00f3 fel: {0}" },
            ...
            { ER_ZERO_OR_ONE, "0 vagy 1" },

            { ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "Az rtf()-et nem t\u00e1mogatja az XRTreeFragSelectWrapper" },
            ...
            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "Az fsb() nem t\u00e1mogatott az XStringForChars-n\u00e1l" },

            { ER_COULD_NOT_FIND_VAR, "Nem tal\u00e1lhat\u00f3 {0} nev\u0171 v\u00e1ltoz\u00f3" },

            { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING,
                    "Az XStringForChars-nak nem adhat meg karakterl\u00e1nc argumentumot" },

            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "A FastStringBuffer argumentum nem lehet null" },
            ...
            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB nem kaphat sztring argumentumot!" },

            { ER_SETTING_WALKER_ROOT_TO_NULL,
                    "\n !!!! Hiba! A bej\u00e1r\u00f3 gy\u00f6ker\u00e9t null-ra \u00e1ll\u00edtotta!!!" },

            { ER_NODESETDTM_CANNOT_ITERATE, "Ez a NodeSetDTM nem iter\u00e1lhat egy kor\u00e1bbi node-ra!" },

            { ER_NODESET_CANNOT_ITERATE, "Ez a NodeSet nem iter\u00e1lhat egy kor\u00e1bbi node-ra!" },
            ...
            { ER_ONLY_ALLOWS, "{0} csak {1} argumentumot enged\u00e9lyez" },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Egy l\u00e9p\u00e9smint\u00e1t v\u00e1rtunk, de '/' szerepelt." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Relat\u00edv \u00fatvonalat v\u00e1rtunk." },
            ...
            { ER_INVALID_XPATH_TYPE, "\u00c9rv\u00e9nytelen XPath t\u00edpus-argumentum: {0}" },

            { ER_EMPTY_XPATH_RESULT, "\u00dcres XPath eredm\u00e9nyobjektum" },
            ...
            { ER_NULL_RESOLVER, "Nem lehet feloldani a prefixet null prefix-felold\u00f3val." },
            ...
            // with respect
            // to this type of node.
            { ER_WRONG_NODETYPE, "A k\u00f6rnyezeti node t\u00edpusa nem t\u00e1mogatott." },

            { ER_XPATH_ERROR, "Ismeretlen hiba az XPath-ban." },
            ...
            { ER_UNSUPPORTED_RETURN_TYPE, "Nem t\u00e1mogatott visszat\u00e9r\u00e9si t\u00edpus: {0}" },
            ...
            { ER_ARG_CANNOT_BE_NULL, "A(z) {0} argumentum nem lehet null" },
            ...
            { WG_PROPERTY_NOT_SUPPORTED, "Az XSL tulajdons\u00e1g nem t\u00e1mogatott: {0}" },
            ...
            { WG_FUNCTION_TOKEN_NOT_FOUND, "A f\u00fcggv\u00e9ny jelsor nem tal\u00e1lhat\u00f3." },

            { WG_COULDNOT_FIND_FUNCTION, "Nem tal\u00e1lhat\u00f3 a f\u00fcggv\u00e9ny: {0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Nem k\u00e9sz\u00edthet\u0151 URL ebb\u0151l: {0}" },

            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "A -E opci\u00f3 nem t\u00e1mogatott a DTM \u00e9rtelmez\u0151h\u00f6z" },

            {
                    WG_ILLEGAL_VARIABLE_REFERENCE,
                    "A v\u00e1ltoz\u00f3ra adott VariableReference (v\u00e1ltoz\u00f3hivatkoz\u00e1s) k\u00edv\u00fcl van a k\u00f6rnyezeten vagy nincs defin\u00edci\u00f3ja!  N\u00e9v = {0}" },

            { WG_UNSUPPORTED_ENCODING, "Nem t\u00e1mogatott k\u00f3dol\u00e1s: {0}" },
