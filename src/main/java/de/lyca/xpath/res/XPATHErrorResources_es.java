  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_CURRENT_NOT_ALLOWED_IN_MATCH,
                    "No est\u00e1 permitida la funci\u00f3n current() en un patr\u00f3n de coincidencia." },

            { ER_CURRENT_TAKES_NO_ARGS, "La funci\u00f3n current() no acepta argumentos." },

            { ER_DOCUMENT_REPLACED,
                    "La implementaci\u00f3n de la funci\u00f3n document() ha sido sustituida por de.lyca.xalan.xslt.FuncDocument." },
            ...
            { ER_TRANSLATE_TAKES_3_ARGS, "La funci\u00f3n translate() utiliza tres argumentos." },

            { ER_UNPARSEDENTITYURI_TAKES_1_ARG,
                    "La funci\u00f3n unparsed-entity-uri deber\u00eda utilizar un solo argumento." },

            { ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "Eje de espacio de nombres a\u00fan no implementado." },
            ...
            { ER_CANT_CONVERT_TO_NUMBER, "No se puede convertir {0} a un n\u00famero" },
            ...
            { ER_EXPECTED_MATCH_PATTERN, "Se esperaba un patr\u00f3n de coincidencia en getMatchScore." },
            ...
            { ER_EXTRA_ILLEGAL_TOKENS, "Se\u00f1ales extra no permitidas: {0}" },
            ...
            { ER_INCORRECT_PROGRAMMER_ASSERTION, "La aserci\u00f3n del programador es incorrecta. - {0}" },
            ...
            { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "El literal del patr\u00f3n ({0}) tiene que estar entrecomillado." },

            { ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "No se ha podido formatear {0} como un n\u00famero." },
            ...
            { ER_COUNT_TAKES_1_ARG, "La funci\u00f3n count deber\u00eda utilizar un solo argumento." },
            ...
            { ER_XERCES_PARSE_ERROR_DETAILS, "Error DOM2Helper.parse: SystemID - {0} l\u00ednea - {1}" },
            ...
            { ER_FUNCTION_TOKEN_NOT_FOUND, "Se\u00f1al de funci\u00f3n no encontrada." },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Aserci\u00f3n del programador: opcode desconocido: {0} " },

            { ER_ZERO_OR_ONE, "0 \u00f3 1" },
            ...
            { ER_NODESETDTM_CANNOT_INDEX, "Este NodeSetDTM no puede realizar funciones de indexaci\u00f3n o recuento." },

            { ER_NODESET_CANNOT_INDEX, "Este NodeSet no puede realizar funciones de indexaci\u00f3n o recuento." },

            { ER_CANNOT_CALL_SETSHOULDCACHENODE,
                    "No se puede llamar a setShouldCacheNodes despu\u00e9s de llamar a nextNode." },

            { ER_ONLY_ALLOWS, "{0} s\u00f3lo admite {1} argumentos" },

            { ER_UNKNOWN_STEP, "Aserci\u00f3n del programador en getNextStepPos: stepType desconocido: {0} " },
            ...
            { ER_EXPECTED_LOC_STEP, "Se esperaba un paso de ubicaci\u00f3n despu\u00e9s de la se\u00f1al '/' o '//'." },
            ...
            // expected,
            // but was not found.
            { ER_EXPECTED_REL_PATH_PATTERN, "Se esperaba un patr\u00f3n de v\u00eda de acceso relativa." },
            ...
            { WG_QUO_NO_LONGER_DEFINED, "La antigua sintaxis: quo(...) ya no est\u00e1 definida en XPath." },

            { WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST,
                    "XPath necesita un objeto derivado para implementar nodeTest." },

            { WG_FUNCTION_TOKEN_NOT_FOUND, "Se\u00f1al de funci\u00f3n no encontrada." },

            { WG_COULDNOT_FIND_FUNCTION, "No se ha podido encontrar la funci\u00f3n: {0}" },

            { WG_CANNOT_MAKE_URL_FROM, "No se puede crear URL desde: {0}" },

            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Opci\u00f3n -E no soportada para analizador DTM" },
            ...
            { "version", ">>>>>>> Xalan versi\u00f3n " }, { "version2", "<<<<<<<" }, { "yes", "s\u00ed" },
            { "line", "L\u00ednea n\u00fam." }, { "column", "Columna n\u00fam." },
            { "xsldone", "XSLProcessor: terminado" }, { "xpath_option", "Opciones de xpath: " },
            { "optionIN", "[-in URLXMLEntrada]" }, { "optionSelect", "[-select expresi\u00f3n xpath]" },
