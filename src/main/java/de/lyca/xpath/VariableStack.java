...
public class VariableStack implements Cloneable
{
  ...
  public XObject getVariableOrParam(
          XPathContext xctxt, de.lyca.xml.utils.QName qname)
            throws javax.xml.transform.TransformerException
  {

    de.lyca.xml.utils.PrefixResolver prefixResolver =
    ...
    if (prefixResolver instanceof de.lyca.xalan.templates.ElemTemplateElement)
    {
      ...
      de.lyca.xalan.templates.ElemTemplateElement prev =
        (de.lyca.xalan.templates.ElemTemplateElement) prefixResolver;
