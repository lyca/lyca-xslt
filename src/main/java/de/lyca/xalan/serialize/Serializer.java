 ...
 * 
 * @deprecated Use de.lyca.xml.serializer.Serializer
 */
@Deprecated
public interface Serializer {
  ...
  /**
   * Resets the serializer. If this method returns true, the serializer may be
   * used for subsequent serialization of new documents. It is possible to
   * change the output format and output stream prior to serializing, or to use
   * the existing output format and output stream.
   * 
