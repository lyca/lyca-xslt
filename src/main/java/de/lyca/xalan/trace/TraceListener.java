 ...
 * @see de.lyca.xalan.trace.TraceManager#addTraceListener
 * @xsl.usage advanced
 */
public interface TraceListener extends java.util.EventListener {

  /**
   * Method that is called when a trace event occurs. The method is blocking. It
   * must return before processing continues.
   * 
   * @param ev
   *          the trace event.
   */
