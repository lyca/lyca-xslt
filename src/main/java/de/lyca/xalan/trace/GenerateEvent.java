 ...
 * result tree. This event responds to and is modeled on the SAX events that are
 * sent to the formatter listener FormatterToXXX)classes.
 * 
 * @see de.lyca.xml.utils.DOMBuilder
 * @see de.lyca.xml.serializer.ToHTMLStream
 * @see de.lyca.xml.serializer.ToTextStream
 * @see de.lyca.xml.serializer.ToXMLStream
 * 
 * @xsl.usage advanced
 */
public class GenerateEvent implements java.util.EventListener {
  ...
  /**
   * The XSLT Transformer, which either directly or indirectly contains most
   * needed information.
   * 
   * @see de.lyca.xalan.transformer.TransformerImpl
   */
   ...
   * 
   * @param processor
   *          The XSLT TransformerFactory instance.
   * @param eventType
   ...
   * 
   * @param processor
   *          The instance of the XSLT processor.
   * @param eventType
   *          One of the EVENTTYPE_XXX constants.
   * @param name
