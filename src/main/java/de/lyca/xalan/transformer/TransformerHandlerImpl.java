 ...
 */
public class TransformerHandlerImpl implements EntityResolver, DTDHandler, ContentHandler, ErrorHandler,
  ...
  protected void clearCoRoutine(SAXException ex) {
    ...
    if (m_dtm instanceof SAX2DTM) {
      ...
      try {
        final SAX2DTM sax2dtm = (SAX2DTM) m_dtm;
        if (null != m_contentHandler && m_contentHandler instanceof IncrementalSAXSource_Filter) {
          final IncrementalSAXSource_Filter sp = (IncrementalSAXSource_Filter) m_contentHandler;
  ...
  public void setResult(Result result) throws IllegalArgumentException {
    ...
    try {
      ...
      final SerializationHandler xoh = m_transformer.createSerializationHandler(result);
   ...
   *           The client may throw an I/O-related exception while obtaining the
   *           new InputSource.
  ...
  public void endDocument() throws SAXException {
     ...
     * 
     * if (null != transformThread) { try {
     * 
     * // This should wait until the transformThread is considered not alive.
     * transformThread.join();
     * 
     * if (!m_transformer.hasTransformThreadErrorCatcher()) { Exception e =
     * m_transformer.getExceptionThrown();
     * 
     * if (null != e) throw new org.xml.sax.SAXException(e); }
     * 
     * m_transformer.setTransformThread(null); } catch (InterruptedException
     * ie){} }
     */
  }
  ...
  public void warning(SAXParseException e) throws SAXException {
    ...
    final javax.xml.transform.ErrorListener errorListener = m_transformer.getErrorListener();
  ...
  /**
   * The transformer this will use to transform a source tree into a result
   * tree.
   */
