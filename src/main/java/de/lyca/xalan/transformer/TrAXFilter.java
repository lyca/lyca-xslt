...
public class TrAXFilter extends XMLFilterImpl {
   ...
   * a parse or do any configuration with setFeature or setProperty.
   * </p>
   * 
   ...
   */
  @Override
  public void parse(InputSource input) throws org.xml.sax.SAXException, IOException {
    if (null == getParent()) {
    ...
    final Exception e = m_transformer.getExceptionThrown();
    if (null != e) {
  ...
  private void setupParse() {
    ...
    final ContentHandler ch = m_transformer.getInputContentHandler();
