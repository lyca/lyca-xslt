...
public class ClonerToResultTree {
  ...
  /**
   * Clone an element with or without children. TODO: Fix or figure out node
   * clone failure! the error condition is severe enough to halt processing.
   * 
   * @param node
   *          The node to clone
   * @param shouldCloneAttributes
   *          Flag indicating whether to clone children attributes
   * 
   * @throws TransformerException
   */
  public static void cloneToResultTree(int node, int nodeType, DTM dtm, SerializationHandler rth,
          boolean shouldCloneAttributes) throws TransformerException {
