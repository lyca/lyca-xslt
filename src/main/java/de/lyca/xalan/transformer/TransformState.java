...
import de.lyca.xml.serializer.TransformStateSetter;
 ...
 * 
 * @see de.lyca.xml.serializer.TransformStateSetter
 */
public interface TransformState extends TransformStateSetter {
   ...
   * 
   * @return the node in the source tree that matched the template obtained via
   *         getMatchedTemplate().
   */
  Node getMatchedNode();
