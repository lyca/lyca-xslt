...
public final class Messages {
  ...
  private static MyErrorMessages messages = (MyErrorMessages) Proxy.newProxyInstance(//
      MyErrorMessages.class.getClassLoader(), //
      new Class[] { MyErrorMessages.class }, //
      new MessageResolver());
   ...
   */
  public static MyErrorMessages get() {
    return messages;
  }
