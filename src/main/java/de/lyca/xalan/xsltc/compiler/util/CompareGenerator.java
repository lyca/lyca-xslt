...
public final class CompareGenerator extends MethodGenerator {
  ...
  public CompareGenerator(int access_flags, Type return_type, Type[] arg_types, String[] arg_names, String method_name,
    ...
    final LocalVariableGen iterator = addLocalVariable("iterator", Util.getJCRefType(Constants.NODE_ITERATOR_SIG),
            null, null);
