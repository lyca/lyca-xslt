...
public final class ErrorMsg {
  ...
  static {
    _bundle = ResourceBundle.getBundle("de.lyca.xalan.xsltc.compiler.util.ErrorMessages", Locale.getDefault());
  }
  ...
  public String toString() {
    final String suffix = _params == null ? null != _code ? getErrorMessage() : _message : MessageFormat.format(
            getErrorMessage(), _params);
  ...
  public String toString(Object obj) {
    ...
    final String suffix = MessageFormat.format(getErrorMessage(), params);
    return formatLine() + suffix;
  }
  ...
  /**
   * Return an ErrorMessages string corresponding to the _code This function is
   * temporary until the three special-cased keys below are moved into
   * ErrorMessages
   * 
