...
//      il.append(methodGen.loadHandler());
//      il.append(SWAP);
//      il.append(new INVOKEINTERFACE(cpg.addInterfaceMethodref(TRANSLET_OUTPUT_INTERFACE, "setWriter", "(" + WRITER_SIG
//          + ")V"), 2));
...
//      il.append(new INVOKEINTERFACE(cpg.addInterfaceMethodref(TRANSLET_OUTPUT_INTERFACE, "setEncoding", "("
//          + STRING_SIG + ")V"), 2));
...
//      il.append(methodGen.loadHandler());
//      il.append(ICONST_1);
//      il.append(new INVOKEINTERFACE(cpg.addInterfaceMethodref(TRANSLET_OUTPUT_INTERFACE, "setOmitXMLDeclaration",
//          "(Z)V"), 2));
...
//    il.append(new INVOKEVIRTUAL(cpg.addMethodref(TRANSLET_CLASS, "displayMessage", "(" + STRING_SIG + ")V")));
    ...
    if (_terminate) {
      ...
      ctx.currentBlock()._throw(_new( ctx.ref(RuntimeException.class)).arg(lit("Termination forced by an xsl:message instruction")));
