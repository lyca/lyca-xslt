...
public class GetOpt {
   ...
   * bad cases, one case is when an illegal option is found, and then other case
   * is when an option takes an argument but no argument was found for that
   * option. If the option found was not declared in the optString, then an
   * IllegalArgumentException will be thrown (case 1). If the next option found
   ...
   * 
   * @return String[] - list of command arguments that may appear after options
