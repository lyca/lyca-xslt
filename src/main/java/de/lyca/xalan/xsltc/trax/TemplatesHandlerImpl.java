...
import de.lyca.xalan.xsltc.compiler.CompilerException;
import de.lyca.xalan.xsltc.compiler.Parser;
...
public class TemplatesHandlerImpl implements ContentHandler, TemplatesHandler, SourceLoader {
   ...
   */
  private final int _indentNumber;
   ...
   * TemplatesHandler object is used as a ContentHandler or DocumentHandler for
   * the parsing of transformation instructions, it creates a Templates object,
   * which the caller can get once the SAX events have been completed.
   * 
   * @return The Templates object that was created during the SAX event process,
   *         or null if no Templates object has been created.
   */
  @Override
  ...
  public void endDocument() throws SAXException {
    ...
    try {
      ...
      final SyntaxTreeNode root = _parser.getDocumentRoot();
