...
public class SmartTransformerFactoryImpl extends SAXTransformerFactory 
{
     ...
     * uses de.lyca.xalan.xsltc.trax.TransformerFactory
    ...
    private void createXalanTransformerFactory() {
 	final String xalanMessage =
	    "de.lyca.xalan.xsltc.trax.SmartTransformerFactoryImpl "+
	    "could not create an "+
     ...
     * result. Uses the de.lyca.xalan.processor.TransformerFactory.
     ...
     * Uses the de.lyca.xalan.xsltc.trax.TransformerFactory.
     * @param source the stylesheet.
     ...
     * Uses de.lyca.xalan.processor.TransformerFactory. 
     */
