...
import de.lyca.xml.utils.LocaleUtility;
...
public class NodeSortRecordFactory {
  ...
  /**
   * Creates a NodeSortRecord producing object. The DOM specifies which tree to
   * get the nodes to sort from, the class name specifies what auxillary class
   * to use to sort the nodes (this class is generated by the Sort class), and
   * the translet parameter is needed for methods called by this object.
   * 
   * @deprecated This constructor is no longer used in generated code. It exists
   ...
   */
  public NodeSortRecord makeNodeSortRecord(int node, int last) throws ExceptionInInitializerError, LinkageError,
          IllegalAccessException, InstantiationException, SecurityException, TransletException {
