...
public class XSLTCDTMManager extends DTMManagerDefault {
  ...
  private static final String DEFAULT_CLASS_NAME = "de.lyca.xalan.xsltc.dom.XSLTCDTMManager";

  private static final String DEFAULT_PROP_NAME = "de.lyca.xalan.xsltc.dom.XSLTCDTMManager";
