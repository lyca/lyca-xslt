...
public class ErrorMessages_it extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * processor.
             */
            { BasisLibrary.RUN_TIME_INTERNAL_ERR, "Errore run-time interno in ''{0}''" },

            /*
             * Note to translators: <xsl:copy> is a keyword that should not be
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "Errore run-time durante l'esecuzione di <xsl:copy>." },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "Tipo di argomento sconosciuto nell'espressione di uguaglianza." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Tipo argomento non valido ''{0}'' nella chiamata a ''{1}''" },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "Impossibile clonare l''''iteratore ''{0}''." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "Iteratore per asse ''{0}'' non supportato." },
             ...
             * support.
             */
            { BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "Iteratore per l''''asse immesso ''{0}'' non sopportato." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "L''''attributo ''{0}'' al di fuori dell''''elemento." },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "Lo spazio nomi per il prefisso ''{0}'' non \u00e8 stato dichiarato. " },

            /*
             * Note to translators: The following represents an internal error.
             * DOMAdapter is a Java class in XSLTC.
             */
            { BasisLibrary.DOM_ADAPTER_INIT_ERR, "DOMAdapter creato utilizzando il tipo di origine DOM errato." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "Impossibile risolvere il riferimento URI ''{0}''." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "Elemento XSL non supportato ''{0}''" },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Estensione XSLTC non riconosciuta ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "Un attributo il cui valore deve essere un QName aveva il valore ''{0}''" },
