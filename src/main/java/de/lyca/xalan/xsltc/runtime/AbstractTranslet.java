...
import de.lyca.xalan.xsltc.dom.KeyIndex;
...
public abstract class AbstractTranslet implements Translet {
  ...
  public final void postInitialization() {
    ...
    if (transletVersion < VER_SPLIT_NAMES_ARRAY) {
      final int arraySize = namesArray.length;
      ...
      for (int i = 0; i < arraySize; i++) {
        ...
        final int colonIndex = name.lastIndexOf(':');
  ...
  /**
   * This method is used to pass the largest DOM size to the translet. Needed to
   * make sure that the translet can index the whole DOM.
   */
  ...
  /************************************************************************
   * Multiple output document extension. See compiler/TransletOutput for actual
   * implementation.
   ************************************************************************/
  ...
  /**
   * Used by some compiled code as a shortcut for passing strings to the output
   * handler
   */
