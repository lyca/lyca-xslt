...
public class ErrorMessages_ca extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "Es produeix un error de temps d'execuci\u00f3 en executar <xsl:copy>." },
             ...
             * of type {0}.
             */
            { BasisLibrary.DATA_CONVERSION_ERR, "Conversi\u00f3 no v\u00e0lida de ''{0}'' a ''{1}''." },
             ...
             */
            { BasisLibrary.EXTERNAL_FUNC_ERR, "XSLTC no d\u00f3na suport a la funci\u00f3 externa ''{0}''. " },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "L'expressi\u00f3 d'igualtat cont\u00e9 un tipus d'argument desconegut." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "No est\u00e0 suportat l''iterador de l''eix ''{0}''. " },
             ...
             * support.
             */
            { BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "No est\u00e0 suportat l''iterador de l''eix escrit ''{0}''. " },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "L''espai de noms del prefix ''{0}'' no s''ha declarat. " },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "No s''ha pogut resoldre la refer\u00e8ncia d''URI ''{0}''." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "L''element XSL ''{0}'' no t\u00e9 suport " },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "No es reconeix l''extensi\u00f3 XSLTC ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "Un atribut, que ha de tenir el valor QName, tenia el valor ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_NCNAME_ERR, "Un atribut, que ha de tenir el valor NCName, tenia el valor ''{0}''" },
