...
public class ErrorMessages_pl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * processor.
             */
            { BasisLibrary.RUN_TIME_INTERNAL_ERR, "B\u0142\u0105d wewn\u0119trzny czasu wykonywania w klasie ''{0}''" },

            /*
             * Note to translators: <xsl:copy> is a keyword that should not be
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "B\u0142\u0105d czasu wykonywania podczas wykonywania <xsl:copy>." },
             ...
             * of type {0}.
             */
            { BasisLibrary.DATA_CONVERSION_ERR, "Niepoprawna konwersja z ''{0}'' na ''{1}''." },
             ...
             */
            { BasisLibrary.EXTERNAL_FUNC_ERR, "Funkcja zewn\u0119trzna ''{0}'' jest nieobs\u0142ugiwana przez XSLTC." },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "Nieznany typ argumentu w wyra\u017ceniu r\u00f3wno\u015bci." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Niepoprawny typ argumentu ''{0}'' w wywo\u0142aniu funkcji ''{1}''" },
             ...
             */
            { BasisLibrary.FORMAT_NUMBER_ERR, "Pr\u00f3ba sformatowania liczby ''{0}'' za pomoc\u0105 wzorca ''{1}''." },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "Nie mo\u017cna utworzy\u0107 kopii iteratora ''{0}''." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "Iterator dla osi ''{0}'' jest nieobs\u0142ugiwany." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "Atrybut ''{0}'' znajduje si\u0119 poza elementem." },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "Nie zadeklarowano przestrzeni nazw dla przedrostka ''{0}''." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "Nieobs\u0142ugiwany element XSL ''{0}''" },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Nierozpoznane rozszerzenie XSLTC ''{0}''." },
