...
public class ErrorMessages_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * processor.
             */
            { BasisLibrary.RUN_TIME_INTERNAL_ERR, "Error interno de ejecuci\u00f3n en ''{0}''" },

            /*
             * Note to translators: <xsl:copy> is a keyword that should not be
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "Error de ejecuci\u00f3n al ejecutar <xsl:copy>." },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "Tipo de argumento desconocido en expresi\u00f3n de igualdad." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Tipo de argumento ''{0}'' no v\u00e1lido en la llamada a ''{1}''" },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "No se puede replicar el iterador ''{0}''." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "Iterador para el eje ''{0}'' no soportado." },
             ...
             * support.
             */
            { BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "Iterador para el eje escrito ''{0}'' no soportado." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "Atributo ''{0}'' fuera del elemento." },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "No se ha declarado el espacio de nombres para el prefijo ''{0}''." },

            /*
             * Note to translators: The following represents an internal error.
             * DOMAdapter is a Java class in XSLTC.
             */
            { BasisLibrary.DOM_ADAPTER_INIT_ERR, "DOMAdapter creado mediante un tipo incorrecto de DOM origen." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "No se ha podido resolver la referencia de URI ''{0}''." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "Elemento XSL ''{0}'' no soportado." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Extensi\u00f3n XSLTC ''{0}'' no reconocida." },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "Un atributo cuyo valor debe ser un QName tiene el valor ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_NCNAME_ERR, "Un atributo cuyo valor debe ser un NCName tiene el valor ''{0}''" },
