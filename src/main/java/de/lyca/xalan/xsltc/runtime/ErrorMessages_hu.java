...
public class ErrorMessages_hu extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "A(z) ''{0}'' iter\u00e1tor nem kl\u00f3nozhat\u00f3." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "A(z) ''{0}'' tengelyre az iter\u00e1tor nem t\u00e1mogatott." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "A(z) ''{0}'' attrib\u00fatum k\u00edv\u00fcl esik az elemen." },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "A(z) ''{0}'' el\u0151tag n\u00e9vtere nincs deklar\u00e1lva." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "Nem lehet feloldani a(z) ''{0}'' URI hivatkoz\u00e1st." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "Nem t\u00e1mogatott XSL elem: ''{0}''" },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Ismeretlen XSLTC kiterjeszt\u00e9s: ''{0}''" },
