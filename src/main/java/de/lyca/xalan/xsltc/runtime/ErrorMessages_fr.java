...
public class ErrorMessages_fr extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * of type {0}.
             */
            { BasisLibrary.DATA_CONVERSION_ERR, "Conversion non valide de ''{0}'' en ''{1}''." },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "Type d'argument inconnu dans l'expression d'\u00e9galit\u00e9." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Type d''argument non valide ''{0}'' lors de l''appel de ''{1}''" },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "Clonage impossible de l''it\u00e9rateur ''{0}''." },
             ...
             * support.
             */
            { BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "It\u00e9rateur de l''axe indiqu\u00e9 ''{0}'' non pris en charge." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "El\u00e9ment XSL non pris en charge ''{0}''" },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Extension XSLTC non reconnue ''{0}''" },
