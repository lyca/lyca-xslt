...
public class ErrorMessages_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * processor.
             */
            { BasisLibrary.RUN_TIME_INTERNAL_ERR, "Interner Fehler bei der Ausf\u00fchrung in ''{0}''" },

            /*
             * Note to translators: <xsl:copy> is a keyword that should not be
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "Fehler bei der Ausf\u00fchrung von <xsl:copy>." },
             ...
             */
            { BasisLibrary.EXTERNAL_FUNC_ERR, "Die externe Funktion ''{0}'' wird nicht von XSLTC unterst\u00fctzt." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Ung\u00fcltiger Argumenttyp ''{0}'' in Aufruf von ''{1}''" },
             ...
             */
            { BasisLibrary.FORMAT_NUMBER_ERR, "Es wird versucht, Nummer ''{0}'' mit Muster ''{1}'' zu formatieren." },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "Iterator ''{0}'' kann nicht geklont werden." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "Iterator f\u00fcr Achse ''{0}'' wird nicht unterst\u00fctzt." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "Attribut ''{0}'' befindet sich nicht in einem Element." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "Der URI-Verweis ''{0}'' konnte nicht aufgel\u00f6st werden." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Nicht erkannte XSLTC-Erweiterung ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "Ein Attribut, dessen Wert ein QName sein muss, hatte den Wert ''{0}''." },
