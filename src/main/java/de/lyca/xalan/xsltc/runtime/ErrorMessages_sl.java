...
public class ErrorMessages_sl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             * processor.
             */
            { BasisLibrary.RUN_TIME_INTERNAL_ERR, "Notranja napaka izvajanja v ''{0}''" },

            /*
             * Note to translators: <xsl:copy> is a keyword that should not be
             * translated.
             */
            { BasisLibrary.RUN_TIME_COPY_ERR, "Notranja napaka izvajanja pri izvajanju <xsl:copy>." },
             ...
             * of type {0}.
             */
            { BasisLibrary.DATA_CONVERSION_ERR, "Neveljavna pretvorba iz ''{0}'' v ''{1}''." },
             ...
             */
            { BasisLibrary.EXTERNAL_FUNC_ERR, "XSLTC ne podpira zunanje funkcije ''{0}''." },
             ...
             * unknown.
             */
            { BasisLibrary.EQUALITY_EXPR_ERR, "Neznan tip argumenta v izrazu enakovrednosti." },
             ...
             */
            { BasisLibrary.INVALID_ARGUMENT_ERR, "Neveljavna vrsta argumenta ''{0}'' pri klicu na ''{1}''" },
             ...
             */
            { BasisLibrary.ITERATOR_CLONE_ERR, "Iteratorja ''{0}'' ni mogo\u010de klonirati." },
             ...
             * support.
             */
            { BasisLibrary.AXIS_SUPPORT_ERR, "Iterator za os ''{0}'' ni podprt." },
             ...
             * support.
             */
            { BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "Iterator za tipizirano os ''{0}'' ni podprt." },
             ...
             */
            { BasisLibrary.STRAY_ATTRIBUTE_ERR, "Atribut ''{0}'' zunaj elementa." },
             ...
             */
            { BasisLibrary.STRAY_NAMESPACE_ERR, "Deklaracija imenskega prostora ''{0}''=''{1}'' je zunaj elementa." },
             ...
             */
            { BasisLibrary.NAMESPACE_PREFIX_ERR, "Imenski prostor za predpono ''{0}'' ni bil naveden." },

            /*
             * Note to translators: The following represents an internal error.
             * DOMAdapter is a Java class in XSLTC.
             */
            { BasisLibrary.DOM_ADAPTER_INIT_ERR, "DOMAdapter ustvarjen z uporabo napa\u010dnega tipa izvornega DOM." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "Ni mogo\u010de razre\u0161iti sklica URI ''{0}''." },
             ...
             */
            { BasisLibrary.UNSUPPORTED_XSL_ERR, "Nepodprt XSL element ''{0}''" },
             ...
             */
            { BasisLibrary.UNSUPPORTED_EXT_ERR, "Neprepoznana raz\u0161iritev XSLTC ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "Atribut, katerega vrednost mora biti QName, je imel vrednost ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_NCNAME_ERR, "Atribut, katerega vrednost mora biti NCName, je imel vrednost ''{0}''" },
