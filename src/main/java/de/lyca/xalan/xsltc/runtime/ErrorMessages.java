...
public class ErrorMessages extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
             ...
             */
            { BasisLibrary.FORMAT_NUMBER_ERR, "Attempting to format number ''{0}'' using pattern ''{1}''." },
             ...
             */
            { BasisLibrary.STRAY_NAMESPACE_ERR, "Namespace declaration ''{0}''=''{1}'' outside of element." },
             ...
             * error.
             */
            { BasisLibrary.CANT_RESOLVE_RELATIVE_URI_ERR, "Could not resolve the URI reference ''{0}''." },
             ...
             */
            { BasisLibrary.INVALID_QNAME_ERR, "An attribute whose value must be a QName had the value ''{0}''" },
             ...
             */
            { BasisLibrary.INVALID_NCNAME_ERR, "An attribute whose value must be an NCName had the value ''{0}''" },
