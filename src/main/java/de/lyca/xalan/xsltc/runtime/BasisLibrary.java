...
public final class BasisLibrary {
	...
	try {
	    if (obj instanceof DTMAxisIterator) 
      {
		...
		//((DOM)obj).copy(((de.lyca.xml.dtm.ref.DTMDefaultBase)((DOMAdapter)obj).getDOMImpl()).getDocument(), handler);
		DOM newDom = (DOM)obj;
     ...
     * <p>See {@link de.lyca.xalan.xsltc.compiler.Stylesheet#compileStaticInitializer(de.lyca.xalan.xsltc.compiler.util.ClassGenerator)}
    ...
    static {
	String resource = "de.lyca.xalan.xsltc.runtime.ErrorMessages";
