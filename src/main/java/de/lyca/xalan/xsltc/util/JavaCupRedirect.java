 ...
 * 
 * Usage-command line:
 * <code>java de.lyca.xalan.xsltc.utils.JavaCupRedirect [args] -stdin filename.ext</code>
 * 
...
public class JavaCupRedirect {
  ...
  private final static String ERRMSG = "You must supply a filename with the -stdin option.";

  public static void main(String args[]) {

    // If we should call System.exit or not
    // @todo make this settable for use inside other java progs
    final boolean systemExitOK = true;
    ...
    final String[] new_args = new String[argc - 2];
    int new_argc = 0;
