...
/**
 * Set up error messages. We build a two dimensional array of message keys and message strings. In order to add a new
 * message here, you need to first add a String constant. And you need to enter key , value pair as part of contents
 * Array. You also need to update MAX_CODE for error strings and MAX_WARNING for warnings ( Needed for only information
 * purpose )
 */
public class XSLTErrorResources extends ListResourceBundle {
   ...
   * 
   * 1) Xalan (or more properly, Xalan-interpretive) and XSLTC are names of components. XSLT is an acronym for
   * "XML Stylesheet Language: Transformations". XSLTC is an acronym for XSLT Compiler.
   * 
   * 2) A stylesheet is a description of how to transform an input XML document into a resultant XML document (or HTML
   * document or text). The stylesheet itself is described in the form of an XML document.
   * 
   * 3) A template is a component of a stylesheet that is used to match a particular portion of an input document and
   * specifies the form of the corresponding portion of the output document.
   * 
   * 4) An element is a mark-up tag in an XML document; an attribute is a modifier on the tag. For example, in <elem
   * attr='val' attr2='val2'> "elem" is an element name, "attr" and "attr2" are attribute names with the values "val"
   * and "val2", respectively.
   * 
   * 5) A namespace declaration is a special attribute that is used to associate a prefix with a URI (the namespace).
   * The meanings of element names and attribute names that use that prefix are defined with respect to that namespace.
   * 
   * 6) "Translet" is an invented term that describes the class file that results from compiling an XML stylesheet into
   * a Java class.
   * 
   * 7) XPath is a specification that describes a notation for identifying nodes in a tree-structured representation of
   * an XML document. An instance of that notation is referred to as an XPath expression.
   */
  ...
  /*
   * Now fill in the message text. Then fill in the message text for that message code in the array. Use the new error
   * code as the index into the array.
   */
  ...
  public Object[][] getContents() {
    return new Object[][] {
        ...
        { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode is null in handleApplyTemplatesInstruction!" },
        ...
        { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME, "processing-instruction name must be a valid NCName: {0}" },
        ...
        { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "Could not create XML TransformerFactory Liaison: {0}" },
        ...
        { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} requires an ''elements'' attribute!" },
        ...
        { ER_STYLESHEET_INCLUDES_ITSELF, "(StylesheetHandler) {0} is directly or indirectly including itself!" },
        ...
        { ER_CAN_ONLY_OUTPUT_TO_ELEMENT, "Can only output to an Element, DocumentFragment, Document, or PrintWriter." },
        ...
        { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "for-each must have either a match or name attribute" },

        { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB, "templates must have either a match or name attribute" },
        ...
        { ER_NOT_ALLOWED_INSIDE_STYLESHEET, "(StylesheetHandler) {0} not allowed inside a stylesheet!" },
        ...
        { ER_INDENTRESULT_NOT_SUPPORTED, "indent-result no longer supported!  Use xsl:output instead." },
        ...
        { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:when not parented by xsl:choose!" },

        { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) misplaced xsl:otherwise!" },

        { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:otherwise not parented by xsl:choose!" },

        { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} is not allowed inside a template!" },

        { ER_UNKNOWN_EXT_NS_PREFIX, "(StylesheetHandler) {0} extension namespace prefix {1} unknown" },

        { ER_IMPORTS_AS_FIRST_ELEM,
            "(StylesheetHandler) Imports can only occur as the first elements in the stylesheet!" },

        { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} is directly or indirectly importing itself!" },
        ...
        { ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM, "Document function not supported in Stylesheet DOM!" },

        { ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER, "Can't resolve prefix of non-Prefix resolver!" },

        { ER_REDIRECT_COULDNT_GET_FILENAME,
            "Redirect extension: Could not get filename - file or select attribute must return vald string." },

        { ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT, "Can not build FormatterListener in Redirect extension!" },

        { ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX, "Prefix in exclude-result-prefixes is not valid: {0}" },
        ...
        { ER_CANT_USE_DTM_FOR_OUTPUT,
            "Cannot use a DTMLiaison for an output DOM node... pass a de.lyca.xpath.DOM2Helper instead!" },

        { ER_CANT_USE_DTM_FOR_INPUT,
            "Cannot use a DTMLiaison for a input DOM node... pass a de.lyca.xpath.DOM2Helper instead!" },
        ...
        { ER_XSLATTRSET_USED_ITSELF, "xsl:attribute-set {0} used itself, which will cause an infinite loop." },
        ...
        { ER_ILLEGAL_DOMSOURCE_INPUT, "The input node can not be null for a DOMSource for newTemplates!" },
        ...
        { ER_COULD_NOT_LOAD_RESOURCE, "Could not load {0} (check CLASSPATH), now using just the defaults" },
        ...
        // This should also be taken care in locale specific files like XSLTErrorResources_de.java,
        ...
        { ER_SAX1_DRIVER_NOT_INSTANTIATED, "SAX1 driver class {0} loaded but cannot be instantiated" },

        { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "SAX1 driver class {0} does not implement org.xml.sax.Parser" },
        ...
        // Note to translators: The following message should not normally be displayed to users. It describes a
        // situation in which the processor has detected an internal consistency problem in itself, and it provides this
        // message for the developer to help diagnose the problem. The name 'ElemTemplateElement' is the name of a
        // class, and should not be translated.
        { ER_ASSERT_NO_TEMPLATE_PARENT, "Programmer's error! The expression has no ElemTemplateElement parent!" },

        // Note to translators: The following message should not normally be displayed to users. It describes a
        // situation in which the processor has detected an internal consistency problem in itself, and it provides this
        // message for the developer to help diagnose the problem. The substitution text provides further information in
        // order to diagnose the problem. The name 'RedundentExprEliminator' is the name of a class, and should not be
        // translated.
        { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Programmer''s assertion in RedundentExprEliminator: {0}" },
        ...
        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "QNAME" is the XML data-type of the attribute, and should not be translated. The substitution text {1} is the
        // attribute value and {0} is the attribute name. The following codes are shared with the warning codes...
        { INVALID_QNAME, "Illegal value: {1} used for QNAME attribute: {0}" },

        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "ENUM" is the XML data-type of the attribute, and should not be translated. The substitution text {1} is the
        // attribute value, {0} is the attribute name, and {2} is a list of valid values.
        { INVALID_ENUM, "Illegal value: {1} used for ENUM attribute: {0}.  Valid values are: {2}." },

        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "NMTOKEN" is the XML data-type of the attribute, and should not be translated. The substitution text {1} is
        // the attribute value and {0} is the attribute name.
        { INVALID_NMTOKEN, "Illegal value: {1} used for NMTOKEN attribute: {0} " },

        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "NCNAME" is the XML data-type of the attribute, and should not be translated. The substitution text {1} is
        // the attribute value and {0} is the attribute name.
        { INVALID_NCNAME, "Illegal value: {1} used for NCNAME attribute: {0} " },

        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "boolean" is the XSLT data-type of the attribute, and should not be translated. The substitution text {1} is
        // the attribute value and {0} is the attribute name.
        { INVALID_BOOLEAN, "Illegal value: {1} used for boolean attribute: {0} " },

        // Note to translators: The following message is used if the value of an attribute in a stylesheet is invalid.
        // "number" is the XSLT data-type of the attribute, and should not be translated. The substitution text {1} is
        // the attribute value and {0} is the attribute name.
        { INVALID_NUMBER, "Illegal value: {1} used for number attribute: {0} " },

        // End of shared codes...

        // Note to translators: A "match pattern" is a special form of XPath expression that is used for matching
        // patterns. The substitution text is the name of a function. The message indicates that when this function is
        // referenced in a match pattern, its argument must be a string literal (or constant.)
        // ER_ARG_LITERAL - new error message for bugzilla //5202
        { ER_ARG_LITERAL, "Argument to {0} in match pattern must be a literal." },

        // Note to translators: The following message indicates that two definitions of a variable. A "global variable"
        // is a variable that is accessible everywhere in the stylesheet.
        // ER_DUPLICATE_GLOBAL_VAR - new error message for bugzilla #790
        { ER_DUPLICATE_GLOBAL_VAR, "Duplicate global variable declaration." },

        // Note to translators: The following message indicates that two definitions of a variable were encountered.
        // ER_DUPLICATE_VAR - new error message for bugzilla #790
        { ER_DUPLICATE_VAR, "Duplicate variable declaration." },

        // Note to translators: "xsl:template, "name" and "match" are XSLT keywords which must not be translated.
        // ER_TEMPLATE_NAME_MATCH - new error message for bugzilla #789
        { ER_TEMPLATE_NAME_MATCH, "xsl:template must have a name or match attribute (or both)" },

        // Note to translators: "exclude-result-prefixes" is an XSLT keyword which should not be translated. The message
        // indicates that a namespace prefix encountered as part of the value of the exclude-result-prefixes attribute
        // was in error.
        // ER_INVALID_PREFIX - new error message for bugzilla #788
        { ER_INVALID_PREFIX, "Prefix in exclude-result-prefixes is not valid: {0}" },

        // Note to translators: An "attribute set" is a set of attributes that can be added to an element in the output
        // document as a group. The message indicates that there was a reference to an attribute set named {0} that was
        // never defined.
        // ER_NO_ATTRIB_SET - new error message for bugzilla #782
        { ER_NO_ATTRIB_SET, "attribute-set named {0} does not exist" },

        // Note to translators: This message indicates that there was a reference to a function named {0} for which no
        // function definition could be found.
        { ER_FUNCTION_NOT_FOUND, "The function named {0} does not exist" },

        // Note to translators: This message indicates that the XSLT instruction that is named by the substitution text
        // {0} must not contain other XSLT instructions (content) or a "select" attribute. The word "select" is an XSLT
        // keyword in this case and must not be translated.
        { ER_CANT_HAVE_CONTENT_AND_SELECT, "The {0} element must not have both content and a select attribute." },

        // Note to translators: This message indicates that the value argument of setParameter must be a valid Java
        // Object.
        ...
        { ER_GET_FEATURE_NULL_NAME, "The feature name cannot be null in TransformerFactory.getFeature(String name)." },
        ...
        { WG_NO_LOCALE_IN_FORMATNUMBER, "Xalan doesn't yet handle the locale name in the format-number function." },
        ...
        { WG_FUNCTIONS_SHOULD_USE_URL, "Old syntax: the functions instruction should use a url of {0}" },
        ...
        { WG_SPECIFICITY_CONFLICTS, "Specificity conflicts found: {0} Last found in stylesheet will be used." },
        ...
        { WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED, "Only one default xsl:decimal-format declaration is allowed." },
        ...
        { WG_COULD_NOT_RESOLVE_PREFIX, "Could not resolve namespace prefix: {0}. The node will be ignored." },
        ...
        // Note to translators: "name" and "xsl:processing-instruction" are keywords and must not be translated.
        { WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML,
            "The value of the 'name' attribute of xsl:processing-instruction name must not be 'xml'" },

        // Note to translators: "name" and "xsl:processing-instruction" are keywords and must not be translated.
        // "NCName" is an XML data-type and must not be translated.
        { WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
            "The value of the ''name'' attribute of xsl:processing-instruction must be a valid NCName: {0}" },

        // Note to translators: This message is reported if the stylesheet that is being processed attempted to
        // construct an XML document with an attribute in a place other than on an element. The substitution text
        ...
        { "FORMAT_FAILED", "Exception thrown during messageFormat call" }, { "version", ">>>>>>> Xalan Version " },
        { "version2", "<<<<<<<" }, { "yes", "yes" }, { "line", "Line #" }, { "column", "Column #" },
        { "xsldone", "XSLProcessor: done" },

        // Note to translators: The following messages provide usage information for the Xalan Process command line.
        // "Process" is the name of a Java class, and should not be translated.
        ...
        { "xslProc_common_options", "-Common Options-" }, { "xslProc_xalan_options", "-Options for Xalan-" },
        { "xslProc_xsltc_options", "-Options for XSLTC-" },
        { "xslProc_return_to_continue", "(press <return> to continue)" },

        // Note to translators: The option name and the parameter name do not need to be translated. Only translate the
        // messages in parentheses. Note also that leading whitespace in the messages is used to indent the usage
        // information for each option in the English messages. Do not translate the keywords: XSLTC, SAX, DOM and DTM.
        { "optionXSLTC", "   [-XSLTC (use XSLTC for transformation)]" }, { "optionIN", "   [-IN inputXMLURL]" },
        { "optionXSL", "   [-XSL XSLTransformationURL]" }, { "optionOUT", "   [-OUT outputFileName]" },
        { "optionLXCIN", "   [-LXCIN compiledStylesheetFileNameIn]" },
        { "optionLXCOUT", "   [-LXCOUT compiledStylesheetFileNameOutOut]" },
        { "optionPARSER", "   [-PARSER fully qualified class name of parser liaison]" },
        { "optionE", "   [-E (Do not expand entity refs)]" }, { "optionV", "   [-E (Do not expand entity refs)]" },
        { "optionQC", "   [-QC (Quiet Pattern Conflicts Warnings)]" }, { "optionQ", "   [-Q  (Quiet Mode)]" },
        ...
        { "noParsermsg1", "XSL Process was not successful." }, { "noParsermsg2", "** Could not find parser **" },
        ...
        { "optionFLAVOR", "   [-FLAVOR flavorName (Explicitly use s2s=SAX or d2d=DOM to do transform.)] " }, // Added
                                                                                                             // by
                                                                                                             // sboag/scurcuru;
                                                                                                             // experimental
        ...
        // Note to translators: The following message describes usage of a particular command-line option that is used
        // to enable the "template inlining" optimization. The optimization involves making a copy of the code generated
        ...
        { "recursionTooDeep", "Template nesting too deep. nesting = {0}, template {1} {2}" }, { "nameIs", "name is" },
   ...
   * However for Chinese, we do distinguish between Taiwan and PRC
   * 
