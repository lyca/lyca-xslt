...
public class XSLTErrorResources_ca extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Error: no hi pot haver un car\u00e0cter '{' dins l'expressi\u00f3" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} t\u00e9 un atribut no perm\u00e8s: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode \u00e9s nul en xsl:apply-imports." },

            { ER_CANNOT_ADD, "No es pot afegir {0} a {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode \u00e9s nul en handleApplyTemplatesInstruction." },

            { ER_NO_NAME_ATTRIB, "{0} ha de tenir un atribut de nom." },

            { ER_TEMPLATE_NOT_FOUND, "No s''ha trobat la plantilla anomenada: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "No s'ha pogut resoldre l'AVT de noms a xsl:call-template." },

            { ER_REQUIRES_ATTRIB, "{0} necessita l''atribut: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} ha de tenir un atribut ''test''. " },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Valor incorrecte a l''atribut de nivell: {0}" },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "El nom processing-instruction no pot ser 'xml'" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
                    "El nom processing-instruction ha de ser un NCName v\u00e0lid: {0}" },

            { ER_NEED_MATCH_ATTRIB, "{0} ha de tenir un atribut que hi coincideixi si t\u00e9 una modalitat." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} necessita un nom o un atribut que hi coincideixi." },

            { ER_CANT_RESOLVE_NSPREFIX, "No s''ha pogut resoldre el prefix d''espai de noms: {0}" },

            { ER_ILLEGAL_VALUE, "xml:space t\u00e9 un valor no v\u00e0lid: {0}" },

            { ER_NO_OWNERDOC, "El node subordinat no t\u00e9 un document de propietari." },

            { ER_ELEMTEMPLATEELEM_ERR, "Error d''ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "S'est\u00e0 intentant afegir un subordinat nul." },

            { ER_NEED_SELECT_ATTRIB, "{0} necessita un atribut de selecci\u00f3." },

            { ER_NEED_TEST_ATTRIB, "xsl:when ha de tenir un atribut 'test'." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param ha de tenir un atribut 'name'." },

            { ER_NO_CONTEXT_OWNERDOC, "El context no t\u00e9 un document de propietari." },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "No s''ha pogut crear la relaci\u00f3 XML TransformerFactory: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: el proc\u00e9s no ha estat correcte." },

            { ER_NOT_SUCCESSFUL, "Xalan no ha estat correcte." },

            { ER_ENCODING_NOT_SUPPORTED, "La codificaci\u00f3 no t\u00e9 suport: {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "No s''ha pogut crear TraceListener: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key necessita un atribut 'name'." },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key necessita un atribut 'match'." },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key necessita un atribut 'use'." },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} necessita un atribut ''elements''. " },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) falta l''atribut ''prefix'' {0}. " },

            { ER_BAD_STYLESHEET_URL, "La URL del full d''estils \u00e9s incorrecta: {0}" },

            { ER_FILE_NOT_FOUND, "No s''ha trobat el fitxer del full d''estils: {0}" },

            { ER_IOEXCEPTION, "S''ha produ\u00eft una excepci\u00f3 d''E/S amb el fitxer de full d''estils: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) No s''ha trobat l''atribut href de {0}" },
            ...
            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) falta l''atribut ''lang'' {0}. " },
            ...
            { ER_UNIMPLNODE_ERROR, "Error d''UnImplNode: {0}" },

            { ER_NO_SELECT_EXPRESSION, "Error. No s'ha trobat l'expressi\u00f3 select d'xpath (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "No es pot serialitzar un XSLProcessor." },

            { ER_NO_INPUT_STYLESHEET, "No s'ha especificat l'entrada del full d'estils." },

            { ER_FAILED_PROCESS_STYLESHEET, "No s'ha pogut processar el full d'estils." },

            { ER_COULDNT_PARSE_DOC, "No s''ha pogut analitzar el document {0}." },

            { ER_COULDNT_FIND_FRAGMENT, "No s''ha pogut trobar el fragment: {0}" },

            { ER_NODE_NOT_ELEMENT, "El node al qual apuntava l''identificador de fragments no era un element: {0}" },
            ...
            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "No hi ha cap clonatge d'un fragment de document." },

            { ER_CANT_CREATE_ITEM, "No es pot crear un element a l''arbre de resultats: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space de l''XML d''origen t\u00e9 un valor no perm\u00e8s: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "No hi ha cap declaraci\u00f3 d''xls:key per a {0}." },

            { ER_CANT_CREATE_URL, "Error. No es pot crear la URL de: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions no t\u00e9 suport." },

            { ER_PROCESSOR_ERROR, "Error d'XSLT TransformerFactory" },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} t\u00e9 un atribut no perm\u00e8s: {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Element XSL desconegut: {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) xsl:sort nom\u00e9s es pot utilitzar amb xsl:apply-templates o xsl:for-each." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) xsl:when est\u00e0 mal col\u00b7locat." },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:when no ha estat analitzat per xsl:choose." },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise est\u00e0 mal col\u00b7locat." },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:otherwise no t\u00e9 com a superior xsl:choose." },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} no est\u00e0 perm\u00e8s dins d''una plantilla." },
            ...
            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space t\u00e9 un valor no perm\u00e8s: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet no ha estat correcte." },

            { ER_SAX_EXCEPTION, "Excepci\u00f3 SAX" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "Aquesta funci\u00f3 no t\u00e9 suport." },

            { ER_XSLT_ERROR, "Error d'XSLT" },
            ...
            { ER_MISSING_NS_URI, "Falta l'URI d'espai de noms del prefix especificat." },

            { ER_MISSING_ARG_FOR_OPTION, "Falta un argument de l''opci\u00f3: {0}" },

            { ER_INVALID_OPTION, "Opci\u00f3 no v\u00e0lida: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Cadena de format mal formada: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet necessita un atribut 'version'." },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "L''atribut {0} t\u00e9 un valor no perm\u00e8s {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose necessita un xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports no es permeten en un xsl:for-each" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "No es pot utilitzar una DTMLiaison per a un node DOM de sortida. En lloc d'aix\u00f2, utilitzeu de.lyca.xpath.DOM2Helper." },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "No es pot utilitzar una DTMLiaison per a un node DOM d'entrada. En lloc d'aix\u00f2, utilitzeu de.lyca.xpath.DOM2Helper." },

            { ER_CALL_TO_EXT_FAILED, "S''ha produ\u00eft un error en la crida de l''element d''extensi\u00f3 {0}" },
            ...
            { ER_CANNOT_MIX_XERCESDOM, "No es pot barrejar entrada no Xerces-DOM amb sortida Xerces-DOM." },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "S''ha trobat m\u00e9s d''una plantilla anomenada {0}" },
            ...
            { ER_ILLEGAL_DOMSOURCE_INPUT, "El node d'entrada no pot ser nul per a DOMSource de newTemplates." },

            { ER_CLASS_NOT_FOUND_FOR_OPTION, "No s''ha trobat el fitxer de classe per a l''opci\u00f3 {0}" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "L''element necessari no s''ha trobat: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream no pot ser nul." },

            { ER_URI_CANNOT_BE_NULL, "L'URI no pot ser nul." },

            { ER_FILE_CANNOT_BE_NULL, "El fitxer no pot ser nul." },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource no pot ser nul." },

            { ER_CANNOT_INIT_BSFMGR, "No s'ha pogut inicialitzar BSF Manager" },

            { ER_CANNOT_CMPL_EXTENSN, "No s'ha pogut compilar l'extensi\u00f3" },

            { ER_CANNOT_CREATE_EXTENSN, "No s''ha pogut crear l''extensi\u00f3 {0} a causa de {1}" },

            { ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "La crida del m\u00e8tode d''inst\u00e0ncia {0} necessita una inst\u00e0ncia d''objecte com a primer argument" },

            { ER_INVALID_ELEMENT_NAME, "S''ha especificat un nom d''element no v\u00e0lid {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "El m\u00e8tode del nom de l''element ha de ser est\u00e0tic {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "No es coneix la funci\u00f3 d''extensi\u00f3 {0} : {1}." },

            { ER_MORE_MATCH_CONSTRUCTOR, "Hi ha m\u00e9s d''una millor coincid\u00e8ncia per al constructor de {0}" },

            { ER_MORE_MATCH_METHOD, "Hi ha m\u00e9s d''una millor coincid\u00e8ncia per al m\u00e8tode {0}" },

            { ER_MORE_MATCH_ELEMENT, "Hi ha m\u00e9s d''una millor coincid\u00e8ncia per al m\u00e8tode d''element {0}" },

            { ER_INVALID_CONTEXT_PASSED, "S''ha donat un context no v\u00e0lid per avaluar {0}" },

            { ER_POOL_EXISTS, "L'agrupaci\u00f3 ja existeix" },

            { ER_NO_DRIVER_NAME, "No s'ha especificat cap nom de controlador" },

            { ER_NO_URL, "No s'ha especificat cap URL" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "La grand\u00e0ria de l'agrupaci\u00f3 \u00e9s inferior a u" },

            { ER_INVALID_DRIVER, "S'ha especificat un nom de controlador no v\u00e0lid" },

            { ER_NO_STYLESHEETROOT, "No s'ha trobat l'arrel del full d'estils" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Valor no perm\u00e8s per a xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "S'ha produ\u00eft un error a processFromNode" },

            { ER_RESOURCE_COULD_NOT_LOAD, "No s''ha pogut carregar el recurs [ {0} ]: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Grand\u00e0ria del buffer <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "S'ha produ\u00eft un error desconegut en cridar l'extensi\u00f3" },

            { ER_NO_NAMESPACE_DECL, "El prefix {0} no t\u00e9 una declaraci\u00f3 d''espai de noms corresponent" },

            { ER_ELEM_CONTENT_NOT_ALLOWED,
                    "El contingut de l''element no est\u00e0 perm\u00e8s per a lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "El full d'estils ha ordenat l'acabament" },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "No es poden inicialitzar les plantilles per defecte" },

            { ER_RESULT_NULL, "El resultat no ha de ser nul" },

            { ER_RESULT_COULD_NOT_BE_SET, "No s'ha pogut establir el resultat" },

            { ER_NO_OUTPUT_SPECIFIED, "No s'ha especificat cap sortida" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "No s''ha pogut transformar en un resultat del tipus {0}" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "No s''ha pogut transformar en un origen del tipus {0}" },

            { ER_NULL_CONTENT_HANDLER, "Manejador de contingut nul" },

            { ER_NULL_ERROR_HANDLER, "Manejador d'error nul" },

            { ER_CANNOT_CALL_PARSE, "L'an\u00e0lisi no es pot cridar si no s'ha establert ContentHandler" },

            { ER_NO_PARENT_FOR_FILTER, "El filtre no t\u00e9 superior" },

            { ER_NO_STYLESHEET_IN_MEDIA, "No s''ha trobat cap full d''estils a {0}, suport= {1}" },

            { ER_NO_STYLESHEET_PI, "No s''ha trobat cap PI d''xml-stylesheet a {0}" },

            { ER_NOT_SUPPORTED, "No t\u00e9 suport: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "El valor de la propietat {0} ha de ser una inst\u00e0ncia booleana" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "No s''ha pogut arribar a l''script extern a {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "No s''ha trobat el recurs [ {0} ].\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "La propietat de sortida no es reconeix: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "S'ha produ\u00eft un error en crear la inst\u00e0ncia ElemLiteralResult" },
            ...
            { ER_VALUE_SHOULD_BE_NUMBER, "El valor de {0} ha de contenir un n\u00famero que es pugui analitzar" },

            { ER_VALUE_SHOULD_EQUAL, "El valor de {0} ha de ser igual a yes o no" },

            { ER_FAILED_CALLING_METHOD, "No s''ha pogut cridar el m\u00e8tode {0}" },

            { ER_FAILED_CREATING_ELEMTMPL, "No s'ha pogut crear la inst\u00e0ncia ElemTemplateElement" },

            { ER_CHARS_NOT_ALLOWED, "En aquest punt del document no es permeten els car\u00e0cters" },

            { ER_ATTR_NOT_ALLOWED, "L''atribut \"{0}\" no es permet en l''element {1}" },

            { ER_BAD_VALUE, "{0} valor erroni {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "No s''ha trobat el valor de l''atribut {0} " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "No es reconeix el valor de l''atribut {0} " },

            { ER_NULL_URI_NAMESPACE, "S'intenta generar un prefix d'espai de noms amb un URI nul" },

            // New ERROR keys added in XALAN code base after Jdk 1.4 (Xalan
            // 2.2-D11)

            { ER_NUMBER_TOO_BIG, "S'intenta formatar un n\u00famero m\u00e9s gran que l'enter llarg m\u00e9s gran" },

            { ER_CANNOT_FIND_SAX1_DRIVER, "No es pot trobar la classe de controlador SAX1 {0}" },

            { ER_SAX1_DRIVER_NOT_LOADED, "S''ha trobat la classe de controlador SAX1 {0} per\u00f2 no es pot carregar" },

            { ER_SAX1_DRIVER_NOT_INSTANTIATED,
                    "S''ha carregat la classe de controlador SAX1 {0} per\u00f2 no es pot particularitzar" },

            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "La classe de controlador SAX1 {0} no implementa org.xml.sax.Parser" },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "No s'ha identificat la propietat del sistema org.xml.sax.parser" },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "L'argument d'analitzador ha de ser nul" },

            { ER_FEATURE, "Caracter\u00edstica: {0}" },

            { ER_PROPERTY, "Propietat: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Solucionador d'entitat nul" },

            { ER_NULL_DTD_HANDLER, "Manejador de DTD nul" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "No s'ha especificat cap nom de controlador" },

            { ER_NO_URL_SPECIFIED, "No s'ha especificat cap URL" },

            { ER_POOLSIZE_LESS_THAN_ONE, "La grand\u00e0ria de l'agrupaci\u00f3 \u00e9s inferior a 1" },

            { ER_INVALID_DRIVER_NAME, "S'ha especificat un nom de controlador no v\u00e0lid" },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "L''afirmaci\u00f3 del programador a RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "{0} no es permet en aquesta posici\u00f3 del full d''estil" },
            ...
            { INVALID_QNAME, "S''ha utilitzat un valor no perm\u00e8s {1} per a l''atribut QNAME {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "S''ha utilitzat un valor no perm\u00e8s {1} per a l''atribut NMTOKEN {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "S''ha utilitzat un valor no perm\u00e8s {1} per a l''atribut NCNAME {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "S''ha utilitzat un valor no perm\u00e8s {1} per a l''atribut boolean {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "S''ha utilitzat un valor no perm\u00e8s {1} per a l''atribut number {0} " },
            ...
            { ER_ARG_LITERAL, "L''argument de {0} del patr\u00f3 de coincid\u00e8ncia ha de ser un literal." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "La declaraci\u00f3 de variable global est\u00e0 duplicada." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "La declaraci\u00f3 de variable est\u00e0 duplicada." },

            // Note to translators: "xsl:template, "name" and "match" are XSLT
            // keywords
            // which must not be translated.
            // ER_TEMPLATE_NAME_MATCH - new error message for bugzilla #789
            { ER_TEMPLATE_NAME_MATCH, "xsl:template ha de tenir un nom o un atribut de coincid\u00e8ncia (o tots dos)" },
            ...
            { ER_INVALID_PREFIX, "El prefix d''exclude-result-prefixes no \u00e9s v\u00e0lid: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "attribute-set anomenat {0} no existeix" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "La funci\u00f3 anomenada {0} no existeix" },
            ...
            { ER_CANT_HAVE_CONTENT_AND_SELECT, "L''element {0} no ha de tenir ni l''atribut content ni el select. " },

            // Note to translators: This message indicates that the value
            // argument
            // of setParameter must be a valid Java Object.
            { ER_INVALID_SET_PARAM_VALUE, "El valor del par\u00e0metre {0} ha de ser un objecte Java v\u00e0lid " },
            ...
            { ER_NAMESPACE_CONTEXT_NULL_NAMESPACE, "No es pot obtenir el prefix per a un URI de nom d'espais nul. " },

            { ER_NAMESPACE_CONTEXT_NULL_PREFIX, "No es pot obtenir l'URI del nom d'espais per a un prefix nul. " },

            { ER_XPATH_RESOLVER_NULL_QNAME, "El nom de la funci\u00f3 no pot ser nul. " },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "L'aritat no pot ser negativa." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "S'ha trobat '}' per\u00f2 no hi ha cap plantilla d'atribut oberta" },

            { WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR,
                    "Av\u00eds: l''atribut de recompte no coincideix amb un antecessor d''xsl:number. Destinaci\u00f3 = {0}" },

            { WG_EXPR_ATTRIB_CHANGED_TO_SELECT, "Sintaxi antiga: El nom de l'atribut 'expr' s'ha canviat per 'select'." },

            { WG_NO_LOCALE_IN_FORMATNUMBER,
                    "Xalan encara no pot gestionar el nom de l'entorn nacional a la funci\u00f3 format-number." },

            { WG_LOCALE_NOT_FOUND, "Av\u00eds: no s''ha trobat l''entorn nacional d''xml:lang={0}" },

            { WG_CANNOT_MAKE_URL_FROM, "No es pot crear la URL de: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "No es pot carregar el document sol\u00b7licitat: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "No s''ha trobat el classificador de <sort xml:lang={0}" },

            { WG_FUNCTIONS_SHOULD_USE_URL,
                    "Sintaxi antiga: la instrucci\u00f3 de funcions ha d''utilitzar una URL de {0}" },

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "Codificaci\u00f3 sense suport: {0}, s''utilitza UTF-8" },

            { WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "Codificaci\u00f3 sense suport: {0}, s''utilitza Java {1}" },

            { WG_SPECIFICITY_CONFLICTS,
                    "S''han trobat conflictes d''especificitat: {0} S''utilitzar\u00e0 el darrer trobat al full d''estils." },

            { WG_PARSING_AND_PREPARING, "========= S''est\u00e0 analitzant i preparant {0} ==========" },

            { WG_ATTR_TEMPLATE, "Plantilla Attr, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "S'ha produ\u00eft un conflicte de coincid\u00e8ncia entre xsl:strip-space i xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan encara no pot gestionar l''atribut {0}" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "No s''ha trobat cap declaraci\u00f3 per al format decimal: {0}" },

            { WG_OLD_XSLT_NS, "Falta l'espai de noms XSLT o \u00e9s incorrecte. " },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} t\u00e9 un atribut no perm\u00e8s: {1}" },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "No s''ha pogut resoldre el prefix d''espai de noms: {0}. Es passar\u00e0 per alt el node." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet necessita un atribut 'version'." },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "El nom d''atribut no \u00e9s perm\u00e8s: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "S''ha utilitzat un valor no perm\u00e8s a l''atribut {0}: {1}" },
            ...
            { NO_MODIFICATION_ALLOWED_ERR, "S'ha intentat modificar un objecte on no es permeten modificacions. " },
            ...
            {
                    "xslProc_no_input",
                    "Error: no s'ha especificat cap full d'estils o xml d'entrada. Per obtenir les instruccions d'\u00fas, executeu aquesta ordre sense opcions." },
            ...
            { "optionLF",
                    "   [-LF (Utilitza salts de l\u00ednia nom\u00e9s a la sortida {el valor per defecte \u00e9s CR/LF})]" },
            { "optionCR",
                    "   [-CR (Utilitza retorns de carro nom\u00e9s a la sortida {el valor per defecte \u00e9s CR/LF})]" },
            { "optionESCAPE",
                    "   [-ESCAPE (Car\u00e0cters per aplicar un escapament {el valor per defecte \u00e9s <>&\"\'\\r\\n}]" },
            { "optionINDENT",
                    "   [-INDENT (Controla quants espais tindr\u00e0 el sagnat {el valor per defecte \u00e9s 0})]" },
            ...
            { "optionVALIDATE",
                    "   [-VALIDATE (Estableix si es produeix la validaci\u00f3. Per defecte no est\u00e0 activada.)]" },
            { "optionEDUMP",
                    "   [-EDUMP {nom de fitxer opcional} (Fer el buidatge de la pila si es produeix un error.)]" },
            ...
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER nom de classe complet (URIResolver que s'ha d'utilitzar per resoldre URI)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER nom de classe complet (EntityResolver que s'ha d'utilitzar per resoldre entitats)]" },
            { "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER nom de classe complet (ContentHandler que s'ha d'utilitzar per serialitzar la sortida)]" },
            ...
            { "optionMEDIA",
                    "   [-MEDIA mediaType (utilitza l'atribut media per trobar un full d'estils relacionat amb un document.)]" },
            { "optionFLAVOR",
                    "   [-FLAVOR nom_flavor (utilitza expl\u00edcitament s2s=SAX o d2d=DOM per fer una transformaci\u00f3.)] " }, // Added
                                                                                                                                  // by
                                                                                                                                  // sboag/scurcuru;
                                                                                                                                  // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (sol\u00b7licita la construcci\u00f3 de DTM incremental establint http://xml.apache.org/xalan/features/incremental en true.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (sol\u00b7licita que no es processi l'optimitzaci\u00f3 de full d'estils establint http://xml.apache.org/xalan/features/optimize en false.)]" },
            { "optionRL",
                    "   [-RL recursionlimit (confirma el l\u00edmit num\u00e8ric de la profunditat de recursivitat del full d'estils.)]" },
            { "optionXO", "   [-XO [nom_translet] (assigna el nom al translet generat)]" },
            { "optionXD",
                    "   [-XD directori_destinaci\u00f3 (especifica un directori de destinaci\u00f3 per al translet)]" },
            { "optionXJ",
                    "   [-XJ fitxer_jar (empaqueta les classes de translet en un fitxer jar amb el nom <fitxer_jar>)]" },
            { "optionXP",
                    "   [-XP paquet (especifica un prefix de nom de paquet per a totes les classes de translet generades)]" },
            ...
            { "recursionTooDeep",
                    "La imbricaci\u00f3 de plantilles t\u00e9 massa nivells. Imbricaci\u00f3 = {0}, plantilla{1} {2}" },
            { "nameIs", "el nom \u00e9s" }, { "matchPatternIs", "el patr\u00f3 de coincid\u00e8ncia \u00e9s" }
