...
public class XSLTErrorResources_sk extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Chyba: Nie je mo\u017en\u00e9 ma\u0165 vo v\u00fdraze '{'" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} m\u00e1 neplatn\u00fd atrib\u00fat: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode je v xsl:apply-imports nulov\u00fd!" },

            { ER_CANNOT_ADD, "Nem\u00f4\u017ee prida\u0165 {0} do {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode je nulov\u00fd v handleApplyTemplatesInstruction!" },

            { ER_NO_NAME_ATTRIB, "{0} mus\u00ed ma\u0165 atrib\u00fat n\u00e1zvu." },

            { ER_TEMPLATE_NOT_FOUND, "Nebolo mo\u017en\u00e9 n\u00e1js\u0165 vzor s n\u00e1zvom: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT,
                    "Nebolo mo\u017en\u00e9 rozl\u00ed\u0161i\u0165 n\u00e1zov AVT v xsl:call-template." },

            { ER_REQUIRES_ATTRIB, "{0} vy\u017eaduje atrib\u00fat: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} mus\u00ed ma\u0165 atrib\u00fat ''test''." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Nespr\u00e1vna hodnota na atrib\u00fate \u00farovne: {0}" },
            ...
            { ER_NEED_MATCH_ATTRIB, "{0} mus\u00ed ma\u0165 porovn\u00e1vac\u00ed atrib\u00fat, ak m\u00e1 re\u017eim." },
            ...
            { ER_ILLEGAL_VALUE, "xml:space m\u00e1 neplatn\u00fa hodnotu: {0}" },

            { ER_NO_OWNERDOC, "Potomok uzla nem\u00e1 dokument vlastn\u00edka!" },

            { ER_ELEMTEMPLATEELEM_ERR, "Chyba ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Pokus o pridanie nulov\u00e9ho potomka!" },

            { ER_NEED_SELECT_ATTRIB, "{0} vy\u017eaduje atrib\u00fat v\u00fdberu." },

            { ER_NEED_TEST_ATTRIB, "xsl:when mus\u00ed ma\u0165 atrib\u00fat 'test'." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param mus\u00ed ma\u0165 atrib\u00fat 'name'." },

            { ER_NO_CONTEXT_OWNERDOC, "kontext nem\u00e1 dokument vlastn\u00edka!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON,
                    "Nebolo mo\u017en\u00e9 vytvori\u0165 vz\u0165ah XML TransformerFactory: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: Proces bol ne\u00faspe\u0161n\u00fd." },

            { ER_NOT_SUCCESSFUL, "Xalan: bol ne\u00faspe\u0161n\u00fd." },

            { ER_ENCODING_NOT_SUPPORTED, "K\u00f3dovanie nie je podporovan\u00e9: {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "Nebolo mo\u017en\u00e9 vytvori\u0165 TraceListener: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key vy\u017eaduje atrib\u00fat 'name'!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key vy\u017eaduje atrib\u00fat 'match'!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key vy\u017eaduje atrib\u00fat 'use'!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} vy\u017eaduje atrib\u00fat ''elements''!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0} ch\u00fdba atrib\u00fat ''prefix''" },

            { ER_BAD_STYLESHEET_URL, "URL \u0161t\u00fdlu dokumentu je nespr\u00e1vna: {0}" },

            { ER_FILE_NOT_FOUND, "S\u00fabor \u0161t\u00fdlu dokumentu nebol n\u00e1jden\u00fd: {0}" },

            { ER_IOEXCEPTION,
                    "V s\u00fabore \u0161t\u00fdlu dokumentu bola vstupno-v\u00fdstupn\u00e1 v\u00fdnimka: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Nebolo mo\u017en\u00e9 n\u00e1js\u0165 atrib\u00fat href pre {0}" },

            { ER_STYLESHEET_INCLUDES_ITSELF, "(StylesheetHandler) {0} priamo, alebo nepriamo, obsahuje s\u00e1m seba!" },

            { ER_PROCESSINCLUDE_ERROR, "chyba StylesheetHandler.processInclude, {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) {0} ch\u00fdba atrib\u00fat ''lang''" },
            ...
            { ER_NO_SELECT_EXPRESSION, "Chyba! Nena\u0161lo sa vyjadrenie v\u00fdberu xpath (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "Nie je mo\u017en\u00e9 serializova\u0165 XSLProcessor!" },

            { ER_NO_INPUT_STYLESHEET, "Nebol zadan\u00fd vstup \u0161t\u00fdl dokumentu!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Zlyhalo spracovanie \u0161t\u00fdlu dokumentu!" },

            { ER_COULDNT_PARSE_DOC, "Nebolo mo\u017en\u00e9 analyzova\u0165 dokument {0}!" },

            { ER_COULDNT_FIND_FRAGMENT, "Nebolo mo\u017en\u00e9 n\u00e1js\u0165 fragment: {0}" },

            { ER_NODE_NOT_ELEMENT, "Uzol, na ktor\u00fd ukazuje identifik\u00e1tor fragmentu nebol elementom: {0}" },
            ...
            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "\u017diadna k\u00f3pia fragmentu dokumentu!" },

            { ER_CANT_CREATE_ITEM, "Nie je mo\u017en\u00e9 vytvori\u0165 polo\u017eku vo v\u00fdsledkovom strome: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space v zdrojovom XML m\u00e1 neplatn\u00fa hodnotu: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "Neexistuje \u017eiadna deklar\u00e1cia xsl:key pre {0}!" },

            { ER_CANT_CREATE_URL, "Chyba! Nie je mo\u017en\u00e9 vytvori\u0165 url pre: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions nie je podporovan\u00e9" },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} m\u00e1 neplatn\u00fd atrib\u00fat: {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Nezn\u00e1my element XSL: {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) xsl:sort mo\u017eno pou\u017ei\u0165 len s xsl:apply-templates alebo xsl:for-each." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) xsl:when na nespr\u00e1vnom mieste!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:when nem\u00e1 ako rodi\u010da xsl:choose!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise na nespr\u00e1vnom mieste!" },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:otherwise nem\u00e1 ako rodi\u010da xsl:choose!" },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} nie je povolen\u00fd vn\u00fatri vzoru!" },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} priamo, alebo nepriami, importuje s\u00e1m seba!" },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space m\u00e1 neplatn\u00fa hodnotu: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet nebol \u00faspe\u0161n\u00fd!" },

            { ER_SAX_EXCEPTION, "V\u00fdnimka SAX" },
            ...
            { ER_CURRENCY_SIGN_ILLEGAL, "znak meny nie je povolen\u00fd vo re\u0165azci form\u00e1tu vzoru" },
            ...
            { ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX, "Predpona v exclude-result-prefixes je neplatn\u00e1: {0}" },

            { ER_MISSING_NS_URI, "Ch\u00fdbaj\u00faci n\u00e1zvov\u00fd priestor URI pre zadan\u00fd prefix" },

            { ER_MISSING_ARG_FOR_OPTION, "Ch\u00fdbaj\u00faci argument pre vo\u013ebu: {0}" },

            { ER_INVALID_OPTION, "Neplatn\u00e1 vo\u013eba. {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Znetvoren\u00fd re\u0165azec form\u00e1tu: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet si vy\u017eaduje atrib\u00fat 'version'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Atrib\u00fat: {0} m\u00e1 neplatn\u00fa hodnotu: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose vy\u017eaduje xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports nie je povolen\u00fd v xsl:for-each" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Nem\u00f4\u017ee pou\u017ei\u0165 DTMLiaison pre v\u00fdstupn\u00fd uzol DOM... namiesto neho odo\u0161lite de.lyca.xpath.DOM2Helper!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "Nem\u00f4\u017ee pou\u017ei\u0165 DTMLiaison pre vstupn\u00fd uzol DOM... namiesto neho odo\u0161lite de.lyca.xpath.DOM2Helper!" },

            { ER_CALL_TO_EXT_FAILED, "Volanie elementu roz\u0161\u00edrenia zlyhalo: {0}" },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "Na\u0161iel sa viac ne\u017e jeden vzor s n\u00e1zvom: {0}" },

            { ER_INVALID_KEY_CALL,
                    "Neplatn\u00e9 volanie funkcie: rekurz\u00edvne volanie k\u013e\u00fa\u010da() nie je povolen\u00e9" },

            { ER_REFERENCING_ITSELF, "Premenn\u00e1 {0} sa priamo, alebo nepriamo, odkazuje sama na seba!" },

            { ER_ILLEGAL_DOMSOURCE_INPUT,
                    "Vstupn\u00fd uzol nem\u00f4\u017ee by\u0165 pre DOMSource pre newTemplates nulov\u00fd!" },

            { ER_CLASS_NOT_FOUND_FOR_OPTION, "S\u00fabor triedy nebol pre vo\u013ebu {0} n\u00e1jden\u00fd" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Po\u017eadovan\u00fd element sa nena\u0161iel: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream nem\u00f4\u017ee by\u0165 nulov\u00fd" },

            { ER_URI_CANNOT_BE_NULL, "URI nem\u00f4\u017ee by\u0165 nulov\u00fd" },

            { ER_FILE_CANNOT_BE_NULL, "S\u00fabor nem\u00f4\u017ee by\u0165 nulov\u00fd" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource nem\u00f4\u017ee by\u0165 nulov\u00fd" },

            { ER_CANNOT_INIT_BSFMGR, "Nebolo mo\u017en\u00e9 inicializova\u0165 Spr\u00e1vcu BSF" },

            { ER_CANNOT_CMPL_EXTENSN, "Nebolo mo\u017en\u00e9 skompilova\u0165 pr\u00edponu" },
            ...
            { ER_INVALID_ELEMENT_NAME, "Bol zadan\u00fd neplatn\u00fd n\u00e1zov s\u00fa\u010dasti {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC,
                    "Met\u00f3da n\u00e1zvu s\u00fa\u010dasti mus\u00ed by\u0165 statick\u00e1 {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Roz\u0161\u00edrenie funkcie {0} : {1} je nezn\u00e1me" },
            ...
            { ER_INVALID_CONTEXT_PASSED, "Bolo odoslan\u00fd neplatn\u00fd kontext na zhodnotenie {0}" },

            { ER_POOL_EXISTS, "Oblas\u0165 u\u017e existuje" },

            { ER_NO_DRIVER_NAME, "Nebol zadan\u00fd \u017eiaden n\u00e1zov ovl\u00e1da\u010da" },

            { ER_NO_URL, "Nebola zadan\u00e1 \u017eiadna URL" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Ve\u013ekos\u0165 oblasti je men\u0161ia ne\u017e jeden!" },

            { ER_INVALID_DRIVER, "Bol zadan\u00fd neplatn\u00fd n\u00e1zov ovl\u00e1da\u010da!" },

            { ER_NO_STYLESHEETROOT, "Nebol n\u00e1jden\u00fd kore\u0148 \u0161t\u00fdlu dokumentu!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Neplatn\u00e1 hodnota pre xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "zlyhal processFromNode" },

            { ER_RESOURCE_COULD_NOT_LOAD, "Prostriedok [ {0} ] sa nedal na\u010d\u00edta\u0165: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Ve\u013ekos\u0165 vyrovn\u00e1vacej pam\u00e4te <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Nezn\u00e1ma chyba po\u010das volania pr\u00edpony" },

            { ER_NO_NAMESPACE_DECL,
                    "Prefix {0} nem\u00e1 zodpovedaj\u00facu deklar\u00e1ciu n\u00e1zvov\u00e9ho priestoru" },

            { ER_ELEM_CONTENT_NOT_ALLOWED, "Obsah elementu nie je povolen\u00fd pre lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Ukon\u010denie riaden\u00e9 \u0161t\u00fdlom dokumentu" },

            { ER_ONE_OR_TWO, "1, alebo 2" },

            { ER_TWO_OR_THREE, "2, alebo 3" },

            {
                    ER_COULD_NOT_LOAD_RESOURCE,
                    "Nebolo mo\u017en\u00e9 zavies\u0165 {0} (check CLASSPATH), teraz s\u00fa po\u017eit\u00e9 len predvolen\u00e9 \u0161tandardy" },

            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Nie je mo\u017en\u00e9 inicializova\u0165 predvolen\u00e9 vzory" },

            { ER_RESULT_NULL, "V\u00fdsledok by nemal by\u0165 nulov\u00fd" },

            { ER_RESULT_COULD_NOT_BE_SET, "V\u00fdsledkom nem\u00f4\u017ee by\u0165 mno\u017eina" },

            { ER_NO_OUTPUT_SPECIFIED, "Nie je zadan\u00fd \u017eiaden v\u00fdstup" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Ned\u00e1 sa transformova\u0165 na v\u00fdsledok typu {0}" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "Ned\u00e1 sa transformova\u0165 zdroj typu {0}" },

            { ER_NULL_CONTENT_HANDLER, "Nulov\u00fd manipula\u010dn\u00fd program obsahu" },

            { ER_NULL_ERROR_HANDLER, "Nulov\u00fd chybov\u00fd manipula\u010dn\u00fd program" },

            { ER_CANNOT_CALL_PARSE,
                    "nem\u00f4\u017ee by\u0165 volan\u00e9 analyzovanie, ak nebol nastaven\u00fd ContentHandler" },

            { ER_NO_PARENT_FOR_FILTER, "\u017diaden rodi\u010d pre filter" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Nena\u0161iel sa \u017eiadny stylesheet v: {0}, m\u00e9dium= {1}" },

            { ER_NO_STYLESHEET_PI, "Nena\u0161iel sa \u017eiadny xml-stylesheet PI v: {0}" },

            { ER_NOT_SUPPORTED, "Nie je podporovan\u00e9: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "Hodnota vlastnosti {0} by mala by\u0165 boolovsk\u00e1 in\u0161tancia" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Nie je mo\u017en\u00e9 dosiahnu\u0165 extern\u00fd skript na {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "Prostriedok [ {0} ] nemohol by\u0165 n\u00e1jden\u00fd.\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "V\u00fdstupn\u00e9 vlastn\u00edctvo nebolo rozoznan\u00e9: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Zlyhalo vytv\u00e1ranie in\u0161tancie ElemLiteralResult" },
            ...
            { ER_VALUE_SHOULD_EQUAL, "Hodnota {0} by sa mala rovna\u0165 \u00e1no, alebo nie" },

            { ER_FAILED_CALLING_METHOD, "Zlyhalo volanie met\u00f3dy {0}" },

            { ER_FAILED_CREATING_ELEMTMPL, "Zlyhalo vytv\u00e1ranie in\u0161tancie ElemTemplateElement" },

            { ER_CHARS_NOT_ALLOWED, "V tomto bode dokumentu nie s\u00fa znaky povolen\u00e9" },

            { ER_ATTR_NOT_ALLOWED, "Atrib\u00fat \"{0}\" nie je povolen\u00fd na s\u00fa\u010dasti {1}!" },

            { ER_BAD_VALUE, "{0} zl\u00e1 hodnota {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "Hodnota atrib\u00fatu {0} nebola n\u00e1jden\u00e1 " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Hodnota atrib\u00fatu {0} nebola rozpoznan\u00e1 " },

            { ER_NULL_URI_NAMESPACE, "Pokus o vytvorenie prefixu n\u00e1zvov\u00e9ho priestoru s nulov\u00fdm URI" },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "Nie je mo\u017en\u00e9 n\u00e1js\u0165 triedu ovl\u00e1da\u010da SAX1 {0}" },
            ...
            { ER_PARSER_ARG_CANNOT_BE_NULL, "Argument syntaktick\u00e9ho analyz\u00e1tora nesmie by\u0165 nulov\u00fd" },

            { ER_FEATURE, "Vlastnos\u0165: {0}" },

            { ER_PROPERTY, "Vlastn\u00edctvo: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Rozklada\u010d nulov\u00fdch ent\u00edt" },

            { ER_NULL_DTD_HANDLER, "Nulov\u00fd manipula\u010dn\u00fd program DTD" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Nie je zadan\u00fd \u017eiaden n\u00e1zov ovl\u00e1da\u010da!" },

            { ER_NO_URL_SPECIFIED, "Nie je zadan\u00e1 \u017eiadna URL!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "Ve\u013ekos\u0165 oblasti je men\u0161ia ne\u017e 1!" },

            { ER_INVALID_DRIVER_NAME, "Je zadan\u00fd neplatn\u00fd n\u00e1zov ovl\u00e1da\u010da!" },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Tvrdenie program\u00e1tora v RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "{0}nie je na tejto poz\u00edcii predlohy so \u0161t\u00fdlmi povolen\u00e9!" },
            ...
            { INVALID_QNAME, "Neplatn\u00e1 hodnota: {1} pou\u017e\u00edvan\u00e1 pre atrib\u00fat QNAME: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Neplatn\u00e1 hodnota: {1} pou\u017e\u00edvan\u00e1 pre atrib\u00fat NMTOKEN:{0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Neplatn\u00e1 hodnota: {1} pou\u017e\u00edvan\u00e1 pre atrib\u00fat NCNAME: {0} " },
            ...
            { ER_ARG_LITERAL, "Argument pre {0} v zhodnom vzore mus\u00ed by\u0165 liter\u00e1lom." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Duplicitn\u00e1 deklar\u00e1cia glob\u00e1lnej premennej." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Duplicitn\u00e1 deklar\u00e1cia premennej." },
            ...
            { ER_INVALID_PREFIX, "Predpona v exclude-result-prefixes je neplatn\u00e1: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "pomenovan\u00e1 sada atrib\u00fatov {0} neexistuje" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "Funkcia s n\u00e1zvom {0} neexistuje." },
            ...
            { ER_INVALID_SET_PARAM_VALUE, "Hodnota parametra {0} mus\u00ed by\u0165 platn\u00fdm objektom jazyka Java." },
            ...
            { ER_UNSUPPORTED_FEATURE, "V tomto TransformerFactory sa ned\u00e1 nastavi\u0165 vlastnos\u0165 ''{0}''." },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "N\u00e1zov funkcie nem\u00f4\u017ee by\u0165 null." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "Arita nem\u00f4\u017ee by\u0165 z\u00e1porn\u00e1." },
            ...
            { WG_LOCALE_NOT_FOUND, "Upozornenie: Nebolo mo\u017en\u00e9 n\u00e1js\u0165 lok\u00e1l pre xml:lang={0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Nie je mo\u017en\u00e9 vytvori\u0165 URL z: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "Nie je mo\u017en\u00e9 zavies\u0165 po\u017eadovan\u00fd doc: {0}" },
            ...
            { WG_PARSING_AND_PREPARING, "========= Anal\u00fdza a pr\u00edprava {0} ==========" },

            { WG_ATTR_TEMPLATE, "Attr vzor, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "Konflikt zhodnosti medzi xsl:strip-space a xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan zatia\u013e nesprac\u00fava atrib\u00fat {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION,
                    "Pre desiatkov\u00fd form\u00e1t sa nena\u0161la \u017eiadna deklar\u00e1cia: {0}" },

            { WG_OLD_XSLT_NS, "Ch\u00fdbaj\u00faci, alebo nespr\u00e1vny n\u00e1zvov\u00fd priestor XSLT. " },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} m\u00e1 neplatn\u00fd atrib\u00fat: {1}" },

            {
                    WG_COULD_NOT_RESOLVE_PREFIX,
                    "Nebolo mo\u017en\u00e9 rozl\u00ed\u0161i\u0165 predponu n\u00e1zvov\u00e9ho priestoru: {0}. Uzol bude ignorovan\u00fd." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet si vy\u017eaduje atrib\u00fat 'version'!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Neplatn\u00fd n\u00e1zov atrib\u00fatu: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Neplatn\u00e1 hodnota pou\u017e\u00edvan\u00e1 pre atrib\u00fat {0}: {1}" },
            ...
            {
                    "xslProc_no_input",
                    "Chyba: nie je uveden\u00fd \u017eiadny \u0161t\u00fdl dokumentu, ani vstupn\u00fd xml. Spustite tento pr\u00edkaz bez akejko\u013evek vo\u013eby pre in\u0161trukcie pou\u017eitia." },
            ...
            { "optionPARSER",
                    "   [-PARSER plne kvalifikovan\u00fd n\u00e1zov triedy sprostredkovate\u013ea syntaktick\u00e9ho analyz\u00e1tora]" },
            ...
            { "optionCR",
                    "   [-CR (Znaky n\u00e1vratu voz\u00edka pou\u017ei\u0165 len vo v\u00fdstupe {default is CR/LF})]" },
            { "optionESCAPE",
            ...
            {
                    "optionVALIDATE",
                    "   [-VALIDATE (Ur\u010duje, \u010di m\u00e1 doch\u00e1dza\u0165 k overovaniu.  Overovanie je \u0161tandardne vypnut\u00e9.)]" },
            { "optionEDUMP",
                    "   [-EDUMP {optional filename} (Vytvori\u0165 v\u00fdpis z\u00e1sobn\u00edka pri chybe.)]" },
            ...
            {
                    "noParsermsg4",
                    "Ak nem\u00e1te Syntaktick\u00fd analyz\u00e1tor XML pre jazyk Java od firmy IBM, m\u00f4\u017eete si ho stiahnu\u0165 z" },
            { "noParsermsg5", "IBM's AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER pln\u00fd n\u00e1zov triedy (URIResolver bude pou\u017eit\u00fd na ur\u010dovanie URI)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER pln\u00fd n\u00e1zov triedy (EntityResolver bude pou\u017eit\u00fd na ur\u010denie ent\u00edt)]" },
            {
                    "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER pln\u00fd n\u00e1zov triedy (ContentHandler bude pou\u017eit\u00fd na serializ\u00e1ciu v\u00fdstupu)]" },
            { "optionLINENUMBERS", "   [-L pou\u017eije \u010d\u00edsla riadkov pre zdrojov\u00fd dokument]" },
            { "optionSECUREPROCESSING",
                    "   [-SECURE (nastav\u00ed funkciu bezpe\u010dn\u00e9ho spracovania na hodnotu true.)]" },
            ...
            {
                    "optionMEDIA",
                    "   [-MEDIA mediaType (pou\u017ei\u0165 atrib\u00fat m\u00e9dia na n\u00e1jdenie \u0161t\u00fdlu h\u00e1rka, priraden\u00e9ho k dokumentu.)]" },
            { "optionFLAVOR",
                    "   [-FLAVOR flavorName (Explicitne pou\u017ei\u0165 s2s=SAX alebo d2d=DOM na vykonanie transform\u00e1cie.)] " }, // Added
                                                                                                                                       // by
                                                                                                                                       // sboag/scurcuru;
                                                                                                                                       // experimental
            { "optionDIAG",
                    "   [-DIAG (Vytla\u010di\u0165 celkov\u00fd \u010das transform\u00e1cie v milisekund\u00e1ch.)]" },
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (\u017eiados\u0165 o inkrement\u00e1lnu kon\u0161trukciu DTM nastaven\u00edm http://xml.apache.org/xalan/features/incremental true.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (po\u017eiadavka na nesprac\u00favanie optimaliz\u00e1cie defin\u00edcie \u0161t\u00fdlov nastaven\u00edm http://xml.apache.org/xalan/features/optimize na hodnotu false.)]" },
            {
                    "optionRL",
                    "   [-RL recursionlimit (nastavi\u0165 \u010d\u00edseln\u00fd limit pre h\u013abku rekurzie \u0161t\u00fdlov h\u00e1rkov.)]" },
            ...
            { "optionXP",
                    "   [-XP package (uv\u00e1dza predponu n\u00e1zvu bal\u00edka pre v\u0161etky generovan\u00e9 triedy transletu)]" },
            ...
            { "nameIs", "n\u00e1zov je" }, { "matchPatternIs", "vzor zhody je" }
