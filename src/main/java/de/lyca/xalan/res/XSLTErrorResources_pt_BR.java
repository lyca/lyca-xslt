...
public class XSLTErrorResources_pt_BR extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Erro: Imposs\u00edvel ter '{' na express\u00e3o" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} possui um atributo inv\u00e1lido: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode \u00e9 nulo em xsl:apply-imports!" },

            { ER_CANNOT_ADD, "Imposs\u00edvel incluir {0} em {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode \u00e9 nulo em handleApplyTemplatesInstruction!" },

            { ER_NO_NAME_ATTRIB, "{0} deve ter um atributo name." },

            { ER_TEMPLATE_NOT_FOUND, "N\u00e3o foi poss\u00edvel localizar o template: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "N\u00e3o foi poss\u00edvel resolver nome AVT em xsl:call-template." },
            ...
            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "O nome de processing-instruction n\u00e3o pode ser 'xml'" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
                    "O nome de processing-instruction deve ser um NCName v\u00e1lido: {0}" },

            { ER_NEED_MATCH_ATTRIB, "{0} deve ter um atributo de correspond\u00eancia se tiver um modo." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} requer um nome ou um atributo de correspond\u00eancia." },

            { ER_CANT_RESOLVE_NSPREFIX, "Imposs\u00edvel resolver prefixo do espa\u00e7o de nomes: {0}" },

            { ER_ILLEGAL_VALUE, "xml:space possui um valor inv\u00e1lido: {0}" },

            { ER_NO_OWNERDOC, "O n\u00f3 filho n\u00e3o possui um documento do propriet\u00e1rio!" },

            { ER_ELEMTEMPLATEELEM_ERR, "Erro de ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Tentando incluir um filho nulo!" },

            { ER_NEED_SELECT_ATTRIB, "{0} requer um atributo select." },

            { ER_NEED_TEST_ATTRIB, "xsl:when deve ter um atributo 'test'." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param deve ter um atributo 'name'." },

            { ER_NO_CONTEXT_OWNERDOC, "context n\u00e3o possui um documento do propriet\u00e1rio!" },
            ...
            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) O atributo ''prefix'' de {0} est\u00e1 ausente" },

            { ER_BAD_STYLESHEET_URL, "A URL da p\u00e1gina de estilo \u00e9 inv\u00e1lida: {0}" },

            { ER_FILE_NOT_FOUND, "O arquivo da p\u00e1gina de estilo n\u00e3o foi encontrado: {0}" },

            { ER_IOEXCEPTION,
                    "Ocorreu uma Exce\u00e7\u00e3o de E/S (entrada/sa\u00edda) no arquivo de p\u00e1gina de estilo: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) N\u00e3o foi poss\u00edvel encontrar o atributo href para {0}" },
            ...
            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) O atributo ''lang'' de {0} est\u00e1 ausente" },
            ...
            { ER_NO_SELECT_EXPRESSION, "Erro! N\u00e3o encontrada a express\u00e3o xpath select (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "N\u00e3o \u00e9 poss\u00edvel serializar um XSLProcessor!" },

            { ER_NO_INPUT_STYLESHEET, "A entrada de folha de estilo n\u00e3o foi especificada!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Falha ao processar folha de estilo!" },

            { ER_COULDNT_PARSE_DOC, "N\u00e3o foi poss\u00edvel analisar o documento {0}!" },

            { ER_COULDNT_FIND_FRAGMENT, "N\u00e3o foi poss\u00edvel localizar o fragmento: {0}" },

            { ER_NODE_NOT_ELEMENT, "O n\u00f3 apontado por um identificador de fragmento n\u00e3o era um elemento: {0}" },

            { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "for-each deve ter um atributo match ou name" },

            { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB, "templates deve ter um atributo match ou name" },

            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Nenhum clone de fragmento de documento!" },

            { ER_CANT_CREATE_ITEM, "Imposs\u00edvel criar item na \u00e1rvore de resultados: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space no XML de origem possui um valor inv\u00e1lido: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "N\u00e3o existe nenhuma declara\u00e7\u00e3o xsl:key para {0}!" },

            { ER_CANT_CREATE_URL, "Erro! Imposs\u00edvel criar url para: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions n\u00e3o \u00e9 suportado" },

            { ER_PROCESSOR_ERROR, "Erro de XSLT TransformerFactory" },

            { ER_NOT_ALLOWED_INSIDE_STYLESHEET,
                    "(StylesheetHandler) {0} n\u00e3o permitido dentro de uma folha de estilo!" },

            { ER_RESULTNS_NOT_SUPPORTED, "result-ns n\u00e3o \u00e9 mais suportado!  Utilize ent\u00e3o xsl:output." },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} possui um atributo inv\u00e1lido: {1}" },
            ...
            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) xsl:when aplicado incorretamente!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:when n\u00e3o est\u00e1 ligado a xsl:choose!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise aplicado incorretamente!" },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} est\u00e1 importando a si mesmo, direta ou indiretamente!" },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space tem um valor inv\u00e1lido: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet n\u00e3o obteve \u00eaxito!" },
            ...
            { ER_MISSING_NS_URI, "URI do espa\u00e7o de nomes ausente para o prefixo especificado" },

            { ER_MISSING_ARG_FOR_OPTION, "Argumento ausente para a op\u00e7\u00e3o: {0}" },

            { ER_INVALID_OPTION, "Op\u00e7\u00e3o inv\u00e1lida: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Cadeia com problemas de formata\u00e7\u00e3o: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet requer um atributo 'version'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Atributo: {0} possui um valor inv\u00e1lido: {1}" },
...

            {
                    ...
                    "Imposs\u00edvel utilizar um DTMLiaison para um n\u00f3 DOM de sa\u00edda... transmita um de.lyca.xpath.DOM2Helper no lugar!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "Imposs\u00edvel utilizar um DTMLiaison para um n\u00f3 DOM de entrada... transmita um de.lyca.xpath.DOM2Helper no lugar!" },

            { ER_CALL_TO_EXT_FAILED, "Falha na chamada do elemento da extens\u00e3o: {0}" },

            { ER_PREFIX_MUST_RESOLVE, "O prefixo deve ser resolvido para um espa\u00e7o de nomes: {0}" },

            { ER_INVALID_UTF16_SURROGATE, "Detectado substituto UTF-16 inv\u00e1lido: {0} ?" },
            ...
            { ER_IN_ELEMTEMPLATEELEM_READOBJECT, "Em ElemTemplateElement.readObject: {0}" },

            { ER_DUPLICATE_NAMED_TEMPLATE, "Encontrado mais de um template chamado: {0}" },
            ...
            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Arquivo de classe n\u00e3o encontrado para a op\u00e7\u00e3o {0}" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Elemento requerido n\u00e3o encontrado: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream n\u00e3o pode ser nulo" },

            { ER_URI_CANNOT_BE_NULL, "URI n\u00e3o pode ser nulo" },

            { ER_FILE_CANNOT_BE_NULL, "File n\u00e3o pode ser nulo" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource n\u00e3o pode ser nulo" },

            { ER_CANNOT_INIT_BSFMGR, "N\u00e3o foi poss\u00edvel inicializar o BSF Manager" },

            { ER_CANNOT_CMPL_EXTENSN, "N\u00e3o foi poss\u00edvel compilar a extens\u00e3o" },

            { ER_CANNOT_CREATE_EXTENSN, "N\u00e3o foi poss\u00edvel criar extens\u00e3o: {0} devido a: {1}" },

            {
                    ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "A chamada do m\u00e9todo da inst\u00e2ncia para o m\u00e9todo {0} requer uma inst\u00e2ncia Object como primeiro argumento" },

            { ER_INVALID_ELEMENT_NAME, "Especificado nome de elemento inv\u00e1lido {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "O m\u00e9todo do nome de elemento deve ser est\u00e1tico {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "A fun\u00e7\u00e3o de extens\u00e3o {0} : {1} \u00e9 desconhecida" },

            { ER_MORE_MATCH_CONSTRUCTOR, "Mais de uma correspond\u00eancia principal para o construtor de {0}" },

            { ER_MORE_MATCH_METHOD, "Mais de uma correspond\u00eancia principal para o m\u00e9todo {0}" },

            { ER_MORE_MATCH_ELEMENT, "Mais de uma correspond\u00eancia principal para o m\u00e9todo do elemento {0}" },

            { ER_INVALID_CONTEXT_PASSED, "Contexto inv\u00e1lido transmitido para avaliar {0}" },

            { ER_POOL_EXISTS, "O conjunto j\u00e1 existe" },

            { ER_NO_DRIVER_NAME, "Nenhum Nome de driver foi especificado" },

            { ER_NO_URL, "Nenhuma URL especificada" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "O tamanho do conjunto \u00e9 menor que um!" },

            { ER_INVALID_DRIVER, "Especificado nome de driver inv\u00e1lido!" },

            { ER_NO_STYLESHEETROOT, "N\u00e3o encontrada a raiz da folha de estilo!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Valor inv\u00e1lido para xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "processFromNode falhou" },

            { ER_RESOURCE_COULD_NOT_LOAD, "O recurso [ {0} ] n\u00e3o p\u00f4de carregar: {1} \n {2} \t {3}" },
            ...
            { ER_ELEM_CONTENT_NOT_ALLOWED, "Conte\u00fado de elemento n\u00e3o permitido para lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Finaliza\u00e7\u00e3o direcionada por folha de estilo" },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Imposs\u00edvel inicializar templates padr\u00e3o" },

            { ER_RESULT_NULL, "O resultado n\u00e3o deve ser nulo" },

            { ER_RESULT_COULD_NOT_BE_SET, "O resultado n\u00e3o p\u00f4de ser definido" },
            ...
            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "N\u00e3o \u00e9 poss\u00edvel transformar em uma Origem do tipo {0} " },

            { ER_NULL_CONTENT_HANDLER, "Rotina de tratamento de conte\u00fado nula" },

            { ER_NULL_ERROR_HANDLER, "Rotina de tratamento de erros nula" },

            { ER_CANNOT_CALL_PARSE, "parse n\u00e3o pode ser chamado se ContentHandler n\u00e3o tiver sido definido" },

            { ER_NO_PARENT_FOR_FILTER, "Nenhum pai para o filtro" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Nenhuma p\u00e1gina de estilo foi encontrada em: {0}, m\u00eddia= {1}" },

            { ER_NO_STYLESHEET_PI, "Nenhum PI xml-stylesheet encontrado em: {0}" },

            { ER_NOT_SUPPORTED, "N\u00e3o suportado: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "O valor para a propriedade {0} deve ser uma inst\u00e2ncia Booleana" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "N\u00e3o foi poss\u00edvel obter script externo em {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "O recurso [ {0} ] n\u00e3o p\u00f4de ser encontrado.\n{1}" },
            ...
            { ER_VALUE_SHOULD_BE_NUMBER, "O valor para {0} deve conter um n\u00famero analis\u00e1vel" },

            { ER_VALUE_SHOULD_EQUAL, "O valor de {0} deve ser igual a yes ou no" },
            ...
            { ER_CHARS_NOT_ALLOWED, "N\u00e3o s\u00e3o permitidos caracteres neste ponto do documento" },

            { ER_ATTR_NOT_ALLOWED, "O atributo \"{0}\" n\u00e3o \u00e9 permitido no elemento {1}!" },

            { ER_BAD_VALUE, "{0} possui valor inv\u00e1lido {1}" },
            ...
            { ER_NULL_URI_NAMESPACE, "Tentando gerar um prefixo do espa\u00e7o de nomes com URI nulo" },

            // New ERROR keys added in XALAN code base after Jdk 1.4 (Xalan
            // 2.2-D11)

            { ER_NUMBER_TOO_BIG, "Tentando formatar um n\u00famero superior ao maior inteiro Longo" },

            { ER_CANNOT_FIND_SAX1_DRIVER, "Imposs\u00edvel encontrar a classe de driver SAX1 {0}" },

            { ER_SAX1_DRIVER_NOT_LOADED, "Classe de driver SAX1 {0} encontrada, mas n\u00e3o pode ser carregada" },

            { ER_SAX1_DRIVER_NOT_INSTANTIATED, "Classe de driver SAX1 {0} carregada, mas n\u00e3o pode ser instanciada" },

            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "A classe de driver SAX1 {0} n\u00e3o implementa org.xml.sax.Parser" },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Propriedade de sistema org.xml.sax.parser n\u00e3o especificada" },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "O argumento Parser n\u00e3o deve ser nulo" },

            { ER_FEATURE, "Recurso: {0}" },

            { ER_PROPERTY, "Propriedade: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Solucionador de entidade nulo" },

            { ER_NULL_DTD_HANDLER, "Rotina de tratamento DTD nula" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Nenhum Nome de Driver Especificado!" },

            { ER_NO_URL_SPECIFIED, "Nenhuma URL Especificada!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "O tamanho do conjunto \u00e9 menor que 1!" },

            { ER_INVALID_DRIVER_NAME, "Especificado Nome de Driver Inv\u00e1lido!" },
            ...
            { INVALID_QNAME, "Valor inv\u00e1lido: {1} utilizado para o atributo QNAME: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Valor inv\u00e1lido: {1} utilizado para o atributo NMTOKEN: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Valor inv\u00e1lido: {1} utilizado para o atributo NCNAME: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Valor inv\u00e1lido: {1} utilizado para o atributo boolean: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Valor inv\u00e1lido: {1} utilizado para o atributo number: {0}" },
            ...
            { ER_ARG_LITERAL, "Argumento para {0} no padr\u00e3o de correspond\u00eancia deve ser um literal." },
            ...
            { ER_INVALID_PREFIX, "O prefixo em exclude-result-prefixes n\u00e3o \u00e9 v\u00e1lido: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "O attribute-set {0} n\u00e3o existe" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "A fun\u00e7\u00e3o denominada {0} n\u00e3o existe" },
            ...
            { ER_INVALID_SET_PARAM_VALUE, "O valor do par\u00e2metro {0} deve ser um Objeto Java v\u00e1lido" },
            ...
            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "O arity n\u00e3o pode ser negativo." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "Encontrado '}', mas nenhum template de atributo aberto!" },

            { WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR,
                    "Aviso: o atributo count n\u00e3o corresponde a um predecessor em xsl:number! Destino = {0}" },

            { WG_EXPR_ATTRIB_CHANGED_TO_SELECT, "Sintaxe antiga: O nome do atributo 'expr' foi alterado para 'select'." },

            { WG_NO_LOCALE_IN_FORMATNUMBER,
                    "Xalan ainda n\u00e3o trata do nome de locale na fun\u00e7\u00e3o format-number." },

            { WG_LOCALE_NOT_FOUND, "Aviso: N\u00e3o foi poss\u00edvel localizar o locale para xml:lang={0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Imposs\u00edvel criar URL a partir de: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "Imposs\u00edvel carregar doc solicitado: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "Imposs\u00edvel localizar Intercalador para <sort xml:lang={0}" },

            { WG_FUNCTIONS_SHOULD_USE_URL,
                    "Sintaxe antiga: a instru\u00e7\u00e3o functions deve utilizar uma url de {0}" },

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "codifica\u00e7\u00e3o n\u00e3o suportada: {0}, utilizando UTF-8" },
            ...
            { WG_PARSING_AND_PREPARING, "========= An\u00e1lise e prepara\u00e7\u00e3o {0} ==========" },

            { WG_ATTR_TEMPLATE, "Template de Atr, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "Conflito de correspond\u00eancia entre xsl:strip-space e xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan ainda n\u00e3o trata do atributo {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "Nenhuma declara\u00e7\u00e3o encontrada para formato decimal: {0}" },

            { WG_OLD_XSLT_NS, "Espa\u00e7o de nomes XSLT ausente ou incorreto." },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} possui um atributo inv\u00e1lido: {1}" },
            ...
            { WG_ILLEGAL_ATTRIBUTE_NAME, "Nome de atributo inv\u00e1lido: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Valor inv\u00e1lido utilizado para o atributo {0}: {1}" },
            ...
            {
                    "xslProc_no_input",
                    "Erro: Nenhuma p\u00e1gina de estilo ou xml de entrada foi especificado. Execute este comando sem nenhuma op\u00e7\u00e3o para instru\u00e7\u00f5es de uso." },
            ...
            { "optionVALIDATE",
                    "   [-VALIDATE (Definir se ocorrer valida\u00e7\u00e3o. A valida\u00e7\u00e3o fica desativada por padr\u00e3o.)]" },
            ...
            { "noParsermsg4",
                    "Se voc\u00ea n\u00e3o tiver o XML Parser para Java da IBM, poder\u00e1 fazer o download dele a partir de" },
            { "noParsermsg5", "IBM's AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER nome completo da classe (URIResolver a ser utilizado para resolver URIs)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER nome completo da classe (EntityResolver a ser utilizado para resolver entidades)]" },
            { "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER nome completo da classe (ContentHandler a ser utilizado para serializar sa\u00edda)]" },
            ...
            { "optionFLAVOR",
                    "   [-FLAVOR flavorName (Utilizar explicitamente s2s=SAX ou d2d=DOM para executar transforma\u00e7\u00e3o.)]" }, // Added
                                                                                                                                     // by
                                                                                                                                     // sboag/scurcuru;
                                                                                                                                     // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (pedir constru\u00e7\u00e3o incremental de DTM definindo http://xml.apache.org/xalan/features/incremental verdadeiro.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (n\u00e3o solicitar o processamento de otimiza\u00e7\u00e3o de folha de estilo definindo http://xml.apache.org/xalan/features/optimize false.)]" },
            { "optionRL",
                    "   [-RL recursionlimit (declarar limite num\u00e9rico em profundidade de recorr\u00eancia de folha de estilo.)]" },
            ...
            { "optionXP",
                    "   [-XP package (especifica um prefixo de nome de pacote para todas as classes translet geradas)]" },
            ...
            { "nameIs", "o nome \u00e9" }, { "matchPatternIs", "o padr\u00e3o de correspond\u00eancia \u00e9" }
