...
public class XSLTErrorResources_pl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "B\u0142\u0105d: Wewn\u0105trz wyra\u017cenia nie mo\u017ce by\u0107 znaku '{'" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} ma niedozwolony atrybut {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode jest puste w xsl:apply-imports!" },

            { ER_CANNOT_ADD, "Nie mo\u017cna doda\u0107 {0} do {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode jest puste w handleApplyTemplatesInstruction!" },

            { ER_NO_NAME_ATTRIB, "{0} musi mie\u0107 atrybut name." },

            { ER_TEMPLATE_NOT_FOUND, "Nie mo\u017cna znale\u017a\u0107 szablonu o nazwie {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "Nie mo\u017cna przet\u0142umaczy\u0107 AVT nazwy na xsl:call-template." },

            { ER_REQUIRES_ATTRIB, "{0} wymaga atrybutu: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} musi mie\u0107 atrybut ''test''." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "B\u0142\u0119dna warto\u015b\u0107 w atrybucie level: {0}" },
            ...
            { ER_NEED_MATCH_ATTRIB, "{0} musi mie\u0107 atrybut match, je\u015bli ma mode." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} wymaga albo atrybutu name, albo match." },

            { ER_CANT_RESOLVE_NSPREFIX, "Nie mo\u017cna rozstrzygn\u0105\u0107 przedrostka przestrzeni nazw {0}" },

            { ER_ILLEGAL_VALUE, "xml:space ma niepoprawn\u0105 warto\u015b\u0107 {0}" },

            { ER_NO_OWNERDOC, "Bezpo\u015bredni w\u0119ze\u0142 potomny nie ma dokumentu w\u0142a\u015bciciela!" },

            { ER_ELEMTEMPLATEELEM_ERR, "B\u0142\u0105d ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Pr\u00f3ba dodania pustego bezpo\u015bredniego elementu potomnego!" },

            { ER_NEED_SELECT_ATTRIB, "{0} wymaga atrybutu select." },

            { ER_NEED_TEST_ATTRIB, "xsl:when musi mie\u0107 atrybut 'test'." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param musi mie\u0107 atrybut 'name'." },

            { ER_NO_CONTEXT_OWNERDOC, "Kontekst nie ma dokumentu w\u0142a\u015bciciela!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON,
                    "Nie mo\u017cna utworzy\u0107 po\u0142\u0105czenia XML TransformerFactory: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Proces Xalan nie wykona\u0142 si\u0119 pomy\u015blnie." },

            { ER_NOT_SUCCESSFUL, "Xalan nie wykona\u0142 si\u0119 pomy\u015blnie." },

            { ER_ENCODING_NOT_SUPPORTED, "Nieobs\u0142ugiwane kodowanie {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "Nie mo\u017cna utworzy\u0107 TraceListener: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key wymaga atrybutu 'name'." },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key wymaga atrybutu 'match'." },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key wymaga atrybutu 'use'." },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} wymaga atrybutu ''elements''!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0} brakuje atrybutu ''prefix''" },

            { ER_BAD_STYLESHEET_URL, "Adres URL arkusza styl\u00f3w jest b\u0142\u0119dny {0}" },

            { ER_FILE_NOT_FOUND, "Nie znaleziono pliku arkusza styl\u00f3w {0}" },

            { ER_IOEXCEPTION, "Wyst\u0105pi\u0142 wyj\u0105tek we/wy w pliku arkusza styl\u00f3w {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Nie mo\u017cna znale\u017a\u0107 atrybutu href dla {0}" },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) {0} zawiera siebie bezpo\u015brednio lub po\u015brednio!" },

            { ER_PROCESSINCLUDE_ERROR, "B\u0142\u0105d StylesheetHandler.processInclude {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) {0} brakuje atrybutu ''lang''" },
            ...
            { ER_PROCESS_ERROR, "B\u0142\u0105d StylesheetRoot.process" },

            { ER_UNIMPLNODE_ERROR, "B\u0142\u0105d UnImplNode: {0}" },

            { ER_NO_SELECT_EXPRESSION, "B\u0142\u0105d! Nie znaleziono wyra\u017cenia wyboru xpath (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "Nie mo\u017cna szeregowa\u0107 XSLProcessor!" },

            { ER_NO_INPUT_STYLESHEET, "Nie podano danych wej\u015bciowych do arkusza styl\u00f3w!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Nie powiod\u0142o si\u0119 przetworzenie arkusza styl\u00f3w!" },

            { ER_COULDNT_PARSE_DOC, "Nie mo\u017cna zanalizowa\u0107 dokumentu {0}!" },

            { ER_COULDNT_FIND_FRAGMENT, "Nie mo\u017cna znale\u017a\u0107 fragmentu {0}" },

            { ER_NODE_NOT_ELEMENT,
                    "W\u0119ze\u0142 wskazywany przez identyfikator fragmentu nie by\u0142 elementem {0}" },

            { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "for-each musi mie\u0107 albo atrybut match, albo name" },

            { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB, "templates musi mie\u0107 albo atrybut match, albo name" },

            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Brak klonu fragmentu dokumentu!" },

            { ER_CANT_CREATE_ITEM, "Nie mo\u017cna utworzy\u0107 elementu w wynikowym drzewie {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE,
                    "xml:space w \u017ar\u00f3d\u0142owym pliku XML ma niepoprawn\u0105 warto\u015b\u0107 {0}" },

            { ER_NO_XSLKEY_DECLARATION, "Nie ma deklaracji xsl:key dla {0}!" },

            { ER_CANT_CREATE_URL, "B\u0142\u0105d! Nie mo\u017cna utworzy\u0107 adresu url dla {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions jest nieobs\u0142ugiwane" },

            { ER_PROCESSOR_ERROR, "B\u0142\u0105d XSLT TransformerFactory" },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} ma niedozwolony atrybut {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Nieznany element XSL {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) xsl:sort mo\u017ce by\u0107 u\u017cywane tylko z xsl:apply-templates lub xsl:for-each." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) b\u0142\u0119dnie umieszczone xsl:when!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:when bez nadrz\u0119dnego xsl:choose!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) b\u0142\u0119dnie umieszczone xsl:otherwise!" },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:otherwise bez nadrz\u0119dnego xsl:choose!" },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} jest niedozwolone wewn\u0105trz szablonu!" },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} importuje siebie bezpo\u015brednio lub po\u015brednio!" },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space ma niedozwolon\u0105 warto\u015b\u0107: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet by\u0142o niepomy\u015blne!" },

            { ER_SAX_EXCEPTION, "Wyj\u0105tek SAX" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "Nieobs\u0142ugiwana funkcja!" },

            { ER_XSLT_ERROR, "B\u0142\u0105d XSLT" },

            { ER_CURRENCY_SIGN_ILLEGAL, "Znak waluty jest niedozwolony w ci\u0105gu znak\u00f3w wzorca formatu" },
            ...
            { ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX, "Przedrostek w exclude-result-prefixes jest niepoprawny: {0}" },

            { ER_MISSING_NS_URI, "Nieobecny identyfikator URI przestrzeni nazw w podanym przedrostku" },

            { ER_MISSING_ARG_FOR_OPTION, "Nieobecny argument opcji {0}" },

            { ER_INVALID_OPTION, "Niepoprawna opcja {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Zniekszta\u0142cony ci\u0105g znak\u00f3w formatu {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet wymaga atrybutu 'version'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Atrybut {0} ma niepoprawn\u0105 warto\u015b\u0107 {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose wymaga xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports jest niedozwolone w xsl:for-each" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Nie mo\u017cna u\u017cy\u0107 DTMLiaison w wyj\u015bciowym w\u0119\u017ale DOM... przeka\u017c zamiast tego de.lyca.xpath.DOM2Helper!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "Nie mo\u017cna u\u017cy\u0107 DTMLiaison w wej\u015bciowym w\u0119\u017ale DOM... przeka\u017c zamiast tego de.lyca.xpath.DOM2Helper!" },

            { ER_CALL_TO_EXT_FAILED, "Wywo\u0142anie elementu rozszerzenia nie powiod\u0142o si\u0119: {0}" },
            ...
            { ER_IN_ELEMTEMPLATEELEM_READOBJECT, "W ElemTemplateElement.readObject: {0}" },

            { ER_DUPLICATE_NAMED_TEMPLATE, "Znaleziono wi\u0119cej ni\u017c jeden szablon o nazwie {0}" },
            ...
            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Nie znaleziono pliku klasy dla opcji {0}" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Nie znaleziono wymaganego elementu {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream nie mo\u017ce by\u0107 pusty" },

            { ER_URI_CANNOT_BE_NULL, "Identyfikator URI nie mo\u017ce by\u0107 pusty" },

            { ER_FILE_CANNOT_BE_NULL, "File nie mo\u017ce by\u0107 pusty" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource nie mo\u017ce by\u0107 pusty" },

            { ER_CANNOT_INIT_BSFMGR, "Nie mo\u017cna zainicjowa\u0107 mened\u017cera BSF" },

            { ER_CANNOT_CMPL_EXTENSN, "Nie mo\u017cna skompilowa\u0107 rozszerzenia" },

            { ER_CANNOT_CREATE_EXTENSN, "Nie mo\u017cna utworzy\u0107 rozszerzenia {0} z powodu  {1}" },

            { ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "Wywo\u0142anie metody Instance do metody {0} wymaga instancji Object jako pierwszego argumentu" },

            { ER_INVALID_ELEMENT_NAME, "Podano niepoprawn\u0105 nazw\u0119 elementu {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "Metoda nazwy elementu musi by\u0107 statyczna {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Funkcja rozszerzenia {0} : {1} jest nieznana" },

            { ER_MORE_MATCH_CONSTRUCTOR, "Wi\u0119cej ni\u017c jedno najlepsze dopasowanie dla konstruktora {0}" },

            { ER_MORE_MATCH_METHOD, "Wi\u0119cej ni\u017c jedno najlepsze dopasowanie dla metody {0}" },

            { ER_MORE_MATCH_ELEMENT, "Wi\u0119cej ni\u017c jedno najlepsze dopasowanie dla metody elementu {0}" },

            { ER_INVALID_CONTEXT_PASSED, "Przekazano niepoprawny kontekst do wyliczenia {0}" },

            { ER_POOL_EXISTS, "Pula ju\u017c istnieje" },

            { ER_NO_DRIVER_NAME, "Nie podano nazwy sterownika" },

            { ER_NO_URL, "Nie podano adresu URL" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Wielko\u015b\u0107 puli jest mniejsza od jedno\u015bci!" },

            { ER_INVALID_DRIVER, "Podano niepoprawn\u0105 nazw\u0119 sterownika!" },

            { ER_NO_STYLESHEETROOT, "Nie znaleziono elementu g\u0142\u00f3wnego arkusza styl\u00f3w!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Niedozwolona warto\u015b\u0107 xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "processFromNode nie powiod\u0142o si\u0119" },

            { ER_RESOURCE_COULD_NOT_LOAD,
                    "Zas\u00f3b [ {0} ] nie m\u00f3g\u0142 za\u0142adowa\u0107: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Wielko\u015b\u0107 buforu <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Nieznany b\u0142\u0105d podczas wywo\u0142ywania rozszerzenia" },

            { ER_NO_NAMESPACE_DECL, "Przedrostek {0} nie ma odpowiadaj\u0105cej mu deklaracji przestrzeni nazw" },

            { ER_ELEM_CONTENT_NOT_ALLOWED, "Zawarto\u015b\u0107 elementu niedozwolona dla lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Arkusz styl\u00f3w zarz\u0105dzi\u0142 zako\u0144czenie" },

            { ER_ONE_OR_TWO, "1 lub 2" },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Nie mo\u017cna zainicjowa\u0107 domy\u015blnych szablon\u00f3w" },

            { ER_RESULT_NULL, "Rezultat nie powinien by\u0107 pusty" },

            { ER_RESULT_COULD_NOT_BE_SET, "Nie mo\u017cna ustawi\u0107 rezultatu" },

            { ER_NO_OUTPUT_SPECIFIED, "Nie podano wyj\u015bcia" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Nie mo\u017cna przekszta\u0142ci\u0107 do rezultatu o typie {0}" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE,
                    "Nie mo\u017cna przekszta\u0142ci\u0107 \u017ar\u00f3d\u0142a o typie {0}" },

            { ER_NULL_CONTENT_HANDLER, "Pusta procedura obs\u0142ugi zawarto\u015bci" },

            { ER_NULL_ERROR_HANDLER, "Pusta procedura obs\u0142ugi b\u0142\u0119du" },

            { ER_CANNOT_CALL_PARSE, "Nie mo\u017cna wywo\u0142a\u0107 parse, je\u015bli nie ustawiono ContentHandler" },

            { ER_NO_PARENT_FOR_FILTER, "Brak elementu nadrz\u0119dnego dla filtru" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Nie znaleziono arkusza styl\u00f3w w {0}, no\u015bnik= {1}" },

            { ER_NO_STYLESHEET_PI, "Nie znaleziono instrukcji przetwarzania xml-stylesheet w {0}" },

            { ER_NOT_SUPPORTED, "Nieobs\u0142ugiwane: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN,
                    "Warto\u015b\u0107 w\u0142a\u015bciwo\u015bci {0} powinna by\u0107 instancj\u0105 typu Boolean" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Nie mo\u017cna si\u0119 dosta\u0107 do zewn\u0119trznego skryptu w {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "Nie mo\u017cna znale\u017a\u0107 zasobu [ {0} ].\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "Nierozpoznana w\u0142a\u015bciwo\u015b\u0107 wyj\u015bciowa {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Nie powiod\u0142o si\u0119 utworzenie instancji ElemLiteralResult" },
            ...
            { ER_VALUE_SHOULD_EQUAL, "Warto\u015bci\u0105 {0} powinno by\u0107 yes lub no" },

            { ER_FAILED_CALLING_METHOD, "Niepowodzenie wywo\u0142ania metody {0}" },

            { ER_FAILED_CREATING_ELEMTMPL, "Nie powiod\u0142o si\u0119 utworzenie instancji ElemTemplateElement" },

            { ER_CHARS_NOT_ALLOWED, "W tym miejscu dokumentu znaki s\u0105 niedozwolone" },

            { ER_ATTR_NOT_ALLOWED, "Atrybut \"{0}\" nie jest dozwolony w elemencie {1}!" },

            { ER_BAD_VALUE, "B\u0142\u0119dna warto\u015b\u0107 {0} {1}" },

            { ER_ATTRIB_VALUE_NOT_FOUND, "Nie znaleziono warto\u015bci atrybutu {0}" },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Nie rozpoznano warto\u015bci atrybutu {0}" },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "Nie mo\u017cna znale\u017a\u0107 klasy sterownika SAX1 {0}" },
            ...
            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "Klasa sterownika SAX1 {0} nie implementuje org.xml.sax.Parser" },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED,
                    "W\u0142a\u015bciwo\u015b\u0107 systemowa org.xml.sax.parser nie zosta\u0142a podana" },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Argument analizatora nie mo\u017ce by\u0107 pusty" },

            { ER_FEATURE, "Opcja: {0}" },

            { ER_PROPERTY, "W\u0142a\u015bciwo\u015b\u0107: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Pusty przelicznik encji" },

            { ER_NULL_DTD_HANDLER, "Pusta procedura obs\u0142ugi DTD" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Nie podano nazwy sterownika!" },

            { ER_NO_URL_SPECIFIED, "Nie podano adresu URL!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "Wielko\u015b\u0107 puli jest mniejsza od 1!" },

            { ER_INVALID_DRIVER_NAME, "Podano niepoprawn\u0105 nazw\u0119 sterownika!" },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Asercja programisty w RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "{0} jest niedozwolone na tej pozycji w arkuszu styl\u00f3w!" },
            ...
            { INVALID_QNAME, "Niedozwolona warto\u015b\u0107 {1} u\u017cyta w atrybucie QNAME {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Niedozwolona warto\u015b\u0107 {1} u\u017cyta w atrybucie NMTOKEN {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Niedozwolona warto\u015b\u0107 {1} u\u017cyta w atrybucie NCNAME {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Niedozwolona warto\u015b\u0107 {1} u\u017cyta w atrybucie logicznym {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Niedozwolona warto\u015b\u0107 {1} u\u017cyta w atrybucie liczbowym {0}" },
            ...
            { ER_ARG_LITERAL, "Argument opcji {0} we wzorcu uzgadniania musi by\u0107 litera\u0142em." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Zduplikowana deklaracja zmiennej globalnej." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Zduplikowana deklaracja zmiennej." },

            // Note to translators: "xsl:template, "name" and "match" are XSLT
            // keywords
            // which must not be translated.
            // ER_TEMPLATE_NAME_MATCH - new error message for bugzilla #789
            { ER_TEMPLATE_NAME_MATCH, "xsl:template musi mie\u0107 atrybut name lub match (lub obydwa)" },
            ...
            { ER_INVALID_PREFIX, "Przedrostek w exclude-result-prefixes jest niepoprawny: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "Zbi\u00f3r atrybut\u00f3w o nazwie {0} nie istnieje" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "Funkcja o nazwie {0} nie istnieje" },
            ...
            { ER_UNSUPPORTED_FEATURE, "Nie mo\u017cna ustawi\u0107 opcji ''{0}'' w tej klasie TransformerFactory." },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "Nazwa funkcji nie mo\u017ce by\u0107 pusta (null)." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "Liczba parametr\u00f3w nie mo\u017ce by\u0107 ujemna." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "Znaleziono znak '}', ale nie jest otwarty \u017caden szablon atrybut\u00f3w!" },
            ...
            { WG_CANNOT_LOAD_REQUESTED_DOC, "Nie mo\u017cna za\u0142adowa\u0107 \u017c\u0105danego dokumentu {0}" },
            ...
            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "Kodowanie nieobs\u0142ugiwane: {0}, u\u017cywane jest UTF-8" },

            { WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "Kodowanie nieobs\u0142ugiwane: {0}, u\u017cywane jest Java {1}" },

            { WG_SPECIFICITY_CONFLICTS,
                    "Znaleziono konflikty specyfiki {0}, u\u017cywany b\u0119dzie ostatni znaleziony w arkuszu styl\u00f3w." },

            { WG_PARSING_AND_PREPARING, "========= Analizowanie i przygotowywanie {0} ==========" },

            { WG_ATTR_TEMPLATE, "Szablon atrybutu {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "Konflikt zgodno\u015bci pomi\u0119dzy xsl:strip-space oraz xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan nie obs\u0142uguje jeszcze atrybutu {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "Nie znaleziono deklaracji formatu dziesi\u0119tnego {0}" },

            { WG_OLD_XSLT_NS, "Nieobecna lub niepoprawna przestrze\u0144 nazw XSLT." },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} ma niedozwolony atrybut {1}" },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "Nie mo\u017cna przet\u0142umaczy\u0107 przedrostka przestrzeni nazw {0}. W\u0119ze\u0142 zostanie zignorowany." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet wymaga atrybutu 'version'!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Niedozwolona nazwa atrybutu {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Niedozwolona warto\u015b\u0107 atrybutu {0}: {1}" },
            ...
            {
                    "xslProc_no_input",
                    "B\u0142\u0105d: Nie podano arkusza styl\u00f3w lub wej\u015bciowego pliku xml. Wykonaj t\u0119 komend\u0119 bez \u017cadnych opcji, aby zapozna\u0107 si\u0119 z informacjami o sk\u0142adni." },
            ...
            { "optionCR",
                    "[-LF (u\u017cycie tylko znak\u00f3w powrotu karetki na wyj\u015bciu {domy\u015blnie CR/LF})]" },
            ...
            { "optionVALIDATE",
                    "[-VALIDATE (w\u0142\u0105czenie sprawdzania poprawno\u015bci - domy\u015blnie jest wy\u0142\u0105czona)]" },
            { "optionEDUMP",
                    "[-EDUMP {opcjonalna nazwa pliku} (wykonywanie zrzutu stosu w przypadku wyst\u0105pienia b\u0142\u0119du)]" },
            ...
            { "noParsermsg4",
                    "Je\u015bli nie masz analizatora XML dla j\u0119zyka Java firmy IBM, mo\u017cesz go pobra\u0107" },
            { "noParsermsg5", "z serwisu AlphaWorks firmy IBM: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER pe\u0142na nazwa klasy (URIResolver u\u017cywany do t\u0142umaczenia URI)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER pe\u0142na nazwa klasy (EntityResolver u\u017cywany do t\u0142umaczenia encji)]" },
            { "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER pe\u0142na nazwa klasy (ContentHandler u\u017cywany do szeregowania wyj\u015bcia)]" },
            { "optionLINENUMBERS", "    [-L u\u017cycie numer\u00f3w wierszy w dokumentach \u017ar\u00f3d\u0142owych]" },
            { "optionSECUREPROCESSING",
                    "   [-SECURE (ustawienie opcji przetwarzania bezpiecznego na warto\u015b\u0107 true.)]" },
            ...
            {
                    "optionMEDIA",
                    "   [-MEDIA typ_no\u015bnika (u\u017cywaj atrybutu media w celu znalezienia arkusza styl\u00f3w zwi\u0105zanego z dokumentem)]" },
            { "optionFLAVOR",
                    "   [-FLAVOR nazwa_posmaku (u\u017cywaj jawnie s2s=SAX lub d2d=DOM w celu wykonania transformacji)]" }, // Added
                                                                                                                            // by
                                                                                                                            // sboag/scurcuru;
                                                                                                                            // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (\u017c\u0105danie przyrostowego budowania DTM poprzez ustawienie http://xml.apache.org/xalan/features/incremental true.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (\u017c\u0105danie braku optymalizowania arkuszy styl\u00f3w poprzez ustawienie http://xml.apache.org/xalan/features/optimize false.)]" },
            {
                    "optionRL",
                    "   [-RL limit_rekurencji (okre\u015blenie liczbowego limitu g\u0142\u0119boko\u015bci rekurencji w arkuszach styl\u00f3w)]" },
            ...
            { "optionXP",
                    "[-XP pakiet (okre\u015blenie przedrostka nazwy pakietu dla wszystkich wygenerowanych klas transletu)]" },
            ...
            { "recursionTooDeep",
                    "Zbyt g\u0142\u0119bokie zagnie\u017cd\u017cenie szablon\u00f3w. zagnie\u017cd\u017cenie= {0}, szablon {1} {2}" },
            { "nameIs", "nazw\u0105 jest" }, { "matchPatternIs", "wzorcem uzgadniania jest" }
