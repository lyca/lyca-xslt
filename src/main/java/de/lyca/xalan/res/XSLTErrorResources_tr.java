...
public class XSLTErrorResources_tr extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Hata: \u0130fade i\u00e7inde '{' olamaz" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} ge\u00e7ersiz {1} \u00f6zniteli\u011fini i\u00e7eriyor" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "xsl:apply-imports i\u00e7inde sourceNode bo\u015f de\u011ferli!" },

            { ER_CANNOT_ADD, "{0}, {1} i\u00e7ine eklenemiyor" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES,
                    "handleApplyTemplatesInstruction i\u00e7inde sourceNode bo\u015f de\u011ferli!" },

            { ER_NO_NAME_ATTRIB, "{0} i\u00e7in \u00f6znitelik belirtilmeli." },

            { ER_TEMPLATE_NOT_FOUND, "Ad\u0131 {0} olan \u015fablon bulunamad\u0131" },

            { ER_CANT_RESOLVE_NAME_AVT, "xsl:call-template i\u00e7inde AVT ad\u0131 \u00e7\u00f6z\u00fclemedi." },

            { ER_REQUIRES_ATTRIB, "{0} i\u00e7in {1} \u00f6zniteli\u011fi gerekiyor." },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} i\u00e7in ''test'' \u00f6zniteli\u011fi gerekiyor." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "{0} d\u00fczey \u00f6zniteli\u011finde hatal\u0131 de\u011fer." },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "processing-instruction ad\u0131 'xml' olamaz" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
                    "processing-instruction ad\u0131 ge\u00e7erli bir NCName olmal\u0131d\u0131r: {0}" },

            { ER_NEED_MATCH_ATTRIB, "{0} kip i\u00e7eriyorsa match \u00f6zniteli\u011fi olmas\u0131 gerekir." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} i\u00e7in name ya da match \u00f6zniteli\u011fi gerekiyor." },

            { ER_CANT_RESOLVE_NSPREFIX, "Ad alan\u0131 \u00f6neki {0} \u00e7\u00f6z\u00fclemiyor." },

            { ER_ILLEGAL_VALUE, "xml:space ge\u00e7ersiz {0} de\u011ferini i\u00e7eriyor." },

            { ER_NO_OWNERDOC, "Alt d\u00fc\u011f\u00fcm\u00fcn iye belgesi yok!" },

            { ER_ELEMTEMPLATEELEM_ERR, "ElemTemplateElement hatas\u0131: {0}" },

            { ER_NULL_CHILD, "Bo\u015f de\u011ferli (null) alt \u00f6\u011fe ekleme giri\u015fimi!" },

            { ER_NEED_SELECT_ATTRIB, "{0} i\u00e7in select \u00f6zniteli\u011fi gerekiyor." },

            { ER_NEED_TEST_ATTRIB, "xsl:when i\u00e7in 'test' \u00f6zniteli\u011fi gereklidir." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param i\u00e7in 'name' \u00f6zniteli\u011fi gereklidir." },

            { ER_NO_CONTEXT_OWNERDOC, "Ba\u011flam\u0131n iye belgesi yok!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "XML TransformerFactory ili\u015fkisi {0} yarat\u0131lamad\u0131" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: Process ba\u015far\u0131l\u0131 olmad\u0131." },

            { ER_NOT_SUCCESSFUL, "Xalan: ba\u015far\u0131l\u0131 olmad\u0131." },

            { ER_ENCODING_NOT_SUPPORTED, "{0} kodlamas\u0131 desteklenmiyor." },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "TraceListener {0} yarat\u0131lamad\u0131." },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key i\u00e7in 'name' \u00f6zniteli\u011fi gerekiyor!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key i\u00e7in 'match' \u00f6zniteli\u011fi gerekiyor!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key i\u00e7in 'use' \u00f6zniteli\u011fi gerekiyor!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB,
                    "(StylesheetHandler) {0} i\u00e7in ''elements'' \u00f6zniteli\u011fi gerekiyor!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0} \u00f6zniteli\u011fi ''prefix'' eksik" },

            { ER_BAD_STYLESHEET_URL, "Bi\u00e7em yapra\u011f\u0131 URL adresi {0} ge\u00e7ersiz" },

            { ER_FILE_NOT_FOUND, "Bi\u00e7em yapra\u011f\u0131 dosyas\u0131 bulunamad\u0131: {0}" },

            { ER_IOEXCEPTION,
                    "Bi\u00e7em yapra\u011f\u0131 dosyas\u0131 {0} ile G\u00c7 kural d\u0131\u015f\u0131 durumu olu\u015ftu" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) {0} i\u00e7in href \u00f6zniteli\u011fi bulunamad\u0131" },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) {0} do\u011frudan ya da dolayl\u0131 olarak kendisini i\u00e7eriyor!" },

            { ER_PROCESSINCLUDE_ERROR, "StylesheetHandler.processInclude hatas\u0131, {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) {0} \u00f6zniteli\u011fi ''lang'' eksik" },
            ...
            { ER_PROCESS_ERROR, "StylesheetRoot.process hatas\u0131" },

            { ER_UNIMPLNODE_ERROR, "UnImplNode hatas\u0131: {0}" },

            { ER_NO_SELECT_EXPRESSION, "Hata! xpath select ifadesi (-select) bulunamad\u0131." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "XSLProcessor diziselle\u015ftirilemez!" },

            { ER_NO_INPUT_STYLESHEET, "Bi\u00e7em yapra\u011f\u0131 giri\u015fi belirtilmedi!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Bi\u00e7em yapra\u011f\u0131 i\u015flenemedi!" },

            { ER_COULDNT_PARSE_DOC, "{0} belgesi ayr\u0131\u015ft\u0131r\u0131lamad\u0131!" },

            { ER_COULDNT_FIND_FRAGMENT, "Par\u00e7a bulunamad\u0131: {0}" },
            ...
            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Belge par\u00e7as\u0131n\u0131n e\u015fkopyas\u0131 de\u011fil!" },

            { ER_CANT_CREATE_ITEM, "Sonu\u00e7 a\u011fac\u0131nda \u00f6\u011fe yarat\u0131lam\u0131yor: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "Kaynak XML i\u00e7inde xml:space ge\u00e7ersiz de\u011fer i\u00e7eriyor: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "{0} i\u00e7in xsl:key bildirimi yok!" },

            { ER_CANT_CREATE_URL, "Hata! \u0130lgili url yarat\u0131lam\u0131yor: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions desteklenmiyor" },

            { ER_PROCESSOR_ERROR, "XSLT TransformerFactory Hatas\u0131" },

            { ER_NOT_ALLOWED_INSIDE_STYLESHEET,
                    "(StylesheetHandler) {0} bi\u00e7em yapra\u011f\u0131 i\u00e7inde olamaz!" },

            { ER_RESULTNS_NOT_SUPPORTED, "result-ns art\u0131k desteklenmiyor!  Yerine xsl:output kullan\u0131n." },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} ge\u00e7ersiz {1} \u00f6zniteli\u011fini i\u00e7eriyor" },

            { ER_UNKNOWN_XSL_ELEM, "Bilinmeyen XSL \u00f6\u011fesi: {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) xsl:sort yaln\u0131zca xsl:apply-templates ya da xsl:for-each ile kullan\u0131labilir." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) xsl:when yeri yanl\u0131\u015f!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:when \u00f6\u011fesinin \u00fcst \u00f6\u011fesi xsl:choose de\u011fil!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise yeri yanl\u0131\u015f!" },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:otherwise \u00f6\u011fesinin \u00fcst \u00f6\u011fesi xsl:choose de\u011fil!" },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} \u015fablon i\u00e7inde kullan\u0131lamaz!" },

            { ER_UNKNOWN_EXT_NS_PREFIX, "(StylesheetHandler) {0} eklenti ad alan\u0131 \u00f6neki {1} bilinmiyor" },
            ...
            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space ge\u00e7ersiz {0} de\u011ferini i\u00e7eriyor" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet ba\u015far\u0131s\u0131z oldu!" },

            { ER_SAX_EXCEPTION, "SAX kural d\u0131\u015f\u0131 durumu" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "\u0130\u015flev desteklenmiyor!" },

            { ER_XSLT_ERROR, "XSLT hatas\u0131" },

            { ER_CURRENCY_SIGN_ILLEGAL, "Bi\u00e7im \u00f6r\u00fcnt\u00fcs\u00fc dizgisinde para birimi simgesi olamaz" },

            { ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM, "Stylesheet DOM belge i\u015flevini desteklemiyor!" },
            ...
            { ER_MISSING_NS_URI, "Belirtilen \u00f6nek i\u00e7in ad alan\u0131 URI eksik" },

            { ER_MISSING_ARG_FOR_OPTION,
                    "{0} se\u00e7ene\u011fi i\u00e7in ba\u011f\u0131ms\u0131z de\u011fi\u015fken eksik" },

            { ER_INVALID_OPTION, "Ge\u00e7ersiz se\u00e7enek: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Bozuk bi\u00e7imli bi\u00e7im dizgisi: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB,
                    "xsl:stylesheet i\u00e7in 'version' \u00f6zniteli\u011fi gerekiyor!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "{0} \u00f6zniteli\u011fi ge\u00e7ersiz {1} de\u011ferini i\u00e7eriyor" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose i\u00e7in xsl:when gerekiyor" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports, xsl:for-each i\u00e7inde kullan\u0131lamaz" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "\u00c7\u0131k\u0131\u015f DOM d\u00fc\u011f\u00fcm\u00fc i\u00e7in DTMLiaison kullan\u0131lamaz... onun yerine de.lyca.xpath.DOM2Helper aktar\u0131n!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "Giri\u015f DOM d\u00fc\u011f\u00fcm\u00fc i\u00e7in DTMLiaison kullan\u0131lamaz... onun yerine de.lyca.xpath.DOM2Helper aktar\u0131n!" },
            ...
            { ER_IN_ELEMTEMPLATEELEM_READOBJECT, "ElemTemplateElement.readObject i\u00e7inde: {0}" },
            ...
            { ER_REQUIRED_ELEM_NOT_FOUND, "Gerekli \u00f6\u011fe bulunamad\u0131: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream bo\u015f de\u011ferli olamaz" },

            { ER_URI_CANNOT_BE_NULL, "URI bo\u015f de\u011ferli olamaz" },

            { ER_FILE_CANNOT_BE_NULL, "Dosya bo\u015f de\u011ferli olamaz" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource bo\u015f de\u011ferli olamaz" },

            { ER_CANNOT_INIT_BSFMGR, "BSF Manager kullan\u0131ma haz\u0131rlanamad\u0131" },

            { ER_CANNOT_CMPL_EXTENSN, "Eklenti derlenemedi" },

            { ER_CANNOT_CREATE_EXTENSN, "Eklenti yarat\u0131lamad\u0131: {0} nedeni: {1}" },

            {
                    ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "{0} y\u00f6ntemine y\u00f6nelik Instance y\u00f6ntemi, birincil ba\u011f\u0131ms\u0131z de\u011fi\u015fkenin somutla\u015fan nesne \u00f6rne\u011fi olmas\u0131n\u0131 gerektirir" },

            { ER_INVALID_ELEMENT_NAME, "Belirtilen \u00f6\u011fe ad\u0131 ge\u00e7ersiz {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "\u00d6\u011fe ad\u0131 y\u00f6ntemi dura\u011fan {0} olmal\u0131" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Eklenti i\u015flevi {0} : {1} bilinmiyor" },
            ...
            { ER_POOL_EXISTS, "Havuz zaten var" },

            { ER_NO_DRIVER_NAME, "S\u00fcr\u00fcc\u00fc ad\u0131 belirtilmedi" },

            { ER_NO_URL, "URL belirtilmedi" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Havuz b\u00fcy\u00fckl\u00fc\u011f\u00fc birden az!" },

            { ER_INVALID_DRIVER, "Belirtilen s\u00fcr\u00fcc\u00fc ad\u0131 ge\u00e7ersiz!" },

            { ER_NO_STYLESHEETROOT, "Bi\u00e7em yapra\u011f\u0131 k\u00f6k\u00fc bulunamad\u0131!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "xml:space i\u00e7in ge\u00e7ersiz de\u011fer" },

            { ER_PROCESSFROMNODE_FAILED, "processFromNode ba\u015far\u0131s\u0131z oldu" },

            { ER_RESOURCE_COULD_NOT_LOAD, "Kaynak [ {0} ] y\u00fckleyemedi: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Arabellek b\u00fcy\u00fckl\u00fc\u011f\u00fc <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Eklenti \u00e7a\u011fr\u0131l\u0131rken bilinmeyen hata" },

            { ER_NO_NAMESPACE_DECL, "{0} \u00f6nekinin ili\u015fkili bir ad alan\u0131 bildirimi yok" },

            { ER_ELEM_CONTENT_NOT_ALLOWED,
                    "lang=javaclass {0} i\u00e7in \u00f6\u011fe i\u00e7eri\u011fine izin verilmiyor" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Bi\u00e7em yapra\u011f\u0131 y\u00f6nlendirmeli sonland\u0131rma" },

            { ER_ONE_OR_TWO, "1 ya da 2" },

            { ER_TWO_OR_THREE, "2 ya da 3" },
            ...
            { ER_RESULT_NULL, "Sonu\u00e7 bo\u015f de\u011ferli olmamal\u0131" },

            { ER_RESULT_COULD_NOT_BE_SET, "Sonu\u00e7 tan\u0131mlanamad\u0131" },

            { ER_NO_OUTPUT_SPECIFIED, "\u00c7\u0131k\u0131\u015f belirtilmedi" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "{0} tipi sonuca d\u00f6n\u00fc\u015ft\u00fcr\u00fclemez" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "{0} tipi kayna\u011fa d\u00f6n\u00fc\u015ft\u00fcr\u00fclemez" },

            { ER_NULL_CONTENT_HANDLER, "Bo\u015f de\u011ferli i\u00e7erik i\u015fleyici" },

            { ER_NULL_ERROR_HANDLER, "Bo\u015f de\u011ferli hata i\u015fleyici" },

            { ER_CANNOT_CALL_PARSE, "ContentHandler tan\u0131mlanmad\u0131ysa parse \u00e7a\u011fr\u0131lamaz" },

            { ER_NO_PARENT_FOR_FILTER, "S\u00fczgecin \u00fcst \u00f6\u011fesi yok" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Bi\u00e7em yapra\u011f\u0131 burada bulunamad\u0131: {0}, ortam= {1}" },

            { ER_NO_STYLESHEET_PI, "xml-stylesheet PI burada bulunamad\u0131: {0}" },
            ...
            { ER_VALUE_SHOULD_EQUAL, "{0} de\u011feri yes ya da no olmal\u0131" },

            { ER_FAILED_CALLING_METHOD, "{0} y\u00f6ntemi \u00e7a\u011fr\u0131s\u0131 ba\u015far\u0131s\u0131z oldu" },

            { ER_FAILED_CREATING_ELEMTMPL,
                    "ElemTemplateElement somut \u00f6rne\u011fi yarat\u0131lmas\u0131 ba\u015far\u0131s\u0131z oldu" },

            { ER_CHARS_NOT_ALLOWED, "Belgenin bu noktas\u0131nda karakterlere izin verilmez" },

            { ER_ATTR_NOT_ALLOWED, "\"{0}\" \u00f6zniteli\u011fi {1} \u00f6\u011fesinde kullan\u0131lamaz!" },

            { ER_BAD_VALUE, "{0} hatal\u0131 de\u011fer {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "{0} \u00f6znitelik de\u011feri bulunamad\u0131 " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "{0} \u00f6znitelik de\u011feri tan\u0131nm\u0131yor " },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "SAX1 s\u00fcr\u00fcc\u00fc s\u0131n\u0131f\u0131 {0} bulunam\u0131yor" },
            ...
            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Sistem \u00f6zelli\u011fi org.xml.sax.parser belirtilmedi" },

            {
                    ER_PARSER_ARG_CANNOT_BE_NULL,
                    "Ayr\u0131\u015ft\u0131r\u0131c\u0131 (Parser) ba\u011f\u0131ms\u0131z de\u011fi\u015fkeni bo\u015f de\u011ferli olmamal\u0131" },

            { ER_FEATURE, "\u00d6zellik: {0}" },

            { ER_PROPERTY, "\u00d6zellik: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Bo\u015f de\u011ferli varl\u0131k \u00e7\u00f6z\u00fcc\u00fc" },

            { ER_NULL_DTD_HANDLER, "Bo\u015f de\u011ferli DTD i\u015fleyici" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "S\u00fcr\u00fcc\u00fc ad\u0131 belirtilmedi!" },

            { ER_NO_URL_SPECIFIED, "URL belirtilmedi!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "Havuz b\u00fcy\u00fckl\u00fc\u011f\u00fc birden az!" },

            { ER_INVALID_DRIVER_NAME, "Belirtilen s\u00fcr\u00fcc\u00fc ad\u0131 ge\u00e7ersiz!" },
            ...
            { ER_NOT_ALLOWED_IN_POSITION, "{0} bi\u00e7em yapra\u011f\u0131nda bu konumda bulunamaz!" },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Yinelenen genel de\u011fi\u015fken bildirimi." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Yinelenen de\u011fi\u015fken bildirimi." },
            ...
            { ER_INVALID_PREFIX, "exclude-result-prefixes i\u00e7indeki \u00f6nek ge\u00e7erli de\u011fil: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "{0} adl\u0131 \u00f6znitelik k\u00fcmesi yok" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "{0} adl\u0131 i\u015flev yok" },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "\u0130\u015flev ad\u0131 bo\u015f de\u011ferli olamaz." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "E\u015flik eksi olamaz." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "'}' bulundu, ancak a\u00e7\u0131k \u00f6znitelik \u015fablonu yok!" },
            ...
            { WG_LOCALE_NOT_FOUND, "Uyar\u0131: xml:lang={0} ile ilgili \u00fclke de\u011feri bulunamad\u0131" },

            { WG_CANNOT_MAKE_URL_FROM, "Dizgiden URL olu\u015fturulamad\u0131: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "\u0130stenen belge y\u00fcklenemiyor: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "<sort xml:lang={0} i\u00e7in Collator bulunamad\u0131" },

            { WG_FUNCTIONS_SHOULD_USE_URL,
                    "Eski s\u00f6zdizimi: functions y\u00f6nergesi {0} url adresini kullanmal\u0131d\u0131r" },

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "{0} kodlamas\u0131 desteklenmiyor, UTF-8 kullan\u0131l\u0131yor" },
            ...
            { WG_ATTR_TEMPLATE, "\u00d6znitelik \u015fablonu, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "xsl:strip-space ile xsl:preserve-space aras\u0131nda e\u015fle\u015fme \u00e7at\u0131\u015fmas\u0131" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan hen\u00fcz {0} \u00f6zniteli\u011fini i\u015flemiyor!" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "Onlu bi\u00e7imi i\u00e7in bildirim bulunamad\u0131: {0}" },

            { WG_OLD_XSLT_NS, "Eksik ya da yanl\u0131\u015f XSLT ad alan\u0131. " },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} ge\u00e7ersiz {1} \u00f6zniteli\u011fini i\u00e7eriyor" },
            ...
            { WG_ILLEGAL_ATTRIBUTE_NAME, "Ge\u00e7ersiz \u00f6znitelik ad\u0131: {0}" },
            ...
            { "xslProc_option",
                    "Xalan-J komut sat\u0131r\u0131 i\u015flem s\u0131n\u0131f\u0131 se\u00e7enekleri\u003a" },
            ...
            {
                    "xslProc_no_input",
                    "Hata: Bi\u00e7em yapra\u011f\u0131 ya da giri\u015f xml belirtilmedi. Kullan\u0131m y\u00f6nergeleri i\u00e7in, bu komutu se\u00e7enek belirtmeden \u00e7al\u0131\u015ft\u0131r\u0131n." },
            ...
            { "optionPARSER",
                    "[-PARSER ayr\u0131\u015ft\u0131r\u0131c\u0131 ili\u015fkisinin tam olarak nitelenmi\u015f s\u0131n\u0131f ad\u0131]" },
            ...
            { "optionLF",
                    "   [-LF (sat\u0131r besleme yaln\u0131zca \u00e7\u0131k\u0131\u015fta kullan\u0131l\u0131r {varsay\u0131lan CR/LF})]" },
            {
                    "optionCR",
                    "   [-CR (Sat\u0131rba\u015f\u0131 yaln\u0131zca \u00e7\u0131k\u0131\u015fta kullan\u0131l\u0131r {varsay\u0131lan CR/LF})]" },
            { "optionESCAPE", "   [-ESCAPE (Ka\u00e7\u0131\u015f karakterleri {varsay\u0131lan <>&\"\'\\r\\n}]" },
            { "optionINDENT",
                    "[-INDENT (Girintili yazarken kullan\u0131lacak bo\u015fluk say\u0131s\u0131 {varsay\u0131lan 0})]" },
            ...
            {
                    "optionVALIDATE",
                    "[-VALIDATE (Ge\u00e7erlilik denetimi yap\u0131l\u0131p yap\u0131lmayaca\u011f\u0131n\u0131 belirler.  Varsay\u0131lan olarak, ge\u00e7erlilik denetimi kapal\u0131d\u0131r.)]" },
            {
                    "optionEDUMP",
                    "[-EDUMP {iste\u011fe ba\u011fl\u0131 dosya ad\u0131} (Hata durumunda y\u0131\u011f\u0131n d\u00f6k\u00fcm\u00fc ger\u00e7ekle\u015ftirilir.)]" },
            ...
            { "noParsermsg4",
                    "Sisteminizde IBM XML Parser for Java arac\u0131 yoksa, \u015fu adresten y\u00fckleyebilirsiniz:" },
            { "noParsermsg5", "IBM's AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "[-URIRESOLVER tam s\u0131n\u0131f ad\u0131 (URI \u00e7\u00f6zmekte kullan\u0131lacak URIResolver)]" },
            {
                    "optionENTITYRESOLVER",
                    "[-ENTITYRESOLVER tam s\u0131n\u0131f ad\u0131 (Varl\u0131klar\u0131 \u00e7\u00f6zmekte kullan\u0131lacak EntityResolver)]" },
            {
                    "optionCONTENTHANDLER",
                    "[-CONTENTHANDLER tam s\u0131n\u0131f ad\u0131 (\u00c7\u0131k\u0131\u015f\u0131 diziselle\u015ftirmekte kullan\u0131lacak ContentHandler)]" },
            { "optionLINENUMBERS", "[-L kaynak belge i\u00e7in sat\u0131r numaralar\u0131 kullan\u0131l\u0131r]" },
            { "optionSECUREPROCESSING",
                    "   [-SECURE (g\u00fcvenli i\u015fleme \u00f6zelli\u011fi true de\u011ferine ayarlan\u0131r.)]" },
            ...
            {
                    "optionMEDIA",
                    "   [-MEDIA mediaType (Ortam \u00f6zniteli\u011fi, bir belgeyle ili\u015fkili bi\u00e7em yapra\u011f\u0131n\u0131 bulmak i\u00e7in kullan\u0131l\u0131r.)]" },
            {
                    "optionFLAVOR",
                    "   [-FLAVOR flavorName (D\u00f6n\u00fc\u015ft\u00fcrmeyi ger\u00e7ekle\u015ftirmek i\u00e7in belirtik olarak s2s=SAX ya da d2d=DOM kullan\u0131l\u0131r.)] " }, // Added
                                                                                                                                                                                     // by
                                                                                                                                                                                     // sboag/scurcuru;
                                                                                                                                                                                     // experimental
            {
                    "optionDIAG",
                    "   [-DIAG (D\u00f6n\u00fc\u015ft\u00fcrmenin ka\u00e7 milisaniye s\u00fcrd\u00fc\u011f\u00fcn\u00fc yazd\u0131r\u0131r.)]" },
            {
                    "optionINCREMENTAL",
                    "  [-INCREMENTAL (http://xml.apache.org/xalan/features/incremental true tan\u0131mlayarak art\u0131msal DTM olu\u015fturulmas\u0131 istenir.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (http://xml.apache.org/xalan/features/optimize false tan\u0131mlayarak bi\u00e7em yapra\u011f\u0131 eniyileme i\u015flemi olmamas\u0131 istenir.)]" },
            {
                    "optionRL",
                    "   [-RL recursionlimit (Bi\u00e7em yapra\u011f\u0131 \u00f6zyineleme derinli\u011fine say\u0131sal s\u0131n\u0131r koyar.)]" },
            {
                    "optionXO",
                    "[-XO [derleme sonucu s\u0131n\u0131f dosyas\u0131 ad\u0131] (Olu\u015fturulan s\u0131n\u0131f dosyas\u0131na bu ad\u0131 atar.)]" },
            { "optionXD",
                    "[-XD destinationDirectory (Derleme sonucu s\u0131n\u0131f dosyas\u0131 i\u00e7in hedef dizin belirtir.)]" },
            { "optionXJ",
                    "[-XJ jardsy (Derleme sonucu \u00fcretilen s\u0131n\u0131flar\u0131 <jardsy> adl\u0131 jar dosyas\u0131nda paketler.)]" },
            {
                    "optionXP",
                    "[-XP paket (Derleme sonucunda \u00fcretilen t\u00fcm s\u0131n\u0131flar i\u00e7in bir paket ad\u0131 \u00f6neki belirtir.)]" },
            ...
            {
                    "optionXT",
                    "[-XT (Yap\u0131labiliyorsa, d\u00f6n\u00fc\u015ft\u00fcrme i\u00e7in derleme sonucu s\u0131n\u0131f dosyas\u0131n\u0131 kullan\u0131r.)]" },
            { "diagTiming", "--------- {1} ile {0} d\u00f6n\u00fc\u015ft\u00fcrme i\u015flemi {2} ms s\u00fcrd\u00fc" },
            {
                    "recursionTooDeep",
                    "\u015eablon i\u00e7i\u00e7e kullan\u0131m derinli\u011fi \u00e7ok fazla. \u0130\u00e7i\u00e7e kullan\u0131m = {0}, \u015fablon {1} {2}" },
            { "nameIs", "ad\u0131" }, { "matchPatternIs", "e\u015fle\u015fme \u00f6r\u00fcnt\u00fcs\u00fc" }
