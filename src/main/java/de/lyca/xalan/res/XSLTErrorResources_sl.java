...
public class XSLTErrorResources_sl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Napaka: Izraz ne sme vsebovati '{'" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} vsebuje neveljaven atribut: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode je NULL v xsl:apply-imports!" },

            { ER_CANNOT_ADD, "Ne morem dodati {0} k {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode je NULL v handleApplyTemplatesInstruction!" },

            { ER_NO_NAME_ATTRIB, "{0} mora vsebovati atribut imena." },

            { ER_TEMPLATE_NOT_FOUND, "Nisem na\u0161em predloge z imenom: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "Imena AVT v xsl:call-template ni bilo mogo\u010de razre\u0161iti." },

            { ER_REQUIRES_ATTRIB, "{0} zahteva atribut: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} mora imeti atribut ''test''." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Slaba vrednost pri atributu stopnje: {0}" },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "Ime navodila za obdelavo ne more biti 'xml'" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME, "Ime navodila za obdelavo mora biti veljavno NCIme: {0}" },

            { ER_NEED_MATCH_ATTRIB, "{0} mora vsebovati primerjalni atribut, \u010de vsebuje vozli\u0161\u010de." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} zahteva atribut imena ali primerjalni atribut." },

            { ER_CANT_RESOLVE_NSPREFIX, "Predpone imenskega prostora ni mogo\u010de razre\u0161iti: {0}" },

            { ER_ILLEGAL_VALUE, "xml:space vsebuje neveljavno vrednost: {0}" },

            { ER_NO_OWNERDOC, "Podrejeno vozli\u0161\u010de ne vsebuje lastni\u0161kega dokumenta!" },

            { ER_ELEMTEMPLATEELEM_ERR, "Napaka ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Poskus dodajanja podrejenega elementa z vrednostjo NULL!" },

            { ER_NEED_SELECT_ATTRIB, "{0} zahteva atribut izbire." },

            { ER_NEED_TEST_ATTRIB, "xsl:when mora vsebovati atribut 'test'." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param mora vsebovati atribut 'ime'." },

            { ER_NO_CONTEXT_OWNERDOC, "Kontekst ne vsebuje lastni\u0161kega dokumenta!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "Ne morem ustvariti zveze XML TransformerFactory: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: postopek ni uspel." },

            { ER_NOT_SUCCESSFUL, "Xalan: ni uspel." },

            { ER_ENCODING_NOT_SUPPORTED, "Kodiranje ni podprto: {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "Ne morem ustvariti javanskega razreda TraceListener: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key zahteva atribut 'ime'!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key zahteva atribut 'ujemanje'!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key zahteva atribut 'uporaba'!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} zahteva atribut ''elementi''!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0} manjka atribut ''predpona''" },

            { ER_BAD_STYLESHEET_URL, "URL slogovne datoteke je neveljaven: {0}" },

            { ER_FILE_NOT_FOUND, "Slogovne datoteke ni bilo mogo\u010de najti: {0}" },

            { ER_IOEXCEPTION, "Pri slogovni datoteki je pri\u0161lo do izjeme IO: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Atributa href za {0} ni bilo mogo\u010de najti" },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) {0} neposredno ali posredno vklju\u010duje samega sebe!" },

            { ER_PROCESSINCLUDE_ERROR, "Napaka StylesheetHandler.processInclude, {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) {0} manjka atribut ''lang'' " },
            ...
            { ER_PROCESS_ERROR, "Napaka StylesheetRoot.process" },

            { ER_UNIMPLNODE_ERROR, "Napaka UnImplNode: {0}" },

            { ER_NO_SELECT_EXPRESSION, "Napaka! Ne najdem izbirnega izraza xpath (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "Ne morem serializirati XSLProcessor!" },

            { ER_NO_INPUT_STYLESHEET, "Vnos slogovne datoteke ni dolo\u010den!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Obdelava slogovne datoteke ni uspela!" },

            { ER_COULDNT_PARSE_DOC, "Dokumenta {0} ni mogo\u010de raz\u010dleniti!" },

            { ER_COULDNT_FIND_FRAGMENT, "Ne najdem fragmenta: {0}" },

            { ER_NODE_NOT_ELEMENT, "Vozli\u0161\u010de, na katerega ka\u017ee identifikator fragmenta, ni element: {0}" },

            { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "vsak mora vsebovati primerjalni atribut ali atribut imena" },

            { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB, "predloge morajo imeti primerjalni atribut ali atribut imena" },

            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Ni klona fragmenta dokumenta!" },

            { ER_CANT_CREATE_ITEM, "Ne morem ustvariti elementa v drevesu rezultatov: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space v izvirnem XML ima neveljavno vrednost: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "Ni deklaracije xsl:key za {0}!" },

            { ER_CANT_CREATE_URL, "Napaka! Ne morem ustvariti URL za: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions niso podprte" },

            { ER_PROCESSOR_ERROR, "Napaka XSLT TransformerFactory" },

            { ER_NOT_ALLOWED_INSIDE_STYLESHEET, "(StylesheetHandler) {0} ni dovoljen znotraj slogovne datoteke!" },

            { ER_RESULTNS_NOT_SUPPORTED, "result-ns ni ve\u010d podprt!  Namesto njega uporabite xsl:output." },

            { ER_DEFAULTSPACE_NOT_SUPPORTED,
                    "default-space ni ve\u010d podprt!  Namesto njega uporabite xsl:strip-space ali xsl:preserve-space." },

            { ER_INDENTRESULT_NOT_SUPPORTED, "indent-result ni ve\u010d podprt!  Namesto njega uporabite xsl:output." },

            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} ima neveljaven atribut: {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Neznani element XSL: {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) xsl:sort lahko uporabljamo samo z xsl:apply-templates ali z xsl:for-each." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) napa\u010dna postavitev xsl:when!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:choose ni nadrejen xsl:when!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) napa\u010dna postavitev xsl:otherwise!" },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:choose ni nadrejen xsl:otherwise!" },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} ni dovoljen znotraj predloge!" },

            { ER_UNKNOWN_EXT_NS_PREFIX, "(StylesheetHandler) Neznana {0} kon\u010dnica predpone imenskega prostora {1}" },

            { ER_IMPORTS_AS_FIRST_ELEM,
                    "(StylesheetHandler) Uvozi se lahko pojavijo samo kot prvi elementi v slogovni datoteki!" },

            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} neposredno ali posredno uva\u017ea samega sebe!" },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space vsebuje neveljavno vrednost: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet ni uspelo!" },

            { ER_SAX_EXCEPTION, "Izjema SAX" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "Funkcija ni podprta!" },

            { ER_XSLT_ERROR, "Napaka XSLT" },

            { ER_CURRENCY_SIGN_ILLEGAL, "V oblikovnem nizu vzorca znak za denarno enoto ni dovoljen" },

            { ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM, "Funkcija dokumenta v slogovni datoteki DOM ni podprta!" },
            ...
            { ER_MISSING_NS_URI, "Za navedeno predpono manjka imenski prostor URI" },

            { ER_MISSING_ARG_FOR_OPTION, "Manjka argument za mo\u017enost: {0}" },

            { ER_INVALID_OPTION, "Neveljavna mo\u017enost: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Po\u0161kodovan niz sloga: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet zahteva atribut 'razli\u010dica'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Atribut: {0} ima neveljavno vrednost: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose zahteva xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports v xsl:for-each ni dovoljen" },

            { ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Za izhodno vozli\u0161\u010de DOM ne morem uporabiti DTMLiaison... namesto njega posredujte de.lyca.xpath.DOM2Helper!" },

            { ER_CANT_USE_DTM_FOR_INPUT,
                    "Za vhodno vozli\u0161\u010de DOM ne morem uporabiti DTMLiaison... namesto njega posredujte de.lyca.xpath.DOM2Helper!" },

            { ER_CALL_TO_EXT_FAILED, "Klic elementa kon\u010dnice ni uspel: {0}" },

            { ER_PREFIX_MUST_RESOLVE, "Predpona se mora razre\u0161iti v imenski prostor: {0}" },

            { ER_INVALID_UTF16_SURROGATE, "Zaznan neveljaven nadomestek UTF-16: {0} ?" },

            { ER_XSLATTRSET_USED_ITSELF,
                    "xsl:attribute-set {0} je uporabil samega sebe, kar bo povzro\u010dilo neskon\u010do ponavljanje." },

            { ER_CANNOT_MIX_XERCESDOM, "Prepletanje ne-Xerces-DOM vhoda s Xerces-DOM vhodom ni mogo\u010de!" },

            { ER_TOO_MANY_LISTENERS, "addTraceListenersToStylesheet - TooManyListenersException" },

            { ER_IN_ELEMTEMPLATEELEM_READOBJECT, "V ElemTemplateElement.readObject: {0}" },

            { ER_DUPLICATE_NAMED_TEMPLATE, "Na\u0161el ve\u010d predlog z istim imenom: {0}" },

            { ER_INVALID_KEY_CALL, "Neveljaven klic funkcije: povratni klici key() niso dovoljeni" },

            { ER_REFERENCING_ITSELF, "Spremenljivka {0} se neposredno ali posredno sklicuje sama nase!" },

            { ER_ILLEGAL_DOMSOURCE_INPUT, "Vhodno vozli\u0161\u010de za DOMSource za newTemplates ne more biti NULL!" },

            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Datoteke razreda za mo\u017enost {0} ni bilo mogo\u010de najti" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Zahtevanega elementa ni bilo mogo\u010de najti: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream ne more biti NULL" },

            { ER_URI_CANNOT_BE_NULL, "URI ne more biti NULL" },

            { ER_FILE_CANNOT_BE_NULL, "Datoteka ne more biti NULL" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource ne more biti NULL" },

            { ER_CANNOT_INIT_BSFMGR, "Inicializacija BSF Manager-ja ni mogo\u010da" },

            { ER_CANNOT_CMPL_EXTENSN, "Kon\u010dnice ni mogo\u010de prevesti" },

            { ER_CANNOT_CREATE_EXTENSN, "Ne morem ustvariti kon\u010dnice: {0} zaradi: {1}" },

            { ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "Klic primerkov metode za metodo {0} zahteva primerek objekta kot prvi argument" },

            { ER_INVALID_ELEMENT_NAME, "Navedeno neveljavno ime elementa {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "Metoda imena elementa mora biti stati\u010dna (static) {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Funkcija kon\u010dnice {0} : {1} je neznana" },

            { ER_MORE_MATCH_CONSTRUCTOR, "Ve\u010d kot eno najbolj\u0161e ujemanje za graditelja za {0}" },

            { ER_MORE_MATCH_METHOD, "Ve\u010d kot eno najbolj\u0161e ujemanje za metodo {0}" },

            { ER_MORE_MATCH_ELEMENT, "Ve\u010d kot eno najbolj\u0161e ujemanje za metodo elementa {0}" },

            { ER_INVALID_CONTEXT_PASSED, "Posredovan neveljaven kontekst za ovrednotenje {0}" },

            { ER_POOL_EXISTS, "Zaloga \u017ee obstaja" },

            { ER_NO_DRIVER_NAME, "Ime gonilnika ni dolo\u010deno" },

            { ER_NO_URL, "URL ni dolo\u010den" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Zaloga je manj\u0161a od ena!" },

            { ER_INVALID_DRIVER, "Navedeno neveljavno ime gonilnika!" },

            { ER_NO_STYLESHEETROOT, "Korena slogovne datoteke ni mogo\u010de najti!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Neveljavna vrednost za xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "processFromNode spodletelo" },

            { ER_RESOURCE_COULD_NOT_LOAD, "Sredstva [ {0} ] ni bilo mogo\u010de nalo\u017eiti: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Velikost medpomnilnika <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Neznana napaka pri klicu kon\u010dnice" },

            { ER_NO_NAMESPACE_DECL, "Predpona {0} nima ustrezne deklaracije imenskega prostora" },

            { ER_ELEM_CONTENT_NOT_ALLOWED, "Vsebina elementa za lang=javaclass {0} ni dovoljena" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Prekinitev usmerja slogovna datoteka" },

            { ER_ONE_OR_TWO, "1 ali 2" },

            { ER_TWO_OR_THREE, "2 ali 3" },

            { ER_COULD_NOT_LOAD_RESOURCE,
                    "Nisem mogel nalo\u017eiti {0} (preverite CLASSPATH), trenutno se uporabljajo privzete vrednosti" },

            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Ne morem inicializirati privzetih predlog" },

            { ER_RESULT_NULL, "Rezultat naj ne bi bil NULL" },

            { ER_RESULT_COULD_NOT_BE_SET, "Rezultata ni bilo mogo\u010de nastaviti" },

            { ER_NO_OUTPUT_SPECIFIED, "Izhod ni naveden" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Ne morem pretvoriti v rezultat tipa {0}" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "Ne morem pretvoriti vira tipa {0}" },

            { ER_NULL_CONTENT_HANDLER, "Program za obravnavo vsebine NULL" },

            { ER_NULL_ERROR_HANDLER, "Program za obravnavo napak NULL" },

            { ER_CANNOT_CALL_PARSE, "klic raz\u010dlenitve ni mo\u017een \u010de ContentHandler ni bil nastavljen" },

            { ER_NO_PARENT_FOR_FILTER, "Ni nadrejenega za filter" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Ni mogo\u010de najti slogovne datoteke v: {0}, medij= {1}" },

            { ER_NO_STYLESHEET_PI, "Ne najdem xml-stylesheet PI v: {0}" },

            { ER_NOT_SUPPORTED, "Ni podprto: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "Vrednost lastnosti {0} bi morala biti ponovitev logi\u010dne vrednosti" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Ne morem dostopati do zunanje skripte na {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "Vira [ {0} ] ni mogo\u010de najti.\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "Izhodna lastnost ni prepoznana: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Priprava primerka ElemLiteralResult ni uspela" },

            // Earlier (JDK 1.4 XALAN 2.2-D11) at key code '204' the key name
            // was ER_PRIORITY_NOT_PARSABLE
            // In latest Xalan code base key name is ER_VALUE_SHOULD_BE_NUMBER.
            // This should also be taken care
            ...
            { ER_VALUE_SHOULD_EQUAL, "Vrednost za {0} bi morala biti enaka da ali ne" },

            { ER_FAILED_CALLING_METHOD, "Klic metode {0} ni uspel" },

            { ER_FAILED_CREATING_ELEMTMPL, "Priprava primerka ElemTemplateElement ni uspela" },

            { ER_CHARS_NOT_ALLOWED, "V tem trenutku znaki v dokumentu niso na voljo" },

            { ER_ATTR_NOT_ALLOWED, "Atribut \"{0}\" v elementu {1} ni dovoljen!" },

            { ER_BAD_VALUE, "{0} slaba vrednost {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "Vrednosti atributa {0} ni bilo mogo\u010de najti " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Vrednosti atributa {0} ni bilo mogo\u010de prepoznati " },

            { ER_NULL_URI_NAMESPACE, "Posku\u0161am generirati predpono imenskega prostora z URI z vrednostjo NULL" },

            // New ERROR keys added in XALAN code base after Jdk 1.4 (Xalan
            // 2.2-D11)

            { ER_NUMBER_TOO_BIG,
                    "Poskus oblikovanja \u0161tevilke, ve\u010dje od najve\u010djega dolgega celega \u0161tevila" },

            { ER_CANNOT_FIND_SAX1_DRIVER, "Ne najdem razreda gonilnika SAX1 {0}" },

            { ER_SAX1_DRIVER_NOT_LOADED, "Na\u0161el razred gonilnika SAX1 {0}, vendar ga ne morem nalo\u017eiti" },

            { ER_SAX1_DRIVER_NOT_INSTANTIATED, "Nalo\u017eil razred gonilnika SAX1 {0}, vendar ga ne morem udejaniti" },

            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "Razred gonilnika SAX1 {0} ne vklju\u010duje org.xml.sax.Parser" },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Sistemska lastnost org.xml.sax.parser ni dolo\u010dena" },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Argument raz\u010dlenjevalnika sme biti NULL" },

            { ER_FEATURE, "Zna\u010dilnost: {0}" },

            { ER_PROPERTY, "Lastnost: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Razre\u0161evalnik entitet NULL" },

            { ER_NULL_DTD_HANDLER, "Program za obravnavanje DTD z vrednostjo NULL" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Ime gonilnika ni dolo\u010deno!" },

            { ER_NO_URL_SPECIFIED, "URL ni dolo\u010den!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "Zaloga je manj\u0161a od 1!" },

            { ER_INVALID_DRIVER_NAME, "Dolo\u010deno neveljavno ime gonilnika!" },

            { ER_ERRORLISTENER, "ErrorListener" },

            // Note to translators: The following message should not normally be
            // displayed
            // to users. It describes a situation in which the processor has
            // detected
            // an internal consistency problem in itself, and it provides this
            // message
            // for the developer to help diagnose the problem. The name
            // 'ElemTemplateElement' is the name of a class, and should not be
            // translated.
            { ER_ASSERT_NO_TEMPLATE_PARENT, "Programerjeva napaka! Izraz nima nadrejenega ElemTemplateElement!" },
            ...
            // an internal consistency problem in itself, and it provides this
            // message
            // for the developer to help diagnose the problem. The substitution
            // text
            // provides further information in order to diagnose the problem.
            // The name
            // 'RedundentExprEliminator' is the name of a class, and should not
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Programerjeva izjava v RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "Na tem polo\u017eaju v slogovni datoteki {0} ni dovoljen!" },
            ...
            // Note to translators: The following message is used if the value
            // of
            ...
            { INVALID_QNAME, "Neveljavna vrednost: {1} uporabljena za atribut QNAME: {0}" },
            ...
            // the attribute, and should not be translated. The substitution
            // text {1} is
            // the attribute value, {0} is the attribute name, and {2} is a list
            // of valid
            // values.
            { INVALID_ENUM, "Neveljavna vrednost: {1} uporabljena za atribut ENUM: {0}.  Veljavne vrednosti so: {2}." },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Neveljavna vrednost: {1} uporabljena za atribut NMTOKEN: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Neveljavna vrednost: {1} uporabljena za atribut NCNAME: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Neveljavna vrednost: {1} uporabljena za atribut boolean: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Neveljavna vrednost: {1} uporabljena za atribut number: {0} " },

            // End of shared codes...

            // Note to translators: A "match pattern" is a special form of XPath
            // expression
            // that is used for matching patterns. The substitution text is the
            // name of
            ...
            { ER_ARG_LITERAL, "Argument za {0} v primerjalnem vzorcu mora biti dobesedni niz." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Dvojnik deklaracije globalne spremenljivke." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Dvojnik deklaracije spremenljivke." },

            // Note to translators: "xsl:template, "name" and "match" are XSLT
            // keywords
            // which must not be translated.
            // ER_TEMPLATE_NAME_MATCH - new error message for bugzilla #789
            { ER_TEMPLATE_NAME_MATCH, "xsl:template mora vsebovati atribut name ali match (ali oba)" },
            ...
            // Note to translators: An "attribute set" is a set of attributes
            // that can
            // be added to an element in the output document as a group. The
            // message
            // indicates that there was a reference to an attribute set named
            // {0} that
            // was never defined.
            // ER_NO_ATTRIB_SET - new error message for bugzilla #782
            { ER_NO_ATTRIB_SET, "Nabor atributov, imenovana {0}, ne obstaja" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "Funkcija, imenovana {0}, ne obstaja" },

            // Note to translators: This message indicates that the XSLT
            // instruction
            // that is named by the substitution text {0} must not contain other
            // XSLT
            // instructions (content) or a "select" attribute. The word "select"
            // is
            // an XSLT keyword in this case and must not be translated.
            { ER_CANT_HAVE_CONTENT_AND_SELECT, "Element {0} ne sme imeti vsebine in atributa izbire hkrati." },

            // Note to translators: This message indicates that the value
            // argument
            // of setParameter must be a valid Java Object.
            { ER_INVALID_SET_PARAM_VALUE, "Vrednost parametra {0} mora biti veljaven javanski objekt" },
            ...
            { ER_GET_FEATURE_NULL_NAME, "Ime funkcije ne sme biti null v TransformerFactory.getFeature(Ime niza)." },

            { ER_UNSUPPORTED_FEATURE, "Ni mogo\u010de nastaviti funkcije ''{0}'' v tem TransformerFactory." },

            { ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
                    "Uporaba raz\u0161iritvene elementa ''{0}'' ni na voljo, ko je funkcija varnega procesiranja nastavljena na true." },

            { ER_NAMESPACE_CONTEXT_NULL_NAMESPACE, "Ni mogo\u010de dobiti predpone za URI imenskega prostora null." },

            { ER_NAMESPACE_CONTEXT_NULL_PREFIX, "Ni mogo\u010de dobiti URI-ja imenskega prostora za predpono null." },

            { ER_XPATH_RESOLVER_NULL_QNAME, "Ime funkcije ne more biti ni\u010d." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "\u0160tevilo argumentov ne more biti negativno" },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "Najden '}' vendar ni odprtih predlog atributov!" },

            { WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR,
                    "Opozorilo: \u0161tevni atribut ni skladen s prednikom v xsl:number! Cilj = {0}" },

            { WG_EXPR_ATTRIB_CHANGED_TO_SELECT, "Stara sintaksa: Ime atributa 'izraz' je bilo spremenjeno v 'izbira'." },

            { WG_NO_LOCALE_IN_FORMATNUMBER,
                    "Xalan \u0161e ne podpira podro\u010dnih imen v funkciji za oblikovanje \u0161tevilk." },

            { WG_LOCALE_NOT_FOUND, "Opozorilo: ne najdem podro\u010dnih nastavitev za xml:lang={0}" },

            { WG_CANNOT_MAKE_URL_FROM, "Iz {0} ni mogo\u010de narediti naslova URL." },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "Ne morem nalo\u017eiti zahtevanega dokumenta: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "Ne najdem kolacionista (collator) za <sort xml:lang={0}" },

            { WG_FUNCTIONS_SHOULD_USE_URL, "Stara sintaksa: navodilo za funkcije bi moralo uporabljati URL {0}" },

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "Kodiranje ni podprto: {0}, uporabljen bo UTF-8" },

            { WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "kodiranje ni podprto: {0}, uporabljena bo Java {1}" },

            { WG_SPECIFICITY_CONFLICTS,
                    "Spori pri specifi\u010dnosti: uporabljen bo zadnji najdeni {0} v slogovni datoteki." },

            { WG_PARSING_AND_PREPARING, "========= Poteka raz\u010dlenjevanje in priprava {0} ==========" },

            { WG_ATTR_TEMPLATE, "Predloga atributa, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "Spor ujemanja med xsl:strip-space in xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan \u0161e ne podpira atributa {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "Deklaracije za decimalno obliko ni bilo mogo\u010de najti: {0}" },

            { WG_OLD_XSLT_NS, "Manjkajo\u010d ali nepravilen imenski prostor XSLT. " },

            { WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED, "Dovoljena je samo ena privzeta deklaracija xsl:decimal-format." },

            { WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE,
                    "Imena xsl:decimal-format morajo biti enoli\u010dna. Ime \"{0}\" je bilo podvojeno." },

            { WG_ILLEGAL_ATTRIBUTE, "{0} vsebuje neveljaven atribut: {1}" },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "Ne morem razre\u0161iti predpone imenskega prostora: {0}. Vozli\u0161\u010de bo prezrto." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet zahteva atribut 'razli\u010dica'!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Neveljavno ime atributa: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Uporabljena neveljavna vrednost za atribut {0}: {1}" },

            {
                    WG_EMPTY_SECOND_ARG,
                    "Posledi\u010dna skupina vozli\u0161\u010d iz drugega argumenta funkcije dokumenta je prazna. Posredujte prazno skupino vozli\u0161\u010d." },

            // Following are the new WARNING keys added in XALAN code base after
            // Jdk 1.4 (Xalan 2.2-D11)
            ...
            // attribute in a
            // place other than on an element. The substitution text specifies
            // the name of
            // the attribute.
            { WG_ILLEGAL_ATTRIBUTE_POSITION,
                    "Atributa {0} ne morem dodati za podrejenimi vozli\u0161\u010di ali pred izdelavo elementa.  Atribut bo prezrt." },

            { NO_MODIFICATION_ALLOWED_ERR, "Izveden je poskus spremembe objekta tam, kjer spremembe niso dovoljene." },
            ...
            // information
            // for the Xalan Process command line. "Process" is the name of a
            // Java class,
            ...
            {
                    "xslProc_no_input",
                    "Napaka: ni dolo\u010dene slogovne datoteke ali vhodnega xml. Po\u017eenite ta ukaz, za katerega ni na voljo napotkov za uporabo." },
            ...
            // Note to translators: The option name and the parameter name do
            // not need to
            // be translated. Only translate the messages in parentheses. Note
            // also that
            ...
            {
                    "optionVALIDATE",
                    "   [-VALIDATE (Nastavi v primeru preverjanja veljavnosti.  Privzeta vrednost za preverjanje veljavnosti je izklopljeno.)]" },
            ...
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER polno ime razreda (EntityResolver za razre\u0161evanje entitet)]" },
            ...
            // XSLTErrorResources.properties files after Jdk 1.4 (Xalan 2.2-D11)

            { "optionMEDIA",
                    "   [-MEDIA TipMedija (z atributom medija poi\u0161\u010dite slogovno datoteko, ki se nana\u0161a na dokument.)]" },
            { "optionFLAVOR",
                    "   [-FLAVOR ImePosebnosti (Za preoblikovanje izrecno uporabljajte s2s=SAX ali d2d=DOM.)] " }, // Added
                                                                                                                   // by
                                                                                                                   // sboag/scurcuru;
                                                                                                                   // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (zahtevajte gradnjo prirastnega DTM tako, da nastavite http://xml.apache.org/xalan/features/incremental na resni\u010dno.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (prepre\u010dite obdelavo optimiziranja slogovne datoteke, tako da nastavite http://xml.apache.org/xalan/features/optimize na false.)]" },
            { "optionRL",
                    "   [-RL mejaRekurzije (zahtevajte numeri\u010dno mejo globine rekurzije slogovne datoteke.)]" },
            ...
            // particular
            // command-line option that is used to enable the
            // "template inlining"
            ...
            { "nameIs", "ime je" }, { "matchPatternIs", "primerjalni vzorec je" }
