...
public class XSLTErrorResources_cs extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Chyba: Ve v\u00fdrazu nelze pou\u017e\u00edt znak '{'" },

            { ER_ILLEGAL_ATTRIBUTE, "{0} m\u00e1 neplatn\u00fd atribut: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "Funkce sourceNode m\u00e1 v prvku xsl:apply-imports hodnotu null!" },

            { ER_CANNOT_ADD, "Nelze p\u0159idat {0} do {1}" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES,
                    "Funkce sourceNode m\u00e1 v instrukci handleApplyTemplatesInstruction hodnotu null!" },

            { ER_NO_NAME_ATTRIB, "{0} mus\u00ed m\u00edt jmenn\u00fd atribut" },

            { ER_TEMPLATE_NOT_FOUND, "Nelze nal\u00e9zt \u0161ablonu s n\u00e1zvem: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "Nelze nal\u00e9zt n\u00e1zev AVT v \u0161ablon\u011b xsl:call-template." },

            { ER_REQUIRES_ATTRIB, "{0} mus\u00ed m\u00edt atribut: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} mus\u00ed m\u00edt atribut ''test''. " },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Nespr\u00e1vn\u00e1 hodnota atributu \u00farovn\u011b: {0}" },
            ...
            { ER_NEED_MATCH_ATTRIB, "M\u00e1-li {0} re\u017eim, mus\u00ed m\u00edt vyhovuj\u00edc\u00ed atribut." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} vy\u017eaduje bu\u010f n\u00e1zev, nebo vyhovuj\u00edc\u00ed atribut." },

            { ER_CANT_RESOLVE_NSPREFIX, "Nelze p\u0159elo\u017eit p\u0159edponu oboru n\u00e1zv\u016f: {0}" },

            { ER_ILLEGAL_VALUE, "Nepovolen\u00e1 hodnota prvku xml:space: {0}" },

            { ER_NO_OWNERDOC, "Uzel potomka nem\u00e1 dokument vlastn\u00edka!" },

            { ER_ELEMTEMPLATEELEM_ERR, "Chyba funkce ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Pokus o p\u0159id\u00e1n\u00ed potomka s hodnotou null!" },

            { ER_NEED_SELECT_ATTRIB, "{0} vy\u017eaduje atribut select." },

            { ER_NEED_TEST_ATTRIB, "Prvek xsl:when mus\u00ed obsahovat atribut 'test'." },

            { ER_NEED_NAME_ATTRIB, "Prvek xsl:with-param mus\u00ed obsahovat atribut 'name'." },

            { ER_NO_CONTEXT_OWNERDOC, "Parametr context nem\u00e1 dokument vlastn\u00edka!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "Nelze vytvo\u0159it prvek XML TransformerFactory Liaison: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: Proces nebyl \u00fasp\u011b\u0161n\u00fd." },

            { ER_NOT_SUCCESSFUL, "Xalan: nebylo \u00fasp\u011b\u0161n\u00e9." },

            { ER_ENCODING_NOT_SUPPORTED, "K\u00f3dov\u00e1n\u00ed nen\u00ed podporov\u00e1no: {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "Nelze vytvo\u0159it TraceListener: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "Prvek xsl:key vy\u017eaduje atribut 'name'!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "Prvek xsl:key vy\u017eaduje atribut 'match'!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "Prvek xsl:key vy\u017eaduje atribut 'use'!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} vy\u017eaduje atribut ''elements''!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) chyb\u00ed atribut ''prefix'' objektu {0}" },

            { ER_BAD_STYLESHEET_URL, "Nespr\u00e1vn\u00e1 adresa URL p\u0159edlohy se styly: {0}" },

            { ER_FILE_NOT_FOUND, "Soubor p\u0159edlohy se styly nebyl nalezen: {0}" },

            { ER_IOEXCEPTION, "Soubor p\u0159edlohy se styly m\u00e1 v\u00fdjimku vstupu/v\u00fdstupu: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Pro {0} nelze naj\u00edt atribut href" },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) {0}: p\u0159\u00edmo nebo nep\u0159\u00edmo zahrnuje sebe sama!" },

            { ER_PROCESSINCLUDE_ERROR, "Chyba: StylesheetHandler.processInclude {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) chyb\u00ed atribut ''lang'' objektu {0}" },
            ...
            { ER_PROCESS_ERROR, "Chyba: StylesheetRoot.process" },

            { ER_UNIMPLNODE_ERROR, "Chyba: UnImplNode: {0}" },

            { ER_NO_SELECT_EXPRESSION, "Chyba! Nebyl nalezen v\u00fdraz v\u00fdb\u011bru xpath (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "Nelze serializovat XSLProcessor!" },

            { ER_NO_INPUT_STYLESHEET, "Nebyl zad\u00e1n vstup p\u0159edlohy se styly!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Nepoda\u0159ilo se zpracovat p\u0159edlohu se styly!" },

            { ER_COULDNT_PARSE_DOC, "Nelze analyzovat dokument {0}!" },

            { ER_COULDNT_FIND_FRAGMENT, "Nelze nal\u00e9zt fragment: {0}" },

            { ER_NODE_NOT_ELEMENT, "Uzel, na kter\u00fd odkazuje identifik\u00e1tor fragmentu, nen\u00ed prvek: {0}" },
            ...
            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "\u017d\u00e1dn\u00fd klon fragmentu dokumentu!" },

            { ER_CANT_CREATE_ITEM, "Ve stromu v\u00fdsledk\u016f nelze vytvo\u0159it polo\u017eku: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "Parametr xml:space ve zdrojov\u00e9m XML m\u00e1 neplatnou hodnotu: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "{0} nem\u00e1 deklarov\u00e1n \u017e\u00e1dn\u00fd parametr xsl:key!" },

            { ER_CANT_CREATE_URL, "Chyba! Nelze vytvo\u0159it url pro: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "Nepodporovan\u00e1 funkce xsl:functions" },

            { ER_PROCESSOR_ERROR, "Chyba: XSLT TransformerFactory" },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) {0} m\u00e1 neplatn\u00fd atribut: {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Nezn\u00e1m\u00fd prvek XSL: {0}" },

            { ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) Parametr xsl:sort lze pou\u017e\u00edt pouze s parametrem xsl:apply-templates nebo xsl:for-each." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) Nespr\u00e1vn\u011b um\u00edst\u011bn\u00fd prvek xsl:when!" },
            ...
            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} - nen\u00ed v r\u00e1mci \u0161ablony povoleno!" },
            ...
            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) Parametr xml:space m\u00e1 neplatnou hodnotu: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "Ne\u00fasp\u011b\u0161n\u00fd proces processStylesheet!" },

            { ER_SAX_EXCEPTION, "V\u00fdjimka SAX" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "Nepodporovan\u00e1 funkce!" },

            { ER_XSLT_ERROR, "Chyba XSLT" },

            { ER_CURRENCY_SIGN_ILLEGAL, "znak m\u011bny nen\u00ed v \u0159et\u011bzci vzorku form\u00e1tu povolen" },
            ...
            { ER_MISSING_NS_URI, "U zadan\u00e9 p\u0159edpony chyb\u00ed obor n\u00e1zv\u016f URI" },

            { ER_MISSING_ARG_FOR_OPTION, "Chyb\u011bj\u00edc\u00ed argument volby: {0}" },

            { ER_INVALID_OPTION, "Neplatn\u00e1 volba: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Vadn\u00fd form\u00e1tovac\u00ed \u0159et\u011bzec: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "Prvek xsl:stylesheet vy\u017eaduje atribut 'version'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Parametr Attribute: {0} m\u00e1 neplatnou hodnotu: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "Prvek xsl:choose vy\u017eaduje parametr xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "Parametr xsl:for-each nen\u00ed v xsl:apply-imports povolen" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Nelze pou\u017e\u00edt DTMLiaison u v\u00fdstupu uzlu DOM node... M\u00edsto toho pou\u017eijte de.lyca.xpath.DOM2Helper!" },

            { ER_CANT_USE_DTM_FOR_INPUT,
                    "Nelze pou\u017e\u00edt DTMLiaison u vstupu uzlu DOM node... M\u00edsto toho pou\u017eijte de.lyca.xpath.DOM2Helper!" },

            { ER_CALL_TO_EXT_FAILED, "Ne\u00fasp\u011b\u0161n\u00e9 vol\u00e1n\u00ed prvku p\u0159\u00edpony: {0}" },

            { ER_PREFIX_MUST_RESOLVE,
                    "P\u0159edponu mus\u00ed b\u00fdt mo\u017eno p\u0159elo\u017eit do oboru n\u00e1zv\u016f: {0}" },

            { ER_INVALID_UTF16_SURROGATE, "Byla zji\u0161t\u011bna neplatn\u00e1 n\u00e1hrada UTF-16: {0} ?" },

            {
                    ER_XSLATTRSET_USED_ITSELF,
                    "Prvek xsl:attribute-set {0} pou\u017e\u00edv\u00e1 s\u00e1m sebe, co\u017e zp\u016fsob\u00ed nekone\u010dnou smy\u010dku." },

            { ER_CANNOT_MIX_XERCESDOM, "Vstup Xerces-DOM nelze sm\u011b\u0161ovat s v\u00fdstupem Xerces-DOM!" },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "Nalezena v\u00edce ne\u017e jedna \u0161ablona s n\u00e1zvem: {0}" },
            ...
            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Nebyl nalezen soubor t\u0159\u00eddy pro volbu {0}" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Nebyl nalezen po\u017eadovan\u00fd prvek: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "Parametr InputStream nesm\u00ed m\u00edt hodnotu null" },

            { ER_URI_CANNOT_BE_NULL, "Parametr URI nesm\u00ed m\u00edt hodnotu null" },

            { ER_FILE_CANNOT_BE_NULL, "Parametr File nesm\u00ed m\u00edt hodnotu null" },

            { ER_SOURCE_CANNOT_BE_NULL, "Parametr InputSource nesm\u00ed m\u00edt hodnotu null" },

            { ER_CANNOT_INIT_BSFMGR, "Nelze inicializovat BSF Manager" },

            { ER_CANNOT_CMPL_EXTENSN, "P\u0159\u00edponu nelze kompilovat" },

            { ER_CANNOT_CREATE_EXTENSN, "Nelze vytvo\u0159it p\u0159\u00edponu: {0}, proto\u017ee: {1}" },

            { ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "Vol\u00e1n\u00ed metody {0} metodou Instance vy\u017eaduje jako prvn\u00ed argument instanci Object" },

            { ER_INVALID_ELEMENT_NAME, "Byl zad\u00e1n neplatn\u00fd n\u00e1zev prvku {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "N\u00e1zev metody prvku mus\u00ed b\u00fdt static {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Funkce v\u00fdjimky {0} : {1} je nezn\u00e1m\u00e1" },

            { ER_MORE_MATCH_CONSTRUCTOR, "Konstruktor {0} m\u00e1 v\u00edce nejlep\u0161\u00edch shod." },

            { ER_MORE_MATCH_METHOD, "Metoda {0} m\u00e1 v\u00edce nejlep\u0161\u00edch shod." },

            { ER_MORE_MATCH_ELEMENT, "Metoda prvku {0} m\u00e1 v\u00edce nejlep\u0161\u00edch shod." },

            { ER_INVALID_CONTEXT_PASSED, "Do vyhodnocen\u00ed byl p\u0159ed\u00e1n neplatn\u00fd kontext {0}." },

            { ER_POOL_EXISTS, "Spole\u010dn\u00e1 oblast ji\u017e existuje." },

            { ER_NO_DRIVER_NAME, "Nebylo zad\u00e1no \u017e\u00e1dn\u00e9 jm\u00e9no ovlada\u010de." },

            { ER_NO_URL, "Nebyla specifikov\u00e1na \u017e\u00e1dn\u00e1 adresa URL." },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Velikost spole\u010dn\u00e9 oblasti je men\u0161\u00ed ne\u017e jedna!" },

            { ER_INVALID_DRIVER, "Byl zad\u00e1n neplatn\u00fd n\u00e1zev ovlada\u010de!" },

            { ER_NO_STYLESHEETROOT, "Nebyl nalezen ko\u0159en p\u0159edlohy se styly!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Neplatn\u00e1 hodnota parametru xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "Selh\u00e1n\u00ed procesu processFromNode" },
            ...
            { ER_ELEM_CONTENT_NOT_ALLOWED, "Obsah prvku nen\u00ed povolen pro lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Ukon\u010den\u00ed sm\u011brovan\u00e9 na p\u0159edlohu se styly." },

            { ER_ONE_OR_TWO, "1 nebo 2" },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Nelze aktualizovat v\u00fdchoz\u00ed \u0161ablony." },

            { ER_RESULT_NULL, "V\u00fdsledek by nem\u011bl m\u00edt hodnotu null" },

            { ER_RESULT_COULD_NOT_BE_SET, "Nelze nastavit v\u00fdsledek" },

            { ER_NO_OUTPUT_SPECIFIED, "Nebyl ur\u010den \u017e\u00e1dn\u00fd v\u00fdstup" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Nelze prov\u00e9st p\u0159evod na v\u00fdsledek typu {0}" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "Nelze prov\u00e9st p\u0159evod zdroje typu {0}" },

            { ER_NULL_CONTENT_HANDLER, "Obslu\u017en\u00fd program obsahu hodnoty null" },

            { ER_NULL_ERROR_HANDLER, "Obslu\u017en\u00fd program pro zpracov\u00e1n\u00ed chyb hodnoty null" },

            { ER_CANNOT_CALL_PARSE,
                    "Nen\u00ed-li nastaven obslu\u017en\u00fd program ContentHandler, nelze volat analyz\u00e1tor." },

            { ER_NO_PARENT_FOR_FILTER, "Filtr nem\u00e1 rodi\u010de." },

            { ER_NO_STYLESHEET_IN_MEDIA, "Nebyla nalezena p\u0159edloha se styly v: {0}, m\u00e9dium= {1}" },

            { ER_NO_STYLESHEET_PI, "Nebyla nalezena p\u0159edloha se styly xml-stylesheet PI v: {0}" },

            { ER_NOT_SUPPORTED, "Nepodporov\u00e1no: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "Hodnota vlastnosti {0} by m\u011bla b\u00fdt booleovsk\u00e1 instance" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Z {0} nelze z\u00edskat extern\u00ed skript." },

            { ER_RESOURCE_COULD_NOT_FIND, "Nelze naj\u00edt zdroj [ {0} ].\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "Nezn\u00e1m\u00e1 vlastnost v\u00fdstupu: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Nepoda\u0159ilo se vytvo\u0159it instanci ElemLiteralResult" },
            ...
            { ER_VALUE_SHOULD_BE_NUMBER, "Hodnota pro {0} by m\u011bla obsahovat analyzovateln\u00e9 \u010d\u00edslo" },

            { ER_VALUE_SHOULD_EQUAL, "Hodnota {0} mus\u00ed b\u00fdt yes nebo no." },

            { ER_FAILED_CALLING_METHOD, "Vol\u00e1n\u00ed metody {0} selhalo." },

            { ER_FAILED_CREATING_ELEMTMPL, "Nepoda\u0159ilo se vytvo\u0159it instanci ElemTemplateElement." },

            { ER_CHARS_NOT_ALLOWED, "V t\u00e9to \u010d\u00e1sti dokumentu nejsou znaky povoleny." },

            { ER_ATTR_NOT_ALLOWED, "Atribut \"{0}\" nen\u00ed u prvku {1} povolen!" },

            { ER_BAD_VALUE, "{0}: nespr\u00e1vn\u00e1 hodnota {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "Atribut hodnoty ({0}) nebyl nalezen " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Atribut hodnoty ({0}) nebyl rozpozn\u00e1n " },

            { ER_NULL_URI_NAMESPACE, "Pokus o generov\u00e1n\u00ed oboru n\u00e1zv\u016f s URI s hodnotou null." },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "Nelze naj\u00edt t\u0159\u00eddu ovlada\u010de SAX1 {0}" },
            ...
            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Nebyla ur\u010dena vlastnost syst\u00e9mu org.xml.sax.parser." },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Argument analyz\u00e1toru nesm\u00ed m\u00edt hodnotu null." },

            { ER_FEATURE, "Funkce: {0}" },

            { ER_PROPERTY, "Vlastnost: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "\u0158e\u0161itel s hodnotou entity null" },

            { ER_NULL_DTD_HANDLER, "Obslu\u017en\u00fd program DTD s hodnotou null" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Nebyl zad\u00e1n n\u00e1zev ovlada\u010de!" },

            { ER_NO_URL_SPECIFIED, "Nebyla specifikov\u00e1na adresa URL!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "Velikost spole\u010dn\u00e9 oblasti je men\u0161\u00ed ne\u017e 1!" },

            { ER_INVALID_DRIVER_NAME, "Zad\u00e1n neplatn\u00fd n\u00e1zev ovlada\u010de!" },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Tvrzen\u00ed program\u00e1tora v RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "{0} - nen\u00ed povoleno v tomto stylu na dan\u00e9m m\u00edst\u011b!" },
            ...
            { INVALID_QNAME, "Neplatn\u00e1 hodnota: {1} pou\u017eito pro atribut QNAME: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Neplatn\u00e1 hodnota: {1} pou\u017eito pro atribut NMTOKEN: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Neplatn\u00e1 hodnota: {1} pou\u017eito pro atribut NCNAME: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Neplatn\u00e1 hodnota: {1} pou\u017eito pro booleovsk\u00fd atribut: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Neplatn\u00e1 hodnota: {1} pou\u017eito pro atribut \u010d\u00edsla: {0} " },
            ...
            { ER_ARG_LITERAL, "Argument pro {0} ve vyhovuj\u00edc\u00edm vzorku mus\u00ed b\u00fdt typu literal." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Duplicitn\u00ed deklarace glob\u00e1ln\u00ed prom\u011bnn\u00e9." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Duplicitn\u00ed deklarace prom\u011bnn\u00e9." },
            ...
            { ER_INVALID_PREFIX, "Neplatn\u00e1 p\u0159edpona ve funkci exclude-result-prefixes: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "sada atribut\u016f pojmenovan\u00e1 {0} neexistuje" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "Funkce se jm\u00e9nem {0} neexistuje." },
            ...
            { ER_UNSUPPORTED_FEATURE, "Nelze nastavit funkci ''{0}'' pro tuto t\u0159\u00eddu TransformerFactory. " },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "N\u00e1zev funkce nesm\u00ed m\u00edt hodnotu Null. " },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "Arita nesm\u00ed m\u00edt z\u00e1pornou hodnotu. " },
            ...
            { WG_CANNOT_LOAD_REQUESTED_DOC, "Po\u017eadovan\u00fd dokument nelze na\u010d\u00edst: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "Nelze naj\u00edt funkci Collator pro <sort xml:lang={0}" },
            ...
            { WG_PARSING_AND_PREPARING, "========= Anal\u00fdza a p\u0159\u00edprava {0} ==========" },

            { WG_ATTR_TEMPLATE, "\u0160ablona atribut\u016f, {0}" },

            { WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE,
                    "Konflikt souladu funkc\u00ed xsl:strip-space a xsl:preserve-space" },

            { WG_ATTRIB_NOT_HANDLED, "Xalan prozat\u00edm neobsluhuje atribut {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION,
                    "U desetinn\u00e9ho form\u00e1tu nebyla nalezena \u017e\u00e1dn\u00e1 deklarace: {0}" },

            { WG_OLD_XSLT_NS, "Chyb\u011bj\u00edc\u00ed nebo nespr\u00e1vn\u00fd obor n\u00e1zv\u016f XSLT. " },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} m\u00e1 neplatn\u00fd atribut: {1}" },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "Nelze p\u0159elo\u017eit p\u0159edponu oboru n\u00e1zv\u016f: {0}. Uzel bude ignorov\u00e1n." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "Prvek xsl:stylesheet vy\u017eaduje atribut 'version'!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Neplatn\u00fd n\u00e1zev atributu: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "V atributu {0} byla pou\u017eita neplatn\u00e1 hodnota: {1}" },
            ...
            { NO_MODIFICATION_ALLOWED_ERR, "Pokus o \u00fapravu objektu, u kter\u00e9ho nejsou \u00fapravy povoleny." },
            ...
            { "xslProc_option",
                    "P\u0159\u00edkazov\u00fd \u0159\u00e1dek Xalan-J: Zpracov\u00e1n\u00ed voleb t\u0159\u00eddy:" },
            { "xslProc_option",
                    "P\u0159\u00edkazov\u00fd \u0159\u00e1dek Xalan-J: Zpracov\u00e1n\u00ed voleb t\u0159\u00eddy\u003a" },
            ...
            {
                    "xslProc_no_input",
                    "Chyba: \u017d\u00e1dn\u00e1 p\u0159edloha stylu ani vstup xml nejsou ur\u010deny. K zobrazen\u00ed pokyn\u016f spus\u0165te tento p\u0159\u00edkaz bez jak\u00e9koliv volby." },
            ...
            { "optionPARSER",
                    "   [-PARSER pln\u011b kvalifikovan\u00fd n\u00e1zev t\u0159\u00eddy spojen\u00ed analyz\u00e1toru]" },
            ...
            {
                    "optionLF",
                    "   [-LF (ve v\u00fdstupu pou\u017e\u00edt pouze \u0159\u00e1dkov\u00e1n\u00ed - LF {v\u00fdchoz\u00ed nastaven\u00ed je CR/LF})]" },
            {
                    "optionCR",
                    "   [-CR (ve v\u00fdstupu pou\u017e\u00edt pouze znak nov\u00fd \u0159\u00e1dek - CR {v\u00fdchoz\u00ed nastaven\u00ed je CR/LF})]" },
            { "optionESCAPE",
                    "   [-ESCAPE (nastaven\u00ed znak\u016f escape sekvence {v\u00fdchoz\u00ed nastaven\u00ed je <>&\"\'\\r\\n}]" },
            { "optionINDENT",
                    "   [-INDENT (ovliv\u0148uje po\u010det znak\u016f odsazen\u00ed {v\u00fdchoz\u00ed nastaven\u00ed je 0})]" },
            ...
            { "optionVALIDATE",
                    "   [-VALIDATE (zap\u00edn\u00e1/vyp\u00edn\u00e1 validaci;  v\u00fdchoz\u00ed nastaven\u00ed je vypnuto)]" },
            { "optionEDUMP",
                    "   [-EDUMP {voliteln\u00fd n\u00e1zev souboru} (p\u0159i chyb\u011b vyp\u00ed\u0161e obsah z\u00e1sobn\u00edku)]" },
            { "optionXML",
                    "   [-XML (pou\u017eije program pro form\u00e1tov\u00e1n\u00ed XML a p\u0159id\u00e1 z\u00e1hlav\u00ed XML)]" },
            ...
            { "noParsermsg4",
                    "Nem\u00e1te-li analyz\u00e1tor XML jazyka Java spole\u010dnosti IBM, m\u016f\u017eete si jej st\u00e1hnout z adresy:" },
            { "noParsermsg5", "AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER cel\u00e9 jm\u00e9no t\u0159\u00eddy (pro p\u0159eklad URI pou\u017eije funkci URIResolver)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER cel\u00e9 jm\u00e9no t\u0159\u00eddy (pro p\u0159eklad entit pou\u017eije funkci EntityResolver)]" },
            {
                    "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER cel\u00e9 jm\u00e9no t\u0159\u00eddy (pro serializaci v\u00fdstupu pou\u017eije funkci ContentHandler)]" },
            { "optionLINENUMBERS",
                    "   [-L ve zdrojov\u00e9m dokumentu pou\u017eije \u010d\u00edsla \u0159\u00e1dk\u016f]" },
            ...
            {
                    "optionMEDIA",
                    "   [-MEDIA mediaType (k vyhled\u00e1n\u00ed p\u0159edlohy se styly p\u0159i\u0159azen\u00e9 dokumentu pou\u017eije atribut m\u00e9dia)]" },
            { "optionFLAVOR",
                    "   [-FLAVOR flavorName (p\u0159i transformaci se explicitn\u011b pou\u017eije s2s=SAX nebo d2d=DOM)] " }, // Added
                                                                                                                               // by
                                                                                                                               // sboag/scurcuru;
                                                                                                                               // experimental
            ...
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (vy\u017eaduje optimalizaci p\u0159edlohy se styly nastaven\u00edm hodnoty http://xml.apache.org/xalan/features/optimize na false)]" },
            { "optionRL",
                    "   [-RL recursionlimit (potvrd\u00ed \u010d\u00edseln\u00fd limit hloubky p\u0159edlohy se styly)]" },
            ...
            { "optionXJ",
                    "   [-XJ jarfile (zabal\u00ed t\u0159\u00eddy transletu do souboru jar s n\u00e1zvem <jarfile>)]" },
            {
                    "optionXP",
                    "   [-XP package (ur\u010d\u00ed p\u0159edponu n\u00e1zvu sady pro v\u0161echny generovan\u00e9 t\u0159\u00eddy transletu)]" },
            ...
            { "recursionTooDeep",
                    "Vno\u0159en\u00ed \u0161ablon je p\u0159\u00edli\u0161 hlubok\u00e9. Vno\u0159en\u00ed = {0}, \u0161ablona {1} {2}" },
            { "nameIs", "n\u00e1zev je" }, { "matchPatternIs", "vzorek shody je" }
