...
public class XSLTErrorResources_hu extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Hiba: Nem lehet '{' a kifejez\u00e9seken bel\u00fcl" },

            { ER_ILLEGAL_ATTRIBUTE, "A(z) {0}-nak \u00e9rv\u00e9nytelen attrib\u00fatuma van: {1}" },

            { ER_NULL_SOURCENODE_APPLYIMPORTS,
                    "A sourceNode \u00e9rt\u00e9ke null az xsl:apply-imports met\u00f3dusban." },

            { ER_CANNOT_ADD, "Nem lehet a(z) {0}-t felvenni a(z) {1}-ba" },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "A sourceNode null a handleApplyTemplatesInstruction-ban!" },

            { ER_NO_NAME_ATTRIB, "A(z) {0}-nak kell legyen name attrib\u00fatuma." },

            { ER_TEMPLATE_NOT_FOUND, "Nem tal\u00e1lhat\u00f3 {0} nev\u0171 sablon" },

            { ER_CANT_RESOLVE_NAME_AVT, "Nem lehet feloldani a n\u00e9v AVT-t az xsl:call-template-ben." },

            { ER_REQUIRES_ATTRIB, "{0}-nek attrib\u00fatum sz\u00fcks\u00e9ges: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "A(z) {0} -nak kell legyen ''test'' attrib\u00fatuma. " },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Rossz \u00e9rt\u00e9k a level attrib\u00fatumban: {0}" },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "A feldolgoz\u00e1si utas\u00edt\u00e1s neve nem lehet 'xml'" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
                    "A feldolgoz\u00e1si utas\u00edt\u00e1s neve \u00e9rv\u00e9nyes NCName kell legyen: {0}" },

            { ER_NEED_MATCH_ATTRIB, "A(z) {0}-nek kell legyen illeszked\u00e9si attrib\u00fatuma, ha van m\u00f3dja." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "A(z) {0}-nak kell vagy n\u00e9v vagy illeszked\u00e9si attrib\u00fatum." },

            { ER_CANT_RESOLVE_NSPREFIX, "Nem lehet feloldani a n\u00e9vt\u00e9r el\u0151tagot: {0}" },

            { ER_ILLEGAL_VALUE, "Az xml:space \u00e9rt\u00e9ke \u00e9rv\u00e9nytelen: {0}" },

            { ER_NO_OWNERDOC, "A lesz\u00e1rmazott csom\u00f3pontnak nincs tulajdonos dokumentuma!" },

            { ER_ELEMTEMPLATEELEM_ERR, "ElemTemplateElement hiba: {0}" },

            { ER_NULL_CHILD, "K\u00eds\u00e9rlet null lesz\u00e1rmazott felv\u00e9tel\u00e9re!" },

            { ER_NEED_SELECT_ATTRIB, "A(z) {0}-nak kell kiv\u00e1laszt\u00e1si attrib\u00fatum." },

            { ER_NEED_TEST_ATTRIB, "Az xsl:when-nek kell legyen 'test' attrib\u00fatuma." },

            { ER_NEED_NAME_ATTRIB, "Az xsl:param-nak kell legyen 'name' attrib\u00fatuma." },

            { ER_NO_CONTEXT_OWNERDOC, "A k\u00f6rnyezetnek nincs tulajdonos dokumentuma!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "Nem lehet XML TransformerFactory Liaison-t l\u00e9trehozni: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "A Xalan folyamat sikertelen volt." },

            { ER_NOT_SUCCESSFUL, "Xalan: sikertelen volt." },

            { ER_ENCODING_NOT_SUPPORTED, "A k\u00f3dol\u00e1s nem t\u00e1mogatott: {0}" },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "Nem lehet TraceListener-t l\u00e9trehozni: {0}" },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "Az xsl:key-nek kell legyen 'name' attrib\u00fatuma!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "Az xsl:key-nek kell legyen 'match' attrib\u00fatuma!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "Az xsl:key-nek kell legyen 'use' attrib\u00fatuma!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB,
                    "(StylesheetHandler) A(z) {0}-nak kell legyen ''elements'' attrib\u00fatuma! " },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) A(z) {0}-nak hi\u00e1nyzik a ''prefix'' attrib\u00fatuma" },

            { ER_BAD_STYLESHEET_URL, "A st\u00edluslap URL rossz: {0}" },

            { ER_FILE_NOT_FOUND, "A st\u00edluslap f\u00e1jl nem tal\u00e1lhat\u00f3: {0}" },

            { ER_IOEXCEPTION, "IO kiv\u00e9tel t\u00f6rt\u00e9nt a st\u00edluslap f\u00e1jln\u00e1l: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) A(z) {0} href attrib\u00fatuma nem tal\u00e1lhat\u00f3" },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) A(z) {0} k\u00f6zvetlen\u00fcl vagy k\u00f6zvetetten tartalmazza saj\u00e1t mag\u00e1t!" },

            { ER_PROCESSINCLUDE_ERROR, "StylesheetHandler.processInclude hiba, {0}" },

            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) A(z) {0}-nak hi\u00e1nyzik a ''lang'' attrib\u00fatuma " },
            ...
            { ER_PROCESS_ERROR, "StylesheetRoot.process hiba" },

            { ER_UNIMPLNODE_ERROR, "UnImplNode hiba: {0}" },

            { ER_NO_SELECT_EXPRESSION,
                    "Hiba! Az xpath kiv\u00e1laszt\u00e1si kifejez\u00e9s nem tal\u00e1lhat\u00f3 (-select)." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "Nem lehet sorbarakni az XSLProcessor-t!" },

            { ER_NO_INPUT_STYLESHEET, "Nem adott meg st\u00edluslap bemenetet!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Nem siker\u00fclt feldolgozni a st\u00edluslapot!" },

            { ER_COULDNT_PARSE_DOC, "Nem lehet elemezni a(z) {0} dokumentumot!" },

            { ER_COULDNT_FIND_FRAGMENT, "Nem tal\u00e1lhat\u00f3 a darab: {0}" },

            { ER_NODE_NOT_ELEMENT, "A darab azonos\u00edt\u00f3 \u00e1ltal mutatott csom\u00f3pont nem elem: {0}" },
            ...
            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Nincs kl\u00f3nja egy dokumentumdarabnak!" },

            { ER_CANT_CREATE_ITEM, "Nem lehet elemet l\u00e9trehozni az eredm\u00e9nyf\u00e1ban: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "Az xml:space-nek a forr\u00e1s XML-ben tiltott \u00e9rt\u00e9ke van: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "Nincs xsl:key deklar\u00e1ci\u00f3 a(z) {0}-hoz!" },

            { ER_CANT_CREATE_URL, "Hiba! Nem lehet URL-t l\u00e9trehozni ehhez: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "Az xsl:functions nem t\u00e1mogatott" },

            { ER_PROCESSOR_ERROR, "XSLT TransformerFactory hiba" },
            ...
            { ER_ILLEGAL_ATTRIB, "(StylesheetHandler) A(z) {0}-nak tiltott attrib\u00fatuma van: {1}" },

            { ER_UNKNOWN_XSL_ELEM, "Ismeretlen XSL elem: {0}" },

            {
                    ER_BAD_XSLSORT_USE,
                    "(StylesheetHandler) Az xsl:sort csak az xsl:apply-templates-szel vagy xsl:for-each-el egy\u00fctt haszn\u00e1lhat\u00f3." },

            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) Rosszul elhelyezett xsl:when!" },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) Az xsl:when sz\u00fcl\u0151je nem xsl:choose!" },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) Rosszul elhelyezett xsl:otherwise!" },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) Az xsl:otherwise sz\u00fcl\u0151je nem xsl:choose!" },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) A(z) {0} nem megengedett sablonok belsej\u00e9ben!" },
            ...
            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space \u00e9rt\u00e9ke nem megengedett: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "A processStylesheet sikertelen volt!" },

            { ER_SAX_EXCEPTION, "SAX kiv\u00e9tel" },

            // add this message to fix bug 21478
            { ER_FUNCTION_NOT_SUPPORTED, "A f\u00fcggv\u00e9ny nem t\u00e1mogatott!" },

            { ER_XSLT_ERROR, "XSLT hiba" },

            { ER_CURRENCY_SIGN_ILLEGAL, "A p\u00e9nzjel nem megengedett a form\u00e1tum minta karakterl\u00e1ncban" },
            ...
            { ER_MISSING_NS_URI, "Hi\u00e1nyzik a megadott el\u0151tag n\u00e9vt\u00e9r URI-ja" },

            { ER_MISSING_ARG_FOR_OPTION, "Hi\u00e1nyzik az opci\u00f3 argumentuma: {0}" },

            { ER_INVALID_OPTION, "\u00c9rv\u00e9nytelen opci\u00f3: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Rossz form\u00e1tum\u00fa karakterl\u00e1nc: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "Az xsl:stylesheet-nek kell legyen 'version' attrib\u00fatuma!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "A(z) {0} attib\u00fatum \u00e9rt\u00e9ke \u00e9rv\u00e9nytelen: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "Az xsl:choose-hoz egy xsl:when sz\u00fcks\u00e9ges" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "Az xsl:apply-imports nem megengedett xsl:for-each-en bel\u00fcl" },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Nem haszn\u00e1lhat DTMLiaison-t kimeneti DOM csom\u00f3pontk\u00e9nt... adjon \u00e1t ink\u00e1bb egy de.lyca.xpath.DOM2Helper-t!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "Nem haszn\u00e1lhat DTMLiaison-t bemeneti DOM csom\u00f3pontk\u00e9nt... adjon \u00e1t ink\u00e1bb egy de.lyca.xpath.DOM2Helper-t!" },

            { ER_CALL_TO_EXT_FAILED, "A kiterjeszt\u00e9s-elem megh\u00edv\u00e1sa sikertelen volt: {0}" },

            { ER_PREFIX_MUST_RESOLVE, "Az el\u0151tagnak egy n\u00e9vt\u00e9rre kell felold\u00f3dnia: {0}" },

            { ER_INVALID_UTF16_SURROGATE, "\u00c9rv\u00e9nytelen UTF-16 helyettes\u00edt\u00e9s: {0} ?" },

            { ER_XSLATTRSET_USED_ITSELF,
                    "A(z) {0} xsl:attribute-set-et saj\u00e1t mag\u00e1val haszn\u00e1lta, ami v\u00e9gtelen ciklust eredm\u00e9nyez." },

            { ER_CANNOT_MIX_XERCESDOM, "Nem keverheti a nem Xerces-DOM bemenetet a Xerces-DOM kimenettel!" },

            { ER_TOO_MANY_LISTENERS, "addTraceListenersToStylesheet - TooManyListenersException" },

            { ER_IN_ELEMTEMPLATEELEM_READOBJECT, "Az ElemTemplateElement.readObject met\u00f3dusban: {0}" },

            { ER_DUPLICATE_NAMED_TEMPLATE, "Egyn\u00e9l t\u00f6bb ''{0}'' nev\u0171 sablont tal\u00e1ltam" },
            ...
            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Az oszt\u00e1ly f\u00e1jl nem tal\u00e1lhat\u00f3 a(z) {0} opci\u00f3hoz" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "A sz\u00fcks\u00e9ges elem nem tal\u00e1lhat\u00f3: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "Az InputStream nem lehet null" },

            { ER_URI_CANNOT_BE_NULL, "Az URI nem lehet null" },

            { ER_FILE_CANNOT_BE_NULL, "A f\u00e1jl nem lehet null" },

            { ER_SOURCE_CANNOT_BE_NULL, "Az InputSource nem lehet null" },

            { ER_CANNOT_INIT_BSFMGR, "Nem lehet inicializ\u00e1lni a BSF kezel\u0151t" },

            { ER_CANNOT_CMPL_EXTENSN, "Nem lehet leford\u00edtani a kiterjeszt\u00e9st" },

            { ER_CANNOT_CREATE_EXTENSN, "Nem lehet l\u00e9trehozni a kiterjeszt\u00e9st ({0}) {1} miatt" },

            {
                    ER_INSTANCE_MTHD_CALL_REQUIRES,
                    "Az {0} met\u00f3dus p\u00e9ld\u00e1ny met\u00f3dush\u00edv\u00e1s\u00e1hoz sz\u00fcks\u00e9g van egy objektump\u00e9ld\u00e1nyra els\u0151 argumentumk\u00e9nt" },

            { ER_INVALID_ELEMENT_NAME, "\u00c9rv\u00e9nytelen elemnevet adott meg {0}" },

            { ER_ELEMENT_NAME_METHOD_STATIC, "Az elemn\u00e9v met\u00f3dus statikus {0} kell legyen" },

            { ER_EXTENSION_FUNC_UNKNOWN, "{0} kiterjeszt\u00e9s funkci\u00f3 : A(z) {1} ismeretlen" },

            { ER_MORE_MATCH_CONSTRUCTOR, "T\u00f6bb legjobb illeszked\u00e9s a(z) {0} konstruktor\u00e1ra" },

            { ER_MORE_MATCH_METHOD, "T\u00f6bb legjobb illeszked\u00e9s a(z) {0} met\u00f3dusra" },

            { ER_MORE_MATCH_ELEMENT, "T\u00f6bb legjobb illeszked\u00e9s a(z) {0} elem met\u00f3dusra" },

            { ER_INVALID_CONTEXT_PASSED,
                    "\u00c9rv\u00e9nytelen k\u00f6rnyzetet adott \u00e1t a(z) {0} ki\u00e9rt\u00e9kel\u00e9s\u00e9hez" },

            { ER_POOL_EXISTS, "A t\u00e1rol\u00f3 m\u00e1r l\u00e9tezik" },

            { ER_NO_DRIVER_NAME, "Nem adott meg meghajt\u00f3nevet" },

            { ER_NO_URL, "Nem adott meg URL-t" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "A t\u00e1rol\u00f3 m\u00e9rete egyn\u00e9l kisebb!" },

            { ER_INVALID_DRIVER, "\u00c9rv\u00e9nytelen meghajt\u00f3nevet adott meg!" },

            { ER_NO_STYLESHEETROOT, "Nem tal\u00e1lhat\u00f3 a st\u00edluslap gy\u00f6kere!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Tiltott \u00e9rt\u00e9k az xml:space-hez" },

            { ER_PROCESSFROMNODE_FAILED, "A processFromNode nem siker\u00fclt" },

            { ER_RESOURCE_COULD_NOT_LOAD, "Az er\u0151forr\u00e1st [ {0} ] nem lehet bet\u00f6lteni: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Pufferm\u00e9ret <= 0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Ismeretlen hiba a kiterjeszt\u00e9s h\u00edv\u00e1s\u00e1n\u00e1l" },

            { ER_NO_NAMESPACE_DECL, "A(z) {0} el\u0151taghoz nem tartozik n\u00e9vt\u00e9r deklar\u00e1ci\u00f3" },

            { ER_ELEM_CONTENT_NOT_ALLOWED, "Elem tartalom nem megengedett a(z) {0} lang=javaclass-hoz" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "St\u00edluslap \u00e1ltal ir\u00e1ny\u00edtott le\u00e1ll\u00e1s" },

            { ER_ONE_OR_TWO, "1 vagy 2" },

            { ER_TWO_OR_THREE, "2 vagy 3" },

            {
                    ER_COULD_NOT_LOAD_RESOURCE,
                    "Nem lehet bet\u00f6lteni a(z) {0}-t (ellen\u0151rizze a CLASSPATH-t), most csak az alap\u00e9rtelmez\u00e9seket haszn\u00e1ljuk" },

            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Nem lehet inicializ\u00e1lni az alap\u00e9rtelmezett sablonokat" },

            { ER_RESULT_NULL, "Az eredm\u00e9ny nem lehet null" },

            { ER_RESULT_COULD_NOT_BE_SET, "Nem lehet be\u00e1ll\u00edtani az eredm\u00e9nyt" },

            { ER_NO_OUTPUT_SPECIFIED, "Nem adott meg kimenetet" },
            ...
            { ER_NULL_CONTENT_HANDLER, "Null tartalomkezel\u0151" },

            { ER_NULL_ERROR_HANDLER, "Null hibakezel\u0151" },

            { ER_CANNOT_CALL_PARSE,
                    "A parse nem h\u00edvhat\u00f3 meg, ha a ContentHandler-t nem \u00e1ll\u00edtotta be" },

            { ER_NO_PARENT_FOR_FILTER, "A sz\u0171r\u0151nek nincs sz\u00fcl\u0151je" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Nincs st\u00edluslap ebben: {0}, adathordoz\u00f3: {1}" },

            { ER_NO_STYLESHEET_PI, "Nem tal\u00e1lhat\u00f3 xml-stylesheet PI itt: {0}" },

            { ER_NOT_SUPPORTED, "Nem t\u00e1mogatott: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN,
                    "A(z) {0} tulajdons\u00e1g \u00e9rt\u00e9ke Boolean p\u00e9ld\u00e1ny kell legyen" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Nem lehet eljutni a k\u00fcls\u0151 parancsf\u00e1jlhoz a(z) {0}-n" },

            { ER_RESOURCE_COULD_NOT_FIND, "A(z) [ {0} ] er\u0151forr\u00e1s nem tal\u00e1lhat\u00f3.\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "A kimeneti tulajdons\u00e1g nem felismerhet\u0151: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Nem siker\u00fclt ElemLiteralResult p\u00e9ld\u00e1nyt l\u00e9trehozni" },
            ...
            { ER_FAILED_CALLING_METHOD, "Nem siker\u00fclt megh\u00edvni a(z) {0} met\u00f3dust" },

            { ER_FAILED_CREATING_ELEMTMPL, "Nem siker\u00fclt ElemTemplateElement p\u00e9ld\u00e1nyt l\u00e9trehozni" },

            { ER_CHARS_NOT_ALLOWED, "Karakterek nem megengedettek a dokumentumnak ezen a pontj\u00e1n" },

            { ER_ATTR_NOT_ALLOWED, "A(z) \"{0}\" attrib\u00fatum nem megengedett a(z) {1} elemhez!" },

            { ER_BAD_VALUE, "{0} rossz \u00e9rt\u00e9k {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "{0} attrib\u00fatum \u00e9rt\u00e9k nem tal\u00e1lhat\u00f3 " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "{0} attrib\u00fatum \u00e9rt\u00e9k ismeretlen " },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "Nem tal\u00e1lhat\u00f3 a(z) {0} SAX1 meghajt\u00f3oszt\u00e1ly" },

            { ER_SAX1_DRIVER_NOT_LOADED, "A(z) {0} SAX1 meghajt\u00f3oszt\u00e1ly megvan, de nem t\u00f6lthet\u0151 be" },
            ...
            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Nem adta meg az org.xml.sax.parser rendszertulajdons\u00e1got" },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Az \u00e9rtelmez\u0151 argumentuma nem lehet null" },

            { ER_FEATURE, "K\u00e9pess\u00e9g: {0}" },

            { ER_PROPERTY, "Tulajdons\u00e1g: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Null entit\u00e1s felold\u00f3" },

            { ER_NULL_DTD_HANDLER, "Null DTD kezel\u0151" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Nem adott meg meghajt\u00f3nevet!" },

            { ER_NO_URL_SPECIFIED, "Nem adott meg URL-t!" },

            { ER_POOLSIZE_LESS_THAN_ONE, "A t\u00e1rol\u00f3 m\u00e9rete 1-n\u00e9l kisebb!" },

            { ER_INVALID_DRIVER_NAME, "\u00c9rv\u00e9nytelen meghajt\u00f3nevet adott meg!" },
            ...
            { ER_NOT_ALLOWED_IN_POSITION, "{0} nem enged\u00e9lyezett a st\u00edluslap ezen hely\u00e9n!" },
            ...
            { INVALID_QNAME, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} CHAR attrib\u00fatumhoz: {1}." },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} NMTOKEN attrib\u00fatumhoz: {1}. " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} NCNAME attrib\u00fatumhoz: {1}. " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} logikai attrib\u00fatumhoz: {1}. " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} sz\u00e1m attrib\u00fatumhoz: {1}. " },
            ...
            { ER_ARG_LITERAL, "A(z) {0} argumentuma az illeszked\u00e9si mint\u00e1ban egy liter\u00e1l kell legyen." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "K\u00e9tszer szerepel a glob\u00e1lis v\u00e1ltoz\u00f3-deklar\u00e1ci\u00f3." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "K\u00e9tszer szerepel a v\u00e1ltoz\u00f3-deklar\u00e1ci\u00f3." },
            ...
            { ER_INVALID_PREFIX, "Az el\u0151tag az exclude-result-prefixes-ben nem \u00e9rv\u00e9nyes: {0}" },
            ...
            { ER_NO_ATTRIB_SET, "A(z) {0} nev\u0171 attribute-set nem l\u00e9tezik" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "A(z) {0} nev\u0171 funkci\u00f3 nem l\u00e9tezik" },
            ...
            { ER_NAMESPACE_CONTEXT_NULL_PREFIX, "Nem olvashat\u00f3 be a n\u00e9vt\u00e9r null el\u0151tag miatt. " },

            { ER_XPATH_RESOLVER_NULL_QNAME, "A f\u00fcggv\u00e9ny neve nem lehet null." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "Az arit\u00e1s nem lehet negat\u00edv." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "'}'-t tal\u00e1ltunk, de nincs attrib\u00fatumsablon megnyitva!" },
            ...
            { WG_CANNOT_MAKE_URL_FROM, "Nem k\u00e9sz\u00edthet\u0151 URL ebb\u0151l: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "A k\u00e9r dokumentum nem t\u00f6lthet\u0151 be: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "Nem tal\u00e1lhat\u00f3 Collator a <sort xml:lang={0}-hez" },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "A(z) {0}-nak \u00e9rv\u00e9nytelen attrib\u00fatuma van: {1}" },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "Nem lehet feloldani a n\u00e9vt\u00e9r el\u0151tagot: {0}. A csom\u00f3pont figyelmen k\u00edv\u00fcl marad." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "Az xsl:stylesheet-nek kell legyen 'version' attrib\u00fatuma!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Nem megengedett attrib\u00fatumn\u00e9v: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Tiltott \u00e9rt\u00e9ket haszn\u00e1lt a(z) {0} attrib\u00fatumhoz: {1}" },
            ...
            {
                    "xslProc_no_input",
                    "Hiba: Nem adott meg st\u00edluslapot vagy bemeneti xml-t. Futtassa ezt a parancsot kapcsol\u00f3k n\u00e9lk\u00fcl a haszn\u00e1lati utas\u00edt\u00e1sok megjelen\u00edt\u00e9s\u00e9re." },
            ...
            { "optionPARSER",
                    "   [-PARSER az \u00e9rtelmez\u0151kapcsolat teljesen meghat\u00e1rozott oszt\u00e1lyneve]" },
            ...
            { "optionLF",
                    "   [-LF (A soremel\u00e9seket csak kimenet eset\u00e9n haszn\u00e1lja {alap\u00e9rtelmez\u00e9s: CR/LF})]" },
            { "optionCR",
                    "   [-CR (A kocsivissza karaktert csak kimenet eset\u00e9n haszn\u00e1lja {alap\u00e9rtelmez\u00e9s: CR/LF})]" },
            { "optionESCAPE",
                    "   [-ESCAPE (Mely karaktereket kell escape-elni {alap\u00e9rtelmez\u00e9s: <>&\"\'\\r\\n}]" },
            {
                    "optionINDENT",
                    "   [-INDENT (Meghat\u00e1rozza, hogy h\u00e1ny sz\u00f3k\u00f6zzel kell beljebb kezdeni {alap\u00e9rtelmez\u00e9s: 0})]" },
            ...
            { "optionTTC",
                    "   [-TTC (Nyomk\u00f6veti a sablon-lesz\u00e1rmazottakat, ahogy azokat feldolgozz\u00e1k.)]" },
            { "optionTCLASS",
                    "   [-TCLASS (TraceListener oszt\u00e1ly a nyomk\u00f6vet\u00e9si kiterjeszt\u00e9sekhez.)]" },
            {
                    "optionVALIDATE",
                    "   [-VALIDATE (Be\u00e1ll\u00edtja, hogy legyen-e \u00e9rv\u00e9nyess\u00e9gvizsg\u00e1lat.  Alap\u00e9rtelmez\u00e9sben nincs \u00e9rv\u00e9nyess\u00e9gvizsg\u00e1lat.)]" },
            { "optionEDUMP",
                    "   [-EDUMP {opcion\u00e1lis f\u00e1jln\u00e9v} (Hib\u00e1n\u00e1l stackdump-ot hajt v\u00e9gre.)]" },
            { "optionXML",
                    "   [-XML (XML form\u00e1z\u00f3 haszn\u00e1lata \u00e9s XML fejl\u00e9c hozz\u00e1ad\u00e1sa.)]" },
            { "optionTEXT", "   [-TEXT (Egyszer\u0171 sz\u00f6vegform\u00e1z\u00f3 haszn\u00e1lata.)]" },
            { "optionHTML", "   [-HTML (HTML form\u00e1z\u00f3 haszn\u00e1lata.)]" },
            { "optionPARAM",
                    "   [-PARAM n\u00e9v kifejez\u00e9s (Be\u00e1ll\u00edt egy st\u00edluslap param\u00e9tert)]" },
            ...
            { "optionURIRESOLVER",
                    "   [-URIRESOLVER teljes oszt\u00e1lyn\u00e9v (az URIResolver fogja feloldani az URI-kat)]" },
            { "optionENTITYRESOLVER",
                    "   [-ENTITYRESOLVER teljes oszt\u00e1lyn\u00e9v (az EntityResolver fogja feloldani az entit\u00e1sokat)]" },
            { "optionCONTENTHANDLER",
                    "   [-CONTENTHANDLER teljes oszt\u00e1lyn\u00e9v (a ContentHandler fogja soros\u00edtani a kimenetet)]" },
            { "optionLINENUMBERS", "   [-L sorsz\u00e1mokat haszn\u00e1l a forr\u00e1sdokumentumhoz]" },
            { "optionSECUREPROCESSING",
                    "   [-SECURE (biztons\u00e1gos feldolgoz\u00e1s szolg\u00e1ltat\u00e1s igazra \u00e1ll\u00edt\u00e1sa.)]" },
            ...
            {
                    "optionMEDIA",
                    "   [-MEDIA adathordoz\u00f3T\u00edpus (a media attrib\u00fatum seg\u00edts\u00e9g\u00e9vel megkeresi a dokumentumhoz tartoz\u00f3 st\u00edluslapot.)]" },
            {
                    "optionFLAVOR",
                    "   [-FLAVOR \u00edzl\u00e9sN\u00e9v (Explicit haszn\u00e1lja az s2s=SAX-ot vagy d2d=DOM-ot a transzform\u00e1ci\u00f3hoz.)] " }, // Added
                                                                                                                                                      // by
                                                                                                                                                      // sboag/scurcuru;
                                                                                                                                                      // experimental
            { "optionDIAG",
                    "   [-DIAG (Ki\u00edrja, hogy \u00f6sszesen h\u00e1ny ezredm\u00e1sodpercig tartott a transzform\u00e1ci\u00f3.)]" },
            {
                    "optionINCREMENTAL",
                    "   [-INCREMENTAL (n\u00f6vekm\u00e9nyes DTM l\u00e9trehoz\u00e1st ig\u00e9nyel a http://xml.apache.org/xalan/features/incremental igazra \u00e1ll\u00edt\u00e1s\u00e1val.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "   [-NOOPTIMIMIZE (nem ig\u00e9nyel st\u00edluslap optimiz\u00e1l\u00e1st a http://xml.apache.org/xalan/features/optimize hamisra \u00e1ll\u00edt\u00e1s\u00e1t.)]" },
            {
                    "optionRL",
                    "   [-RL rekurzi\u00f3korl\u00e1t (numerikusan korl\u00e1tozza a st\u00edluslap rekurzi\u00f3 m\u00e9lys\u00e9g\u00e9t.)]" },
            ...
            { "recursionTooDeep",
                    "A sablonon egym\u00e1sba \u00e1gyaz\u00e1sa t\u00fal m\u00e9ly. Be\u00e1gyaz\u00e1s = {0}, sablon: {1} {2}" },
            { "nameIs", "A n\u00e9v:" }, { "matchPatternIs", "Az illeszked\u00e9si minta:" }
