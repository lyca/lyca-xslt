...
public class XSLTErrorResources_sv extends XSLTErrorResources {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Fel: Kan inte ha '{' inuti uttryck" },
            ...
            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode \u00e4r null i handleApplyTemplatesInstruction!" },
            ...
            { ER_CANT_RESOLVE_NAME_AVT, "Kunde inte l\u00f6sa namn-AVT i xsl:call-template." },
            ...
            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "D\u00e5ligt v\u00e4rde p\u00e5 niv\u00e5-attribut: {0}" },
            ...
            { ER_NEED_MATCH_ATTRIB, "{0} m\u00e5ste ha ett matchningsattribut om det har ett tillst\u00e5nd." },

            /** ER_NEED_NAME_OR_MATCH_ATTRIB */
            // public static final int ER_NEED_NAME_OR_MATCH_ATTRIB = 15;

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} kr\u00e4ver antingen ett namn eller ett matchningsattribut." },

            /** ER_CANT_RESOLVE_NSPREFIX */
            // public static final int ER_CANT_RESOLVE_NSPREFIX = 16;

            { ER_CANT_RESOLVE_NSPREFIX, "Kan inte l\u00f6sa namnrymdsprefix: {0}" },
            ...
            { ER_NO_OWNERDOC, "Barnnod saknar \u00e4gardokument!" },
            ...
            { ER_NEED_NAME_ATTRIB, "xsl:with-param m\u00e5ste ha ett 'namn'-attribut." },

            /** ER_NO_CONTEXT_OWNERDOC */
            // public static final int ER_NO_CONTEXT_OWNERDOC = 24;

            { ER_NO_CONTEXT_OWNERDOC, "Kontext saknar \u00e4gardokument!" },

            /** ER_COULD_NOT_CREATE_XML_PROC_LIAISON */
            // public static final int ER_COULD_NOT_CREATE_XML_PROC_LIAISON =
            // 25;

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "Kunde inte skapa XML TransformerFactory Liaison: {0}" },

            /** ER_PROCESS_NOT_SUCCESSFUL */
            // public static final int ER_PROCESS_NOT_SUCCESSFUL = 26;

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan: Process misslyckades." },
            ...
            { ER_COULD_NOT_CREATE_TRACELISTENER, "Kunde inte skapa TraceListener: {0}" },

            /** ER_KEY_REQUIRES_NAME_ATTRIB */
            // public static final int ER_KEY_REQUIRES_NAME_ATTRIB = 30;

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key m\u00e5ste ha ett 'namn'-attribut." },

            /** ER_KEY_REQUIRES_MATCH_ATTRIB */
            // public static final int ER_KEY_REQUIRES_MATCH_ATTRIB = 31;

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key m\u00e5ste ha ett 'matcha'-attribut." },

            /** ER_KEY_REQUIRES_USE_ATTRIB */
            // public static final int ER_KEY_REQUIRES_USE_ATTRIB = 32;

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key m\u00e5ste ha ett 'anv\u00e4nd'-attribut." },

            /** ER_REQUIRES_ELEMENTS_ATTRIB */
            // public static final int ER_REQUIRES_ELEMENTS_ATTRIB = 33;

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} kr\u00e4ver ett ''element''-attribut!" },

            /** ER_MISSING_PREFIX_ATTRIB */
            // public static final int ER_MISSING_PREFIX_ATTRIB = 34;

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0} ''prefix''-attribut saknas" },
            ...
            { ER_IOEXCEPTION, "Fick IO-Undantag med stylesheet-fil: {0}" },

            /** ER_NO_HREF_ATTRIB */
            // public static final int ER_NO_HREF_ATTRIB = 38;

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Hittade inte href-attribute f\u00f6r {0}" },
            ...
            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) {0} ''lang''-attribut' saknas" },
            ...
            { ER_NO_INPUT_STYLESHEET, "Stylesheet-indata ej angiven!" },

            /** ER_FAILED_PROCESS_STYLESHEET */
            // public static final int ER_FAILED_PROCESS_STYLESHEET = 49;

            { ER_FAILED_PROCESS_STYLESHEET, "Kunde inte behandla stylesheet!" },
            ...
            { ER_NODE_NOT_ELEMENT, "Nod som pekades p\u00e5 av fragment-identifierare var inte ett element: {0}" },
            ...
            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space i k\u00e4ll-XML har ett otill\u00e5tet v\u00e4rde: {0}" },
            ...
            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} \u00e4r inte till\u00e5ten inne i en mall!" },

            /** ER_UNKNOWN_EXT_NS_PREFIX */
            // public static final int ER_UNKNOWN_EXT_NS_PREFIX = 74;

            { ER_UNKNOWN_EXT_NS_PREFIX, "(StylesheetHandler) {0} utbyggnadsnamnrymdsprefix {1} ok\u00e4nt" },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} importerar, direkt eller indirekt, sig sj\u00e4lv!" },

            /** ER_XMLSPACE_ILLEGAL_VAL */
            // public static final int ER_XMLSPACE_ILLEGAL_VAL = 77;

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) " + "xml:space har ett otill\u00e5tet v\u00e4rde: {0}" },

            /** ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL */
            // public static final int ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL = 78;

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet misslyckades!" },
            ...
            { ER_CURRENCY_SIGN_ILLEGAL, "valutatecken \u00e4r inte till\u00e5tet i formatm\u00f6nsterstr\u00e4ng" },

            /** ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM */
            // public static final int
            // ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM = 83;

            { ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM, "Dokumentfunktion inte underst\u00f6dd i Stylesheet DOM!" },

            /** ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER */
            // public static final int
            // ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER = 84;

            { ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER, "Kan inte l\u00f6sa prefix i icke-Prefixl\u00f6sare!" },
            ...
            // public static final int
            // ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT = 86;

            { ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT, "Kan inte bygga FormatterListener i Redirect extension!" },

            /** ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX */
            // public static final int ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX
            // = 87;

            { ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX, "Prefix i exkludera-resultat-prefix \u00e4r inte giltig: {0}" },
            ...
            { ER_MISSING_ARG_FOR_OPTION, "Argument saknas f\u00f6r alternativ: {0}" },
            ...
            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet m\u00e5ste ha ett 'version'-attribut!" },
            ...
            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports inte till\u00e5tet i ett xsl:for-each" },

            /** ER_CANT_USE_DTM_FOR_OUTPUT */
            // public static final int ER_CANT_USE_DTM_FOR_OUTPUT = 96;

            { ER_CANT_USE_DTM_FOR_OUTPUT,
                    "Kan inte anv\u00e4nda DTMLiaison till en DOM utdatanod... skicka en de.lyca.xpath.DOM2Helper ist\u00e4llet!" },

            /** ER_CANT_USE_DTM_FOR_INPUT */
            // public static final int ER_CANT_USE_DTM_FOR_INPUT = 97;

            { ER_CANT_USE_DTM_FOR_INPUT,
                    "Kan inte anv\u00e4nda DTMLiaison till en DOM indatanod... skicka en de.lyca.xpath.DOM2Helper ist\u00e4llet!" },

            /** ER_CALL_TO_EXT_FAILED */
            // public static final int ER_CALL_TO_EXT_FAILED = 98;

            { ER_CALL_TO_EXT_FAILED, "Anrop till anslutningselement misslyckades: {0}" },

            /** ER_PREFIX_MUST_RESOLVE */
            // public static final int ER_PREFIX_MUST_RESOLVE = 99;

            { ER_PREFIX_MUST_RESOLVE, "Prefix m\u00e5ste l\u00f6sa till en mamnrymd: {0}" },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "Hittade mer \u00e4n en mall med namnet: {0}" },

            /** ER_INVALID_KEY_CALL */
            // public static final int ER_INVALID_KEY_CALL = 106;

            { ER_INVALID_KEY_CALL, "Ogiltigt funktionsanrop: rekursiva key()-anrop \u00e4r inte till\u00e5tna" },

            /** Variable is referencing itself */
            // public static final int ER_REFERENCING_ITSELF = 107;

            { ER_REFERENCING_ITSELF, "Variabel {0} h\u00e4nvisar, direkt eller indirekt, till sig sj\u00e4lv!" },
            ...
            { ER_REQUIRED_ELEM_NOT_FOUND, "N\u00f6dv\u00e4ndigt element saknas: {0}" },

            /** InputStream cannot be null */
            // public static final int ER_INPUT_CANNOT_BE_NULL = 111;

            { ER_INPUT_CANNOT_BE_NULL, "InputStream f\u00e5r inte vara null" },

            /** URI cannot be null */
            // public static final int ER_URI_CANNOT_BE_NULL = 112;

            { ER_URI_CANNOT_BE_NULL, "URI f\u00e5r inte vara null" },

            /** File cannot be null */
            // public static final int ER_FILE_CANNOT_BE_NULL = 113;

            { ER_FILE_CANNOT_BE_NULL, "Fil f\u00e5r inte vara null" },

            /** InputSource cannot be null */
            // public static final int ER_SOURCE_CANNOT_BE_NULL = 114;

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource f\u00e5r inte vara null" },

            /** Could not initialize BSF Manager */
            // public static final int ER_CANNOT_INIT_BSFMGR = 116;

            { ER_CANNOT_INIT_BSFMGR, "Kan inte initialisera BSF Manager" },

            /** Could not compile extension */
            // public static final int ER_CANNOT_CMPL_EXTENSN = 117;

            { ER_CANNOT_CMPL_EXTENSN, "Kunde inte kompilera anslutning" },

            /** Could not create extension */
            // public static final int ER_CANNOT_CREATE_EXTENSN = 118;

            { ER_CANNOT_CREATE_EXTENSN, "Kunde inte skapa anslutning: {0} p\u00e5 grund av: {1}" },
            ...
            { ER_ELEMENT_NAME_METHOD_STATIC, "Elementnamnmetod m\u00e5ste vara static {0}" },

            /** Extension function {0} : {1} is unknown */
            // public static final int ER_EXTENSION_FUNC_UNKNOWN = 122;

            { ER_EXTENSION_FUNC_UNKNOWN, "Anslutningsfunktion {0} : {1} \u00e4r ok\u00e4nd" },

            /** More than one best match for constructor for */
            // public static final int ER_MORE_MATCH_CONSTRUCTOR = 123;

            { ER_MORE_MATCH_CONSTRUCTOR, "Fler \u00e4n en b\u00e4sta matchning f\u00f6r konstruktor f\u00f6r {0}" },
            ...
            { ER_NO_DRIVER_NAME, "Inget driver-namn angivet" },
            ...
            { ER_INVALID_DRIVER, "Ogiltigt driver-namn angivet" },

            /** Did not find the stylesheet root */
            // public static final int ER_NO_STYLESHEETROOT = 132;

            { ER_NO_STYLESHEETROOT, "Hittade inte stylesheet-roten!" },

            /** Illegal value for xml:space */
            // public static final int ER_ILLEGAL_XMLSPACE_VALUE = 133;

            { ER_ILLEGAL_XMLSPACE_VALUE, "Ogiltigt v\u00e4rde f\u00f6r xml:space" },

            /** processFromNode failed */
            // public static final int ER_PROCESSFROMNODE_FAILED = 134;

            { ER_PROCESSFROMNODE_FAILED, "processFromNode misslyckades" },
            ...
            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Bufferstorlek <=0" },

            /** Unknown error when calling extension */
            // public static final int ER_UNKNOWN_ERROR_CALLING_EXTENSION = 137;

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Ok\u00e4nt fel vid anslutningsanrop" },

            /** Prefix {0} does not have a corresponding namespace declaration */
            // public static final int ER_NO_NAMESPACE_DECL = 138;

            { ER_NO_NAMESPACE_DECL, "Prefix{0} har inte en motsvarande namnrymdsdeklaration" },
            ...
            { ER_STYLESHEET_DIRECTED_TERMINATION, "Stylesheet-ledd avslutning" },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Kan inte initialisera standardmallar" },
            ...
            { ER_RESULT_COULD_NOT_BE_SET, "Result kunde inte s\u00e4ttas" },
            ...
            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Kan inte omvandla till en Result av typ {0}" },

            /** Can't transform to a Source of type */
            // public static final int ER_CANNOT_TRANSFORM_SOURCE_TYPE = 149;

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "Kan inte omvandla en Source av typ {0}" },
            ...
            { ER_NO_PARENT_FOR_FILTER, "Ingen f\u00f6r\u00e4lder till filter" },

            /** No stylesheet found in: {0}, media */
            // public static final int ER_NO_STYLESHEET_IN_MEDIA = 154;

            { ER_NO_STYLESHEET_IN_MEDIA, "Stylesheet saknas i: {0}, media= {1}" },

            /** No xml-stylesheet PI found in */
            // public static final int ER_NO_STYLESHEET_PI = 155;

            { ER_NO_STYLESHEET_PI, "xml-stylesheet PI saknas i: {0}" },
            ...
            { ER_PROPERTY_VALUE_BOOLEAN, "V\u00e4rde p\u00e5 egenskap {0} borde vara en Boolesk instans" },
            ...
            { "ER_SRC_ATTRIB_NOT_SUPPORTED", "src-attributet underst\u00f6ds \u00e4nnu inte f\u00f6r {0}" },

            /** The resource [] could not be found */
            // public static final int ER_RESOURCE_COULD_NOT_FIND = 196;

            { ER_RESOURCE_COULD_NOT_FIND, "Resursen [ {0} ] saknas. \n {1}" },

            /** output property not recognized: */
            // public static final int ER_OUTPUT_PROPERTY_NOT_RECOGNIZED = 197;

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "Utdata-egenskap k\u00e4nns inte igen: {0}" },
            ...
            { ER_VALUE_SHOULD_EQUAL, "V\u00e4rde p\u00e5 {0} borde motsvara ja eller nej" },
            ...
            { ER_CHARS_NOT_ALLOWED, "Tecken \u00e4r inte till\u00e5tna i dokumentet vid den h\u00e4r tidpunkten" },

            /** attribute is not allowed on the element */
            // public static final int ER_ATTR_NOT_ALLOWED = 209;

            { ER_ATTR_NOT_ALLOWED, "Attributet \"{0}\" \u00e4r inte till\u00e5ten i det {1} elementet!" },

            /** Bad value */
            // public static final int ER_BAD_VALUE = 211;

            { ER_BAD_VALUE, "{0} d\u00e5ligt v\u00e4rde {1} " },
            ...
            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Attributv\u00e4rdet {0} k\u00e4nns inte igen " },

            /** Attempting to generate a namespace prefix with a null URI */
            // public static final int ER_NULL_URI_NAMESPACE = 216;

            { ER_NULL_URI_NAMESPACE, "F\u00f6rs\u00f6ker generera ett namnomr\u00e5desprefix med en null-URI" },

            // Following are the new ERROR keys added in XALAN code base after
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "Det g\u00e5r inte att hitta SAX1-drivrutinen klass {0}" },
            ...
            { ER_SAX1_DRIVER_NOT_INSTANTIATED, "SAX1-drivrutinen klass {0} hittades men kan inte instansieras" },

            // ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER
            // public static final int ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER =
            // 221;

            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "SAX1-drivrutinen klass {0} implementerar inte org.xml.sax.Parser" },

            // ER_PARSER_PROPERTY_NOT_SPECIFIED
            // public static final int ER_PARSER_PROPERTY_NOT_SPECIFIED = 222;

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Systemegenskapen org.xml.sax.parser \u00e4r inte angiven" },

            // ER_PARSER_ARG_CANNOT_BE_NULL
            // public static final int ER_PARSER_ARG_CANNOT_BE_NULL = 223 ;

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Tolkningsargumentet f\u00e5r inte vara null" },

            // ER_FEATURE
            // public static final int ER_FEATURE = 224;

            { ER_FEATURE, "Funktion:a {0}" },

            // ER_PROPERTY
            // public static final int ER_PROPERTY = 225 ;

            { ER_PROPERTY, "Egenskap:a {0}" },

            // ER_NULL_ENTITY_RESOLVER
            // public static final int ER_NULL_ENTITY_RESOLVER = 226;

            { ER_NULL_ENTITY_RESOLVER, "Nullenhetsl\u00f6sare" },

            // ER_NULL_DTD_HANDLER
            // public static final int ER_NULL_DTD_HANDLER = 227 ;

            { ER_NULL_DTD_HANDLER, "Null-DTD-hanterare" },

            // No Driver Name Specified!
            // public static final int ER_NO_DRIVER_NAME_SPECIFIED = 228;

            { ER_NO_DRIVER_NAME_SPECIFIED, "Inget drivrutinsnamn \u00e4r angett!" },

            // No URL Specified!
            // public static final int ER_NO_URL_SPECIFIED = 229;

            { ER_NO_URL_SPECIFIED, "Ingen URL har angetts!" },

            // Pool size is less than 1!
            // public static final int ER_POOLSIZE_LESS_THAN_ONE = 230;

            { ER_POOLSIZE_LESS_THAN_ONE, "Poolstorleken \u00e4r mindre \u00e4n 1!" },

            // Invalid Driver Name Specified!
            // public static final int ER_INVALID_DRIVER_NAME = 231;

            { ER_INVALID_DRIVER_NAME, "Ett ogiltigt drivrutinsnamn har angetts!" },
            ...
            { ER_ASSERT_NO_TEMPLATE_PARENT, "Programmerarfel! expr har inget \u00f6verordnat ElemTemplateElement!" },

            // Programmer's assertion in RundundentExprEliminator: {0}
            // public static final int ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR =
            // 234;

            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Programmerarkontroll i RundundentExprEliminator: {0}" },

            // {0}is not allowed in this position in the stylesheet!
            // public static final int ER_NOT_ALLOWED_IN_POSITION = 237;

            { ER_NOT_ALLOWED_IN_POSITION, "{0} \u00e4r inte till\u00e5ten i denna position i formatmallen!" },

            // Non-whitespace text is not allowed in this position in the
            // stylesheet!
            // public static final int ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION
            // = 238;
            ...
            { INVALID_QNAME, "Ogiltigt v\u00e4rde:a {1} anv\u00e4nds f\u00f6r QNAME-attributet:a {0}" },
            ...
            { INVALID_NMTOKEN, "Ogiltigt v\u00e4rde:a {1} anv\u00e4nds f\u00f6r NMTOKEN-attributet:a {0} " },
            ...
            { INVALID_NCNAME, "Ogiltigt v\u00e4rde:a {1} anv\u00e4nds f\u00f6r NCNAME-attributet:a {0} " },
            ...
            { INVALID_BOOLEAN, "Ogiltigt v\u00e4rde:a {1} anv\u00e4nds som Booleskt attribut:a {0} " },
            ...
            { INVALID_NUMBER, "Ogiltigt v\u00e4rde:a {1} anv\u00e4nds som sifferattribut:a {0} " },
            ...
            { ER_ARG_LITERAL, "Argument f\u00f6r {0} i matchningsm\u00f6nstret m\u00e5ste vara literalt." },
            ...
            { ER_DUPLICATE_VAR, "Dubbel variabeldeklaration." },
            ...
            { ER_INVALID_PREFIX, "Prefix i exclude-result-prefixes \u00e4r ogiltigt:a {0}" },

            // Note to translators: An "attribute set" is a set of attributes
            // that can be
            // added to an element in the output document as a group. The
            // message indicates
            ...
            { WG_FOUND_CURLYBRACE, "Hittade '}' men ingen attributmall \u00e4r \u00f6ppen!" },
            ...
            { WG_NO_LOCALE_IN_FORMATNUMBER, "Xalan hanterar \u00e4nnu inte locale-namnet i funktionen format-number." },

            /** WG_LOCALE_NOT_FOUND */
            // public static final int WG_LOCALE_NOT_FOUND = 5;

            { WG_LOCALE_NOT_FOUND, "Varning: Hittade inte locale f\u00f6r xml:lang{0}" },
            ...
            { WG_CANNOT_LOAD_REQUESTED_DOC, "Kan inte ladda beg\u00e4rd doc: {0}" },

            /** WG_CANNOT_FIND_COLLATOR */
            // public static final int WG_CANNOT_FIND_COLLATOR = 8;

            { WG_CANNOT_FIND_COLLATOR, "Hittade inte Collator f\u00f6r <sort xml:lang={0}" },

            /** WG_FUNCTIONS_SHOULD_USE_URL */
            // public static final int WG_FUNCTIONS_SHOULD_USE_URL = 9;

            { WG_FUNCTIONS_SHOULD_USE_URL, "Gammal syntax: Funktionsinstruktionen borde anv\u00e4nda en url av {0}" },

            /** WG_ENCODING_NOT_SUPPORTED_USING_UTF8 */
            // public static final int WG_ENCODING_NOT_SUPPORTED_USING_UTF8 =
            // 10;

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "kodning underst\u00f6ds inte: {0}, anv\u00e4nder UTF-8" },

            /** WG_ENCODING_NOT_SUPPORTED_USING_JAVA */
            // public static final int WG_ENCODING_NOT_SUPPORTED_USING_JAVA =
            // 11;

            { WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "kodning underst\u00f6ds inte: {0}, anv\u00e4nder Java {1}" },
            ...
            { WG_NO_DECIMALFORMAT_DECLARATION, "Deklaration saknas f\u00f6r decimalformat: {0}" },
            ...
            { WG_COULD_NOT_RESOLVE_PREFIX, "Kan inte l\u00f6sa namnrymdsprefix: {0}. Noden kommer att ignoreras." },

            /** WG_STYLESHEET_REQUIRES_VERSION_ATTRIB */
            // public static final int WG_STYLESHEET_REQUIRES_VERSION_ATTRIB =
            // 23;

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet m\u00e5ste ha ett 'version'-attribut!" },
            ...
            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Ogiltigt v\u00e4rde anv\u00e4nt f\u00f6r attribut {0}: {1}" },
            ...
            /** WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML */
            // public static final int WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML
            // = 27;
            ...
            /** WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME */
            // public static final int WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME
            // = 28;
            ...
            // WHY THERE IS A GAP B/W NUMBERS in the XSLTErrorResources
            // properties file?
            ...
            { "help_language", "sv" },
            { "language", "sv" },
            { "BAD_CODE", "Parameter till createMessage ligger utanf\u00f6r till\u00e5tet intervall" },
            ...
            { "optionPARSER", "   [-PARSER fullt kvalificerat klassnamn eller tolkf\u00f6rbindelse]" },
            ...
            { "optionLF", "   [-LF (Anv\u00e4nd radframmatning enbart p\u00e5 utdata {standard \u00e4r CR/LF})]" },
            { "optionCR", "   [-CR (Anv\u00e4nd vagnretur enbart p\u00e5 utdata {standard \u00e4r CR/LF})]" },
            { "optionESCAPE", "   [-ESCAPE (Vilka tecken \u00e4r skiftningstecken {standard \u00e4r <>&\"\'\\r\\n}]" },
            { "optionINDENT", "   [-INDENT (Best\u00e4m antal blanksteg f\u00f6r att tabulera {standard \u00e4r 0})]" },
            { "optionTT", "   [-TT (Sp\u00e5ra mallarna allt eftersom de blir anropade.)]" },
            { "optionTG", "   [-TG (Sp\u00e5ra varje generationsh\u00e4ndelse.)]" },
            { "optionTS", "   [-TS (Sp\u00e5ra varje valh\u00e4ndelse.)]" },
            { "optionTTC", "   [-TTC (Sp\u00e5ra mallbarnen allt eftersom de blir behandlade.)]" },
            { "optionTCLASS", "   [-TCLASS (TraceListener-klass f\u00f6r sp\u00e5rningsanslutningar.)]" },
            { "optionVALIDATE",
            ...
            { "optionTEXT", "   [-XML (Anv\u00e4nd enkel Text-formaterare.)]" },
            { "optionHTML", "   [-HTML (Anv\u00e4nd HTML-formaterare)]" },
            { "optionPARAM", "   [-PARAM namn uttryck (S\u00e4tt en stylesheet-parameter)]" },
            { "noParsermsg1", "XSL-Process misslyckades." },
            { "noParsermsg2", "** Hittade inte tolk **" },
            { "noParsermsg3", "V\u00e4nligen kontrollera din classpath" },
            { "noParsermsg4", "Om du inte har IBMs XML-Tolk f\u00f6r Java, kan du ladda ner den fr\u00e5n" },
            ...
            { "optionFLAVOR", " [-FLAVOR flavorName (Anv\u00e4nd s2s=SAX eller d2d=DOM f\u00f6r transformationen.)] " }, // Added
                                                                                                                         // by
                                                                                                                         // sboag/scurcuru;
                                                                                                                         // experimental
            { "optionDIAG", " [-DIAG (Skriv ut totala transformationer, millisekunder.)]" },
            {
                    "optionINCREMENTAL",
            ...
            { "optionXD", " [-XD destinationDirectory (ange m\u00e5lkatalog f\u00f6r translet)]" },
            { "optionXJ", " [-XJ jarfile (paketerar transletklasserna i en jar-fil med namnet <jarfile>)]" },
            { "optionXP", " [-XP-paket (anger ett paketnamnsprefix f\u00f6r alla genererade transletklasser)]" }
