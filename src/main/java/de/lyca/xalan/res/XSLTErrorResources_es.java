...
public class XSLTErrorResources_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Error: No puede haber '{' dentro de la expresi\u00f3n" },
            ...
            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode es nulo en handleApplyTemplatesInstruction." },

            { ER_NO_NAME_ATTRIB, "{0} debe tener un atributo de nombre." },

            { ER_TEMPLATE_NOT_FOUND, "No se ha podido encontrar la plantilla: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT, "No se ha podido resolver AVT de nombre en xsl:call-template." },

            { ER_REQUIRES_ATTRIB, "{0} necesita un atributo: {1}" },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} debe tener un atributo ''test''." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Valor incorrecto en atributo de nivel: {0}" },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "Nombre de processing-instruction no puede ser 'xml'" },

            { ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
                    "Nombre de processing-instruction debe ser un NCName v\u00e1lido: {0}" },

            { ER_NEED_MATCH_ATTRIB, "{0} debe tener un atributo de coincidencia si tiene una modalidad." },

            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} necesita un atributo de nombre o de coincidencia." },

            { ER_CANT_RESOLVE_NSPREFIX, "No se puede resolver el prefijo del espacio de nombres: {0}" },

            { ER_ILLEGAL_VALUE, "xml:space tiene un valor no permitido: {0}" },

            { ER_NO_OWNERDOC, "El nodo hijo no tiene un documento propietario." },

            { ER_ELEMTEMPLATEELEM_ERR, "Error de ElemTemplateElement: {0}" },

            { ER_NULL_CHILD, "Intentando a\u00f1adir un hijo nulo" },
            ...
            { ER_NO_CONTEXT_OWNERDOC, "El contexto no tiene un documento propietario." },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "No se ha podido crear Liaison TransformerFactory XML: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "El proceso Xalan no ha sido satisfactorio." },
            ...
            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) Falta el atributo ''prefix'' de {0} " },

            { ER_BAD_STYLESHEET_URL, "El URL de la hoja de estilos es incorrecto: {0}" },

            { ER_FILE_NOT_FOUND, "No se ha encontrado el archivo de hoja de estilos: {0}" },

            { ER_IOEXCEPTION, "Se ha producido una excepci\u00f3n de ES con el archivo de hoja de estilos: {0}" },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) No se ha podido encontrar el atributo href para {0}" },
            ...
            { ER_MISSING_LANG_ATTRIB, "(StylesheetHandler) Falta el atributo ''lang'' de {0}" },
            ...
            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "No se puede serializar un XSLProcessor." },

            { ER_NO_INPUT_STYLESHEET, "No se ha especificado la entrada de hoja de estilos." },

            { ER_FAILED_PROCESS_STYLESHEET, "No se ha podido procesar la hoja de estilos." },

            { ER_COULDNT_PARSE_DOC, "No se ha podido analizar el documento {0}." },

            { ER_COULDNT_FIND_FRAGMENT, "No se ha podido encontrar el fragmento: {0}" },

            { ER_NODE_NOT_ELEMENT, "El nodo se\u00f1alado por un identificador de fragmento no es un elemento: {0}" },

            { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "for-each debe tener un atributo de coincidencia o de nombre." },

            { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB, "templates debe tener un atributo de coincidencia o de nombre." },

            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "No es r\u00e9plica de un fragmento de documento." },

            { ER_CANT_CREATE_ITEM, "No se puede crear el elemento en el \u00e1rbol de resultados: {0}" },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space en el XML fuente tiene un valor no permitido: {0}" },

            { ER_NO_XSLKEY_DECLARATION, "No hay declaraci\u00f3n xsl:key para {0}." },

            { ER_CANT_CREATE_URL, "Error. No se puede crear url para: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions no est\u00e1 soportado" },

            { ER_PROCESSOR_ERROR, "Error de XSLT TransformerFactory" },

            { ER_NOT_ALLOWED_INSIDE_STYLESHEET, "(StylesheetHandler) {0} no permitido dentro de una hoja de estilos." },

            { ER_RESULTNS_NOT_SUPPORTED, "Ya no se soporta result-ns.  Utilice xsl:output en su lugar." },

            { ER_DEFAULTSPACE_NOT_SUPPORTED,
                    "Ya no se soporta default-space.  Utilice xsl:strip-space o xsl:preserve-space en su lugar." },

            { ER_INDENTRESULT_NOT_SUPPORTED, "Ya no se soporta indent-result.  Utilice xsl:output en su lugar." },
            ...
            { ER_MISPLACED_XSLWHEN, "(StylesheetHandler) xsl:when equivocado." },

            { ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE, "(StylesheetHandler) xsl:when no emparentado por xsl:choose." },

            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise equivocado." },

            { ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
                    "(StylesheetHandler) xsl:otherwise no emparentado por xsl:choose." },

            { ER_NOT_ALLOWED_INSIDE_TEMPLATE, "(StylesheetHandler) {0} no permitido dentro de una plantilla." },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) Importaci\u00f3n propia de {0} directa o indirectamente." },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space tiene un valor no permitido: {0}" },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet no satisfactorio." },
            ...
            { ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX, "El prefijo en exclude-result-prefixes no es v\u00e1lido: {0}" },
            ...
            { ER_MALFORMED_FORMAT_STRING, "Serie de formato mal formada: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet necesita un atributo 'version'." },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Atributo: {0} tiene un valor no permitido: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose necesita un xsl:when" },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports no permitido en xsl:for-each" },

            { ER_CANT_USE_DTM_FOR_OUTPUT,
                    "No se puede utilizar DTMLiaison para un nodo DOM de salida... Pase de.lyca.xpath.DOM2Helper en su lugar." },

            { ER_CANT_USE_DTM_FOR_INPUT,
                    "No se puede utilizar DTMLiaison para un nodo DOM de entrada... Pase de.lyca.xpath.DOM2Helper en su lugar." },

            { ER_CALL_TO_EXT_FAILED, "Anomal\u00eda al llamar al elemento de extensi\u00f3n: {0}" },
            ...
            { ER_CANNOT_MIX_XERCESDOM, "No se puede mezclar la entrada Xerces-DOM con la salida Xerces-DOM." },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "Se ha encontrado m\u00e1s de una plantilla con el nombre: {0}" },
            ...
            { ER_ILLEGAL_DOMSOURCE_INPUT, "El nodo de entrada no puede ser nulo para DOMSource de newTemplates." },

            { ER_CLASS_NOT_FOUND_FOR_OPTION, "No se ha encontrado el archivo de clase para la opci\u00f3n {0}" },

            { ER_REQUIRED_ELEM_NOT_FOUND, "No se ha encontrado un elemento necesario: {0}" },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream no puede ser nulo" },

            { ER_URI_CANNOT_BE_NULL, "URI no puede ser nulo" },

            { ER_FILE_CANNOT_BE_NULL, "Archivo no puede ser nulo" },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource no puede ser nulo" },

            { ER_CANNOT_INIT_BSFMGR, "No se ha podido inicializar el Gestor BSF" },

            { ER_CANNOT_CMPL_EXTENSN, "No se ha podido compilar la extensi\u00f3n" },

            { ER_CANNOT_CREATE_EXTENSN, "No se ha podido crear la extensi\u00f3n: {0} como consecuencia de: {1}" },
            ...
            { ER_ELEMENT_NAME_METHOD_STATIC, "El m\u00e9todo del nombre de elemento debe ser est\u00e1tico {0}" },

            { ER_EXTENSION_FUNC_UNKNOWN, "Funci\u00f3n de extensi\u00f3n {0} : {1} desconocida" },

            { ER_MORE_MATCH_CONSTRUCTOR, "Hay m\u00e1s de una coincidencia m\u00e1xima para el constructor de {0}" },

            { ER_MORE_MATCH_METHOD, "Hay m\u00e1s de una coincidencia m\u00e1xima para el m\u00e9todo {0}" },

            { ER_MORE_MATCH_ELEMENT, "Hay m\u00e1s de una coincidencia m\u00e1xima para el m\u00e9todo de elemento {0}" },

            { ER_INVALID_CONTEXT_PASSED, "Se ha pasado un contexto no v\u00e1lido para evaluar {0}" },

            { ER_POOL_EXISTS, "La agrupaci\u00f3n ya existe" },

            { ER_NO_DRIVER_NAME, "No se ha especificado un nombre de controlador" },

            { ER_NO_URL, "No se ha especificado un URL" },

            { ER_POOL_SIZE_LESSTHAN_ONE, "El tama\u00f1o de la agrupaci\u00f3n es menor que uno." },

            { ER_INVALID_DRIVER, "Se ha especificado un nombre de controlador no v\u00e1lido." },

            { ER_NO_STYLESHEETROOT, "No se ha encontrado la ra\u00edz de la hoja de estilos." },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Valor no permitido para xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "Anomal\u00eda de processFromNode" },

            { ER_RESOURCE_COULD_NOT_LOAD, "No se ha podido cargar el recurso [ {0} ]: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Tama\u00f1o de almacenamiento intermedio <=0" },
            ...
            { ER_ELEM_CONTENT_NOT_ALLOWED, "No se permite el contenido del elemento para lang=javaclass {0}" },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Terminaci\u00f3n de hoja de estilos dirigida" },

            { ER_ONE_OR_TWO, "1 \u00f3 2" },

            { ER_TWO_OR_THREE, "2 \u00f3 3" },

            {
                    ER_COULD_NOT_LOAD_RESOURCE,
                    "No se ha podido cargar {0} (compruebe la CLASSPATH), ahora s\u00f3lo se est\u00e1n utilizando los valores predeterminados" },

            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "No se han podido inicializar las plantillas predeterminadas" },

            { ER_RESULT_NULL, "El resultado no deber\u00eda ser nulo" },

            { ER_RESULT_COULD_NOT_BE_SET, "No se ha podido establecer el resultado" },

            { ER_NO_OUTPUT_SPECIFIED, "No se ha especificado salida" },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "No se puede transformar un resultado de tipo {0} " },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "No se puede transformar un fuente de tipo {0} " },

            { ER_NULL_CONTENT_HANDLER, "Manejador de contenido nulo" },

            { ER_NULL_ERROR_HANDLER, "Manejador de error nulo" },

            { ER_CANNOT_CALL_PARSE, "No se puede llamar a parse si no se ha establecido ContentHandler" },

            { ER_NO_PARENT_FOR_FILTER, "No hay padre para el filtro" },

            { ER_NO_STYLESHEET_IN_MEDIA, "No se han encontrado hojas de estilos en: {0}, soporte= {1}" },

            { ER_NO_STYLESHEET_PI, "No se ha encontrado xml-stylesheet PI en: {0}" },

            { ER_NOT_SUPPORTED, "No soportado: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "El valor de la propiedad {0} deber\u00eda ser una instancia Boolean" },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "No se ha podido encontrar el script externo en {0}" },

            { ER_RESOURCE_COULD_NOT_FIND, "No se ha podido encontrar el recurso [ {0} ].\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "No se reconoce la propiedad de salida: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Anomal\u00eda al crear la instancia ElemLiteralResult" },
            ...
            { ER_VALUE_SHOULD_BE_NUMBER, "El valor para {0} deber\u00eda contener un n\u00famero analizable" },

            { ER_VALUE_SHOULD_EQUAL, "El valor de {0} deber\u00eda ser s\u00ed o no" },

            { ER_FAILED_CALLING_METHOD, "Anomal\u00eda al llamar al m\u00e9todo {0}" },

            { ER_FAILED_CREATING_ELEMTMPL, "Anomal\u00eda al crear la instancia ElemTemplateElement" },

            { ER_CHARS_NOT_ALLOWED, "No se permiten caracteres en este punto del documento" },
            ...
            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "No se ha reconocido el valor del atributo {0} " },

            { ER_NULL_URI_NAMESPACE, "Se ha intentado generar un prefijo de espacio de nombres con un URI nulo" },

            // New ERROR keys added in XALAN code base after Jdk 1.4 (Xalan
            // 2.2-D11)

            { ER_NUMBER_TOO_BIG, "Se ha intentado formatear un n\u00famero mayor que el entero largo m\u00e1s grande" },

            { ER_CANNOT_FIND_SAX1_DRIVER, "No se ha podido encontrar la clase de controlador SAX1 {0}" },
            ...
            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "La clase de controlador SAX1 {0} no implementa org.xml.sax.Parser" },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "No se ha especificado la propiedad del sistema org.xml.sax.parser" },
            ...
            { ER_NULL_ENTITY_RESOLVER, "Resolucionador de entidad nulo" },

            { ER_NULL_DTD_HANDLER, "Manejador DTD nulo" },

            { ER_NO_DRIVER_NAME_SPECIFIED, "No se ha especificado un nombre de controlador." },

            { ER_NO_URL_SPECIFIED, "No se ha especificado un URL." },

            { ER_POOLSIZE_LESS_THAN_ONE, "El tama\u00f1o de la agrupaci\u00f3n es menor que 1." },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Aserci\u00f3n del programador en RedundentExprEliminator: {0} " },

            { ER_NOT_ALLOWED_IN_POSITION, "{0} no est\u00e1 permitido en esta posici\u00f3n de la hoja de estilos." },
            ...
            { INVALID_QNAME, "Valor no permitido: se ha utilizado {1} para el atributo QNAME: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Valor no permitido: se ha utilizado {1} para el atributo NMTOKEN: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NCNAME, "Valor no permitido: se ha utilizado {1} para el atributo NCNAME: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_BOOLEAN, "Valor no permitido: se ha utilizado {1} para el atributo boolean: {0} " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Valor no permitido: se ha utilizado {1} para el atributo number: {0} " },
            ...
            { ER_ARG_LITERAL, "El argumento para {0} en el patr\u00f3n de coincidencia debe ser un literal." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Declaraci\u00f3n de variable global duplicada." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Declaraci\u00f3n de variable duplicada." },
            ...
            { ER_NO_ATTRIB_SET, "attribute-set de nombre {0} no existe" },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "La funci\u00f3n de nombre {0} no existe" },
            ...
            { ER_CANT_HAVE_CONTENT_AND_SELECT, "El elemento {0} no debe tener contenido y un atributo select." },

            // Note to translators: This message indicates that the value
            // argument
            // of setParameter must be a valid Java Object.
            { ER_INVALID_SET_PARAM_VALUE, "El valor del par\u00e1metro {0} debe ser un objeto Java v\u00e1lido" },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "El nombre de funci\u00f3n no puede ser nulo." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "La aridad no puede ser negativa." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "Se ha encontrado '}' pero no se ha abierto una plantilla de atributos." },
            ...
            { WG_LOCALE_NOT_FOUND, "Aviso: No se ha podido encontrar el entorno local para xml:lang={0}" },

            { WG_CANNOT_MAKE_URL_FROM, "No se puede crear URL desde: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "No se puede cargar el doc solicitado: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "No se ha podido encontrar clasificador para <sort xml:lang={0}" },

            { WG_FUNCTIONS_SHOULD_USE_URL,
                    "Sintaxis antigua: La instrucci\u00f3n functions deber\u00eda utilizar un url de {0}" },

            { WG_ENCODING_NOT_SUPPORTED_USING_UTF8, "Codificaci\u00f3n no soportada: {0}, se utiliza UTF-8" },

            { WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "Codificaci\u00f3n no soportada: {0}, se utiliza Java {1}" },
            ...
            { WG_NO_DECIMALFORMAT_DECLARATION, "No se ha encontrado declaraci\u00f3n para el formato decimal: {0}" },
            ...
            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Se ha utilizado un valor no permitido para el atributo {0}: {1}" },
            ...
            { NO_MODIFICATION_ALLOWED_ERR, "Se ha intentado modificar un objeto que no admite modificaciones. " },
            ...
            {
                    "xslProc_no_input",
                    "Error: No se ha especificado ninguna hoja de estilos ni xml de entrada. Ejecute este mandato sin opciones para ver las instrucciones de uso." },
            ...
            { "optionLF",
                    "[-LF (Utilizar s\u00f3lo avances de l\u00ednea en la salida {el valor predeterminado es CR/LF})]" },
            { "optionCR",
                    "[-CR (Utilizar s\u00f3lo retornos de carro en la salida {el valor predeterminado es CR/LF})]" },
            { "optionESCAPE", "[-ESCAPE (Caracteres con escape {el valor predeterminado es <>&\"\'\\r\\n}]" },
            { "optionINDENT",
                    "[-INDENT (Controlar el n\u00famero de espacios de sangrado {el valor predeterminado es 0})]" },
            ...
            {
                    "optionVALIDATE",
                    "[-VALIDATE (Establecer si se realiza la validaci\u00f3n.  De forma predeterminada la validaci\u00f3n est\u00e1 desactivada.)]" },
            ...
            { "optionENTITYRESOLVER",
                    "[-ENTITYRESOLVER nombre de clase completo (EntityResolver a utilizar para resolver entidades)]" },
            { "optionCONTENTHANDLER",
                    "[-CONTENTHANDLER nombre de clase completo (ContentHandler a utilizar para serializar la salida)]" },
            ...
            { "optionMEDIA",
                    "[-MEDIA tipo_soporte (Utilizar el atributo de soporte para encontrar la hoja de estilos asociada con un documento.)]" },
            { "optionFLAVOR",
                    "[-FLAVOR nombre_estilo (Utilizar expl\u00edcitamente s2s=SAX o d2d=DOM para realizar la transformaci\u00f3n.)] " }, // Added
                                                                                                                                         // by
                                                                                                                                         // sboag/scurcuru;
                                                                                                                                         // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "[-INCREMENTAL (Solicitar construcci\u00f3n DTM incremental estableciendo http://xml.apache.org/xalan/features/incremental como verdadero.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "[-NOOPTIMIMIZE (Solicitar proceso de optimizaci\u00f3n de hoja de estilos estableciendo http://xml.apache.org/xalan/features/optimize como falso.)]" },
            {
                    "optionRL",
                    "[-RL l\u00edmite_recursi\u00f3n (L\u00edmite num\u00e9rico de aserci\u00f3n sobre profundidad de recursi\u00f3n de hoja de estilos.)]" },
            ...
            { "optionXP",
                    "[-XP paquete (Especifica un prefijo para el nombre del paquete de todas las clases translet generadas)]" },
