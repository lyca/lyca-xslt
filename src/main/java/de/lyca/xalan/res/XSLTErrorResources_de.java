...
public class XSLTErrorResources_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
            ...
            { ER_NO_CURLYBRACE, "Fehler: '{' darf nicht innerhalb des Ausdrucks stehen." },

            { ER_ILLEGAL_ATTRIBUTE, "{0} hat ein unzul\u00e4ssiges Attribut {1}." },

            { ER_NULL_SOURCENODE_APPLYIMPORTS, "sourceNode ist Null in xsl:apply-imports!" },

            { ER_CANNOT_ADD, "{0} kann nicht {1} hinzugef\u00fcgt werden." },

            { ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES, "sourceNode ist Null in handleApplyTemplatesInstruction!" },

            { ER_NO_NAME_ATTRIB, "{0} muss ein Namensattribut haben." },

            { ER_TEMPLATE_NOT_FOUND, "Vorlage konnte nicht gefunden werden: {0}" },

            { ER_CANT_RESOLVE_NAME_AVT,
                    "Namensvorlage f\u00fcr den Attributwert in xsl:call-template konnte nicht aufgel\u00f6st werden." },

            { ER_REQUIRES_ATTRIB, "{0} erfordert das Attribut {1}." },

            { ER_MUST_HAVE_TEST_ATTRIB, "{0} muss \u00fcber ein Attribut ''test'' verf\u00fcgen." },

            { ER_BAD_VAL_ON_LEVEL_ATTRIB, "Falscher Wert f\u00fcr Ebenenattribut: {0}." },

            { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "Name der Verarbeitungsanweisung darf nicht 'xml' sein." },
            ...
            { ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} erfordert einen Namen oder ein \u00dcbereinstimmungsattribut." },

            { ER_CANT_RESOLVE_NSPREFIX, "Pr\u00e4fix des Namensbereichs kann nicht aufgel\u00f6st werden: {0}." },

            { ER_ILLEGAL_VALUE, "xml:space weist einen ung\u00fcltigen Wert auf: {0}" },

            { ER_NO_OWNERDOC, "Der Kindknoten hat kein Eignerdokument!" },

            { ER_ELEMTEMPLATEELEM_ERR, "ElemTemplateElement-Fehler: {0}" },

            { ER_NULL_CHILD, "Es wird versucht, ein leeres Kind hinzuzuf\u00fcgen!" },

            { ER_NEED_SELECT_ATTRIB, "{0} erfordert ein Attribut ''''select''''." },

            { ER_NEED_TEST_ATTRIB, "xsl:when muss \u00fcber ein Attribut 'test' verf\u00fcgen." },

            { ER_NEED_NAME_ATTRIB, "xsl:with-param muss \u00fcber ein Attribut 'name' verf\u00fcgen." },

            { ER_NO_CONTEXT_OWNERDOC, "Der Kontextknoten verf\u00fcgt nicht \u00fcber ein Eignerdokument!" },

            { ER_COULD_NOT_CREATE_XML_PROC_LIAISON, "XML-TransformerFactory-Liaison konnte nicht erstellt werden: {0}" },

            { ER_PROCESS_NOT_SUCCESSFUL, "Xalan:-Prozess konnte nicht erfolgreich durchgef\u00fchrt werden." },

            { ER_NOT_SUCCESSFUL, "Xalan: war nicht erfolgreich." },

            { ER_ENCODING_NOT_SUPPORTED, "Verschl\u00fcsselung wird nicht unterst\u00fctzt: {0}." },

            { ER_COULD_NOT_CREATE_TRACELISTENER, "TraceListener konnte nicht erstellt werden: {0}." },

            { ER_KEY_REQUIRES_NAME_ATTRIB, "xsl:key erfordert ein Attribut 'name'!" },

            { ER_KEY_REQUIRES_MATCH_ATTRIB, "xsl:key erfordert ein Attribut 'match'!" },

            { ER_KEY_REQUIRES_USE_ATTRIB, "xsl:key erfordert ein Attribut 'use'!" },

            { ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} erfordert ein Attribut ''elements''!" },

            { ER_MISSING_PREFIX_ATTRIB, "(StylesheetHandler) {0}: Das Attribut ''prefix'' fehlt." },

            { ER_BAD_STYLESHEET_URL, "Formatvorlagen-URL-Adresse ist ung\u00fcltig: {0}." },

            { ER_FILE_NOT_FOUND, "Formatvorlagendatei konnte nicht gefunden werden: {0}." },

            { ER_IOEXCEPTION, "Bei folgender Formatvorlagendatei ist eine E/A-Ausnahmebedingung aufgetreten: {0}." },

            { ER_NO_HREF_ATTRIB, "(StylesheetHandler) Attribut ''href'' f\u00fcr {0} konnte nicht gefunden werden." },

            { ER_STYLESHEET_INCLUDES_ITSELF,
                    "(StylesheetHandler) {0} schlie\u00dft sich selbst direkt oder indirekt mit ein!" },

            { ER_PROCESSINCLUDE_ERROR, "Fehler in StylesheetHandler.processInclude, {0}." },
            ...
            { ER_PROCESS_ERROR, "Fehler in StylesheetRoot.process" },

            { ER_UNIMPLNODE_ERROR, "UnImplNode-Fehler: {0}" },

            { ER_NO_SELECT_EXPRESSION, "Fehler! xpath-Auswahlausdruck (-select) konnte nicht gefunden werden." },

            { ER_CANNOT_SERIALIZE_XSLPROCESSOR, "XSLProcessor kann nicht serialisiert werden!" },

            { ER_NO_INPUT_STYLESHEET, "Formatvorlageneingabe wurde nicht angegeben!" },

            { ER_FAILED_PROCESS_STYLESHEET, "Verarbeitung der Formatvorlage fehlgeschlagen!" },

            { ER_COULDNT_PARSE_DOC, "Dokument {0} konnte nicht syntaktisch analysiert werden!" },

            { ER_COULDNT_FIND_FRAGMENT, "Fragment konnte nicht gefunden werden: {0}." },

            { ER_NODE_NOT_ELEMENT, "Der Knoten, auf den von einer Fragment-ID verwiesen wurde, war kein Element: {0}." },

            { ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB, "'for-each' muss entweder ein Attribut 'match' oder 'name' haben." },

            { ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB,
                    "Vorlagen m\u00fcssen entweder ein Attribut 'match' oder 'name' haben." },

            { ER_NO_CLONE_OF_DOCUMENT_FRAG, "Kein Klon eines Dokumentfragments!" },

            { ER_CANT_CREATE_ITEM, "Im Ergebnisbaum kann kein Eintrag erzeugt werden: {0}." },

            { ER_XMLSPACE_ILLEGAL_VALUE, "xml:space in der Quellen-XML hat einen ung\u00fcltigen Wert: {0}." },

            { ER_NO_XSLKEY_DECLARATION, "Keine Deklaration xsl:key f\u00fcr {0} vorhanden!" },

            { ER_CANT_CREATE_URL, "Fehler! URL kann nicht erstellt werden f\u00fcr: {0}" },

            { ER_XSLFUNCTIONS_UNSUPPORTED, "xsl:functions wird nicht unterst\u00fctzt." },
            ...
            { ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise steht an der falschen Position!" },
            ...
            { ER_IMPORTING_ITSELF, "(StylesheetHandler) {0} importiert sich direkt oder indirekt selbst!" },

            { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space hat einen ung\u00fcltigen Wert: {0}." },

            { ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet nicht erfolgreich!" },

            { ER_SAX_EXCEPTION, "SAX-Ausnahmebedingung" },
            ...
            { ER_MISSING_NS_URI, "Fehlende Namensbereichs-URI f\u00fcr angegebenes Pr\u00e4fix." },

            { ER_MISSING_ARG_FOR_OPTION, "Fehlendes Argument f\u00fcr Option: {0}." },

            { ER_INVALID_OPTION, "Ung\u00fcltige Option: {0}" },

            { ER_MALFORMED_FORMAT_STRING, "Syntaktisch falsche Formatzeichenfolge: {0}" },

            { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet erfordert ein Attribut 'version'!" },

            { ER_ILLEGAL_ATTRIBUTE_VALUE, "Attribut {0} weist einen ung\u00fcltigen Wert auf: {1}" },

            { ER_CHOOSE_REQUIRES_WHEN, "xsl:choose erfordert xsl:when." },

            { ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports ist in xsl:for-each nicht zul\u00e4ssig." },

            {
                    ER_CANT_USE_DTM_FOR_OUTPUT,
                    "DTMLiaison kann nicht f\u00fcr einen Ausgabe-Dokumentobjektmodellknoten verwendet werden... \u00dcbergeben Sie stattdessen de.lyca.xpath.DOM2Helper!" },

            {
                    ER_CANT_USE_DTM_FOR_INPUT,
                    "DTMLiaison kann nicht f\u00fcr einen Eingabe-Dokumentobjektmodellknoten verwendet werden... \u00dcbergeben Sie stattdessen de.lyca.xpath.DOM2Helper!" },

            { ER_CALL_TO_EXT_FAILED, "Aufruf an Erweiterungselement fehlgeschlagen: {0}." },

            { ER_PREFIX_MUST_RESOLVE, "Das Pr\u00e4fix muss in einen Namensbereich aufgel\u00f6st werden: {0}" },
            ...
            { ER_DUPLICATE_NAMED_TEMPLATE, "Mehrere Vorlagen mit folgendem Namen gefunden: {0}." },
            ...
            { ER_CLASS_NOT_FOUND_FOR_OPTION, "Klassendatei f\u00fcr Option {0} wurde nicht gefunden." },

            { ER_REQUIRED_ELEM_NOT_FOUND, "Erforderliches Element nicht gefunden: {0}." },

            { ER_INPUT_CANNOT_BE_NULL, "InputStream kann nicht Null sein." },

            { ER_URI_CANNOT_BE_NULL, "URI kann nicht Null sein." },

            { ER_FILE_CANNOT_BE_NULL, "Eine Datei kann nicht Null sein." },

            { ER_SOURCE_CANNOT_BE_NULL, "InputSource kann nicht Null sein." },

            { ER_CANNOT_INIT_BSFMGR, "BSF Manager kann nicht initialisiert werden." },

            { ER_CANNOT_CMPL_EXTENSN, "Erweiterung konnte nicht kompiliert werden." },

            { ER_CANNOT_CREATE_EXTENSN, "Erweiterung {0} konnte nicht erstellt werden. Ursache: {1}." },
            ...
            { ER_MORE_MATCH_CONSTRUCTOR, "Mehrere passende Entsprechungen f\u00fcr Konstruktor f\u00fcr {0}." },

            { ER_MORE_MATCH_METHOD, "Mehrere passende Entsprechungen f\u00fcr Methode {0}." },

            { ER_MORE_MATCH_ELEMENT, "Mehrere passende Entsprechungen f\u00fcr Elementmethode {0}." },
            ...
            { ER_NO_URL, "Keine URL-Adresse angegeben." },

            { ER_POOL_SIZE_LESSTHAN_ONE, "Poolgr\u00f6\u00dfe ist kleiner als Eins!" },

            { ER_INVALID_DRIVER, "Ung\u00fcltiger Treibername angegeben!" },

            { ER_NO_STYLESHEETROOT, "Root der Formatvorlage konnte nicht gefunden werden!" },

            { ER_ILLEGAL_XMLSPACE_VALUE, "Ung\u00fcltiger Wert f\u00fcr xml:space" },

            { ER_PROCESSFROMNODE_FAILED, "processFromNode ist fehlgeschlagen." },

            { ER_RESOURCE_COULD_NOT_LOAD, "Die Ressource [ {0} ] konnte nicht geladen werden: {1} \n {2} \t {3}" },

            { ER_BUFFER_SIZE_LESSTHAN_ZERO, "Puffergr\u00f6\u00dfe <=0" },

            { ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Unbekannter Fehler beim Aufrufen der Erweiterung." },

            { ER_NO_NAMESPACE_DECL, "Pr\u00e4fix {0} hat keine entsprechende Namensbereichsdeklaration." },

            { ER_ELEM_CONTENT_NOT_ALLOWED, "Elementinhalt nicht zul\u00e4ssig f\u00fcr lang=javaclass {0}." },

            { ER_STYLESHEET_DIRECTED_TERMINATION, "Formatvorlage hat die Beendigung ausgel\u00f6st." },
            ...
            { ER_CANNOT_INIT_DEFAULT_TEMPLATES, "Standardvorlagen k\u00f6nnen nicht initialisiert werden." },

            { ER_RESULT_NULL, "Das Ergebnis darf nicht Null sein." },

            { ER_RESULT_COULD_NOT_BE_SET, "Das Ergebnis konnte nicht festgelegt werden." },

            { ER_NO_OUTPUT_SPECIFIED, "Keine Ausgabe angegeben." },

            { ER_CANNOT_TRANSFORM_TO_RESULT_TYPE, "Umsetzen in ein Ergebnis des Typs {0} ist nicht m\u00f6glich" },

            { ER_CANNOT_TRANSFORM_SOURCE_TYPE, "Umsetzen einer Quelle des Typs {0} ist nicht m\u00f6glich" },

            { ER_NULL_CONTENT_HANDLER, "Es ist keine Inhaltssteuerroutine vorhanden." },

            { ER_NULL_ERROR_HANDLER, "Kein Fehlerbehandlungsprogramm vorhanden" },

            { ER_CANNOT_CALL_PARSE,
                    "Die Syntaxanalyse kann nicht aufgerufen werden, wenn ContentHandler nicht festgelegt wurde." },

            { ER_NO_PARENT_FOR_FILTER, "Kein Elter f\u00fcr Filter vorhanden" },

            { ER_NO_STYLESHEET_IN_MEDIA, "Keine Formatvorlage gefunden in: {0}, Datentr\u00e4ger= {1}." },

            { ER_NO_STYLESHEET_PI, "Keine Verarbeitungsanweisung f\u00fcr xml-stylesheet gefunden in {0}." },

            { ER_NOT_SUPPORTED, "Nicht unterst\u00fctzt: {0}" },

            { ER_PROPERTY_VALUE_BOOLEAN, "Der Wert f\u00fcr Merkmal {0} sollte eine Boolesche Instanz sein." },

            { ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Externes Script bei {0} konnte nicht erreicht werden." },

            { ER_RESOURCE_COULD_NOT_FIND, "Die Ressource [ {0} ] konnte nicht gefunden werden.\n {1}" },

            { ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "Ausgabemerkmal nicht erkannt: {0}" },

            { ER_FAILED_CREATING_ELEMLITRSLT, "Das Erstellen der Instanz ElemLiteralResult ist fehlgeschlagen." },
            ...
            { ER_VALUE_SHOULD_BE_NUMBER, "Der Wert f\u00fcr {0} sollte eine syntaktisch analysierbare Zahl sein." },

            { ER_VALUE_SHOULD_EQUAL, "Der Wert f\u00fcr {0} sollte ''''yes'''' oder ''''no'''' entsprechen." },

            { ER_FAILED_CALLING_METHOD, "Aufruf von Methode {0} ist fehlgeschlagen" },

            { ER_FAILED_CREATING_ELEMTMPL, "Das Erstellen der Instanz ElemTemplateElement ist fehlgeschlagen." },

            { ER_CHARS_NOT_ALLOWED, "Zeichen sind an dieser Stelle im Dokument nicht zul\u00e4ssig." },

            { ER_ATTR_NOT_ALLOWED, "Das Attribut \"{0}\" ist im Element {1} nicht zul\u00e4ssig!" },

            { ER_BAD_VALUE, "{0} ung\u00fcltiger Wert {1} " },

            { ER_ATTRIB_VALUE_NOT_FOUND, "Attributwert {0} wurde nicht gefunden " },

            { ER_ATTRIB_VALUE_NOT_RECOGNIZED, "Attributwert {0} wurde nicht erkannt " },

            { ER_NULL_URI_NAMESPACE, "Es wird versucht, ein Namensbereichspr\u00e4fix mit einer Null-URI zu erzeugen." },
            ...
            { ER_CANNOT_FIND_SAX1_DRIVER, "SAX1-Treiberklasse {0} konnte nicht gefunden werden." },

            { ER_SAX1_DRIVER_NOT_LOADED, "SAX1-Treiberklasse {0} gefunden, kann aber nicht geladen werden." },

            { ER_SAX1_DRIVER_NOT_INSTANTIATED, "SAX1-Treiberklasse {0} geladen, kann aber nicht instanziert werden." },

            { ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER, "SAX1-Treiberklasse {0} implementiert nicht org.xml.sax.Parser." },

            { ER_PARSER_PROPERTY_NOT_SPECIFIED, "Systemmerkmal org.xml.sax.parser ist nicht angegeben." },

            { ER_PARSER_ARG_CANNOT_BE_NULL, "Parserargument darf nicht Null sein." },

            { ER_FEATURE, "Feature: {0}" },

            { ER_PROPERTY, "Merkmal: {0}" },

            { ER_NULL_ENTITY_RESOLVER, "Es ist keine Entit\u00e4tenaufl\u00f6sungsroutine vorhanden." },

            { ER_NULL_DTD_HANDLER, "Es ist keine Steuerroutine f\u00fcr Dokumenttypbeschreibungen vorhanden." },

            { ER_NO_DRIVER_NAME_SPECIFIED, "Kein Treibername angegeben!" },

            { ER_NO_URL_SPECIFIED, "Keine URL-Adresse angegeben!" },
            ...
            // be
            // translated.
            { ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Programmiererfestlegung in RedundentExprEliminator: {0}" },

            { ER_NOT_ALLOWED_IN_POSITION, "{0} ist an dieser Position in der Formatvorlage nicht zul\u00e4ssig!" },
            ...
            { INVALID_QNAME, "Unzul\u00e4ssiger Wert {1} f\u00fcr QNAME-Attribut verwendet: {0}" },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NMTOKEN, "Unzul\u00e4ssiger Wert {1} f\u00fcr NMTOKEN-Attribut verwendet: {0}. " },
            ...
            // text {1} is
            // the attribute value and {0} is the attribute name.
            { INVALID_NUMBER, "Unzul\u00e4ssiger Wert {1} f\u00fcr NUMBER-Attribut verwendet: {0}. " },
            ...
            { ER_ARG_LITERAL, "Argument von {0} in Suchmuster muss ein Literal sein." },
            ...
            { ER_DUPLICATE_GLOBAL_VAR, "Doppelte Deklaration einer globalen Variablen." },

            // Note to translators: The following message indicates that two
            // definitions of
            // a variable were encountered.
            // ER_DUPLICATE_VAR - new error message for bugzilla #790
            { ER_DUPLICATE_VAR, "Doppelte Deklaration einer Variablen." },

            // Note to translators: "xsl:template, "name" and "match" are XSLT
            // keywords
            // which must not be translated.
            // ER_TEMPLATE_NAME_MATCH - new error message for bugzilla #789
            { ER_TEMPLATE_NAME_MATCH, "xsl:template muss ein Attribut 'name' und/oder 'match' haben." },
            ...
            { ER_NO_ATTRIB_SET, "Die Attributgruppe {0} ist nicht vorhanden." },
            ...
            // found.
            { ER_FUNCTION_NOT_FOUND, "Die Funktion {0} ist nicht vorhanden." },
            ...
            { ER_INVALID_SET_PARAM_VALUE, "Der Wert von Parameter {0} muss ein g\u00fcltiges Java-Objekt sein." },
            ...
            { ER_UNSUPPORTED_FEATURE, "Die Funktion ''{0}'' kann in dieser TransformerFactory nicht festgelegt werden." },
            ...
            { ER_XPATH_RESOLVER_NULL_QNAME, "Es muss ein Funktionsname angegeben werden." },

            { ER_XPATH_RESOLVER_NEGATIVE_ARITY, "Die Stelligkeit darf nicht negativ sein." },

            // Warnings...

            { WG_FOUND_CURLYBRACE, "'}' gefunden, es ist aber keine Attributvorlage ge\u00f6ffnet!" },
            ...
            { WG_CANNOT_MAKE_URL_FROM, "URL konnte nicht erstellt werden aus: {0}" },

            { WG_CANNOT_LOAD_REQUESTED_DOC, "Angefordertes Dokument kann nicht geladen werden: {0}" },

            { WG_CANNOT_FIND_COLLATOR, "Collator f\u00fcr <sort xml:lang={0} konnte nicht gefunden werden." },
            ...
            { WG_PARSING_AND_PREPARING, "========= Syntaxanalyse und Vorbereitung von {0} ==========" },
            ...
            { WG_ATTRIB_NOT_HANDLED, "Xalan bearbeitet noch nicht das Attribut {0}!" },

            { WG_NO_DECIMALFORMAT_DECLARATION, "Keine Deklaration f\u00fcr Dezimalformat gefunden: {0}" },

            { WG_OLD_XSLT_NS, "Fehlender oder ung\u00fcltiger XSLT-Namensbereich " },
            ...
            { WG_ILLEGAL_ATTRIBUTE, "{0} hat ein unzul\u00e4ssiges Attribut {1}." },

            { WG_COULD_NOT_RESOLVE_PREFIX,
                    "Namensbereichspr\u00e4fix konnte nicht aufgel\u00f6st werden: {0}. Der Knoten wird ignoriert." },

            { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet erfordert ein Attribut 'version'!" },

            { WG_ILLEGAL_ATTRIBUTE_NAME, "Unzul\u00e4ssiger Attributname: {0}" },

            { WG_ILLEGAL_ATTRIBUTE_VALUE, "Unzul\u00e4ssiger Wert f\u00fcr Attribut {0} verwendet: {1}" },
            ...
            {
                    "xslProc_no_input",
                    "Fehler: Es wurde keine Formatvorlagen- oder Eingabe-XML angegeben. F\u00fchren Sie diesen Befehl ohne Optionen f\u00fcr Syntaxanweisungen aus." },
            ...
            { "optionINDENT",
                    "[-INDENT (Steuerung, um wie viele Leerzeichen einger\u00fcckt werden soll {Standardeinstellung ist 0})]" },
            ...
            { "optionTTC",
                    "[-TTC (Trace f\u00fcr die untergeordneten Vorlagen ausf\u00fchren, wenn sie verarbeitet werden.)]" },
            { "optionTCLASS", "[-TCLASS (TraceListener-Klasse f\u00fcr Trace-Erweiterungen.)]" },
            {
                    "optionVALIDATE",
                    "[-VALIDATE (Festlegen, ob eine G\u00fcltigkeitspr\u00fcfung erfolgen soll. Die G\u00fcltigkeitspr\u00fcfung ist standardm\u00e4\u00dfig ausgeschaltet.)]" },
            ...
            { "noParsermsg4",
                    "Wenn Sie nicht \u00fcber einen IBM XML-Parser f\u00fcr Java verf\u00fcgen, k\u00f6nnen Sie ihn herunterladen:" },
            { "noParsermsg5", "IBM AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" },
            { "optionURIRESOLVER",
                    "[-URIRESOLVER vollst\u00e4ndiger Klassenname (URIResolver wird zum Aufl\u00f6sen von URIs verwendet)]" },
            { "optionENTITYRESOLVER",
                    "[-ENTITYRESOLVER vollst\u00e4ndiger Klassenname (EntityResolver wird zum Aufl\u00f6sen von Entit\u00e4ten verwendet)]" },
            { "optionCONTENTHANDLER",
                    "[-CONTENTHANDLER vollst\u00e4ndiger Klassenname (ContentHandler wird zum Serialisieren der Ausgabe verwendet)]" },
            ...
            {
                    "optionMEDIA",
                    "[-MEDIA Datentr\u00e4gerTyp (Datentr\u00e4gerattribut verwenden, um die einem Dokument zugeordnete Formatvorlage zu suchen.)]" },
            { "optionFLAVOR",
                    "[-FLAVOR WunschName (Explizit s2s=SAX oder d2d=DOM verwenden, um die Umsetzung auszuf\u00fchren.)] " }, // Added
                                                                                                                             // by
                                                                                                                             // sboag/scurcuru;
                                                                                                                             // experimental
            ...
            {
                    "optionINCREMENTAL",
                    "[-INCREMENTAL (Inkrementelle DTM-Erstellung mit der Einstellung 'true' f\u00fcr http://xml.apache.org/xalan/features/incremental anfordern.)]" },
            {
                    "optionNOOPTIMIMIZE",
                    "[-NOOPTIMIMIZE (Mit der Einstellung 'false' f\u00fcr 'http://xml.apache.org/xalan/features/optimize' anfordern, dass keine Formatvorlagenoptimierung ausgef\u00fchrt wird.)]" },
            { "optionRL",
                    "[-RL Verschachtelungsbegrenzung (Numerische Begrenzung f\u00fcr Verschachtelungstiefe der Formatvorlage festlegen.)]" },
            ...
            { "nameIs", "Der Name ist" }, { "matchPatternIs", "Das Suchmuster ist" }
