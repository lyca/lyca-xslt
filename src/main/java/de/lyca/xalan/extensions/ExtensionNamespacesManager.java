...
public class ExtensionNamespacesManager {
  ...
  public void registerExtension(String namespace) {
    if (namespaceIndex(namespace, m_extensions) == -1) {
      final int predef = namespaceIndex(namespace, m_predefExtensions);
      if (predef != -1) {
   ...
   * "component" declaration or exslt function declaration, attempt to create an
   * ExtensionNamespaceSuport object for the appropriate Java class or Java
   * package Extension Handler.
   * 
   * Called by StylesheetRoot.recompose(), after all ElemTemplate compose()
   * operations have taken place, in order to set up handlers for the remaining
   * extension namespaces.
   * 
   * @param ns
   *          The extension namespace URI.
   * @return An ExtensionNamespaceSupport object for this namespace (which
   *         defines the ExtensionHandler to be used), or null if such an object
   *         cannot be created.
   * 
  ...
  public ExtensionNamespaceSupport defineJavaNamespace(String ns, String classOrPackage) {
    ...
    try {
      ...
      return new ExtensionNamespaceSupport(ns, "de.lyca.xalan.extensions.ExtensionHandlerJavaClass", new Object[] { ns,
              "javaclass", className });
    } catch (final ClassNotFoundException e) {
      return new ExtensionNamespaceSupport(ns, "de.lyca.xalan.extensions.ExtensionHandlerJavaPackage", new Object[] {
              ns, "javapackage", className + "." });
    }
  }
  ...
  private void setPredefinedNamespaces() {
    String uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_JAVA_URL;
    String handlerClassName = "de.lyca.xalan.extensions.ExtensionHandlerJavaPackage";
    String lang = "javapackage";
    String lib = "";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_OLD_JAVA_URL;
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_LOTUSXSL_JAVA_URL;
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_BUILTIN_EXTENSIONS_URL;
    handlerClassName = "de.lyca.xalan.extensions.ExtensionHandlerJavaClass";
    lang = "javaclass"; // for remaining predefined extension namespaces.
    lib = "de.lyca.xalan.lib.Extensions";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_BUILTIN_OLD_EXTENSIONS_URL;
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    // Xalan extension namespaces (redirect, pipe and SQL).
    uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_REDIRECT_URL;
    lib = "de.lyca.xalan.lib.Redirect";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_PIPE_URL;
    lib = "de.lyca.xalan.lib.PipeDocument";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXTENSIONS_SQL_URL;
    lib = "de.lyca.xalan.lib.sql.XConnection";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    // EXSLT namespaces (not including EXSLT function namespaces which are
    // registered by the associated ElemFunction.
    uri = de.lyca.xml.utils.Constants.S_EXSLT_COMMON_URL;
    lib = "de.lyca.xalan.lib.ExsltCommon";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXSLT_MATH_URL;
    lib = "de.lyca.xalan.lib.ExsltMath";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXSLT_SETS_URL;
    lib = "de.lyca.xalan.lib.ExsltSets";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXSLT_DATETIME_URL;
    lib = "de.lyca.xalan.lib.ExsltDatetime";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXSLT_DYNAMIC_URL;
    lib = "de.lyca.xalan.lib.ExsltDynamic";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));

    uri = de.lyca.xml.utils.Constants.S_EXSLT_STRINGS_URL;
    lib = "de.lyca.xalan.lib.ExsltStrings";
    m_predefExtensions.add(new ExtensionNamespaceSupport(uri, handlerClassName, new Object[] { uri, lang, lib }));
  }
