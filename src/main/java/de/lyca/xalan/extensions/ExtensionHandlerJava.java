...
public abstract class ExtensionHandlerJava extends ExtensionHandler {
   ...
   * @param srcURL
   *          value of src attribute (if any) - treated as a URL or a classname
   *          depending on the value of lang. If srcURL is not null, then
   *          scriptSrc is ignored.
   * @param scriptSrc
   ...
   * 
   * @param methodKey
   *          A key that uniquely identifies this invocation in the stylesheet.
   * @param objType
