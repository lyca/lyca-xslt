...
final class ObjectFactory {
  ...
  /**
   * cache the contents of the xalan.properties file. Until an attempt has been
   * made to read this file, this will be null; if the file does not exist or we
   * encounter some other error during the read, this will be empty.
   */
  ...
  static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
    ...
    try {
      final String systemProp = SecuritySupport.getSystemProperty(factoryId);
      if (systemProp != null) {
    ...
    if (propertiesFilename == null) {
      ...
      try {
        final String javah = SecuritySupport.getSystemProperty("java.home");
  ...
  static ClassLoader findClassLoader() throws ConfigurationError {
    ...
    final ClassLoader system = SecuritySupport.getSystemClassLoader();
  ...
  private static String findJarServiceProviderName(String factoryId) {
    final String serviceId = SERVICES_PATH + factoryId;
    InputStream is = null;
