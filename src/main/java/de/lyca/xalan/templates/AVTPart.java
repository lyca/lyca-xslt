...
/**
 * Class to hold a part, either a string or XPath, of an Attribute Value
 * Template.
 * 
 * @xsl.usage internal
 */
public abstract class AVTPart implements java.io.Serializable, XSLTVisitable {
   ...
   */
  public abstract void evaluate(XPathContext xctxt, FastStringBuffer buf, int context,
          de.lyca.xml.utils.PrefixResolver nsNode) throws javax.xml.transform.TransformerException;
