...
public class ElemNumber extends ElemTemplateElement 
{
  ...
  */
            ...
            throws javax.xml.transform.TransformerException
  {
        ...
        if (null == m_alphaCountTable){
                thisBundle =
                  (XResourceBundle) XResourceBundle.loadResourceBundle(
                    de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, getLocale(transformer, contextNode));
                m_alphaCountTable = (CharArrayWrapper) thisBundle.getObject(de.lyca.xml.utils.res.XResourceBundle.LANG_ALPHABET);                
        }
    ...
    case 0x3042 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("ja", "JP", "HA"));
    ...
    case 0x3044 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("ja", "JP", "HI"));
    ...
    case 0x30A2 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("ja", "JP", "A"));
    ...
    case 0x30A4 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("ja", "JP", "I"));
    ...
    case 0x4E00 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("zh", "CN"));
    ...
    case 0x58F9 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("zh", "TW"));
    ...
    case 0x0E51 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("th", ""));
    ...
    case 0x05D0 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("he", ""));
    ...
    case 0x10D0 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("ka", ""));
    ...
    case 0x03B1 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("el", ""));
    ...
    case 0x0430 :
    {
      ...
      thisBundle = (XResourceBundle) XResourceBundle.loadResourceBundle(
        de.lyca.xml.utils.res.XResourceBundle.LANG_BUNDLE_NAME, new Locale("cy", ""));
                                ...
                                FastStringBuffer stringBuf)
  {
    ...
    //String orientation = thisBundle.getString(de.lyca.xml.utils.res.XResourceBundle.LANG_ORIENTATION);
  ...
  protected String tradAlphaCount(long val, XResourceBundle thisBundle)
  {
    ...
    IntArrayWrapper groups = (IntArrayWrapper) thisBundle.getObject(de.lyca.xml.utils.res.XResourceBundle.LANG_NUMBERGROUPS);

    // array of tables of hundreds, tens, digits...
    StringArrayWrapper tables =
      (StringArrayWrapper) (thisBundle.getObject(de.lyca.xml.utils.res.XResourceBundle.LANG_NUM_TABLES));

    //some languages have additive alphabetical notation,
    //some multiplicative-additive, etc... Handle them differently.
    String numbering = thisBundle.getString(de.lyca.xml.utils.res.XResourceBundle.LANG_NUMBERING);

    // do multiplicative part first
    if (numbering.equals(de.lyca.xml.utils.res.XResourceBundle.LANG_MULT_ADD))
    {
      String mult_order = thisBundle.getString(de.lyca.xml.utils.res.XResourceBundle.MULT_ORDER);
      LongArrayWrapper multiplier =
        (LongArrayWrapper) (thisBundle.getObject(de.lyca.xml.utils.res.XResourceBundle.LANG_MULTIPLIER));
          ...
          while (k < groups.getLength())
          {
            ...
            else
            {
              ...
              char multiplierChar = ((CharArrayWrapper) (thisBundle.getObject(
                de.lyca.xml.utils.res.XResourceBundle.LANG_MULTIPLIER_CHAR))).getChar(i);
