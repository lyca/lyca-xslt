...
public class DecimalFormatProperties extends ElemTemplateElement {
   ...
   * <p>
   * The xsl:decimal-format element declares a decimal-format, which controls
   * the interpretation of a format pattern used by the format-number function.
   ...
   * value of the name attribute is a QName, which is expanded as described in
   * [2.4 Qualified Names]. It is an error to declare either the default
   * decimal-format or a decimal-format with a given name more than once (even
   * with different import precedence), unless it is declared every time with
   * the same value for all attributes (taking into account any default values).
   * </p>
   * <p>
   * The other attributes on xsl:decimal-format correspond to the methods on the
   * JDK 1.1 DecimalFormatSymbols class. For each get/set method pair there is
   * an attribute defined for the xsl:decimal-format element.
   * </p>
   * 
   * @return the decimal format Symbols for this element.
   */
  ...
  /**
   * Set the "name" attribute. If there is a name attribute, then the element
   * declares a named decimal-format; otherwise, it declares the default
   * decimal-format.
   * 
   * @param qname
   *          The name to set as the "name" attribute.
   */
  ...
  /**
   * Get the "name" attribute. If there is a name attribute, then the element
   * declares a named decimal-format; otherwise, it declares the default
   * decimal-format.
   * 
  ...
  /**
   * Set the "decimal-separator" attribute. decimal-separator specifies the
   * character used for the decimal sign; the default value is the period
   * character (.).
   * 
   * @param ds
  ...
  /**
   * Get the "decimal-separator" attribute. decimal-separator specifies the
   * character used for the decimal sign; the default value is the period
   * character (.).
   * 
  ...
  /**
   * Set the "grouping-separator" attribute. grouping-separator specifies the
   * character used as a grouping (e.g. thousands) separator; the default value
  ...
  /**
   * Get the "grouping-separator" attribute. grouping-separator specifies the
   * character used as a grouping (e.g. thousands) separator; the default value
   * is the comma character (,).
   * 
  ...
  /**
   * Set the "infinity" attribute. infinity specifies the string used to
   * represent infinity; the default value is the string Infinity.
   * 
   * @param inf
  ...
  /**
   * Get the "infinity" attribute. infinity specifies the string used to
   * represent infinity; the default value is the string Infinity.
   * 
  ...
  /**
   * Set the "minus-sign" attribute. minus-sign specifies the character used as
   * the default minus sign; the default value is the hyphen-minus character (-,
   * #x2D).
   * 
   * @param v
  ...
  /**
   * Get the "minus-sign" attribute. minus-sign specifies the character used as
   * the default minus sign; the default value is the hyphen-minus character (-,
   * #x2D).
   * 
  ...
  /**
   * Set the "NaN" attribute. NaN specifies the string used to represent the NaN
  ...
  /**
   * Get the "NaN" attribute. NaN specifies the string used to represent the NaN
   * value; the default value is the string NaN.
   * 
  ...
  /**
   * Set the "percent" attribute. percent specifies the character used as a
  ...
  /**
   * Get the "percent" attribute. percent specifies the character used as a
   * percent sign; the default value is the percent character (%).
   * 
  ...
  /**
   * Set the "per-mille" attribute. per-mille specifies the character used as a
  ...
  /**
   * Get the "per-mille" attribute. per-mille specifies the character used as a
   * per mille sign; the default value is the Unicode per-mille character
   * (#x2030).
   * 
  ...
  /**
   * Set the "zero-digit" attribute. zero-digit specifies the character used as
   * the digit zero; the default value is the digit zero (0).
   * 
   * @param v
  ...
  /**
   * Get the "zero-digit" attribute. zero-digit specifies the character used as
   * the digit zero; the default value is the digit zero (0).
   * 
  ...
  /**
   * Set the "pattern-separator" attribute. pattern-separator specifies the
   * character used to separate positive and negative sub patterns in a pattern;
  ...
  /**
   * Get the "pattern-separator" attribute. pattern-separator specifies the
   * character used to separate positive and negative sub patterns in a pattern;
   * the default value is the semi-colon character (;).
   * 
  ...
  /**
   * This function is called to recompose() all of the decimal format properties
   * elements.
   * 
   * @param root
   *          Stylesheet root
