...
/**
 * Implement xsl:with-param. xsl:with-param is allowed within both
 ...
 * 
 * @see <a
 *      href="http://www.w3.org/TR/xslt#element-with-param">element-with-param
...
public class ElemWithParam extends ElemTemplateElement {
  ...
  /**
   * The "select" attribute, which specifies the value of the argument, if
   * element content is not specified.
   * 
   * @serial
   */
  ...
  /**
   * Set the "select" attribute. The "select" attribute specifies the value of
   * the argument, if element content is not specified.
   * 
   * @param v
  ...
  /**
   * Get the "select" attribute. The "select" attribute specifies the value of
   * the argument, if element content is not specified.
   * 
   ...
   * variable the value of whose binding is to be replaced). The value of the
