...
public class ElemPI extends ElemTemplateElement {
   ...
   * name attribute is interpreted as an attribute value template.
   * 
   * @serial
   */
  ...
  /**
   * Create a processing instruction in the result tree. The content of the
   * xsl:processing-instruction element is a template for the string-value of
  ...
  public void execute(TransformerImpl transformer) throws TransformerException {
    ...
    final String piName = m_name_atv == null ? null : m_name_atv.evaluate(xctxt, sourceNode, this);
    ...
    if (piName.equalsIgnoreCase("xml")) {
      transformer.getMsgMgr().warn(this, XSLTErrorResources.WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML,
    ...
    // Ignore processing instruction, if invalid
      ...
      transformer.getMsgMgr().warn(this, XSLTErrorResources.WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
              new Object[] { Constants.ATTRNAME_NAME, piName });
      return;
    }
