...
public class ElemTemplate extends ElemTemplateElement {
  ...
  /**
   * The owning stylesheet. (Should this only be put on the template element, to
   * conserve space?)
   * 
   * @serial
   */
  ...
  /**
   * Get the stylesheet composed (resolves includes and imports and has methods
   * on it that return "composed" properties.
   * 
  ...
  /**
   * The match attribute is a Pattern that identifies the source node or nodes
  ...
  /**
   * Set the "match" attribute. The match attribute is a Pattern that identifies
   * the source node or nodes to which the rule applies. The match attribute is
   * required unless the xsl:template element has a name attribute (see [6 Named
   * Templates]). It is an error for the value of the match attribute to contain
   * a VariableReference.
   * 
  ...
  /**
   * Get the "match" attribute. The match attribute is a Pattern that identifies
   * the source node or nodes to which the rule applies. The match attribute is
   * required unless the xsl:template element has a name attribute (see [6 Named
   * Templates]). It is an error for the value of the match attribute to contain
   * a VariableReference.
  ...
  /**
   * Set the "name" attribute. An xsl:template element with a name attribute
   * specifies a named template. If an xsl:template element has a name
   * attribute, it may, but need not, also have a match attribute.
   * 
   * @see <a href="http://www.w3.org/TR/xslt#named-templates">named-templates in
  ...
  /**
   * Get the "name" attribute. An xsl:template element with a name attribute
   * specifies a named template. If an xsl:template element has a name
   * attribute, it may, but need not, also have a match attribute.
   * 
   * @see <a href="http://www.w3.org/TR/xslt#named-templates">named-templates in
   ...
   * times, each time producing a different result. If xsl:template does not
   * have a match attribute, it must not have a mode attribute.
   * 
  ...
  /**
   * Set the "priority" attribute. The priority of a template rule is specified
   * by the priority attribute on the template rule. The value of this must be a
   * real number (positive or negative), matching the production Number with an
  ...
  /**
   * Get the "priority" attribute. The priority of a template rule is specified
   * by the priority attribute on the template rule. The value of this must be a
   * real number (positive or negative), matching the production Number with an
   * optional leading minus sign (-).
   * 
  ...
  /**
   * The stack frame size for this template, which is equal to the maximum
   * number of params and variables that can be declared in the template at one
   * time.
   */
  ...
  /**
   * List of namespace/local-name pairs, DTM style, that are unique qname
   * identifiers for the arguments. The position of a given qname in the list is
   * the argument ID, and thus the position in the stack frame.
   */
  ...
  /**
   * Copy the template contents into the result tree. The content of the
   * xsl:template element is the template that is instantiated when the template
   * rule is applied.
   * 
   * @param transformer
