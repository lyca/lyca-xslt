        ...
        implements TemplatesHandler, PrefixResolver, NodeConsumer
{
   ...
   * to support the {@link de.lyca.xml.utils.PrefixResolver} interface,
    ...
    try
    {
      ...
      if(
	   ...
	   ("doc-cache-off".equals(localName) &&
	    ns.equals("de.lyca.xalan.xslt.extensions.Redirect") )
	 )
      {
   ...
   *
   * @param msg An key into the {@link de.lyca.xalan.res.XSLTErrorResources}
   ...
   * exception.
   *
   * @param msg A key into the {@link de.lyca.xalan.res.XSLTErrorResources}
   * table, that is one of the WG_ prefixed definitions.
   * @param args An array of arguments for the given warning.
   * @param e An error which the SAXException should wrap.
   *
