...
import de.lyca.xalan.templates.DecimalFormatProperties;

/**
 * Process xsl:decimal-format by creating a DecimalFormatProperties 
 * object and passing it to the stylesheet.
 * 
 * @see de.lyca.xalan.templates.Stylesheet#setDecimalFormat
 * @see de.lyca.xalan.templates.DecimalFormatProperties
