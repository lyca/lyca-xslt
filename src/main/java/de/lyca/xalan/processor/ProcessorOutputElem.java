...
class ProcessorOutputElem extends XSLTElementProcessor {
  ...
  /**
   * The output properties, set temporarily while the properties are being set
   * from the attributes, and then nulled after that operation is completed.
   */
   ...
   *          non-null reference to processed attribute value.
   */
  public void setMethod(de.lyca.xml.utils.QName newValue) {
   ...
   * 
   * @param newValue
   *          non-null reference to attribute value.
   */
  ...
  public void startElement(StylesheetHandler handler, String uri, String localName, String rawName,
    ...
    // Hmmm... for the moment I don't think I'll have default properties set for
    // this. -sb
    ...
    final String entitiesFileName = (String) m_outputProperties.getProperties().get(
