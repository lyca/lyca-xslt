 ...
 * de.lyca.xalan.processor.Version class.
 * </P>
 * <P>
...
public class Version {
  ...
  /**
   * Get the basic version string for the current Xalan release. Version String
   * formatted like <CODE>"<B>Xalan</B> <B>Java</B> v.r[.dd| <B>D</B>nn]"</CODE>
   * .
   * 
   ...
   * significant, externally apparent enhancement from the previous release. 'n'
   * represents the n'th version.
   * 
  ...
  /**
   * Maintenance Drop Number. Optional identifier used to designate maintenance
   * drop applied to a specific release and contains fixes for defects reported.
  ...
  /**
   * Development Drop Number. Optional identifier designates development drop of
   * a specific release. D01 is the first development drop of a new release.
   * 
   ...
   * complete. At the point of the final drop for the release, the D suffix will
   * be omitted.
   * 
